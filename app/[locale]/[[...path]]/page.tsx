  ...
  if (params.path?.[0] === 'changelog') {
    ...
    return (
      ...
      >
        ...
        <ul>
          <li>
            <a href="https://sentry-content-dashboard.sentry.dev/" target="_blank" rel="noreferrer noopener">
              Full Content Dashboard
            </a>{' '}
            - View all Sentry content (blog, videos, docs, changelog)
          </li>
          <li>
            <a href="https://sentry-content-dashboard.sentry.dev/api/docs/feed" target="_blank" rel="noreferrer noopener">
              RSS Feed
            </a>{' '}
            - Subscribe to doc updates in your RSS reader
          </li>
          <li>
            <a href="https://sentry-content-dashboard.sentry.dev/api/docs" target="_blank" rel="noreferrer noopener">
              JSON API
            </a>{' '}
