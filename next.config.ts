...
const outputFileTracingExcludes = process.env.NEXT_PUBLIC_DEVELOPER_DOCS
  ...
  : {
      ...
      // App Router catch-all docs page – aggressively exclude heavy build-time deps
      'app/[locale]/[[...path]]/page': [
        'docs/**/*',
        'develop-docs/**/*',
        'public/mdx-images/**/*',
        'public/og-images/**/*',
      ...
      // Fallback key form some Next versions expect (route-style key)
      '/[locale]/[[...path]]/page': [
        'docs/**/*',
        'develop-docs/**/*',
        'public/mdx-images/**/*',
