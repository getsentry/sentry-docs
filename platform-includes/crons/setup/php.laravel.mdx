...
To set up, add the `sentryMonitor()` macro to your scheduled tasks defined in your `app/Console/Kernel.php` file (please note that this will create a Cron monitor that will count against your quota):
