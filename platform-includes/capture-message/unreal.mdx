...
SentrySubsystem->CaptureEventWithScope(Event, ScopeDelegate);
...
For the full list of supported values, check out [_Event Payloads_](https://develop.sentry.dev/sdk/foundations/transport/event-payloads/) and linked documents.
