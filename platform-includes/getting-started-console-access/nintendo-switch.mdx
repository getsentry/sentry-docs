...
If you want to add additional context to your crash dumps or you want to capture non-fatal events, Sentry offers SDK support specifically for Nintendo Switch.
...
To get access to the SDK, please reach out via the [Nintendo Developer Authorization](https://developer.nintendo.com/group/development/getting-started/g1kr9vj6/middleware/sentry) form or via [Sentry Support](https://sentry.zendesk.com/hc/en-us/requests/new).
