...
![Set tag](/platform-includes/enriching-events/set-tag/unreal_set_tag.png)
...
![Configure default tags](/platform-includes/enriching-events/set-tag/unreal_tags_setting.png)
