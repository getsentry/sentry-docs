To track automatic [Breadcrumbs for HTTP requests](https://develop.sentry.dev/sdk/foundations/data-model/events/breadcrumbs/#breadcrumb-types), you can add a Sentry wrapper that does it automatically for you.
