...
4. Open the [**Logs**](https://docs.sentry.io/platforms/javascript/guides/nextjs/logs/) page and filter by service, environment, or search keywords to view log entries from your application.
