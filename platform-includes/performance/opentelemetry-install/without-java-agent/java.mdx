...
Please note, if you're using Spring Boot, there's a separate `sentry-opentelemetry-agentless-spring` dependency. You can [find out more here](/guides/spring-boot/tracing/instrumentation/opentelemetry/).
