...
The Sentry Android SDK offers [OkHttp](/platforms/android/integrations/okhttp/) and [Apollo](/platforms/android/integrations/apollo4/) integrations for HTTP and GraphQL requests respectively.
