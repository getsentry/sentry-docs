...
![Sample transaction  with Entity Framework Core Integration.](/platform-includes/performance/automatic-instrumentation-integrations/dotnet-ef-core-integration.png)
...
![Sample transaction  with SQLClient Integration.](/platform-includes/performance/automatic-instrumentation-integrations/dotnet-sql-client-integration.png)
