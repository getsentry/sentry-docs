...
To pass options to Ember's default tracing integration, see <PlatformLink to="/tracing/instrumentation/automatic-instrumentation/">Automatic instrumentation</PlatformLink>
