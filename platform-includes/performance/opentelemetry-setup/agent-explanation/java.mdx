...
Since `sentry-opentelemetry-agent` is based on `opentelemetry-agent`, you may also find [OpenTelemetry docs](https://opentelemetry.io/docs/zero-code/java/agent/) helpful.
