...
The Sentry SDK does not register ESM loader hooks. [Register the hooks yourself](https://github.com/open-telemetry/opentelemetry-js/blob/main/doc/esm-support.md#instrumentation-hook-required-for-esm) for your OpenTelemetry instrumentation.
