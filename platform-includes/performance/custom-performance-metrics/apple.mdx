...
if (span != nil) {
    // Record amount of memory used
    [span setMeasurement:@"memory_used" value:@64 unit:SentryObjCMeasurementUnitInformation.megabyte];

    // Record time it took to load user profile
    [span setMeasurement:@"user_profile_loading_time" value:@1.3 unit:SentryObjCMeasurementUnitDuration.second];
