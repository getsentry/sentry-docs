...
-(void) performCheckout
{
  ...
  SentryObjCSpan *transaction = [SentryObjCSDK startTransactionWithName:@"checkout",
                                                   operation:@"perform-checkout"
  );

  // Validate the cart
  SentryObjCSpan *validationSpan = [transaction startChildWithOperation:@"validation",
                                                     description:@"validating shopping cart"];
  ...
  // Process the order
  SentryObjCSpan *processSpan = [transaction startChildWithOperation:@"process",
                                                  description:@"processing shopping cart"];
