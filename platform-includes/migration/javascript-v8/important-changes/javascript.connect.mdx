...
4. Add `--require` to your Node.js call

Using [--require](https://nodejs.org/api/cli.html#-r---require-module) is the easiest way to guarantee that Sentry is imported and initialized before any other modules in your application.
...
If you cannot run node with [--require](https://nodejs.org/api/cli.html#-r---require-module), [add a top-level import of `instrument.js` in your application](/platforms/javascript/guides/connect/initialize-sentry/add-as-toplevel-import).
