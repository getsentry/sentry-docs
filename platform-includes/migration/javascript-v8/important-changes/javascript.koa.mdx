...
If you cannot run node with [--require](https://nodejs.org/api/cli.html#-r---require-module), [add a top-level import of `instrument.js` in your application](/platforms/javascript/guides/koa/initialize-sentry/add-as-toplevel-import).
