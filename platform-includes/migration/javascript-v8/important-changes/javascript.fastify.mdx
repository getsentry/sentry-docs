...
3. Add `--require` to your Node.js call
...
If you cannot run node with [--require](https://nodejs.org/api/cli.html#-r---require-module), [add a top-level import of `instrument.js` in your application](/platforms/javascript/guides/fastify/initialize-sentry/add-as-toplevel-import).
