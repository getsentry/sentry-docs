...
![An example of a Crash-Report modal with text boxes for user name, email, and additional details about the break.](/platform-includes/user-feedback/setup-intro/user_feedback_widget.png)
