The SDK's [`sentry::metrics` module](https://docs.rs/sentry/latest/sentry/metrics/index.html) contains functions for capturing each of the [three metric types](/product/metrics/#metric-types) that Sentry supports.

Metrics are automatically associated with the trace and, if applicable, the span they are captured within.

### Capture a Counter

Capture [counter metrics](/product/metrics/#counters) using [`metrics::counter`](https://docs.rs/sentry/latest/sentry/metrics/fn.counter.html).
...
Capture [gauge metrics](/product/metrics/#gauges) using [`metrics::gauge`](https://docs.rs/sentry/latest/sentry/metrics/fn.gauge.html).
...
Capture [distribution metrics](/product/metrics/#distributions) using [`metrics::distribution`](https://docs.rs/sentry/latest/sentry/metrics/fn.distribution.html).
