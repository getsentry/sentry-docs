After the SDK is initialized, you can send metric data through `\Sentry\traceMetrics()`, which acts as the entry point for recording counts, gauges, and distributions.
