...
Use scope APIs to set attributes that apply to all metrics (and logs) while the scope is active.
...
See [supported units](https://develop.sentry.dev/sdk/foundations/data-model/attributes/#units) for the full list.
