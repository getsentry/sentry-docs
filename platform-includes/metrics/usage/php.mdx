...
The SDK will store up 1000 metric items at once. If more are tracked, only the last 1000 are kept. Make sure to add intermediate flush if you want to store more than 1000 metrics.
