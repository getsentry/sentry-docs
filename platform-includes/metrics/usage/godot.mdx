...
Global attributes support `bool`, `int`, `float`, and `String` data types. Other types will be converted to strings. Attributes passed directly to a metric call take precedence over global attributes with the same key.
