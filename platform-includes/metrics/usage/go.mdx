Once you initialize the SDK, you can create a meter and send metrics using its methods.

The meter exposes three methods that you can use to capture different types of metric information: `Count`, `Gauge`, and `Distribution`.
...
Use `WithCtx` to link metrics to the current trace.
