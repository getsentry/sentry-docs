...
To import and initialize Sentry, create a file named `instrument.(js|mjs)` and add the following code:
...
<Alert level="info" title="Looking for alternative installation methods?">

... or are you unsure which one you need? Find additional installation methods and support <PlatformLink to="/install">here</PlatformLink>.
...
## Step 5: Instrument Your Frontend (Optional)

<PlatformContent includePath="getting-started-instrument-other-end" />
