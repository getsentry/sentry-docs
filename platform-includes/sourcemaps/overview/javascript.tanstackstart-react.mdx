...
and use it in the `sentryTanstackStart` configuration:
...
Configure source map behavior using the [plugin options](https://www.npmjs.com/package/@sentry/vite-plugin/#configuration):
