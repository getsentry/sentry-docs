...
<PlatformSection notSupported={['javascript.node', 'javascript.azure-functions', 'javascript.nextjs', 'javascript.astro', 'javascript.nuxt', 'javascript.remix', 'javascript.solidstart', 'javascript.sveltekit']} supported={['javascript', 'javascript.firebase']}>
