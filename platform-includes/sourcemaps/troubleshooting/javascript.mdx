...
Verify your artifacts are being uploaded to Sentry. You can find them at **[Settings] > Projects > Select your project > [Source Maps](https://sentry.io/orgredirect/organizations/:orgslug/settings/projects/:projectId/source-maps/)**.
