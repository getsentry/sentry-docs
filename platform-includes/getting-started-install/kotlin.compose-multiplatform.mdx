...
- If you use the Kotlin CocoaPods plugin (deprecated), it installs the Sentry Cocoa dependency.

<Include name="kmp-cocoapods-deprecation.mdx" />

<Alert>

If you use Swift Package Manager, you need to install the [Sentry Cocoa dependency with Swift Package Manager](/platforms/apple/install/swift-package-manager/) in your Xcode project first before executing the Gradle plugin.
