<OnboardingOptionButtons
  options={["error-monitoring", "performance", {id: "opentelemetry", checked: true}, "profiling", {id: "logs", checked: true}]}
/>

```xml {tabTitle:Maven Plugin} {mdExpandTabs} {filename:pom.xml}
<plugin>
