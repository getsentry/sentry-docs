...
```groovy {tabTitle:Gradle (Spring Boot 4)}
implementation 'io.sentry:sentry-spring-boot-4:{{@inject packages.version('sentry.java.spring-boot-4', '8.15.1') }}'
// ___PRODUCT_OPTION_START___ profiling
implementation 'io.sentry:sentry-async-profiler:{{@inject packages.version('sentry.java.async-profiler', '8.23.0') }}'
// ___PRODUCT_OPTION_END___ profiling
```
...
```xml {tabTitle:Maven (Spring Boot 4)}
<dependency>
    <groupId>io.sentry</groupId>
    <artifactId>sentry-spring-boot-4</artifactId>
    <version>{{@inject packages.version('sentry.java.spring-boot-4', '8.15.1') }}</version>
</dependency>
// ___PRODUCT_OPTION_START___ profiling
<dependency>
    <groupId>io.sentry</groupId>
