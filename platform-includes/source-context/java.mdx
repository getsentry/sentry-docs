...
After uploading, you can find your source bundle under **Project Settings > Debug Files**. Search by the debug ID you used during the upload to locate it, and use the **Download** button to grab a copy.
