...
# Replace <platform> with the mobile or desktop platform you're building for: https://docs.flutter.dev/deployment
flutter build <platform> --obfuscate --split-debug-info=<output-directory> --extra-gen-snapshot-options=--save-obfuscation-map=build/app/obfuscation.map.json
```
