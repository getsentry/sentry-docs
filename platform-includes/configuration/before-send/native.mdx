...
sentry_value_t strip_sensitive_data(sentry_value_t event, sentry_hint_t *hint, void *user_data) {
    (void)hint;
...
on_crash_callback(
    ...
    sentry_hint_t *hint,           // provides the attachments included with the crash
