...
In C#, initialize the SDK by calling `Sentry.Godot.SentrySdk.Init()` from your code. See <PlatformLink to="/dotnet/#manual-initialization">C#/.NET Support</PlatformLink> for details.
