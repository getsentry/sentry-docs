...
The C# layer self-initializes through the use of the [BeforeSceneLoad RuntimeInitializeOnLoadMethodAttribute](https://docs.unity3d.com/ScriptReference/RuntimeInitializeLoadType.BeforeSceneLoad.html). On desktop, the C# layer is also responsible for initializing the native SDKs.
...
![Options Configuration](/platform-includes/configuration/config-intro/unity-options-configuration.png)
