...
On web you're required to use the `SentryNavigatorObserver` since sessions are tied to navigation events and your navigation routes to have names e.g using `RouteSettings`.
