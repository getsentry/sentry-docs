Distributed tracing works out of the box for [supported frameworks](/platforms/python/distributed-tracing/#how-to-use-distributed-tracing) and when <PlatformLink to="/performance/">performance monitoring</PlatformLink> is enabled. If you're using an unsupported framework or don't want to turn on performance monitoring, you can set up custom instrumentation for distributed tracing.
