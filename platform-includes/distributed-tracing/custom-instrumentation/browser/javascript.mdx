...
If you have not enabled tracing, or you need to propagate traces in other places than outgoing HTTP requests, you can manually set up your application for distributed tracing to work.
