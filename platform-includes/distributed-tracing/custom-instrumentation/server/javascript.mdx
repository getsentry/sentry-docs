...
For other cases where you may want to continue traces (e.g. in a job queue or when working with web sockets), you can manually extract and inject tracing information.

If you want to use automated distributed tracing but not tracing, set the `tracesSampleRate` option to `0`.
