...
<Alert title="Errors in Nested React Server Components" level="warning">

Since Next.js is not exposing errors thrown in nested React Server Components, the SDK can currently not capture them.

[Follow our proposal in the Next.js repository.](https://github.com/vercel/next.js/discussions/67149)
