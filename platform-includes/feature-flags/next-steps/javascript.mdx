...
- **Track feature flag evaluations in other parts of your codebase.** If needed, you can set up evaluation tracking for more than one SDK. <PlatformLink to="/feature-flags/#enable-evaluation-tracking">Read the docs</PlatformLink> to learn more.
- **Set up your change tracking webhook.** In order to take full advantage of the feature flag capabilities Sentry offers there is an additional setup step needed. Your feature flag provider needs to notify Sentry when a feature flag definition has changed. A Sentry webhook URL can be registered with your provider. <PlatformLink to="/feature-flags/#enable-change-tracking">Learn how</PlatformLink>.
