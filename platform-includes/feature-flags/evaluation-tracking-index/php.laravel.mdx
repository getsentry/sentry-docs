...
When using [rich values](https://laravel.com/docs/12.x/pennant#rich-feature-values), it is important to know that a feature is considered "active" when it has any value other than false.
