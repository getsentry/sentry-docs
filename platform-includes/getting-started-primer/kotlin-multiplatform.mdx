...
<Note>
Due to Apple's new requirements, you need to provide a privacy manifest file for your app and therefore recommend using Sentry Cocoa SDK version `8.25.0` or newer.
