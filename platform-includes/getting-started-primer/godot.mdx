Our Godot Engine SDK builds on top of other Sentry SDKs and extends them with Godot Engine specific features. It gives developers helpful hints for where and why an error or performance issue might have occurred.
