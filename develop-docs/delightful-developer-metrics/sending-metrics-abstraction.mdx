...
Do not use the internal abstraction for sending metrics at this stage. We want to dogfood the SDK methods to feel the ergonomics and the experience our customers will get. [Use this instead.](/delightful-developer-metrics/sending-metrics/)
