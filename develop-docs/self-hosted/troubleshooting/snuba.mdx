...
Snuba is the service that handles Sentry's search and analytics. It's separated into two: a consumer that ingest data from Kafka into ClickHouse, and a queryer that queries ClickHouse and returns the results into Sentry.
