...
This documentation assume `100.100.123.123` as your statsd host IP address. On most services, it is recommended to provide IP address for the host, instead of a domain name (something like `statsd.yourcompany.com`).
