...
<Alert title="Important" level="warning">
    The docs below are contributed by the community. Sentry does not officially provide support for setting up reverse proxies for your self-hosted Sentry setup. Follow these guidelines at your own risk as these docs are not maintained nor kept up to date!
</Alert>
