...
- 24.8.0
- 25.5.1
- 26.5.1 (if you encounter `IntegrityError` error, refer to [this troubleshooting section](../troubleshooting/sentry#database-migration-issue-for-notifmsg_metric_or_workflow_exclusive-check-constraint))
