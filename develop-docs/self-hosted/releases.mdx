...
In short, this is to keep the self-hosted Sentry as close to the live version hosted at [sentry.io](http://sentry.io/). There are more details for the curious over at our [blog post announcing the switch](https://blog.sentry.io/2020/06/22/self-hosted-sentry-switching-to-calver).
