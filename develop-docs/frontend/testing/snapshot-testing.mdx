...
Have claude (or your favorite agent) create a snapshot test for you! Point it to an existing snapshot test (like `button.snapshot.tsx`) and ask it to generate a similar snapshot test for your component.
