...
- `taskbroker`: Bring up sentry dependencies, and taskbroker
- `taskworker`: Bring up sentry dependencies, taskbroker, taskworker, and taskworker-scheduler
...
devservices sandbox logs [SERVICE] [-f]                # View service logs
