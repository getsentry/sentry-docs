...
- [The Indexed Outcome Category](/application-architecture/dynamic-sampling/outcomes/)
...
[The Indexed Outcome Category](/application-architecture/dynamic-sampling/outcomes/) for details.
