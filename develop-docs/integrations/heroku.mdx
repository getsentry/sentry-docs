...
---
## Deprecation Warning
Heroku plugin is deprecated and will be removed on October 23, 2025. This plugin automatically tracked releases and deployments from your Heroku apps in Sentry, linking them to error tracking and performance monitoring.
You can still use Sentry with Heroku by setting up [Releases](/product/releases/overview/). Releases let you track versions, commits, crash-free sessions, and more.
