...
Follow our [documentation on using the Microsoft Teams integration](https://docs.sentry.io/integrations/notification-incidents/msteams/) to use the integration.
