...
<CreateGitHubAppForm
  url="https://github.com/organizations/:org/settings/apps/new?name=:org-Sentry-Integration&public=false&members=read&emails=read&administration=read&contents=write&checks=write&statuses=write&issues=write&pull_requests=write&repository_hooks=write&actions=write&code_quality=read&security_events=read&url=:url-prefix&callback_urls[]=:url-prefix%2Fauth%2Fsso%2F&callback_urls[]=:url-prefix%2Fextensions%2Fgithub%2Fsetup%2F&setup_url=:url-prefix%2Fextensions%2Fgithub%2Fsetup%2F&webhook_url=:url-prefix%2Fextensions%2Fgithub%2Fwebhook%2F&events[]=push&events[]=pull_request&events[]=check_run&events[]=check_suite&events[]=pull_request_review&events[]=pull_request_review_comment&webhook_active=true"
...
| Repository / Code quality                        | Read-only    |
