...
Route based analytics can be customized to have different event names and parameters. For class based components, `withRouteAnalytics` can be used. For functional components, the following hooks can be used:
