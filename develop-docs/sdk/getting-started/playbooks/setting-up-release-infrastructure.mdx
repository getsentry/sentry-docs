...
- [Version format](/sdk/getting-started/standards/release-versioning#version-format) — SemVer requirements
- [Release tooling](/sdk/getting-started/standards/release-versioning#release-tooling) — Craft and publish setup
- [Release gating criteria](/sdk/getting-started/standards/review-ci#release-gating-criteria) — Pre-release validation requirements
- [Rollback procedures](/sdk/getting-started/standards/coordination-maintenance#rollback-procedures) — Emergency release rollback process
