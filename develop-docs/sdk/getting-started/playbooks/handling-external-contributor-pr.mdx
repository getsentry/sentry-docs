...
If the PR is non-trivial and has no linked issue, use this [saved reply](/sdk/getting-started/templates/saved-replies#closing-pull-requests):
...
If the PR is a style-only change or refactor with no linked issue or problem statement, use this [saved reply](/sdk/getting-started/templates/saved-replies#closing-pull-requests):
