...
- [Aligning Cross-SDK Changes](/sdk/getting-started/playbooks/aligning-cross-sdk-changes) — coordinating deprecations across multiple SDKs
...
If the deprecation affects multiple Sentry SDKs, you **MUST** follow the [Aligning Cross-SDK Changes](/sdk/getting-started/playbooks/aligning-cross-sdk-changes) process first to coordinate timing and approach across SDK teams.
