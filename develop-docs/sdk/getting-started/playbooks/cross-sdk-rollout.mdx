...
##### If the change involves new attributes: Land semantic conventions first

You **MUST** land the sentry-conventions PR first ([Semantic conventions process](/sdk/getting-started/standards/api-architecture#semantic-conventions-process)).
