...
Related resources:
- [Platform/language version support policy](/sdk/getting-started/standards/coordination-maintenance#version-support) — support policy and requirements
...
- [Platform/language version support policy](/sdk/getting-started/standards/coordination-maintenance#version-support) — support policy baseline
