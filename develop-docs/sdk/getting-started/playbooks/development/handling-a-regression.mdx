...
- Cut a patch release following [Cutting a Release](/sdk/getting-started/playbooks/sdk-lifecycle/cutting-a-release), expedited — you **MAY** skip non-essential gates for critical severity
