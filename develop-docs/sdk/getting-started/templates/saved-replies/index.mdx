...
<CopyableCard title="Issue/Acknowledge: Valid low-prio feature request">

Thanks for the report, we appreciate you taking the time to write this up!

We've looked into this and while we do think it's a valid issue, it's currently not something we're able to prioritize. We have other work on our roadmap that we consider more impactful to address first.

If this is important to you, we'd genuinely welcome a contribution. Feel free to open a PR and we'd be happy to review and guide you through the process. Please have a look at our contributing guidelines, and don't hesitate to ask questions here first.

We'll leave this open in case someone wants to pick it up!
