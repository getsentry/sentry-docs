...
Use the [`sentry-skills:contributing-md`](https://github.com/getsentry/skills/blob/main/plugins/sentry-skills/skills/contributing-md/SKILL.md) skill to generate initial content from your codebase — it detects commands, CI config, and ecosystem from the repo and fills in the placeholders below.
