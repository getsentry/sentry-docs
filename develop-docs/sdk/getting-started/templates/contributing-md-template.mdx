...
Use the [`sentry-sdk-skills:contributing-md`](https://github.com/getsentry/skills/blob/main/plugins/sentry-sdk-skills/skills/contributing-md/SKILL.md) skill to create or update your `CONTRIBUTING.md` — it detects commands, CI config, and ecosystem from the repo, fills in the placeholders below, and preserves any SDK-specific sections already present.
