...
Every SDK **MUST** have a documented rollback plan covering:
...
An annual rollback drill is recommended. See [Setting up release infrastructure](/sdk/getting-started/playbooks/setup/setting-up-release-infrastructure) for initial setup.
