...
| **[Sentry MCP Server](/ai/mcp/)** | Live Sentry data in your LLM client | Bring Sentry issues and Seer analysis into your coding session |
| **[Sentry CLI](/ai/sentry-cli/)** | Natural-language issue management | List, inspect, and triage issues from the terminal or an agent |
