...
Public skills for setting up Sentry in customer projects and debugging issues — SDK setup, AI monitoring configuration, issue fixing, and PR review workflows. See [Agent Skills](/ai/agent-skills/) for the full list and install instructions.
