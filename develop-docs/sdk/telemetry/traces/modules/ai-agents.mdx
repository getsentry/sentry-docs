...
- If the request originates from an agent, the `gen_ai.agent.name` attribute SHOULD be set to the name of the agent.
- All [Common Span Attributes](#common-span-attributes) SHOULD be set (all `required` common attributes MUST be set).
...
- Attribute `gen_ai.agent.name` SHOULD be set to the name of the agent that invoked the tool.
- All [Common Span Attributes](#common-span-attributes) SHOULD be set (all `required` common attributes MUST be set).
