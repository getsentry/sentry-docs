...
Sentry currently auto-generates AI Agent Monitoring data for `openai-agents` in Python and `Vercel AI` in Javascript. You may need to manually annotate spans for other frameworks.
