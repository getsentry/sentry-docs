...
spec_id: sdk/telemetry/traces/modules/ai-agents
spec_version: 1.13.0
spec_status: stable
spec_changelog:
  - version: 1.13.0
    date: 2026-02-10
    summary: Narrowed operation names, elaborated agent/pipeline naming
  - version: 1.0.0
    date: 2025-07-07
    summary: Initial spec — AI Agents module
---
...
<SpecSection id="overview" status="stable" since="1.0.0">
...
<SpecSection id="create-agent-span" status="stable" since="1.0.0">
...
<SpecSection id="invoke-agent-span" status="stable" since="1.0.0">
...
<SpecSection id="ai-client-span" status="stable" since="1.0.0">
...
<SpecSection id="execute-tool-span" status="stable" since="1.0.0">
...
<SpecSection id="handoff-span" status="stable" since="1.0.0">
...
<SpecSection id="common-span-attributes" status="stable" since="1.0.0">
