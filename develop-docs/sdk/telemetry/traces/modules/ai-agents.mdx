...
| Attribute                               | Type | Requirement Level | Description                                                                                     | Example |
| :-------------------------------------- | :--- | :---------------- | :---------------------------------------------------------------------------------------------- | :------ |
| `gen_ai.usage.input_tokens`             | int  | optional          | The number of tokens used to process the AI input (prompt) without cached input tokens. **[2]** | `10`    |
...
| `gen_ai.usage.output_tokens`            | int  | optional          | The number of tokens used for creating the AI output without reasoning tokens. **[3]**          | `100`   |
...
- **[2]:** Cached tokens are NOT included in `gen_ai.usage.input_tokens`; they are tracked separately in `gen_ai.usage.input_tokens.cached`.
- **[3]:** Reasoning tokens are NOT included in `gen_ai.usage.output_tokens`; they are tracked separately in `gen_ai.usage.output_tokens.reasoning`.
...
| `gen_ai.pipeline.name`  | string | optional          | Name of the AI pipeline or chain being executed.                                         | `"weather-pipeline"`  |
