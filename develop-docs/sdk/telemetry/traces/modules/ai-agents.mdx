...
For your AI agents data to show up in the Sentry [AI Agents Insights](https://sentry.io/orgredirect/organizations/:orgslug/insights/ai/agents/), a couple of different spans must be created and have well-defined names and data attributes.
...
| Attribute               | Type   | Requirement Level | Description                                                                              | Example               |
| :---------------------- | :----- | :---------------- | :--------------------------------------------------------------------------------------- | :-------------------- |
| `gen_ai.system`         | string | required          | The Generative AI product as identified by the client or server instrumentation. **[2]** | `"openai"`            |
| `gen_ai.request.model`  | string | required          | The name of the AI model a request is being made to.                                     | `"gpt-4o"`            |
| `gen_ai.operation.name` | string | required          | The name of the operation being performed. **[3]**                                       | `"chat"`              |
...
**[2]** Well defined values for data attribute `gen_ai.system`:
...
**[3]** Well defined values for data attribute `gen_ai.operation.name`:
