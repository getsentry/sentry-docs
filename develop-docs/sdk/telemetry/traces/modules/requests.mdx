...
spec_id: sdk/telemetry/traces/modules/requests
spec_version: 1.2.0
spec_status: stable
spec_changelog:
  - version: 1.2.0
    date: 2024-08-15
    summary: Sync dev docs
  - version: 1.0.0
    date: 2024-06-03
    summary: Initial spec — HTTP requests module
---
...
<SpecSection id="span-attributes" status="stable" since="1.0.0">
...
<SpecSection id="instrumentation-example" status="stable" since="1.0.0">
