---
title: Queues Module
spec_id: sdk/telemetry/traces/modules/queues
spec_version: 1.2.0
spec_status: stable
spec_changelog:
  - version: 1.2.0
    date: 2025-06-24
    summary: Fixed latency unit
  - version: 1.0.0
    date: 2024-04-01
    summary: Initial spec — queues module
---
...
<SpecSection id="instrumentation" status="stable" since="1.0.0">
