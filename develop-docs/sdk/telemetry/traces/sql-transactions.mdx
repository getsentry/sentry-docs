...
spec_id: sdk/telemetry/traces/sql-transactions
spec_version: 1.0.0
spec_status: stable
spec_changelog:
  - version: 1.0.0
    date: 2025-10-21
    summary: Initial spec — auto-instrumentation of SQL transaction statements
---
...
<SpecSection id="span-data" status="stable" since="1.0.0">
