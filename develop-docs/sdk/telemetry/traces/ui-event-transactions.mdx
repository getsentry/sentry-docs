...
spec_id: sdk/telemetry/traces/ui-event-transactions
spec_version: 1.1.0
spec_status: stable
spec_platforms: mobile
spec_changelog:
  - version: 1.1.0
    date: 2023-03-06
    summary: Same event same element handling
  - version: 1.0.0
    date: 2022-10-06
    summary: Initial spec — UI event transactions for mobile
---
...
<SpecSection id="specification" status="stable" since="1.0.0">
...
<SpecSection id="binding-to-scope" status="stable" since="1.0.0">
...
auto-generated spans not to be empty. Therefore, the SDK **SHOULD NOT** start a UI event transaction if there
...
<SpecSection id="transaction-name" status="stable" since="1.0.0">
