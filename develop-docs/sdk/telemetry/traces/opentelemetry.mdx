...
spec_id: sdk/telemetry/traces/opentelemetry
spec_version: 1.18.0
spec_status: stable
spec_changelog:
  - version: 1.18.0
    date: 2025-02-25
    summary: Format and consolidation updates
  - version: 1.0.0
    date: 2022-08-03
    summary: Initial spec — OpenTelemetry support
---
...
Related specs:
- [Performance Monitoring Research](/sdk/research/performance/) — historical background
- [Span Protocol](/sdk/foundations/data-model/event-payloads/span/) — Sentry span interface
...
<SpecSection id="step-6-instrumenter-option" status="deprecated" since="1.0.0">
...
### Generate Errors from Spans

<SpecSection id="step-7-generate-sentry-errors" status="stable" since="1.0.0">
...
<SpecSection id="span-protocol" status="stable" since="1.0.0">
...
// canonicalCodesHTTPMap maps some HTTP codes to Sentry's span statuses. See possible mapping in https://develop.sentry.dev/sdk/foundations/data-model/event-payloads/span/
...
<SpecSection id="transaction-protocol" status="stable" since="1.0.0">
...
<SpecSection id="opentelemetry-context" status="stable" since="1.0.0">
...
<SpecSection id="step-1-sentry-span-processor" status="stable" since="1.0.0">
...
<SpecSection id="step-2-sentry-propagator" status="stable" since="1.0.0">
...
### `isSentryRequest` and `getTraceData`

<SpecSection id="step-3-is-sentry-request" status="stable" since="1.0.0">
...
<SpecSection id="step-3-get-trace-data" status="stable" since="1.0.0">
...
<SpecSection id="step-4-update-span-with-otel-data" status="stable" since="1.0.0">
...
<SpecSection id="step-5-opentelemetry-context" status="stable" since="1.0.0">
