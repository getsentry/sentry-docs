...
spec_id: sdk/telemetry/traces/time-to-initial-full-display
spec_version: 1.1.0
spec_status: stable
spec_platforms:
  - mobile
spec_changelog:
  - version: 1.1.0
    date: 2023-07-10
    summary: Align start timestamp with app start timestamp
  - version: 1.0.0
    date: 2023-02-27
    summary: Initial spec — TTID and TTFD spans for mobile/desktop
---
...
<SpecSection id="ttid" status="stable" since="1.0.0">
...
<SpecSection id="ttfd" status="stable" since="1.0.0">
