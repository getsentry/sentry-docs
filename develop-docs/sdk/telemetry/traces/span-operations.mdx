...
spec_id: sdk/telemetry/traces/span-operations
spec_version: 1.16.0
spec_status: stable
spec_changelog:
  - version: 1.16.0
    date: 2025-10-09
    summary: Missing categories update
  - version: 1.0.0
    date: 2022-01-26
    summary: Initial spec — span operations reference
---
...
<SpecSection id="operations-reference" status="stable" since="1.0.0">
