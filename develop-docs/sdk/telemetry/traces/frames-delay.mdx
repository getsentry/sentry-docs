---
title: Frames Delay
spec_id: sdk/telemetry/traces/frames-delay
spec_version: 1.0.0
spec_status: stable
spec_platforms:
  - mobile
spec_changelog:
  - version: 1.0.0
    date: 2024-02-15
    summary: Initial spec — frames delay metric for mobile and desktop SDKs
---
...
Related specs:
- [Span Data Conventions](/sdk/telemetry/traces/span-data-conventions/#mobile) — `frames.delay` attribute
...
<SpecSection id="frames-delay-spec" status="stable" since="1.0.0">
...
SDKs **SHOULD** attach frames delay in seconds to spans via <Link to="/sdk/telemetry/traces/span-data-conventions/#mobile">span data</Link>
