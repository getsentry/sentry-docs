...
the <Link to="/sdk/foundations/data-model/events/contexts/#trace-context">trace context</Link>, <Link to="/sdk/foundations/data-model/events/span/">spans</Link>, or <Link to="/sdk/telemetry/logs/">logs</Link>.
...
- <Link to="/sdk/foundations/data-model/events/span/">Span Interface</Link>
- <Link to="/sdk/foundations/data-model/events/contexts/#trace-context">Trace Context</Link>
