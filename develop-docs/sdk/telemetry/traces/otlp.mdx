...
spec_id: sdk/telemetry/traces/otlp
spec_version: 1.1.0
spec_status: candidate
spec_changelog:
  - version: 1.1.0
    date: 2025-12-16
    summary: Added capture_exceptions interceptor for Span.record_exception
  - version: 1.0.0
    date: 2025-11-18
    summary: Initial spec — OTLPIntegration for simplified OpenTelemetry setup
---
...
Related specs:
- [OpenTelemetry Support](/sdk/telemetry/traces/opentelemetry/) — the older POTEL approach
...
<SpecSection id="integration-spec" status="candidate" since="1.0.0">
...
<SpecSection id="span-exporter" status="candidate" since="1.0.0">
...
<SpecSection id="propagator" status="candidate" since="1.0.0">
...
<SpecSection id="external-propagation-context" status="candidate" since="1.0.0">
...
<SpecSection id="exception-interceptor" status="candidate" since="1.1.0">
