...
In SDKs adapting OpenTelemetry's tracing capabilities ([POTel](/sdk/foundations/state-management/scopes/#otel-context-alignment)), the TwP trace data could also be stored in a non-recording span.
