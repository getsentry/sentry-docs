...
spec_id: sdk/telemetry/traces/span-data-conventions
spec_version: 1.21.0
spec_status: stable
spec_changelog:
  - version: 1.21.0
    date: 2025-04-14
    summary: Naming conventions for flags
  - version: 1.0.0
    date: 2023-02-14
    summary: Initial spec — span data conventions reference
---
...
<SpecSection id="conventions" status="stable" since="1.0.0">
...
<SpecSection id="data-reference" status="stable" since="1.0.0">
...
| `call_stack`          | StackFrame[] | The most relevant stack frames, that lead to the File I/O span. The stack frame should adhere to the [`StackFrame`](https://develop.sentry.dev/sdk/foundations/data-model/event-payloads/stacktrace/#frame-attributes) interface. |                       |
