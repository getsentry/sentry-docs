...
| `call_stack`          | StackFrame[] | The most relevant stack frames, that lead to the File I/O span. The stack frame should adhere to the [`StackFrame`](https://develop.sentry.dev/sdk/foundations/data-model/events/stacktrace/#frame-attributes) interface. |                       |
