...
This SHOULD be a sequence of integers, denoting HTTP status codes.
If suitable for the platform, the option MAY also admit pairs of integers, denoting HTTP status code ranges.
...
Examples:
`[403, 404]`: don't sample transactions with status code 403 or 404
`[[300, 305], [401, 404]]`: don't sample transactions with status codes between 300 and 305 (inclusive) or between 401 and 404 (inclusive)
