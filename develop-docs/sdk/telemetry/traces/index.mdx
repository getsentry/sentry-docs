...
The [Span](/sdk/foundations/data-model/event-payloads/span/) class stores each individual span in a
trace.

The [Transaction](/sdk/foundations/data-model/event-payloads/transaction/) class is like a span, with a
few key differences:
