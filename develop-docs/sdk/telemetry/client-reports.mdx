...
SDKs can assume client reports are never rate limited.

For more details on retry behavior and error handling, see [Dealing with Network Failures](/sdk/expected-features/#dealing-with-network-failures).
