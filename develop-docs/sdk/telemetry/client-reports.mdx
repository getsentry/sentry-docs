...
- [Envelope Items](/sdk/foundations/envelopes/envelope-items/) — envelope item types
...
- Size limit: 4 KiB (see [Envelopes — Size Limits](/sdk/foundations/envelopes/)).
