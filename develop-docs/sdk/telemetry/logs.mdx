...
SDKs **MUST** have a hard limit of 100 log events queued up to avoid causing your customers' applications going out of memory. Logs added once this hard limit has been reached are dropped. SDKs **MAY** use lower values, but they **MUST NOT** exceed 100. Also, Relay is optimized for 100 logs or less per envelope. SDKs **MUST** not exceed this limit when sending log envelopes.
