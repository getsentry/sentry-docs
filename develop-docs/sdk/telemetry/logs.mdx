...
spec_changelog:
  - version: 1.16.0
    date: 2026-02-06
    summary: Added sentry.log.sequence default attribute for deterministic log ordering
  - version: 1.15.0
    date: 2026-02-03
...
| `sentry.log.sequence` | 1.16.0 | A monotonically incrementing integer counter used to determine correct ordering of logs when timestamps are identical. See [Log Ordering](#log-ordering). |
...
- Be scoped to the SDK instance lifetime. It resets naturally on process restart.
  ...
  "items": [
    ...
    },
    {
      ...
      "attributes": {
        ...
        "sentry.log.sequence": { "value": 1, "type": "integer" }
      }
    },
    {
      "timestamp": 1746456149.0191998,
      ...
      "attributes": {
        ...
        "sentry.log.sequence": { "value": 2, "type": "integer" }
      }
    },
    {
      ...
      "attributes": {
        ...
        "sentry.log.sequence": { "value": 3, "type": "integer" }
      }
    },
    {
      "timestamp": 1746456149.0192997,
      ...
      "attributes": {
        ...
        "sentry.log.sequence": { "value": 4, "type": "integer" }
      }
    },
    {
      "timestamp": 1746456149.0192997,
      ...
      "attributes": {
        ...
        "sentry.log.sequence": { "value": 5, "type": "integer" }
      }
    }
  ]
}
