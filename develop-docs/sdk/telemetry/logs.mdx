...
As Relay has a hard limit of 1000 logs per envelope, SDKs MUST ensure not to exceed this limit. SDKs SHOULD therefore batch logs into envelopes of 100 logs or less.
