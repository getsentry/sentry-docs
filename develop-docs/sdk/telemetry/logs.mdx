...
- [Trace Origin](/sdk/telemetry/transactions/#trace-origin) — origin attribute format
...
If a log is generated by an SDK integration, the SDK **SHOULD** set the `sentry.origin` attribute per the [Trace Origin](/sdk/telemetry/transactions/#trace-origin) documentation.
