...
<VersionedSection id="check-in-lifecycle" status="stable" since="1.0.0">
...
<VersionedSection id="trace-context-linking" status="stable" since="1.3.0">
...
<VersionedSection id="zero-uuid-update" status="stable" since="1.2.0">
...
<VersionedSection id="monitor-upsert" status="stable" since="1.1.0">
...
<VersionedSection id="auto-instrumentation" status="stable" since="1.1.0">
...
<VersionedSection id="check-in-payload" status="stable" since="1.0.0">
...
<VersionedSection id="monitor-config-payload" status="stable" since="1.1.0">
...
<VersionedSection id="schedule-config" status="stable" since="1.1.0">
...
<VersionedSection id="capture-check-in" status="stable" since="1.0.0">
...
<VersionedSection id="monitor-wrapper" status="stable" since="1.1.0">
...
<VersionedSection id="hooks" status="stable" since="1.6.0">
