...
| `contexts` | Object | **OPTIONAL** | 1.3.0 | Contextual information. Currently supports [trace context](/sdk/foundations/transport/event-payloads/contexts/#trace-context) with `trace_id` for linking check-ins to errors. |
