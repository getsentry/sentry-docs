...
To ensure the best [Dynamic Sampling Context](/sdk/foundations/trace-propagation/dynamic-sampling-context/) (DSC) consistency, SDKs **SHOULD** materialize and freeze the DSC as late as possible. In practice:
