...
This page specifies requirements for the span buffer. It intentionally does not specify as much as the [Telemetry Processor](/sdk/foundations/processor/) page. SDKs MAY implement and extend the span buffer with platform-specific behaviour,
