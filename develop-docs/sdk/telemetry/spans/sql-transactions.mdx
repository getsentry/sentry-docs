...
If a synonym like BEGIN TRANSACTION for BEGIN is used, the operation name CAN be either synonym, so "BEGIN TRANSACTION" MAY be used in this instance.
...
Other modified transaction statements are treated the same.
