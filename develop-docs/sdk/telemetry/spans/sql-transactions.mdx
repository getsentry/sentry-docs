...
Spans for other transaction-level statements, such as SAVEPOINT, are RECOMMENDED, and when implemented, MUST also correspond to individual SQL instructions.
