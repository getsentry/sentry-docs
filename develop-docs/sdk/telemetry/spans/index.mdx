...
The payload **MAY** also include top-level `version` and `ingest_settings` fields to instruct Relay to infer IP address and user agent from the incoming request:
