...
5. Mobile SDKs MUST minimize data loss when sudden process terminations occur. Refer to the [Sudden Process Terminations](/sdk/telemetry/telemetry-buffer/mobile-telemetry-buffer/#sudden-process-terminations) section for more details.
