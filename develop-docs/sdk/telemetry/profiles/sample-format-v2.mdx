...
: *Object, required on native platforms.* This carries the same payload as the [`debug_meta` interface](/sdk/foundations/data-model/events/sdk/).
...
: *List, required*. Contains a list of frame objects (see [Frame Attributes](/sdk/foundations/data-model/events/stacktrace/#frame-attributes)).
