...
- [Envelope Items](/sdk/foundations/transport/envelope-items/) — `profile` and `profile_chunk` item type constraints
...
A V1 profile **MUST** be serialized as JSON and sent in the same [envelope](/sdk/foundations/transport/envelopes/) as the associated transaction with item type [`profile`](/sdk/foundations/transport/envelope-items/#profile).
...
A V2 profile chunk **MUST** be serialized as JSON and sent in an [envelope](/sdk/foundations/transport/envelopes/) with item type [`profile_chunk`](/sdk/foundations/transport/envelope-items/#profile-chunk).
