...
[Envelope](/sdk/foundations/transport/envelopes/) as the associated transaction with the item type
[`profile`](/sdk/foundations/transport/envelope-items/#profile) and send it to Relay.
