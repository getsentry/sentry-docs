...
[Envelope](/sdk/foundations/data-model/envelopes/) as the associated transaction with the item type
[`profile`](/sdk/foundations/data-model/envelope-items/#profile) and send it to Relay.
