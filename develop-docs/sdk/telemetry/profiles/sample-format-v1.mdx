...
: *Object, required on native platforms.* This carries the same payload as the [`debug_meta` interface](/sdk/event-payloads/sdk/).
...
: *List, required*. Contains a list of frame objects (see [Frame Attributes](/sdk/event-payloads/stacktrace/#frame-attributes)).
