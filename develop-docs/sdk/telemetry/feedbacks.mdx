...
Forms **MUST** check the message before calling the capture API. When validation fails, the form **MUST** prevent submission, preserve the user's input, and display an accessible error explaining how to correct it.
