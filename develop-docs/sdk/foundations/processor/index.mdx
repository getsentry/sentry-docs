...
* [Backend Telemetry Processor](./backend/): Detailed backend design
* [Browser Telemetry Processor](./browser/): To be defined
* [GDX Telemetry Processor](./gdx/): To be defined
* [Mobile Telemetry Processor](./mobile/): Spec under validation.

## FAQ

### Where is the Batch Processor?

The batch processor is deprecated, so we moved it to the [batch-processor](/sdk/foundations/processor/batch-processor/) page. The telemetry buffer will include parts of the batch processor functionality.
