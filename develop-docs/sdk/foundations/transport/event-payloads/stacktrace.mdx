...
- If the stack trace is part of an error, exception or crash, add it to the [Exception Interface](/sdk/foundations/transport/event-payloads/exception/).
- Otherwise, add it as a thread in the [Threads Interface](/sdk/foundations/transport/event-payloads/threads/).
...
known image is defined in the [Debug Meta Interface](/sdk/foundations/transport/event-payloads/debugmeta/), then
