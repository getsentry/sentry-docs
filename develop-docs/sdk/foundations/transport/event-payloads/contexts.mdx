...
The following example illustrates the contexts part of the <Link to="/sdk/foundations/transport/event-payloads/">event payload</Link> and omits other attributes for simplicity.
