...
Events are packed into [envelopes](/sdk/foundations/envelopes/) and are sent to the `/api/{PROJECT_ID}/envelope/` API endpoint.
...
Fingerprints](https://docs.sentry.io/concepts/data-management/event-grouping/).
...
See [Envelope Size Limits](/sdk/foundations/envelopes/#size-limits) for further details.
...
- [Exception Interface](/sdk/telemetry/errors/#wire-format)
