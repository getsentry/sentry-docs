...
As per Sentry policy, the thread that crashed with an [exception](/sdk/telemetry/errors/) should not
...
declared in the [Exception Interface](/sdk/telemetry/errors/#wire-format) instead.
