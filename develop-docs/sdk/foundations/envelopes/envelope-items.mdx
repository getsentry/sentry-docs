...
10. **User reports (deprecated)**: SDKs **MUST** send `user_report` envelope items in the same envelope as their associated event; see [User Reports](/sdk/telemetry/user-reports/#envelope-item).
