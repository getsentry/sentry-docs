...
The operation type should follow the [Span Operation Conventions](/sdk/telemetry/transactions/#span-operations).

Extra (`data`) attributes for transactions and/or spans, there are [Span Data](/sdk/telemetry/transactions/#span-data-conventions) and [OTel GraphQL](https://opentelemetry.io/docs/specs/otel/trace/semantic_conventions/instrumentation/graphql/) conventions.
