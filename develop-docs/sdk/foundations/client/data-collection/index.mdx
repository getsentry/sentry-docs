...
| `database` | Boolean | `true` | 0.6.0 | Include parameters/arguments passed to database queries, or the results of a query. Setting this to false will omit these values. |
