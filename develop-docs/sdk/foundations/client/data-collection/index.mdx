...
| `database` | Boolean | `true` | 0.6.0 | Include parameters/arguments passed to database queries, or the results of a query. Setting this to false will either omit these values. |
| `queues` | Boolean | `true` | 0.7.0 | Include arguments passed to tasks within queues. Setting this to false will omit the value. |
