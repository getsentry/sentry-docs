...
<SpecSection id="collect-options" status="draft" since="1.0.0">
  ...
  | `frameContextLines` | Number<br/>(Boolean, if not otherwise possible) | `5`<br/>(`true`) | (Number of) lines of context to include around stack frames. |
  ...
  <SpecSection id="option-types" status="draft" since="1.0.0">
...
<SpecSection id="use-case-default" status="draft" since="1.0.0">
...
<SpecSection id="use-case-debugging" status="draft" since="1.0.0">
...
<SpecSection id="use-case-migration" status="draft" since="1.0.0">
