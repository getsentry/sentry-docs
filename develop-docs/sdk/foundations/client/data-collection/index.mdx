...
<SpecSection id="setup-snippet-opt-out" status="candidate" since="0.5.0">
...
| `database` | `{ queryParams? }` | `true` | 0.5.0 | Include parameters/arguments passed to database queries. Setting this to false will either omit the value altogether, or replace the value with '[Filtered]'. |
