...
**Result:** Cookies, headers, query params, HTTP bodies, generative AI inputs/outputs, stack frame variables, and user identity fields (`user.*`) are all collected. The sensitive denylist scrubs sensitive values.
