...
Each key under `collect` maps to a category of automatically collected data types and uses one of two option types, depending on whether the data is structured as key-value pairs.
