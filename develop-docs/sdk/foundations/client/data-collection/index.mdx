...
- Any key containing **`x-forwarded-`** (e.g., `x-forwarded-for`, `x-forwarded-host`) — these often carry client IP or host.
- Any key ending with or containing **`-user`** (e.g., `x-user-id`, `remote-user`) — these often carry user identifiers.
