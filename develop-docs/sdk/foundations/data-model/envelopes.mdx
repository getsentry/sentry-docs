...
data integrity and a list of valid Item types refer to [Envelope Items](/sdk/foundations/data-model/envelope-items/).
...
- Based on the contents of the Envelope, certain header attributes may be
  required. See [Envelope Items](/sdk/foundations/data-model/envelope-items/) for a specification of required
  attributes.
...
: *Object, recommended.* This can carry the same payload as the [`sdk` interface](/sdk/foundations/data-model/event-payloads/sdk/)
...
: **String, required.** Specifies the type of this Item and its contents. Based
  on the Item type, more headers may be required. See [Envelope Items](/sdk/foundations/data-model/envelope-items/) for a list
  of all Item types.
...
This section has been moved to [Envelope Items](/sdk/foundations/data-model/envelope-items/).
## Ingestion
