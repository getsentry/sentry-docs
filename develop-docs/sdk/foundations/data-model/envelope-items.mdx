...
Item type `"event"`. This Item contains an error or default [event payload](/sdk/foundations/data-model/events/)
encoded in JSON.
...
for this item type. For other attributes, see [Event Payloads](/sdk/foundations/data-model/events/).
