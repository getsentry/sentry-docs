...
A [Transaction](/sdk/foundations/data-model/events/transaction/) may contain zero or more Spans in an array attribute named `spans`. Spans in the list don't have to be ordered, they will be ordered by start / end time on the Server.
...
The following example illustrates the Span as part of the [Transaction](/sdk/foundations/data-model/events/transaction/) and omits other attributes for simplicity.
