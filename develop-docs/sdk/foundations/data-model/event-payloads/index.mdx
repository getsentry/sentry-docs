...
Events are packed into [envelopes](/sdk/foundations/data-model/envelopes/) and are sent to the `/api/{PROJECT_ID}/envelope/` API endpoint.
...
See [Envelope Size Limits](/sdk/foundations/data-model/envelopes/#size-limits) for further details.
