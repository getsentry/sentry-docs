...
You need just a default installation of `sentry` on your computer. Please install it following the [Development Environment Setup Guide](/development-infrastructure/environment/).
...
Follow the instructions on the [Ngrok documentation](/development-infrastructure/ngrok/) page to install ngrok.
