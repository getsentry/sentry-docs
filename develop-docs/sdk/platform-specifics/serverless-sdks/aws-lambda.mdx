...
We have an [internal document in Notion](https://www.notion.so/sentry/Serverless-Development-Environment-AWS-Lambda-61c4578c23784b5c9a54ab01b9b6daad) on how to set up a local development environment for Sentry employees. Most of the time you do not need this. But if you want to send data from a AWS Lambda function to your local Sentry, it is described there.
