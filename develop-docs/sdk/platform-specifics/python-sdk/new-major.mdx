...
Don't break existing APIs for minor maintenance benefit on your end.
...
Many folks might try to upgrade using AI. Try it out yourself on an example project. Consider adding rules specifically for migration.
