...
Make the process as seamless as possible. Don't break existing APIs for minor maintenance benefit on your end.


## Make Upgrading as Effortless as Possible

Create a migration guide. Include easily understandable and copy-pastable examples wherever possible.

Many folks might try to upgrade using AI. Try it out yourself on an example project.


## Dropping Version Support

In general, we want to keep supporting as many Python versions and as many framework/library versions as possible.

Consider whether we should drop support for an old Python version. There is data in Looker you can use to make an informed decision.
...
Look over the codebase to look for mentions of deprecated features. Remove them.
