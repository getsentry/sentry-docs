...
While the reuse of the [Unified SDK architecture](https://develop.sentry.dev/sdk/foundations/state-management/hub-and-scope/) (hubs, clients, scopes) and the transaction ingestion model have merits, experience revealed some issues that we categorize into two groups.
