...
Changes to grouping are always considered breaking and should be released in a major version. Changes to dashboards and alerts need closer inspection. In order to make a good decision, you can try to estimate how many users are affected using our data analytics tools.
