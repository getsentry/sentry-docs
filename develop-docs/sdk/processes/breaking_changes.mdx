...
Changes to grouping are always considered breaking and should be released in a major version. Changes to dashboards and alerts need closer inspection. You can try to gauge the impact in the product using our data analytics tools.
