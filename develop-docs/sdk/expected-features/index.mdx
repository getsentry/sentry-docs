...
See the [Attachments](/sdk/telemetry/attachments/) spec for full documentation of attachments, including screenshots, max attachment size, and SDK API guidance.
