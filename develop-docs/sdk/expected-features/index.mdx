...
For all SDKs, it is strongly recommended to send the `User Feedback` as an [envelope item](/sdk/foundations/transport/envelope-items/#user-report---deprecated). Alternatively, the SDKs can
