...
Native Sentry SDKs like [sentry-native](https://github.com/getsentry/sentry-native) and [sentry-cocoa](https://github.com/getsentry/sentry-cocoa/) have to work with signal handlers
