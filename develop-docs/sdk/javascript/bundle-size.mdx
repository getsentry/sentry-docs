...
However users can still set up [advanced tree-shaking](https://docs.sentry.io/platforms/javascript/configuration/tree-shaking/) to remove the integrations they don't need it.
