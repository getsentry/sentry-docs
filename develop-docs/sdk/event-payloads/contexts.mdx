...
The following example illustrates the contexts part of the <Link to="/sdk/event-payloads/overview">event payload</Link> and omits other attributes for simplicity.
