...
An <Link to="/sdk/event-payloads/overview">event</Link> may contain one or more exceptions in an attribute named `exception`.
...
contains the exception part of the <Link to="/sdk/event-payloads/overview">event payload</Link> and omits other
