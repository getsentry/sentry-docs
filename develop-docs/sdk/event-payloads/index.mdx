...
SDK developers might benefit from consulting the [source code defining the protocol as understood by the server](https://github.com/getsentry/relay/tree/master/relay-event-schema/src/protocol).
