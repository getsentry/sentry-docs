...
- **extra**: Truly arbitrary data attached by client users.  This is a deprecated feature but will continue to be supported for the forseeable future.  User are encouraged to use contexts instead.
