...
```python
from sentry.scm.types import PaginationParams
...
For the full list of available actions and their signatures, see [`src/sentry/scm/actions.py`](https://github.com/getsentry/sentry/blob/main/src/sentry/scm/actions.py).
...
Use [`bin/github-client`](https://github.com/getsentry/scm-platform/blob/main/bin/github-client) to run actions against the RPC server. GitLab equivalents are available via [`bin/gitlab-client`](https://github.com/getsentry/scm-platform/blob/main/bin/gitlab-client).
