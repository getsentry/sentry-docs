...
- Make another pull request to:
    ...
    - Update the `historical_silo_assignments` in [sentry](https://github.com/getsentry/sentry/blob/51a435cef008af63385a1d8c02996aedbb59fcca/src/sentry/db/router.py#L68) or [getsentry](https://github.com/getsentry/getsentry/blob/7481ac9c6fff0eb2ca4e3befa2720f6451d90d59/getsentry/db/router.py#L283).
...
You might need to set `SENTRY_FALLBACK_CELL="us"` in your sentry config in order to successfully update the organization mappings.
