...
to="/backend/application-domains/pii/selectors/">selector</Link>.
...
- _Rule types_ describe what to match. See <Link to="/backend/application-domains/pii/types/">PII Rule
  Types</Link> for an exhaustive list.
- _Rule redaction methods_ describe what to do with the match. See <Link
  to="/backend/application-domains/pii/methods/">PII Redaction Methods</Link> for a list.
