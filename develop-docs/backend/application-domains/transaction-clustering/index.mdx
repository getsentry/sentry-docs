...
In terms of user experience, this feature plays a similar role as [Issue Grouping](/backend/application-domains/grouping/).
In terms of technical implementation, it is similar to [Data Scrubbing](/backend/application-domains/pii/).

## The Problem

In many of our [pre-built dashboards](https://docs.sentry.io/product/dashboards/sentry-dashboards/) product, transactions are grouped by their name
(the [`event.transaction`](/sdk/foundations/envelopes/event-payloads/#optional-attributes) field).
