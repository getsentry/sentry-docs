...
You can modify the state of [feature flags in tests](/development-infrastructure/testing/#setting-options-and-feature-flags) using a context manager.
...
If you want to back your feature flag via options, you can do so using the [Flagpole](/backend/application-domains/feature-flags/flagpole/) library
...
See the [Flagpole Local Development](/backend/application-domains/feature-flags/flagpole/#testing-a-flagpole-feature-locally) docs for more information on this.
...
[Flagpole](/backend/application-domains/feature-flags/flagpole/) is Sentry's internal feature
...
implement a feature handler in getsentry. For example, you can create a feature flag that is backed by [options](/backend/application-domains/options/). follow these steps:
