...
Writing a detector is the hardest part of creating a new issue type. Refer to <Link to="/backend/issue-platform/writing-detectors/">this guide</Link> for tips on how to write one.
