...
This guidance only partially applies to SDKs, where slightly different rules prevail. For that, please refer to the [SDK Development Philosophy](/sdk/philosophy/).
...
For SDKs we are even stricter. For that, please refer to the [SDK Development Philosophy](/sdk/philosophy/).
