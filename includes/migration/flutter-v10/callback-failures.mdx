...
From alpha.7, an exception in an event processor or a filtering callback drops the affected telemetry item instead of sending the item through unchanged.
