...
For the unreleased web session-status change, see [Flutter Web Uses JavaScript SDK v11](/platforms/dart/guides/flutter/migration/v9-to-v10/#flutter-web-uses-javascript-sdk-v11).
