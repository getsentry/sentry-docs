...
`browserTracingIntegration` no longer accepts an `_experiments` object at all. Remove both options, and update dashboards or alerts that read CLS or LCP as pageload span measurements.
