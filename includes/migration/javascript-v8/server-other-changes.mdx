...
by the Sentry backend by default. You can disable dropping them in your project's [Inbound Filters](https://sentry.io/orgredirect/organizations/:orgslug/settings/projects/:projectId/filters/data-filters/) settings. If you still want to
