...
The Issues chart shows the number of new and resolved issues for that project over time. It also gives a preview of the two most recently seen issues for that project. The chart header, when hovered, has a button to view all issues for that project.
