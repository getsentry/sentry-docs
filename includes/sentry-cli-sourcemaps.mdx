...
sentry-cli sourcemaps inject --org ./www
```

```bash {tabTitle: Ionic Capacitor Build}
# Android
sentry-cli sourcemaps inject --org ./android/app/src/main/assets/public

# iOS
sentry-cli sourcemaps inject --org ./ios/App/App/public
```
