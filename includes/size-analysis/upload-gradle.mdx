The Gradle plugin will automatically detect your [build's metadata](#upload-metadata) and include it in the upload. If for any reason you need to override values, you can use the `vcsInfo` extension.
...
Configure overrides in your `build.gradle.kts`:
