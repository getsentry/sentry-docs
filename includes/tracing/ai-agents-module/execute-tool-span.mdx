...
The [@sentry_sdk.trace()](/platforms/python/tracing/instrumentation/custom-instrumentation/trace-decorator/#span-templates) decorator can also be used to create this span.
