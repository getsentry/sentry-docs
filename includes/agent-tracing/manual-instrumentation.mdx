...
If you're using a library that Sentry doesn't provide helpers for, create spans manually. A complete trace lets you see how long the agent and each model or tool call took, where failures happened, and how the agent produced its final response.
