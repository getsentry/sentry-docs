...
- [Error Free Sessions](/product/releases/health/#errored)
- [Session Health](/product/releases/health/#session-status)
- [Session Counts](/product/releases/health/#session)
- User Health
- User Counts
...
The Session Health and User Health charts aim to break down trends in how your sessions are performing status-wise. The status options are healthy, crashed, errored, or abnormal. [Learn more about session statuses](/product/releases/health/#session-status).
