...
You must have [sessions and releases](/product/releases/setup/) enabled in order to view these insights. Session Health on Sentry Dashboards is available only for the Frontend and Mobile modules.
