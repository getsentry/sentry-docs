...
To see replays for backend errors, you need to have Sentry set up for both your frontend and backend, along with [distributed tracing](/concepts/key-terms/tracing/). This provides end-to-end data connectivity on your APIs, allowing Sentry to link replays to backend endpoints.