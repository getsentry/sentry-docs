...
```dart {14-16} {mdExpandTabs} {tabTitle: Navigator}
...
```dart {3} {mdExpandTabs} {tabTitle: Navigator}
MaterialPageRoute(
...
```dart {5, 13-18} {mdExpandTabs} {tabTitle: Wrap with SentryDisplayWidget}
Navigator.push(
  context,
  MaterialPageRoute(
...
```dart {mdExpandTabs} {tabTitle: Navigator}
import 'package:flutter/material.dart';
