...
Asset bundle instrumentation isn't supported in stream mode yet — it creates spans only in the default transaction mode. See <PlatformLink to="/tracing/new-spans/">New Spans</PlatformLink>.
