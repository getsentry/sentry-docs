The Overview dashboard provides a high-level view of your agent activity:

![Agents Tracing Overview =900x](./img/agent-overview-dash.png)
...
Agents are grouped by name. If your agents show up as unnamed, see [Naming Your Agents](/product/ai-observability/naming/).
