...
To match tokens and DSNs in logs or secret scanners, see [Token and Credential Formats](/security-legal-pii/security/token-formats/).
...
To get started, see our docs on [Internal Integrations](/integrations/integration-platform/).
