...
When transferring projects some project data such as releases, and session data are not transferred. Please also note that Organization Settings such as team assignments, and code-mappings will need to be applied to the project again.
