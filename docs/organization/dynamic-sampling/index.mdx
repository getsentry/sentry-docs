...
1. **Dynamic Sampling with Sampling Priorities** - available on selected Team, Business & Enterprise plans
...
2. **Dynamic Sampling with Custom Sample Rates** - available on selected Enterprise plans
