...
- [AuthO](/account/sso/#auth0)
- [Azure Active Directory](/account/sso/#azure-active-directory)
- [Okta](/account/sso/#okta)
- [OneLogin](/account/sso/#onelogin)
- [Rippling](/account/sso/#rippling)
- [Jumpcloud](/account/sso/#jumpcloud)
...
You may refer to [our documentation](/account/sso/azure-sso/) for more detailed setup instructions.
...
You may refer to [our documentation](/account/sso/okta-sso/) for more detailed setup instructions.
...
1. Click "Configure".
1. Under the SSO menu, update the SP Entity ID and ACS URLs for your tenant. They should be in the format as described [here](/account/sso/saml2/#register-sentry-with-idp).
1. Click "save".
...
For other SAML2 SSO providers not listed above, Sentry provides generic connectors for [SAML2 based authentication](/account/sso/saml2/), which may be configured manually.
...
- [Okta SCIM Setup](/account/sso/okta-sso/okta-scim/)
- [Azure AD SCIM Setup](/account/sso/azure-sso/#scim-integration)
