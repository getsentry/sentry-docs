...
- [AuthO](/organization/sso/#auth0)
- [Azure Active Directory](/organization/sso/#azure-active-directory)
- [Okta](/organization/sso/#okta)
- [OneLogin](/organization/sso/#onelogin)
- [Rippling](/organization/sso/#rippling)
- [Jumpcloud](/organization/sso/#jumpcloud)
...
You may refer to [our documentation](/organization/sso/azure-sso/) for more detailed setup instructions.
...
You may refer to [our documentation](/organization/sso/okta-sso/) for more detailed setup instructions.
...
1. Click "Configure".
1. Under the SSO menu, update the SP Entity ID and ACS URLs for your tenant. They should be in the format as described [here](/organization/sso/saml2/#register-sentry-with-idp).
1. Click "save".
...
For other SAML2 SSO providers not listed above, Sentry provides generic connectors for [SAML2 based authentication](/organization/sso/saml2/), which may be configured manually.
...
- [Okta SCIM Setup](/organization/sso/okta-sso/okta-scim/)
- [Azure AD SCIM Setup](/organization/sso/azure-sso/#scim-integration)
