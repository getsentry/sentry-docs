...
1. Go back to [Sentry](https://sentry.io). Navigate to [**Settings > Auth**](https://sentry.io/orgredirect/organizations/:orgslug/settings/auth/) and click on "Configure" for SAML2.
