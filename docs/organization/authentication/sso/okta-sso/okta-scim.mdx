...
- Configuration of SAML SSO for Okta [as documented here](/organization/sso/okta-sso/), or use the Okta sign-on tab in your Sentry Okta application to configure SAML.
