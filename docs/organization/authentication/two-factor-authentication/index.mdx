...
1. Go to [**Organization Settings > General Settings**](https://sentry.io/orgredirect/organizations/:orgslug/settings/).
...
1. Go to [**Organization Settings > Audit Log**](https://sentry.io/orgredirect/organizations/:orgslug/settings/audit-log/).
...
3. If you can't find the email, ask an organization Owner or Manager to go to the [**Organization Settings > Members**](https://sentry.io/orgredirect/organizations/:orgslug/settings/members/) page and resend your invite.
