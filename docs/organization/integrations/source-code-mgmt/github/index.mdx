...
| Issues             | Read & Write  | To create GitHub issues from Sentry events, update linked issues, and enable issue sync features such as issue status, comments, and assignees sync.                               |
