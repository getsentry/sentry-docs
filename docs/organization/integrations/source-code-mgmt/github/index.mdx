...
Sentry can comment on merged pull requests that contain suspect commits for new issues. This feature is disabled by default. To enable it, go to **Settings > Integrations > GitHub** and toggle it on.

![How to enable Sentry comments on GitHub pull requests](./img/github-org-settings.png)
