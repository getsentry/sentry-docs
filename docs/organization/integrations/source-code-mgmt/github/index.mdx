...
The [Seer GitHub App](https://github.com/apps/seer-by-sentry) is used by [Seer](/product/ai-in-sentry/seer) to make Pull Requests for Issue Fixes and for [Sentry Prevent AI](/product/ai-in-sentry/sentry-prevent-ai) to analyze your Pull Requests.
