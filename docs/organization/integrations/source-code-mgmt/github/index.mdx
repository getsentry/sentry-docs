...
- [Seer GitHub App](#installing-the-seer-github-app) - _Deprecated: Use the regular [GitHub](#installing-github) intregration instead._
...
_Deprecated: This GitHub app is no longer supported and will be removed in the future. Migrate to the [Seer GitHub integration](/organization/integrations/source-code-mgmt/github/#installing-the-seer-github-app) instead._
...
If you have added [Seer](/product/ai-in-sentry/seer/) to your organization, you can enable [Issue Autofix](/product/ai-in-sentry/seer/issue-autofix/) and [Code Review](/product/ai-in-sentry/seer/code-review/) in your [organization settings](https://sentry.io/orgredirect/organizations/:orgslug/settings/seer/).
