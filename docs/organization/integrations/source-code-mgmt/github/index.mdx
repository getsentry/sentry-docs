...
<Alert title="Note" level="info">
Issue Sync is not yet available for GitHub Enterprise.
</Alert>
### Issue Sync
...
<Alert title="Note" level="info">
Open Pull Request Comments is not available for GitHub Enterprise.
</Alert>
...
<Alert title="Note" level="info">
Missing Member Detection is not available for GitHub Enterprise.
</Alert>
...
<Alert title="Note" level="info">
Single Sign-On with GitHub Enterprise is not supported.
</Alert>
