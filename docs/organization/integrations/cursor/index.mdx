...
Go to your [Seer settings](https://sentry.io/orgredirect/organizations/:orgslug/settings/seer/), select your project, and configure Cursor Cloud Agent as the target in the "Where should Seer stop?" section.
