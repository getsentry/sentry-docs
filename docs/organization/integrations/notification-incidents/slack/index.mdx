...
In [performance metric alerts](/product/alerts/alert-types/#performance-metric-alerts), select the Slack option in the dropdown that corresponds to your workspace and the select your channel:
