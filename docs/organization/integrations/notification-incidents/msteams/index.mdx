...
In [performance metric alerts](/product/alerts/alert-types/#performance-metric-alerts), select the Microsoft Teams option in the dropdown that corresponds to your team and then enter the username or channel:
