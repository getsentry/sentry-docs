...
You'll need Sentry owner, manager, or admin-level permissions to be able to install this integration. You'll only be able to install this integration if your organization is on the Business plan.
