...
If you choose to create a key via the Opsgenie API, you will need to set "allowConfigurationAccess" to true. We validate keys via the Opsgenie authentication endpoint, which requires a key to have configuration access.
