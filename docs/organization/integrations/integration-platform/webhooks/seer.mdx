...
Sentry integrations that have subscribed to Seer webhooks can receive notifications about the Seer [Root Cause Analysis](/product/ai-in-sentry/seer/issue-autofix/) process. These webhooks allow you to track the progress of automated root cause analysis, solution generation, and code fixes.
