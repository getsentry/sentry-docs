...
sidebar_order: 3
description: >-
  Learn about Sentry's Amazon SQS data forwarder, which enables forwarding sentry errors
---
...
You may now modify any other settings on the AWS side as necessary. If you modify any of the above details from the AWS console, you'll have to update the forwarder you've configured in Sentry as well, manually.
