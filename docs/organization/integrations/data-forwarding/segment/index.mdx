...
You may now modify any other settings on the Segment source as necessary. If you modify the Segment write key later on, you'll have to update the forwarder you've configured in Sentry as well, manually.
