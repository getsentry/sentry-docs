...
As of February 2024, Jira has discontinued support for Jira Server. Accordingly, we have stopped maintaining the integration, though the integration works the same way to its successor, Jira Data Center.
