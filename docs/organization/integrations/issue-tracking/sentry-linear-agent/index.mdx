...
- Enable/Disable automatic Seer runs - Toggle whether Seer automatically runs(wtihout confirmation) when issues are assigned in Linear.
...
- Via buttons after an issue is assigned:
  - `Yes, run Seer RCA` runs Seer RCA for the current issue
