...
This integration highly benefits from having [automation configured within Seer](https://docs.sentry.io/product/ai-in-sentry/seer/#automation), to automatically create Root Cause Analysis and Solutions based on fixability scores from Seer. 

<Alert title="Beta">

The support for **Sentry Agent for Linear** is in its beta phase. Changes to the UX and functionality should be expected.
...
4. Once linked, you'll be prompted if you want to run a Seer Issue Fix for the application. You can answer "Yes", or ask for "Help" to see more options. 
