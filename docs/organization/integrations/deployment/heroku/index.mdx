...
---
## Deprecation Warning
Heroku integration on Sentry is deprecated and will be removed on October 23, 2025. This plugin automatically tracked releases and deployments from your Heroku apps in Sentry, linking them to error tracking and performance monitoring.
You can still install the Sentry Add-on on Heroku and use Sentry with Heroku by setting up [Releases](/product/releases/overview/) yourself. Heroku integration on Sentry will no longer be available.
