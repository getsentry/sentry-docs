...
The Copilot agent integration uses GitHub Actions minutes and Copilot premium requests. For more information see the [Copilot cloud agent docs](https://docs.github.com/en/copilot/concepts/agents/cloud-agent/about-cloud-agent#copilot-cloud-agent-usage-costs).
