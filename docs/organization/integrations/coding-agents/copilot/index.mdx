...
Sentry Owner, Manager, or Admin permissions are required to install this integration. Additionally, you'll need the Copilot Cloud Agent feature enabled in your GitHub account. See the [Github Copilot cloud agent docs](https://docs.github.com/en/enterprise-cloud@latest/copilot/concepts/agents/cloud-agent/about-cloud-agent) for more information.
...
The Copilot agent integration consumes GitHub Actions minutes and Copilot premium requests. For more information see the [Copilot cloud agent docs](https://docs.github.com/en/copilot/concepts/agents/cloud-agent/about-cloud-agent#copilot-cloud-agent-usage-costs).
