...
- [Spike Protection](/account/quotas/spike-protection/)
- [Spend Allocation](/account/quotas/spend-allocation/)
- [Manage Your Error Quota](/account/quotas/manage-event-stream-guide/)
- [Manage Your Performance Units Quota](/account/quotas/manage-transaction-quota/)
- [Manage Your Replay Quota](/account/quotas/manage-replay-quota/)
- [Manage Your Attachments Quota](/account/quotas/manage-attachments-quota/)
...
| [Spike protection](#/account/quotas/manage-event-stream-guide/#when-does-spike-protection-become-inactive) no longer active (errors) | &check; |
