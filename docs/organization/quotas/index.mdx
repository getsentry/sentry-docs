...
Data and quotas are interconnected in Sentry. When you [subscribe to Sentry](https://sentry.io/pricing/), you pay for the amount of data - events (errors, replays, transactions, and transactions with profiling), and attachments - to be tracked. Each data category has its own quota that you can adjust. When Sentry tracks an event or attachment, it counts toward your quota for that type of data.
...
- [Spike Protection](/organization/quotas/spike-protection/)
- [Spend Allocation](/organization/quotas/spend-allocation/)
- [Manage Your Error Quota](/organization/quotas/manage-event-stream-guide/)
- [Manage Your Performance Units Quota](/organization/quotas/manage-transaction-quota/)
- [Manage Your Replay Quota](/organization/quotas/manage-replay-quota/)
- [Manage Your Attachments Quota](/organization/quotas/manage-attachments-quota/)
...
| [Spike protection](#/organization/quotas/manage-event-stream-guide/#when-does-spike-protection-become-inactive) no longer active (errors) | &check; |
