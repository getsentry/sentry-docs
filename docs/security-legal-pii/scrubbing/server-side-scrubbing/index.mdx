...
- Values that themselves contain, or whose keynames contain, any of the following strings:
  ...
  - token
  - bearer
- Values that contain strings in, or whose keynames are listed in, your project's [Security & Privacy](https://sentry.io/settings/projects/:projectId/security-and-privacy/) settings under "Additional Sensitive Fields".
