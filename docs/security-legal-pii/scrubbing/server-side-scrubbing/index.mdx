...
Geo information is extracted based on the IP address of the user. This will happen independently of whether the setting to
prevent storing IP addresses is enabled.
