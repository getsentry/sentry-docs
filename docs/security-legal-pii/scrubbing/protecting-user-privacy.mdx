...
A: If you choose to utilize a consent banner, you can find [technical guidance](https://www.sentry.help/en/articles/37358708239003-How-can-I-delay-replay-recording-until-a-user-consents) to configure Session Replay SDKs to initiate only after user consent is obtained.
