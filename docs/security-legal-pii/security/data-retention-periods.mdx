...
By default, new account trials have Team plan retention. If you are trialing a different plan type, you will have the same retention as that plan until the trial ends.  
...
13 month downsampled data is a subset of span data. Sampled retention is currently only available for span data.
