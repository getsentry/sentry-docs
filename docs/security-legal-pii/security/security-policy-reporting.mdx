...
The Expect-CT header is [deprecated](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Expect-CT).

</Alert>

[Certificate Transparency](https://en.wikipedia.org/wiki/Certificate_Transparency) (CT) is a security standard that helps track and identify valid certificates, allowing identification of maliciously issued certificates.
