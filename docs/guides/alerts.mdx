...
Instead, use the [**For Review** tab](/product/issues/states-triage/) in Issues as your low-priority inbox. It shows issues with state changes in the last seven days, with no alert required. Reserve real-time alerts for issues that genuinely require immediate action.
