...
You've set up [Sentry's Application Metrics](/product/explore/metrics/). Now what? This guide covers the high-value metric patterns that give you visibility into application health and how to drill into traces when something looks off.
...
Explore the [Application Metrics product walkthrough](/product/explore/metrics/) to learn more about the Sentry interface and discover additional tips.