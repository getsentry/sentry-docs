...
You've got auto-instrumentation running. Now what? Auto-instrumentation captures HTTP, database, and framework operations, but it can't see business logic, third-party APIs without auto-instrumentation, or background jobs. This guide shows you where to add custom spans.
