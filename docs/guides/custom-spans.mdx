...
For AI workloads, use [Sentry Agent Tracing](/product/ai-observability/) instead of manual instrumentation when possible. It automatically captures agent workflows, tool calls, and token usage.
