...
The file, `docs/product/monitors-and-alerts/alerts/index.mdx`, can reference the local `docs/product/monitors-and-alerts/alerts/img/alert-details.png` image like so :

```markdown {filename:docs/product/monitors-and-alerts/alerts/index.mdx}
...
The folder structure of `public` mimics that of `docs` so that you can reference these images with relative paths. For example, the file, `docs/product/monitors-and-alerts/alerts/index.mdx`, can reference the image, `public/product/monitors-and-alerts/alerts/issue-alert.png`, like so :

```markdown {filename:docs/product/monitors-and-alerts/alerts/index.mdx}
![Issue alert](issue-alert.png)
```

Content files living elsewhere can also reference public images by using their full paths (excluding `public`). For example, the file, `docs/platform/apple/index.mdx`, can also reference the same image, `public/product/monitors-and-alerts/alerts/issue-alert.png`, like so:

```markdown {filename:docs/platform/apple/index.mdx}
![Issue alert](/product/monitors-and-alerts/alerts/issue-alert.png)
```
