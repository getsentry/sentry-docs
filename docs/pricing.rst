...
Best practices for managing event volume
-----
If your projects have a high volume of events, you can control how many errors Sentry receives in a few ways:

- Within the SDK you can reduce the data volume you’re sending (all SDKs provide some mechanism to override if an event should send).
