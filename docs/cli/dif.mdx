...
the debug files are listed in [_Project Settings > Debug Files_](https://sentry.io/orgredirect/organizations/:orgslug/settings/projects/:projectId/debug-symbols/). Alternatively,
...
To make sure that it worked, you can check [_Project Settings > ProGuard_](https://sentry.io/orgredirect/organizations/:orgslug/settings/projects/:projectId/proguard/) and see if the upload mapping files are listed.
