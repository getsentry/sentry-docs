...
If you want to narrow down your investigation to profiles executed under a specific environment, use the search bar filters.

The right right side of the page has a list of the slowest functions. There's also a list of general information about the profile including:
