...
<Alert>
  Sentry's Team plan has a 14 day query window; and Sentry's Business plan has a 30 day query window.
</Alert>
...
- The duration and granularity by which you can query your spans and extrapolate metrics depends on your plan - Developer: 7 days | Team: 14 days | Business: 30 days.
...
![Trace Explorer Screenshot](./img/Trace_explorer_search.png)
...
<Arcade src="https://demo.arcade.software/nXPir2EkZiFJ5xVzGIlF?embed" />
...
<Arcade src="https://demo.arcade.software/pBHHdkt5wbmR69k1uDHr?embed" />

<Arcade src="https://demo.arcade.software/VHJoWo0h4zjYaH9OdxtI?embed" />
...
![Trace Explorer Screenshot](./img/Trace_explorer_alerts.png)
