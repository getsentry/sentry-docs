...
#### Reading the Percentage Badges

Each widget displays two percentages, like `99.8% | 84.6%`:
...
- Compare the **shape** of colored bars vs. gray bars
...
2. **Right-click** and choose "Compare Attribute Breakdowns"
...
If you see that 80% of spans in your selection come from a specific `release` that only accounts for 20% of the baseline, you've likely found the culprit.

### Best Practices

- **Start broad, then narrow down**: Begin with your full query, identify suspect attributes, then add filters to investigate further.
