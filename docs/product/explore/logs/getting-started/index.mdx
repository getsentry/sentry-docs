...
title: Set Up
sidebar_order: 0
description: "Learn how to set up Sentry's Logs feature using our supported SDKs and Log Drains."
---
...
You can also use log forwarders and agents to send logs to Sentry.

- [Fluent Bit via the OpenTelemetry Output Plugin](./log-forwarder/fluent-bit/)
