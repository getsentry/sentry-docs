...
- Click **Export Data** to select your format, choose the number of log lines, and pick which columns to include. 
- JSONL supports exporting all columns, while CSV exports the currently displayed columns. 
