...
Raw text search is case sensitive and allows you to search for specific strings within the *message* attribute of the Log. Raw text search over the entire log JSON is not supported.
