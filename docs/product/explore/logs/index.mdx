...
- **[Sentry MCP Server](/product/sentry-mcp/)**: Provides secure connectivity between your Sentry data (including logs) and LLM clients using the Model Context Protocol. This enables natural language queries and deep integration with AI tools like Claude, Cursor, and VS Code.
