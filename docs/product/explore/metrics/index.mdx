...
<Alert level="info">
  Metrics is currently in Open Beta for non-Enterprise plans customers using supported SDKs, including JavaScript, Python, Apple (iOS), Android, .NET, Java, Go, PHP, Ruby, Flutter, React Native, Unity, Unreal, and Native. See the [Getting Started](/product/explore/metrics/getting-started/) page for the full, up-to-date list. If you have any questions or feedback comment on this [GitHub discussion](https://github.com/getsentry/sentry/discussions/102275) or contact us at feedback-metrics@sentry.io. Features in beta are still in-progress and may have bugs. We recognize the irony.
</Alert>
