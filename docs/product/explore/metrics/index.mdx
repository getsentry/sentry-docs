...
[Cross-Event Querying](/product/explore/trace-explorer/#cross-event-querying-beta) (currently in Beta) makes this easier by letting you filter traces based on related spans and logs. The comparable trace gives you the same debugging context as a directly attached one.
