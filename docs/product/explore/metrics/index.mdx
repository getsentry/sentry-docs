...
[Cross-Event Querying](/product/explore/trace-explorer/#cross-event-querying) makes this easier by letting you filter traces based on related spans, logs, and application metrics. The comparable trace gives you the same debugging context as a directly attached one.
