...
- <LinkWithPlatformIcon
    platform="go.echo"
    label="Echo"
    url="/platforms/go/guides/echo/metrics/"
  />  
  - <LinkWithPlatformIcon
  ...
  - <LinkWithPlatformIcon
    platform="go.fiber"
    label="Fiber"
    url="/platforms/go/guides/fiber/metrics/"
  />
  - <LinkWithPlatformIcon
    platform="go.gin"
    label="Gin"
    url="/platforms/go/guides/gin/metrics/"
  />
  - <LinkWithPlatformIcon
    platform="go.iris"
    label="Iris"
    url="/platforms/go/guides/iris/metrics/"
  />
  - <LinkWithPlatformIcon
    platform="go.negroni"
    label="Negroni"
    url="/platforms/go/guides/negroni/metrics/"
  />
  - <LinkWithPlatformIcon
    platform="go.net-http"
    label="net/http"
    url="/platforms/go/guides/http/metrics/"
  />
  - <LinkWithPlatformIcon
    platform="go.slog"
    label="Slog"
    url="/platforms/go/guides/slog/metrics/"
  />
  - <LinkWithPlatformIcon
    platform="go.zerolog"
    label="Zerolog"
    url="/platforms/go/guides/zerolog/metrics/"
  />
