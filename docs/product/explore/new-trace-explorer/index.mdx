...
<Alert>
  The new Trace Explorer is currently an Early Adopter feature available to self serve customers, to use it you
  will need to [enable your Early Adopter
  status](/organization/early-adopter-features/). Enterprise customers can react out to their account team for more information. If you are not an Early
