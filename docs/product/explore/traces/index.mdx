...
Sentry has reached 100k organizations, and we're celebrating by giving away $100k worth of swag to devs like you who found our Trace Explorer docs. Use the code **CATSOUTOFTHEBAG** to [grab your free mouse](https://sentry.shop/products/sentry-mouse) before we run out.
