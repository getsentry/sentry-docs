...
sidebar_order: 30
description: "Learn how to use the Sentry Trace Explorer to search span data, find distributed traces, and debug performance issues across your entire application stack."
---

<Note>
  The Trace Explorer is currently in beta. Beta features are still in progress and
