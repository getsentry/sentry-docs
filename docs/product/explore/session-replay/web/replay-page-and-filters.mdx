...
## Deleting Replay Records

You can delete one or more replay records from the **Replay** page. Please note that deleting replay records do not affect your quota.

Select the replays you wish to delete by clicking the checkbox in the left column. The click the 'Delete' button to confirm your selection and delete the replays.

![](img/replay-index-delete-visible.png)

You can also delete all replays matching your current search query by clicking the link in the yellow banner: "Select all replays that match: __my serach query__". Again click 'Delete' to confirm the search query and date range.

![](img/replay-index-delete-all.png)

Deleting a large number of replays may take some time to complete. If a job is running you will see a banner at the top of the Replay list and a link to 'Track Progress'. You can also visit Settings > Projects > My Project > Replays to see the history of previous deletion jobs.

You must have project:write or project:admin access to delete replays.