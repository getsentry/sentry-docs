...
To delete multiple replays at once, go to the **Replay** page and use the checkboxes next to each replay row to select the ones you want to delete. Then, click the "Delete" button to remove the selected replays. A pop up will appear which will direct you to a dedicated UI for monitoring the bulk delete job's progress.
