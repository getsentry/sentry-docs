...
sidebar_order: 10
description: "Use Session Replay to get video-like reproductions of user interactions to improve your website experience."
---
...
- User closes the tab or page that's being recorded.
