...
Replay summaries require replay access permissions. If your organization has enabled replay access control, only users on the allowlist will be able to view and generate AI summaries. Learn more about [replay access control](/product/explore/session-replay/access-control/).
