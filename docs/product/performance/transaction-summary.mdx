...
Learn about how to control the type and amount of transactions you send to Sentry, in [Manage Your Transaction Quota](/account/quotas/manage-transaction-quota/). For a more in-depth explanation of what’s in a transaction as it relates to traces, check out our [full tracing documentation](/product/sentry-basics/tracing/).
