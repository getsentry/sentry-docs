...
![Performance homepage with Web Vitals tab selected.](./img/01_full_widget_frontend.png)
...
"Mobile" puts an emphasis on [Mobile Vitals](/product/insights/mobile-vitals/). Note that if you've selected a non-mobile project, this mode also displays all of those transactions.
