...
![Performance homepage with Web Vitals tab selected.](/product/performance/filters-display/01_full_widget_frontend.png)
...
![Updated transaction search](/product/performance/filters-display/transaction-name-search.png)
...
![Performance homepage with Web Vitals widgets.](/product/performance/filters-display/01_half_widget_frontend.png)
