...
You can define up to 10 custom performance measurements per transaction. If more custom performance measurements are included in a transaction event, the list will be truncated.
