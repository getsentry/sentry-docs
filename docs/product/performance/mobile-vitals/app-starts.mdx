...
![Example of App Starts](/product/performance/app-starts.png)
...
- The `performanceV2` feature flag and [App Start Profiling](/platforms/android/profiling/#app-start-profiling) must also be enabled in the SDK, e.g.:
```java
...
![Example of Screen Summary](/product/performance/app-starts-screen-summary.png)
...
![Example of Samples By Event](/product/performance/app-starts-samples-by-event.png)

## Span Detail View

![Example of Span Detail View](/product/performance/app-starts-span-detail-view.png)
