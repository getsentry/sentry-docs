...
![Example of Screen Loads](/product/performance/screen-loads.png)
...
- `>=5.20.0` TTID+TTFD for React Navigation and Expo Router (released March, 2024), [docs](/platforms/react-native/performance/instrumentation/time-to-display/)
...
![Example of Screen Summary](/product/performance/screen-loads-screen-summary.png)
...
The Screen Summary page also shows the average TTID, average TTFD, and Count (the number of times a screen has been called) - broken out by release.
...
![Example of Span Detail View](/product/performance/screen-loads-span-detail.png)
