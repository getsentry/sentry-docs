...
title: "Screen Loads"
sidebar_order: 10
description: "Learn more about Screen Loads and how to get better visibility on your application's TTID and TTFD performance."
---

The **Screen Loads** page shows an overview of how long it takes for your application to load its screens. Here you can identify slow or regressed screens and get additional information to understand the factors contributing to the slowness of both time to initial display (TTID) and time to full display (TTFD).
