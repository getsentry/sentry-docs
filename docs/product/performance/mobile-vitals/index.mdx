...
While the SDKs differentiate between a cold and a warm start, they don't track hot starts or resumes. To get more insight into your cold and warm start metrics, you can use the [App Starts](/product/performance/mobile-vitals/app-starts/) feature.
...
To get more insight into the performance of your time to initial display and time to full display metrics, using the [Screen Loads](/product/performance/mobile-vitals/screen-loads/) feature.