...
To get more insight into the performance of your time to initial display and time to full display metrics, use the [Screen Loads](/product/performance/mobile-vitals/screen-loads/) feature.
