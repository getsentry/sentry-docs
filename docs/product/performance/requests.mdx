...
<div style={{"height":"0px","paddingBottom":"calc(56.8359% + 41px)","position":"relative","width":"100%"}}>
  <iframe
    src="https://demo.arcade.software/BACnYWFHTvhZU6YK1rpq?embed&show_copy_link=true"
    frameborder="0"
    loading="lazy"
    ...
    title="Performance -> Requests Module Walkthrough"
  ></iframe>
</div>
...
If the SDK you're using doesn't automatically instrument HTTP requests, you can instrument your application by following the <PlatformLink to="/performance/instrumentation/custom-instrumentation/">custom instrumentation</PlatformLink> instructions. Because all the concepts are the same, if your platform doesn't have dedicated custom instrumentation instructions, you can try adapting the code from another platform.
...
- The span `op` field is `http.client`
- The span `description` is a string including the HTTP request method, and the full URL. e.g., "GET https://example.com/data.json?filter=all"
- The span `data` is key-value mapping of span attributes. (e.g., {"http.query": "filter=all", "server.address": "prod-2.example.com"}). This optional but required for full experience.
...
<div style={{"height":"0px","paddingBottom":"calc(56.8359% + 41px)","position":"relative","width":"100%"}}>
  <iframe
    src="https://demo.arcade.software/cViUuIfSy1qNF5pECFkX?embed&show_copy_link=true"
    frameborder="0"
    loading="lazy"
    webkitallowfullscreen
    mozallowfullscreen
    allowfullscreen
    style={{"colorScheme":"light","height":"100%","left":"0px","position":"absolute","top":"0px","width":"100%"}}
    title="Performance -> Requests Page"
  ></iframe>
</div>
...
<div style={{"height":"0px","paddingBottom":"calc(56.8359% + 41px)","position":"relative","width":"100%"}}>
  <iframe
    src="https://demo.arcade.software/fR2KyVQhqYTkgBhc2WUA?embed&show_copy_link=true"
    frameborder="0"
    loading="lazy"
    webkitallowfullscreen
    mozallowfullscreen
    allowfullscreen
    style={{"colorScheme":"light","height":"100%","left":"0px","position":"absolute","top":"0px","width":"100%"}}
    title="Performance -> Requests -> Domain Summary"
  ></iframe>
</div>
...
<div style={{"height":"0px","paddingBottom":"calc(56.8359% + 41px)","position":"relative","width":"100%"}}>
  <iframe
    src="https://demo.arcade.software/8sgDmcYEaVECd8eM3O52?embed&show_copy_link=true"
    frameborder="0"
    loading="lazy"
    webkitallowfullscreen
    mozallowfullscreen
    allowfullscreen
    style={{"colorScheme":"light","height":"100%","left":"0px","position":"absolute","top":"0px","width":"100%"}}
    title="Performance -> Requests -> Domains -> Samples"
  ></iframe>
</div>
