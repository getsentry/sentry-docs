...
To be alerted when crash-report feedback comes in, set up Workflow Notifications as described [here](https://docs.sentry.io/product/alerts/notifications/#workflow-notifications). Also, please make sure that Crash Report Notifications are enabled in Settings > Projects > [Project Name] > User Feedback page.
