...
<div style={{ width: "550px" }}>![AI User Feedback Summary.](./img/ai-feedback-summary.png)</div>
...
3. Under **Alert Builder**, add a filter for `Issue Category is equal to Feedback`.
4. Under **Add Actions**, choose which actions to perform when the filter matches.
...
1. Go to the [Alerts](https://sentry.io/monitors/alerts) page in Sentry and click **Create Alert**.
2. Select the project(s) with user feedback set up as the source.
3. Under **Set Filters**, add a filter for `The issue's category is equal to… "Feedback"`.
4. Under **Add Actions**, scroll to the "Create new..." section and select the integration you'd like to use.
5. Default issue link settings, such as the repository, labels, and assignees, can be configured by clicking the "Issue Link Settings" button.
6. Add an alert name and owner.
