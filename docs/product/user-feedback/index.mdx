...
If you'd like to automatically create an external issue (such as a GitHub or Jira issue) every time you receive a user feedback, you can do so through the Alerts page in Sentry, similar to how you would create an issue alert for user feedback (illustrated in the section above).
