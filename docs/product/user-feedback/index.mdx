...
Sentry now provides **AI-powered user feedback summaries** that automatically analyze and categorize your feedback to give you actionable insights at a glance. This at-a-glance summary can help you understand large amounts of user feedback without having to manually triage every piece of feedback.

### How It Works

At the top of the User Feedback index, you'll see a summary highlighting your users' most common sentiments of the week, whether positive or negative. The summary provides a concise overview of what users are saying about your product:



![AI User Feedback Sumamry.](./img/ai-feedback-summary.png)

### Key Features

**Sentiment Analysis**: The AI automatically categorizes feedback as positive or negative, making it easy to identify areas of concern and satisfaction.

**Actionable Insights**: Below the summary paragraph, you'll see a short list (usually 3-4 points) highlighting the key sentiments from the summary.

**Smart Filtering**: Click on any key sentiment to filter the user feedback list to show only unresolved feedback related to that specific issue or feature.

**Shareable Views**: Filtered views can be shared via URL, allowing you to quickly share high-priority feedback with your team for triage.

**Bulk Actions**: Use the bulk resolve feature to quickly resolve all feedback related to a specific sentiment once the underlying issue has been addressed, saving you from manually resolving each piece of feedback individually.

This AI-powered approach transforms overwhelming feedback into actionable insights, helping you prioritize user experience improvements and track sentiment trends over time.
