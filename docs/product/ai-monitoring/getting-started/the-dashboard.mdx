...
In the picture above, you can see that the `ai.chat_completions.create.langchain` span
has been decorated with its input messages and LLM responses.
Other spans like `ai.chat_completions.create.openai` include the number of tokens used for that particular
chat completion.

This view can include other data as well. If you call your LLM from a webserver, the trace will include details
about the webserver through other integrations, and you'll get a holistic view of all the related parts.
