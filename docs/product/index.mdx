...
Trace and monitor agent workflows, conversations, and MCP servers. Sentry captures LLM calls, tool executions, token usage, and errors alongside the rest of your application telemetry. [Learn more →](/product/agents/)
