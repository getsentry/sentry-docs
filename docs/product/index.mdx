...
### [Agents Tracing](/ai/observability/agents/)
If you're building AI-powered features, Sentry traces LLM calls, agent tool executions, and token usage alongside the rest of your application telemetry. [Learn more →](/ai/observability/)
