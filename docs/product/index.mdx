...
When you `pip install sentry` into a project that is also using an AI provider like `openai`, Sentry will automatically pick up useful metrics like token usage, prompts, and model IDs and send them to our AI Monitoring dashboard.

Our [**AI Monitoring**](/product/ai-monitoring/) feature gives you insights into your AI pipelines within the broader context of your app.
