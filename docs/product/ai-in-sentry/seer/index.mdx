...
If your organization has [Open Team Membership](https://sentry.io/orgredirect/organizations/:orgslug/settings/#organizationJoinMode) disabled, Seer Agent will not be available. Seer Agent makes org-wide queries on your data, and does not have finer-grained access controls yet.
