...
You can turn specific Seer settings off or on in bulk by going to [Seer settings](https://sentry.io/settings/seer/) and selecting from the dropdown at the top of the table in each tab. 
