...
If your organization has [Open Team Membership](https://docs.sentry.io/organization/membership/#open-membership) disabled, Seer Agent will not be available. Seer Agent makes org-wide queries on your data, and does not have finer-grained access controls yet.
