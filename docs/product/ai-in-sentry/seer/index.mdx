...
Seer is an add-on to your Sentry subscription. By enabling it, you are signing up for active contributor pricing for this feature. Any person who creates 2 or more PRs in a month in a Seer-Enabled project will be billed. A repo is considered Seer-Enabled when it is connected to Sentry and has one or more Seer features enabled. You can learn more about Seer pricing [here](/pricing/#seer-pricing).
