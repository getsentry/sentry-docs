...
- [**Automation**](#automation): Combine these tools into powerful workflow: automatically identifying actionable issues in real time with scanner, and then generating high quality fixes
...
2. **Set up GitHub Integration**: For Seer to be able to create patches and open pull request [connect your GitHub repositories](/organization/integrations/source-code-mgmt/github/)
