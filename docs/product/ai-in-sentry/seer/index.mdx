...
Supported coding agents for handoff are: Claude Code, Cursor Cloud Agents, and GitHub Copilot. Learn more about how to set up each coding agent [here](/integrations/coding-agents/). [Read more](/product/ai-in-sentry/seer/autofix/#handoff-to-claude-code-cursor-cloud-agents-or-copilot) about using them with Autofix.
...
**Open Team Membership Required**: Seer Agent requires that your organization has [Open Team Membership](https://sentry.io/orgredirect/organizations/:orgslug/settings/#organizationJoinMode) enabled. This setting ensures appropriate access controls, as Seer Agent can query org-wide data to answer your questions. If Open Team Membership is disabled, the **Ask Seer** button will not be available.
...
- For organizations that need to prevent Seer from creating PRs, or adding additional context in Alerts, you can find these configurations under [Advanced Settings](https://sentry.io/orgredirect/organizations/:orgslug/settings/seer/advanced/#enableSeerCoding) in Seer settings. 
