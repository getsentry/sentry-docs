...
## Best Practices
- Setup the GitHub integration, allowing Seer access to your codebase and enabling it to generate code fixes. Enabling the GitHub integration will make Seer much smarter and more capable. See the [Sentry GitHub integration](/organization/integrations/source-code-mgmt/github/) to learn how
- The more Sentry context you have (stack traces, traces, logs, profiles, and more), the better equipped Seer will be to help
...
<Alert>
Currently, GitHub is the only SCM supported by Seer. We are currently working to add support for GitLab and BitBucket. 
</Alert>
