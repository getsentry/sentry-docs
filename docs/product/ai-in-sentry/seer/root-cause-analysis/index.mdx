...
**Note:** You can still ask Seer to provide code snippets, but the `Code Changes` step in Root Cause Analysis will not run, and Seer will not create a PR, even if asked.
</Alert>
