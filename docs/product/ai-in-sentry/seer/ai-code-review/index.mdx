...
1. Configure default [Seer Code Review Settings](https://sentry.io/orgredirect/organizations/:orgslug/settings/seer/). **Note:** Enabling Seer starts *active contributor pricing* for this feature. Learn more about [Seer pricing](/pricing/#seer-pricing).

2. Select which repositories to connect:

   a. To configure existing repositories, go to [Repository Code Review Settings](https://sentry.io/orgredirect/organizations/:orgslug/settings/seer/repos).
   
   b. To add a repository for Code Review, you first have to install a new repo in your Sentry organization at [GitHub Integration Settings](https://sentry.io/orgredirect/organizations/:orgslug//settings/integrations/github/). 
