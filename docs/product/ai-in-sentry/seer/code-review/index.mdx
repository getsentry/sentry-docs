...
**Seer Code Review** helps you reviews your code changes, predicting errors and offering suggestions for improvement before merging pull requests.
...
3. Turn on [Seer Code Review](https://sentry.io/orgredirect/organizations/:orgslug/settings/seer/repos/) for your repositories and configure the [default setting for new repos](https://sentry.io/orgredirect/organizations/:orgslug/settings/seer/repos/#autoEnableCodeReview).

**Note:** Enabling Seer Code Review for one a repository starts *active contributor pricing*. Learn more about [Seer pricing](/pricing/#seer-pricing).
