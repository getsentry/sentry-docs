...
- **GitHub Copilot Cloud Agent** — Seer hands off the root cause and solution to a [GitHub Copilot cloud agent](/integrations/coding-agents/copilot/), which implements the fix and opens a pull request in your linked GitHub repository.
