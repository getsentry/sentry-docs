...
The [Datadog for Seer](/integrations/debugging/datadog-seer/datadog-seer/) integration gives Seer access to Datadog data like metrics, spans, traces, logs, notebooks, monitors, dashboards, and more. Seer can then use Datadog data to enhance or supplement Sentry telemetry in issue analysis or investigations.
