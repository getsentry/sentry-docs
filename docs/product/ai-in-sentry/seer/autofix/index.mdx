...
"Seer has driven down our bug load significantly. For easy fixes, it just creates PRs that require no manual intervention — the team just reviews them, no handholding required. A lot of bugs that would've previously gone uninvestigated just... get fixed."

*— Komal Ali, Director of Engineering, [Pulumi](https://www.pulumi.com/)*
