...
Our generative AI features use some of the data you've configured to collect and send to your Sentry instance to provide additional insights, analysis, and solutions for your review. 
...
In all cases, our subprocessors are only permitted to use the data as directed by Sentry and in accordance with the commitments  we make to you for the Sentry service, including for [data retention](security/#data-retention) and [data storage location](/organization/data-storage-location/).
