...
Sentry offers an administrative level control to disable all generative AI features. Go to [organization settings](https://sentry.io/orgredirect/organizations/:orgslug/settings/) and turn off the `Show Generative AI Features` toggle.