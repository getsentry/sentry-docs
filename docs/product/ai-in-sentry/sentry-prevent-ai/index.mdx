...
The ["Show Generative AI Features" toggle](https://sentry.io/orgredirect/organizations/:orgslug/settings/#hideAiFeatures) does **not** currently apply to Sentry Prevent AI. If you don't want Sentry Prevent AI to run on your projects, you can uninstall the [Seer GitHub app](https://github.com/apps/seer-by-sentry) at any time.

Learn more about [AI privacy and security](/product/ai-in-sentry/ai-privacy-and-security/).

{/* todo: bring back when we have a docs page */}
