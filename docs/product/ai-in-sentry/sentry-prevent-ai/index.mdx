...
To enable the Sentry Prevent AI assistant in your GitHub organization or on specific repositories, you need to install the [Sentry Prevent AI GitHub App Integration - Seer by Sentry](https://github.com/apps/seer-by-sentry). This allows the assistant to analyze pull requests and provide insights.
...
Sentry Prevent AI only runs on GitHub, and only runs when triggered by a comment. If you don't want sentry prevent AI used on your projects, you can uninstall the app at any time, or select specific projects to run the app on. 
