...
After installing the app, Sentry Prevent can help you in three ways:

1. **Error Prediction** - When you create a pull request and set it to `Ready for Review`, Prevent AI will check for errors in your code. If no error is found, you will see a 🎉 emoji as a reaction to your PR description. Otherwise, Prevent AI will add comments to your PR. 
