...
![The conditions that can be set to alert on an issue.](/product/alerts/create-alerts/issue-change-alert.png)
...
![Suggested Assignees with notify all project members selected.](/product/alerts/create-alerts/suggested_assignee_all_members.png)
...
![A sliding adjustment scale for the frequency of alert emails.](/product/alerts/create-alerts/alert-digest.png)
