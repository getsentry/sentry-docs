...
In your project's [Alerts](https://sentry.io/settings/projects/:projectId/alerts/) settings, you can configure alert email subject templates and digest settings. Sentry users with owner, manager, or admin permissions and above can change these default notification settings.
