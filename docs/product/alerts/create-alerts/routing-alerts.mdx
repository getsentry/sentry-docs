...
![Slack notification](/product/alerts/create-alerts/alerts_notifications_15.png)
...
![Discord notification](/product/alerts/create-alerts/alerts-notifications-discord.png)
