...
You can also create an alert by duplicating an existing issue or performance metric alert rule. To do so, navigate to **Alerts** and click "Duplicate" in the context menu (under "Actions") on the row with the alert rule you want to copy:
