...
Read more details about Performanc Metric Alerts [here](/product/alerts/alert-types/#performance-metric-alerts). Check out the full list of available Performance Metrics on the [Alert Config page](https://sentry.io/orgredirect/organizations/:orgslug/issues/alerts/wizard/?referrer=alert_stream).
