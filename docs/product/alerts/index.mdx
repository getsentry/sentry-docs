...
[Performance Metric alerts](/product/alerts/alert-types/#performance-metric-alerts) trigger when a [performance metric](/product/insights/overview/metrics/) is breached for either error or transaction events. Use performance metric alerts to monitor a finite and known set of metrics you care about, such as error frequency or crash-free session rate. Do this for your entire project, on important pages, or with specific tags.

**Some examples of available performance metric alerts:**
...
Read more details about Performance Metric Alerts [here](/product/alerts/alert-types/#performance-metric-alerts). Check out the full list of available Performance Metrics on the [Alert Config page](https://sentry.io/orgredirect/organizations/:orgslug/issues/alerts/wizard/?referrer=alert_stream).
