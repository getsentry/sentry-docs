...
User Feedback alerts for the [User Feedback Widget](/product/user-feedback/#user-feedback-widget) can be enabled under issue alerts. Follow these steps to set up alerts for every new feedback:
