...
The **Alert Details** page provides a timeline of uptime check events associated with the alert. This timeline allows you to track when and where failures occurred. Selecting a section section of the timeline automatically updates the date range filter, enabling you to browse historical uptime check data.
