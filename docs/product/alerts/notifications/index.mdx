...
Sentry sends you notifications regarding workflow activities, [release deploys](/product/releases/), and [quota usage](/account/quotas/), as well as weekly reports. These notifications let you know about:
...
You cannot change or disable these notifications. Learn more in the [full Quotas documentation](/account/quotas/).
