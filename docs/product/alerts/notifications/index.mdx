...
- 80% of the organization's reserved volume (such as errors, transactions, and attachments) has been depleted.
- The entire reserved volume and any on-demand capacity for a category (such as errors, transactions, and attachments) has been depleted.
- 80% of the organization's on-demand capacity has been used.
