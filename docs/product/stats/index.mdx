...
- **Disabled**:  Data was received for a feature or function that is currently turned off or not operational.
...
- **Global Limit**: This is an old setting available to some orgs to configure rate limits on organization and project level.
