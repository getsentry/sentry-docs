...
Once an automatically detected **Uptime Monitor** has been created, you can customize its configuration—including the HTTP request method, headers, and request body—from the [Monitors](https://sentry.io/issues/monitors/) page.

## Disabling Automatic Detection

If you prefer not to use automatically detected Uptime Monitors, you can delete them from the [Monitors](https://sentry.io/issues/monitors/) page.
