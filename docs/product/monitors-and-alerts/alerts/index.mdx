...
See [Creating alerts](/product/alerts/create-alerts/) for how to configure alerts in Sentry. The main goal is to create Alerts that are valuable and not too noisy.
