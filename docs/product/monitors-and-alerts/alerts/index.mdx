...
Alerts are an Organization-level feature. By default, all team members can create and edit Alerts. You can update this setting in [Organization Membership settings](https://sentry.io/orgredirect/organizations/:orgslug/settings/).
