...
Sentry's **Alerts** take action when issues in your organization match the defined rules. An alert can send notifications, create tickets, call webhooks, or use other [integrations](/organization/integrations/)—for issues coming from projects or [Monitors](/product/monitors-and-alerts/monitors/).

Learn more about [Alerts best practices](/product/monitors-and-alerts/alerts/best-practices/).
...
Check out our [Alerts best practices](/guides/monitors-and-alerts/) for a full guide on how to create useful Alerts without overwhelming your team. The main goal is to create Alerts that are valuable and not too noisy.
