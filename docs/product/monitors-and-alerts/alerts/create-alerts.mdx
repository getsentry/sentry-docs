...
Create a work item in an issue tracker. Each ticket creation action has its own settings panel, where you configure fields such as project, issue type, assignee, and labels:

{/* TODO: souredoutlook to supply a screenshot of the ticket creation sub-settings modal. Place it in ./img/ and reference as ![alt =800x](./img/name.png) */}
