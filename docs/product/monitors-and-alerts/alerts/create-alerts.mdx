...
| **An event or issue activity is captured**         | Sentry captures an event or records issue activity, including on existing issues.                                                                                                   |
...
![Ticket creation settings panel =600x](./img/settings-modal.png)
