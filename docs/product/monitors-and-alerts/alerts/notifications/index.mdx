...
- Resolving an unassigned issue with the ["Claim Unassigned Issues I've Resolved"](/product/monitors-and-alerts/alerts/notifications/notification-settings/#my-activity) option turned on
