...
For a concise **Issues-centric** explanation (how this shows up in your triage flow), see [Monitors and Alerts](/product/issues/monitors-and-alerts/). For **hands-on patterns**, see the [**Monitors and Alerts guide**](/guides/monitors-and-alerts/).
...
| Personal and workflow notifications (email, Slack, quota, and so on) | [Notifications](/product/monitors-and-alerts/alerts/notifications/)                                                  |
| Reduce noise and choose thresholds                                   | [Alerts best practices](/product/monitors-and-alerts/alerts/best-practices/) · [Guide](/guides/monitors-and-alerts/) |
