...
You can set ownership by defining ownership rules per project. To configure ownership rules, go to your project's [Ownership Rules](https://sentry.io/settings/projects/:projectId/ownership/) settings, or click on the "Create Ownership Rule" button on an **Issue Details** page.
...
Teams _must_ have access to the project to become owners. To grant a team access to a project, go to your project's [Project Teams](https://sentry.io/settings/projects/:projectId/teams/) settings, and click "Add Team".
...
You can add an ownership rule from your project's [Ownership Rules](https://sentry.io/settings/projects/:projectId/ownership/) settings and click "Edit Rules":
...
You can automatically assign issues to their owners by enabling the "Auto-assign to issue owner" setting in your project's [Ownership Rules](https://sentry.io/settings/projects/:projectId/ownership/) settings.
