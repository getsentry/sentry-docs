...
You can also add an ownership rule from the **Issue Details** page by clicking the "Assignee" dropdown then clicking the "Ownership" button:

![Assignee dropdown](./img/assignee-dropdown.png)
