...
| Code Health | Code patterns and anti-patterns that may indicate maintainability or correctness problems | Configuration Warning, Deprecation Warning |
...
Under **Project Settings > Performance**, The **AI Issue Detection** toggle controls whether Sentry runs AI issue detection at all. If on, you can enable or disable each category individually. 
