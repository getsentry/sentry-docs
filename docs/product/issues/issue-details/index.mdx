...
_Event Highlights_ are specific [tags](#tags) and [context](#contexts) items that have been promoted to the top of the page for quicker debugging.
...
The [Application Metrics](/product/logs) section lists the tracked counters, gauges, and distributions, along with their values at the time of the event.
