...
![Issue details](/product/issues/issue-details/issue_details_page.png)
...
![Event Navigator](/product/issues/issue-details/event-navigator.png)
...
The trace navigator (which displays below the date) is a timeline view of other issues in the current event's [trace](/product/sentry-basics/tracing/distributed-tracing). It displays up to 100 other issues in the trace, and you can click on any of them to view their details. The trace navigator is only available for issues that are part of a trace and have more than one issue.

- **Current Issue**: The current event you're viewing, which is larger than the other events in the trace.
- **Error Issues**: Appears as a solid red circle, will appear darker depending on the number of events at the same timestamp.
- **Performance Issues**: Appears as a bordered circle

Click "View Full Trace" to display the [Trace View](/product/sentry-basics/tracing/trace-view).

## Suspect Commits

![Suspect Commit](/product/issues/issue-details/suspect-commit.png)
...
![Tags](/product/issues/issue-details/tags.png)
...
![Exception](/product/issues/issue-details/issue-exception.png)
...
![Breadcrumbs](/product/issues/issue-details/issue-breadcrumbs.png)
...
![Trace Details](/product/issues/issue-details/trace-details.png)
...
![Issue Tabs](/product/issues/issue-details/issue-tabs.png)
