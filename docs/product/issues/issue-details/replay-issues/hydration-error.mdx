...
Sometimes the diff the Sentry shows is doesn't contain any visible changes. This is a limitation of debugging React in production mode. You've still got a hydration error to fix even if the diff is blank!
