...
An attribute `xmlns="http://www.w3.org/2000/svg"` was removed. This is an XML attribute and not needed within a valid HTML page, so react did not include it in the render.
