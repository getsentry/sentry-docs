...
You can configure Replay to ignore specific selectors if you are seeing <PlatformLink to="/session-replay/troubleshooting/#why-am-i-seeing-too-many-or-too-few-rage-clicks">too many rage clicks</PlatformLink> reported. For example, you might want to ignore clicks on "Print" or "Download" buttons.
