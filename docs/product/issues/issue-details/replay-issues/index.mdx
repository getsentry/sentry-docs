...
If you've enabled Session Replay, you'll be able to see rage click issues on the **Issues** page in Sentry. Rage clicks, a series of consecutive clicks on the same unresponsive element, are a sure sign of user frustration and most likely deserve your attention.
