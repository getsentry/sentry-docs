...
Issue Summary and Autofix are currently in Beta free of charge for paid Sentry customers. We welcome all feedback and suggestions, which can be submitted in-product or via email to autofix@sentry.io. Sentry AI access may not be available for EU customers or customers under an MSA.
