...
![Large Render Blocking Asset detector threshold settings](/product/issues/issue-details/performance-issues/large-render-blocking-asset/render-blocking-asset-detector-settings.png)
...
![Large Render Blocking Asset issue span evidence](/product/issues/issue-details/performance-issues/large-render-blocking-asset/span-evidence.png)
