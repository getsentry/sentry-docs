...
![Consecutive HTTP detector threshold settings](/product/issues/issue-details/performance-issues/consecutive-http/consecutive-http-threshold-settings.png)
...
![Consecutive HTTP span evidence](/product/issues/issue-details/performance-issues/consecutive-http/span-evidence.png)
