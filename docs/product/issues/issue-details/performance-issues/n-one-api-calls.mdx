...
![N+1 API Calls detector threshold settings](/product/issues/issue-details/performance-issues/n-plus-one-api-calls-detector-settings.png)
...
![N+1 API Calls span evidence](/product/issues/issue-details/performance-issues/n-plus-one-api-calls-evidence.png)
...
![N+1 API Calls in an example application](/product/issues/issue-details/performance-issues/n-plus-one-api-calls-in-book-application.png)
