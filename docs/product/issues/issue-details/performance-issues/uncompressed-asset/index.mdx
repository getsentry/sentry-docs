...
![Uncompressed Asset detector threshold settings](/product/issues/issue-details/performance-issues/uncompressed-asset/uncompressed-asset-detector-settings.png)
...
![Uncompressed asset span evidence](/product/issues/issue-details/performance-issues/uncompressed-asset/span-evidence.png)
