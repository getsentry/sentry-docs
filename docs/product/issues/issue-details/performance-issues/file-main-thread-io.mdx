...
![File I/O on Main Thread detector threshold settings](/product/issues/issue-details/performance-issues/file-main-thread-io-detector-settings.png)
...
![File I/O Span Evidence](/product/issues/issue-details/performance-issues/file-io.png)
