...
![Large HTTP Payload detector threshold settings](/product/issues/issue-details/performance-issues/large-http-payload/large-http-payload-detector-settings.png)
...
![Large HTTP payload span evidence](/product/issues/issue-details/performance-issues/large-http-payload/span-evidence.png)
