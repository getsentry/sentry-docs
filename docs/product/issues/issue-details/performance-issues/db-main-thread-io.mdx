...
![Database on Main Thread detector threshold settings](/product/issues/issue-details/performance-issues/db-on-main-thread-detector-settings.png)
...
![Database Span Evidence](/product/issues/issue-details/performance-issues/db-io.png)
