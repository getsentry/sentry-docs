...
![Slow DB Query detector threshold settings](/product/issues/issue-details/performance-issues/slow-db-queries/slow-db-queries-detector-settings.png)
...
![Slow DB Query span evidence](/product/issues/issue-details/performance-issues/slow-db-queries/span-evidence.png)
