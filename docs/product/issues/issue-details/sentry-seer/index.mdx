...
Issue Summary and Autofix are currently in Beta, free of charge, for paid Sentry customers. Feedback is highly welcomed and can be submitted in-product or via email to [autofix@sentry.io](mailto:autofix@sentry.io).
