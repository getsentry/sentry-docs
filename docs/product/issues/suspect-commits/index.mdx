...
On the **Issue Details** page, you'll see suggested assignees based on [ownership rules](/product/issues/ownership-rules/) matching the event, and suspect commits. You can manually assign the issue to a suggested assignee by selecting an option on the dropdown.
...
![Select from dropdown to automatically assign issues to their suspect commit authors.](/product/issues/ownership-rules/auto-assign-suspect-commits.png)
