...
<div
  style={{
    height: "0px",
    paddingBottom: "calc(43.4492% + 41px)",
    position: "relative",
    width: "100%",
  }}
>
...
![Highlighting where in the UI to find the file path for native stack traces](code-mappings-stacktrace-native.png)
...
<div
  style={{
    height: "0px",
    paddingBottom: "calc(48.6671% + 41px)",
    position: "relative",
    width: "100%",
  }}
>
