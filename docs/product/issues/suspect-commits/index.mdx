...
sidebar_order: 32
description: "With suspect commits, you can see the most recent commit to your code in the stack trace. Learn more about how integrations enable suspect commits here."
---
