...
![Spike limit example](/product/issues/states-triage/escalating-issues/spike_limit.png)
...
**Example**
![Bursty limit example](/product/issues/states-triage/escalating-issues/bursty_limit.png)
