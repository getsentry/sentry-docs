...
A typical application sends a large number of events to Sentry. You can think of an <SandboxLink scenario="oneIssue" projectSlug="react">issue</SandboxLink> as a single bug or problem with your app. To make them manageable, we [group similar events into issues](/product/data-management-settings/event-grouping/) based on a fingerprint. This grouping of events into issues allows you to see how frequently a problem is happening and how many users it's affecting.
