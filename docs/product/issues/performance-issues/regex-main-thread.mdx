...
![Regex on Main Thread Function Evidence](/product/issues/issue-details/performance-issues/regex-main-thread/regex-function-evidence.png)
...
![Regex on Main Thread Profile](/product/issues/issue-details/performance-issues/regex-main-thread/regex-profile.png)

## Stack Trace

The “Stack Trace” section shows a full stack trace for where the detected regex function was called from:

![Regex on Main Thread Stack Trace](/product/issues/issue-details/performance-issues/regex-main-thread/regex-stack-trace.png)
