...
![Frame Drop Function Evidence](/product/issues/issue-details/performance-issues/frame-drop/frame-drop-function-evidence.png)
...
![Frame Drop Profile](/product/issues/issue-details/performance-issues/frame-drop/frame-drop-profile.png)

## Stack Trace

The “Stack Trace” section shows a full stack trace view, highlighting the long-running function frame:

![Frame Drop Stack Trace](/product/issues/issue-details/performance-issues/frame-drop/frame-drop-stack-trace.png)
