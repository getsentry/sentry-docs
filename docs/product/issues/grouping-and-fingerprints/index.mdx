...
Here's how to set the match based on the error **type** in your project's [Issue Grouping](https://sentry.io/settings/projects/:projectId/issue-grouping/) settings under Fingerprint Rules:
