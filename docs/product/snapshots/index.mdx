...
- **Auth token** — A Sentry auth token with `project:write` or `org:ci` scope. See the [sentry-cli configuration docs](/cli/configuration/#to-authenticate-manually) for setup.
