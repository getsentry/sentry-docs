...
You can use webhooks to be notified when a new installable build is available. To enable, you can follow these [docs](/organization/integrations/integration-platform/webhooks/preprod-artifacts/).
