...
**Hands-on guide:** See [Using Session Replay](/guides/session-replay/) for debugging workflows including root cause analysis, reproducing bugs, and finding rage clicks.
