...
![Session Replay details user interface](/product/session-replay/replay-details.png)
...
![Highlight the button to share a replay](/product/session-replay/replay-details-share.png)

## Delete Replays

Delete an individual replay by clicking the “Delete” button in the top-right corner of **the Replay Details** page. You can’t delete replays that are in-progress. In the event of a PII (Personal Identifiable Information) leak where you need to **bulk** delete replays, contact [support@sentry.io](mailto:support@sentry.io). Please note that deleting replays do not affect your quota.
...
![Highlight the button to share a replay](/product/session-replay/replay-details-tags.png)
