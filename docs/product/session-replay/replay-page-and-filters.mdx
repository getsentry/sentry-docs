...
Each replay will bring users to the [**Replay Details**](/product/session-replay/web/replay-details/) page.
...
To delete a [single replay](/product/session-replay/web/replay-details/#delete-replays), go to the Replay Details page and click the "Delete" link, which is located under the "..." (more options) button.
