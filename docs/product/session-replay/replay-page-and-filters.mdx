...
The **Replay** page also shows two widgets titled "Most Dead Clicks" and "Most Rage Clicks" that show the top selectors that have been rage or dead clicked on. Expanding the selector will show example replays that contain clicks on that selector. You can also click the "See all selectors" button to see all selectors that have been rage or dead clicked on. SDK version `7.60.1` or higher is required to see rage and dead click data on the **Replay** page.
