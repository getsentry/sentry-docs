...
![View of the release details page showing a release comparison graph, issues, adoption, and other details.](/product/releases/release_details.png)
...
![Session count graph with healthy and errored sessions hidden](/product/releases/healthy_sessions_hidden.png)
