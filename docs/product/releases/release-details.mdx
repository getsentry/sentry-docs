...
Clicking the link will open a quick flyout with even more details of the Release. If you want to further explore the Release, you can click the "View Full Details" button in the top right corner of the flyout.

![The Releases flyout drawer after clicking the Release link](./img/release_details_flyout_drawer.png)