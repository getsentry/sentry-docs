...
Sessions as it pertains to Release Health are not billed and should not be confused with Session Replay. The video-like reproduction of the user's session.
