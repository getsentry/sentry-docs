...
![Sort By: Active Sessions dropdown](/product/releases/health/release_active_sessions.png)

![Sort By: Active Users dropdown](/product/releases/health/release_active_users.png)
...
![Sort By: Crash Free Sessions dropdown](/product/releases/health/release_crash_free_sessions.png)

![Sort By: Crash Free Users dropdown](/product/releases/health/release_crash_free_users.png)
...
![The adoption bar on the Releases page](/product/releases/health/adoption_bar.png)
...
![Release Adoption Chart](/product/releases/health/release_adoption_chart.png)
...
![Adoption stage label on the Releases page.](/product/releases/health/adoption-stage-label.png)
