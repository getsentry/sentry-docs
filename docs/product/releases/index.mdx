...
If you're looking for the latest Sentry SDK release details, head on over to <a href="https://github.com/getsentry">Sentry's GitHub profile</a>, find your specific SDK repo, and browse the tags for releases.
