...
![View of internal integration permissions.](/product/releases/setup/release-automation/travis-ci/internal-integration-permissions.png)
...
![View of Travis CI environment variables.](/product/releases/setup/release-automation/travis-ci/travis-env-vars.png)
