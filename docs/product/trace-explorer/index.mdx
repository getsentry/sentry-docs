...
**Hands-on guides:** See [Querying Traces](/guides/querying-traces/) for practical queries to find slow pages and bottlenecks, and [Adding Custom Spans](/guides/custom-spans/) for instrumenting your own code.
