...
sidebar_order: 95
description: "Traces explorer allows for powerful searching of span data, including conditions relating to the structure of the trace itself."
---

[//]: # (Check sandbox link)
<SandboxLink scenario="traces" projectSlug="react">Traces</SandboxLink> provides visibility into your span data across environments and all projects.
You can query and find particular distributed traces to help you debug problems or to optimize hot paths in your application.

![Full view of the Trace explorer with some example trace results displayed.](./img/traces-homepage.png)

The <SandboxLink scenario="traces" projectSlug="react">Traces</SandboxLink> page displays a query builder for spans where you can immediately begin creating a new query.

### Build a New Traces Query

From the **Traces** page, you can build a <SandboxLink scenario="oneDiscoverQuery" projectSlug="react">query</SandboxLink> by applying up to three search conditions to modify the results of the query.
