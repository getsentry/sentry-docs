...
In order for Alerts to run, you need to connect them to at least one [Monitor](/product/new-monitors-and-alerts/monitors/). To do so, select **Add Monitor** in the alert configuration page. You can add multiple monitors to an Alert.
