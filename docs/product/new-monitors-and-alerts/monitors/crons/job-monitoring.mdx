...
Monitor owners also receive notifications when a monitor becomes broken. Learn more about [broken monitor notifications](/product/new-monitors-and-alerts/monitors/crons/troubleshooting/#why-was-my-monitor-environment-marked-as-broken-or-automatically-muted).
