...
- **Uptime request spans**: A [default set of root spans](/product/new-monitors-and-alerts/monitors/uptime-monitoring/#uptime-request-spans) that identifies this as an uptime check
