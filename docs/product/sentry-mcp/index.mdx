...
- Execute Issue Fix runs and retrieve Issue Fix status and details 
...
- Use Sentry's Issue Fix feature, and help me analyze and propose a solution for `issue id`.

![Sentry MCP using Issue Fix](./img/mcp-autofix1.png)
