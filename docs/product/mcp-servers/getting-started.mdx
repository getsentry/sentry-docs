...
See [Instrument MCP Servers on Cloudflare](/platforms/javascript/guides/cloudflare/tracing/instrumentation/mcp-module/) for the configuration and filtering differences in stream mode.
