...
Since the Dev Toolbar will be visible to users within your app, it's important to consider which environments should render it. See the [FAQ: _"In what environments should I enable the Dev Toolbar?"_](/product/dev-toolbar/faq/#in-what-environments-should-i-enable-the-dev-toolbar) for tips.
...
See the [FAQ: _"How can I conditionally initialize the Toolbar?"_](/product/dev-toolbar/faq/#how-can-i-conditionally-initialize-the-toolbar) for help implementing conditions for different environments.
