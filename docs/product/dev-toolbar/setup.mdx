...
In production environments, the Dev Toolbar can make it easier to reproduce real issues your users are having, but the Toolbar should not be rendered for all users of the site -- only when an employee/engineer/etc visits.
