...
![Sentry displays slow and frozen frames above the flamechart of a particular profile.](/product/profiling/mobile-app-profiling/flamechart-with-gpu-overlay.png)
