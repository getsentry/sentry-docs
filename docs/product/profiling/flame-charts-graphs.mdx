...
![Profiling details page with a flame graph](/product/profiling/profile-flame-chart.png)
...
![A flame graph from Sentry](/product/profiling/flame-chart.png)
...
![A flame graph showing a program that generates the fibonacci sequence](/product/profiling/fib-flame-chart.png)

![An aggregated flame graph showing a program that generates the fibonacci sequence](/product/profiling/fib-flame-graph.png)
...
![The aggregated flame graph view](/product/profiling/aggregated-flame-graph-view.png)
