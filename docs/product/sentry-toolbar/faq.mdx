...
Initializing the Sentry Toolbar allows all developers and testers can use it and quickly go from the page they're looking at back to Sentry for further debugging.
