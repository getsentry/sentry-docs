...
<Alert level="warning" title="Sentry Toolbar Is Deprecated">
  The Sentry Toolbar is deprecated and will not receive new features. Use [Sentry's AI toolkit](/ai/) and the [Sentry MCP server](https://mcp.sentry.dev) instead if your workflow supports them.
</Alert>
