...
Once the prerequisites have been met, you can enable Codecov by going to the **Settings** page in Sentry and toggling on "Enable Code Coverage Insights".

![Codecov in Org Settings](./img/codecov-setup-in-ui.png)
