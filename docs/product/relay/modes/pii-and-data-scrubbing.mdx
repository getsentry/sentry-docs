...
If you are running Managed Mode, _or_ you are OK with sensitive data being scrubbed by Sentry's own servers, refer to [Server-Side Data Scrubbing](/product/data-management-settings/scrubbing/server-side-scrubbing/) instead.
