...
If you're using custom tags or custom filters for in your widgets, we will start collecting metrics to give you accurate counts and rates. During widget creation or editing you will see approximate data based on indexed events, but as soon as you save we will start extracting metrics for those widgets.
