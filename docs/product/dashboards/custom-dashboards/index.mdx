...
You can prevent other users from editing or deleting your dashboard by toggling the Edit Access Selector. The creator of the dashboard will always have edit access for their dashboards. To limit access to specific teams, use the Edit Access Selector to select teams. Clicking on "Save Changes" will update the Edit permissions for the dashboard. Only the dashboard's creator can modify edit permissions.
