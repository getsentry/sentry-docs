...
If you're using custom tags or custom filters in your widgets using the transaction dataset, we will start collecting metrics to give you accurate counts and rates. During widget creation or editing, you will see approximate data based on indexed event. As soon as you save, we will start extracting metrics for those widgets. It may take up to 15 minutes to start seeing metrics.
