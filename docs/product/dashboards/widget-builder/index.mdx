...
![Widget Builder overview. =900x](./img/widget-builder-hero.png)
...
Heat maps are a great way to visualize value density over time. This is ideal for distribution metrics where you want to see where values concentrate rather than just percentile lines, or sums of single counts. 

**Use Application Metrics data to create heat maps.**

![Heat map widget. =700x](./img/heat-map-widget.png)
...
![Filter your results.](./img/editing-widget-filter.png)
...
![Drag and drop group by. =500x](./img/widget-builder-drag-and-drop-group-by.png)
...
![Custom equation field. =500x](./img/widget-builder-custom-equation-field.png)
