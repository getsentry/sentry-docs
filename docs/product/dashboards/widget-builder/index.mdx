...
![Widget Builder overview.](/product/dashboards/widget-builder/widget-builder-overview.png)
...
![Time-series visualizations.](/product/dashboards/widget-builder/widget-builder-time-series-visualizations.png)
...
![Drag and drop column.](/product/dashboards/widget-builder/widget-builder-drag-and-drop-column.png)
...
![Filter your results.](/product/dashboards/widget-builder/widget-builder-filter-your-results-example.png)
...
![Drag and drop group by.](/product/dashboards/widget-builder/widget-builder-drag-and-drop-group-by.png)
...
![Custom equation field.](/product/dashboards/widget-builder/widget-builder-custom-equation-field.png)
...
![Set Thresholds Step](/product/dashboards/widget-builder/widget-builder-thresholds.png)
![Widget Coloured Indicator Hover](/product/dashboards/widget-builder/widget-builder-thresholds-hover.png)

## Extracted metrics

<Include name="feature-available-for-user-group-early-adopter.mdx" />

If you are building a widget with transaction data, and would like to use event-like filters (eg. transaction.duration:>100ms) or custom tags that you set on your transactions, we will routinely collect metrics to show you accurate count and rates for you.

![Extracted Metrics Tooltip](/product/dashboards/widget-builder/widget-builder-extracted-metrics-tooltip.png)

Not all widgets are compatible with extracted metrics however, the following cases will cause your widget to continue using event backed data:
- Equations
-- Using equations will show you event data instead of metrics
- Widgets that display data from errors and transactions simultaneously, or use a custom tag or filter without also filtering on `event.type`
-- Extraction only happens for transaction data, if you add `event.type:error` or `event.type:transaction` to your filter along with your custom tags the data will us errors or the extracted metrics as intended.
