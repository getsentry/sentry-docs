...
Markdown visualizations allow you to display plain text or rich markdown content on your dashboard. This is ideal for providing incident playbooks, or other dashboard-specific instructions. Select to make a custom widget, and *Text (Markdown)* as the visualization type.
