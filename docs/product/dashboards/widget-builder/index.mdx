...
A big number visualization displays the current value of a single function or equation. This visualization is well suited for high-level aggregates. An example scenario would be “p95 of all transactions”.
