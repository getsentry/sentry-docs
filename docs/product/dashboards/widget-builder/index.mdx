...
- Tracking your number of user signups
- Tracking API request payloads
- Processing time for a task

Please note that the widget builder UI is slightly different than for other datasets, to allow for an optimal experience when querying metrics.

![Metrics widget builder.](./img/metrics-widget-builder.png)
