...
![Queries overview dashboard =800x](../img/queries-dash.png)
...
- The span `op` field is set to an [eligible value](https://develop.sentry.dev/sdk/telemetry/transactions/#database).
