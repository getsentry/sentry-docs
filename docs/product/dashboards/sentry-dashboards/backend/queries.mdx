...
- The `db.system` span data value is set to the [correct identifier](https://opentelemetry.io/docs/specs/semconv/database/database-spans/) (e.g., `"postgresql"` or `"mongodb"`).
