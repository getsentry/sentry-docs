...
The Mobile Vitals module in Sentry Dashboards provides a high-level overview of the performance of your screens, and allows you to drill down into the performance metrics of individual screens.

![The Mobile Vitals module.](./img/mobile-vitals.png)
...
On the Mobile Vitals page in Sentry Dashboards, you can see a slow and frozen frame rate, indicating the percentage of frames that are slow or frozen during the lifetime of the transaction.
