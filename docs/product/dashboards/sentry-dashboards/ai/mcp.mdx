...
- **Most Used Tools/Resources/Prompts**: Shows which MCP tools, resources, and prompts are called most frequently by clients
- **Slowest Tools/Resources/Prompts**: Identifies tools, resources, and prompts with the highest response times for performance optimization
- **Most Failing Tools/Resources/Prompts**: Highlights tools, resources, and prompts with the highest error rates that need attention

Click into any tool, resource, or prompt listed under widgets to get to the respective details dashboard.

Below these widgets are tables with detailed performance information:

Click on any row to open the respective details dashboard.
