...
MCP Dashboards, found in [Sentry Dashboards](https://sentry.io/orgredirect/organizations/:orgslug/dashboards/?filter=onlyPrebuilt&query=mcp&sort=mostPopular), provide a comprehensive view of your MCP server activities, including requests, tool executions, resource access, and prompt usage. Once you've [configured the Sentry SDK](/product/ai-observability/mcp/getting-started/) for your MCP project, telemetry data is collected and displayed in the dashboard to support analysis of system behavior and performance.
