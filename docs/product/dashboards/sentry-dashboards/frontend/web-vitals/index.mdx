...
The **Web Vitals** page, found in the **Sentry Dashboards** tab, gives you an overview of your page load and interaction performance for the selected project(s). It's a starting point for investigating poor Web Vitals affecting your web app and drilling down to better understand which pages are affecting your web performance the most.
