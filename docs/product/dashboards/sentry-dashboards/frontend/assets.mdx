...
Open the **Assets** page by clicking "Assets" in the sidebar, under "Sentry Dashboards". Alternatively, the **Performance** page also surfaces the highest impact assets in the "Most Time Consuming Assets" widget. From there, you can click "View All" to open the **Assets** page.
