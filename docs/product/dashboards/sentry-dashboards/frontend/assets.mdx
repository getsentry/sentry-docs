...
To view more details, click on a asset from the table to open its **Asset Summary** dashboard.
...
![Example of Sample Images](../img/frontend-asset.png)
