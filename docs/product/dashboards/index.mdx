...
![Widgets visualizing events, errors by country, affected users, and handled vs unhandled issues.](/product/dashboards/dashboard-default.png)
...
![Widgets visualizing key page performance, Web Vitals, and user misery.](/product/dashboards/dashboard-custom.png)
