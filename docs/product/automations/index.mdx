...
Sentry's Automations can be configured to take external actions, like sending notifications and creating tickets when specific criteria are met. Automations are powered by issue state. When an issue changes state, is created, or passes a threshold, an automation is “triggered”. When the automation is triggered. They can be paired with monitors to notify a team when an issue is created, or call a webhook or integration.
