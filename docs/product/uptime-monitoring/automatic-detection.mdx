...
Once an automatically detected uptime alert has been created, you'll be able to [customize its configuration](/product/monitors-and-alerts/monitors/uptime-monitoring/), including the HTTP request method, headers, and request body.
