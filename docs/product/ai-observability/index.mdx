...
description: >-
  Monitor agent workflows, conversations, and MCP servers. Use agent tracing to explore agent runs, tool calls, model interactions, token usage, and errors.
keywords:
  - AI agents
  - AI observability
  - LLM monitoring
...
Sentry helps you understand what's going on with your agent workflows. It automatically collects information about agent runs, tool calls, model interactions, and errors across your entire AI pipeline—from user interaction to final response. You can also monitor MCP servers and replay past agent activity.

## Get Started

To use AI Observability tools like MCP monitoring, agent tracing, and reviewing conversations, you must have an existing Sentry account and project set up. If you don't have one, [create an account here](https://sentry.io/signup/).
...
- Users report that your agent is returning unexpected or malformed responses, and you need to explore the full context of prompts, model calls, and outputs.
