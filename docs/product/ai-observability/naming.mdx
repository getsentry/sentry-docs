...
Sentry uses the `gen_ai.agent.name` span attribute to identify agents in the [Agents Dashboard](/product/ai-observability/dashboards/). Without a name, you won't be able to filter for a specific agent, group results by agent, or set up alerts for individual agents.
...
- [Agents Dashboard](/product/ai-observability/dashboards/) — view and filter agents by name
