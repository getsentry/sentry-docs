...
Sentry uses the `gen_ai.agent.name` span attribute to identify agents in the [AI Agents Dashboard](/product/ai-observability/dashboards/). Without a name, you won't be able to filter for a specific agent, group results by agent, or set up alerts for individual agents.
...
- [AI Agents Dashboard](/product/ai-observability/dashboards/) — view and filter agents by name
- [Data Privacy](/product/ai-observability/privacy/) — control what data is sent to Sentry
- [Model Costs](/product/ai-observability/costs/) — track token usage and estimated costs
