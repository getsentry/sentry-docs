...
The **Model Cost** widget in the [Agents Dashboard](/product/ai-observability/dashboards/) Models tab shows estimated costs for your LLM usage. This page explains how those costs are calculated.
