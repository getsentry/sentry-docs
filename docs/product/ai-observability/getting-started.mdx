...
To use [Agents](/product/ai-observability/agents/), set a conversation ID for each chat. Sentry uses the `gen_ai.conversation.id` attribute to group related AI spans, and some SDK integrations set it automatically.
...
After setting up, [name your agents](/product/ai-observability/naming/) so they appear as identifiable entries in the AI Agents dashboard.
