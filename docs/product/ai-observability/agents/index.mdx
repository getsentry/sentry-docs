...
Sentry's Agents view lets you observe the interactions users have had with your chat-based assistants. It provides a user-like view into past conversations, showing the full exchange of messages and tool calls so you can understand exactly what happened during each session.

Find conversations and their related spans in **Explore > Agents** in the Sentry sidebar.

## Prerequisites

The Agents view is built on top of [agent tracing](/product/ai-observability/getting-started/). Before you can use it, you need:

1. **Tracing enabled** with the Sentry SDK configured for your agent project. Follow the [agent tracing getting started guide](/product/ai-observability/getting-started/) if you haven't already.
