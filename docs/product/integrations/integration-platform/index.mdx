...
![Demo kanban application user interface that was built to show integration platform features.](/product/integrations/integration-platform/reference-implementation-frontend.png)
...
![Settings page that allows developer to choose between public or internal integrations.](/product/integrations/integration-platform/dev-settings.png)
...
![Dropdown menu of actions for an alert rule.](/product/integrations/integration-platform/alert-rules.png)
...
![Form that allows developer to set what permissions they'll need from their user.](/product/integrations/integration-platform/permissions.png)
