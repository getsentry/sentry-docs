...
![Diagram showing process difference between public and internal integrations.](/product/integrations/integration-platform/authentication-flow.png)
...
![Image showing the ability to copy tokens, create new tokens, revoke tokens, and when they were created in UTC.](/product/integrations/integration-platform/tokens.png)
