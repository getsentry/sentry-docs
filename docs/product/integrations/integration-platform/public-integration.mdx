...
![A list of integrations that a user can install.](/product/integrations/integration-platform/integration-directory.png)
...
![Buttons providing the options to publish or delete.](/product/integrations/integration-platform/publish-button.png)
