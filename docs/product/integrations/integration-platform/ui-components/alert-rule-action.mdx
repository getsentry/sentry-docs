...
![Example of an alert rule UI component.](/product/integrations/integration-platform/ui-components/alert-rule-component-action-example.png)

![Example of an alert rule settings modal.](/product/integrations/integration-platform/ui-components/alert-rule-component-modal-example.png)
