...
![Issue linking sidebar showing Shortcut icon.](/product/integrations/integration-platform/ui-components/issue-sidebar-icons.png)

Clicking the link opens a modal allowing the user to create or link the issue to a task in the external service:
![Sentry modal that creates a Shortcut Story that's linked to a Sentry issue.](/product/integrations/issue-tracking/shortcut/shortcut_create_story_with_issue.png)
...
![Sentry's sidebar button illustrating that an issue is linked.](/product/integrations/issue-tracking/shortcut/shortcut_story_in_linked_issues_82.png)
