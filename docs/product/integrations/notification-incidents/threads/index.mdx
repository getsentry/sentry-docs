...
![Install Threads integration](/product/integrations/notification-incidents/threads/threads-install.png)
...
![Threads alert rule action settings](/product/integrations/notification-incidents/threads/threads-rule.png)
...
![Threads metric alert rule firing and resolving](/product/integrations/notification-incidents/threads/threads-metric-alert.png)
...
![Issue statuses synced](/product/integrations/notification-incidents/threads/threads-issue-alert.png)
