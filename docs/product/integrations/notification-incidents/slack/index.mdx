...
Slack notifications in metric alerts are also contained within threads, so all notifications related to a singular issue will be replies to the original notification and contained.
