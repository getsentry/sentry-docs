...
- The layer for Sentry is added to your Lambdas. Any existing layers are honored and the Sentry layer is appended to the end.
  ...
  ![](/product/integrations/cloud-monitoring/aws-lambda/layer.png)
...
- Sentry adds the following environment variables
  ...
  ![](/product/integrations/cloud-monitoring/aws-lambda/env_variables.png)
...
- The layer for Sentry is added to your Lambdas. Any existing layers are honored and the Sentry layer is appended to the end.
  ...
  ![](/product/integrations/cloud-monitoring/aws-lambda/layer_python.png)
  ...
  ![](/product/integrations/cloud-monitoring/aws-lambda/handler_python.png)
...
- Sentry adds the following environment variables
  ...
  ![](/product/integrations/cloud-monitoring/aws-lambda/env_variables_python.png)
