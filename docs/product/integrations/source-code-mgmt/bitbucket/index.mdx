...
![Install BitBucket integration](/product/integrations/source-code-mgmt/bitbucket/bitbucket-install-pg.png)
...
5. On your new Bitbucket instance in Sentry, click "Configure".
   ...
   ![Configure BitBucket integration](/product/integrations/source-code-mgmt/bitbucket/bitbucket-installed.png)

6. Add any repositories from which you want to collect commit data.

   ![Add repositories](/product/integrations/source-code-mgmt/bitbucket/bitbucket-add-repo.png)
...
![Link BitBucket issue to Sentry issue](/product/integrations/source-code-mgmt/bitbucket/bitbucket-link-issue.png)
