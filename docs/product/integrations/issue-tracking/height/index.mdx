...
![Installed Height integration](/product/integrations/issue-tracking/height/height-install.png)
...
![Height metric alert rule action settings](/product/integrations/issue-tracking/height/height-rule.png)
...
![Link Height issue in Sentry](/product/integrations/issue-tracking/height/height-link-issue.png)

Here, you’ll be able to create or link Height tasks:

![Create Height issue form](/product/integrations/issue-tracking/height/height-create-issue.png)
