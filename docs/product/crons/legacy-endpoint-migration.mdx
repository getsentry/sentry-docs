...
Versions of the `sentry-cli` **before v2.19.0** are using the legacy API
endpoints. [Please upgrade](/product/cli/installation/#updating-and-uninstalling) to the latest version.

If your CLI is configured with an auth token, it will use the legacy API endpoints. Please update your CLI configuration to utilize your project's DSN instead. Refer to the [configuration guide](https://docs.sentry.io/product/crons/getting-started/cli/#configuration) for more information.
