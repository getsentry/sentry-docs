...
<div style={{"height":"0px","paddingBottom":"calc(54.2969% + 41px)","position":"relative","width":"100%"}}>
  <iframe
...
<div style={{"height":"0px","paddingBottom":"calc(61.7215% + 41px)","position":"relative","width":"100%"}}>
  <iframe
...
<div style={{"height":"0px","paddingBottom":"calc(54.3131% + 41px)","position":"relative","width":"100%"}}>
  <iframe
