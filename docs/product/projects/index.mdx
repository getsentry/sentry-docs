...
When you first [create a project](/product/sentry-basics/integrate-frontend/create-new-project/), you also assign a team to it. All members of the assigned team have access to the project. Additional teams can be added in your project's [Project Teams](https://sentry.io/settings/projects/:projectId/teams/) settings.
