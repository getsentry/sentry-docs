...
You can override this by configuring it on a function call level. For more details see [Configuration](/platforms/javascript/guides/nextjs/agent-tracing/vercelai/#configuration).
