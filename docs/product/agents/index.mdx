...
Sentry helps you understand what's going on with your agent workflows. Using [agent tracing](/product/agents/getting-started/), it automatically collects information about agent runs, tool calls, model interactions, and errors across your entire AI pipeline—from user interaction to final response. You can also replay past conversations. If you are looking for MCP monitoring, see [MCP Servers](/product/mcp-servers/).
...
Use agent tracing by [setting up Sentry for Agents](/product/agents/getting-started/) and [name your agents](/product/agents/naming/) so they're identifiable in the dashboard.
