...
![Facet map for transaction and handled tags. Map looks like a bar with gradient colors.](/product/discover-queries/discover-facet-map.png)
...
![Menu showing additional options to add to filter or exclude from filter](/product/discover-queries/discover-table-cell.png)
