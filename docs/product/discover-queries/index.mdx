...
![Full view of the Discover Homepage with query cards and button to build new queries.](/product/discover-queries/discover-homepage.png)
...
![Page displaying a graph of error spikes by URL, the event tag summary, and results of the query.](/product/discover-queries/discover-results.png)
...
![Context menu](/product/discover-queries/013.png)
...
![Event detail page displaying a graph with spikes, the event details, and different metrics for tags.](/product/discover-queries/discover-event-details.png)
