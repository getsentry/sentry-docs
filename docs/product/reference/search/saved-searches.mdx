...
![UI walkthrough of the Saved Searches feature.](/product/reference/search/saved-searches.gif)
...
![Recommended searches section in the saved searches sidebar.](/product/reference/search/search-recommended.png)
...
![UI walkthrough of the Custom Saved Searches feature.](/product/reference/search/custom-saved-searches.gif)
...
![A saved search with an open overflow menu with edit and delete options](/product/reference/search/search-saved-search-edit-delete.png)
...
2. Click the "Set as Default" button located in the header.
   ...
   ![Cursor mousing over the "Set as Default" button.](/product/reference/search/set_default_search.png)

Once defaulted, Sentry will name the search "My Default Search" and return to it whenever you navigate to the **Issues** page.

![Issues page with a default search set.](/product/reference/search/my_default_search.png)
