...
By default, all Sentry accounts have 100 builds of Size Analysis / month. Below are our options for controlling which builds will be processed for Size Analysis.
...
See [Integrating Into CI](/product/size-analysis/integrating-into-ci/) for end-to-end setup, and our sample Github actions for [Android](https://github.com/EmergeTools/hackernews/blob/main/.github/workflows/android_emerge_upload.yml) and [iOS](https://github.com/EmergeTools/hackernews/blob/main/.github/workflows/ios_emerge_upload_pr.yml). Platform-specific uploading are covered in the [Upload Guides](#upload-guides) below.
