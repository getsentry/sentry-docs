...
You can further tune your builds for Size Analysis in Sentry Settings. Go to your project's [Mobile Builds](https://sentry.io/settings/projects/:projectId/mobile-builds/) settings.
