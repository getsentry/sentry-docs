...
Size Analysis tracks your iOS and Android build sizes inside Sentry. Upload builds from CI to spot regressions early, understand what's inside each bundle, and keep release artifacts lean.
