...
You can use webhooks to be notified when a new build is uploaded for Size Analysis. To enable, you can follow these [docs](/organization/integrations/integration-platform/webhooks/preprod-artifacts/).
