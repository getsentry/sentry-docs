...
You can find uploaded builds through the Releases page. Mobile Build will show up in two places:

1. When a Mobile Project is selected, you will see a "Mobile Builds" tab. This tab will list all the builds for the project.

   ![Mobile Builds tab screenshot](./images/mobile-builds-tab.png)

2. Mobile Builds will show up in a Release's details page. Here you will see every build for the Release's version.
