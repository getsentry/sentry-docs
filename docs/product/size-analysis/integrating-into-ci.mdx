...
<Alert level="info" title="Experimental API">
...
![Status Checks Settings Page =600x](./images/status-check-enabled.png)
...
![Status Check Rule Configuration =600x](./images/status-check-rule.png)
