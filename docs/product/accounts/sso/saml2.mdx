...
![](/product/accounts/sso/saml2-metadata-url.png)
...
![](/product/accounts/sso/saml2-provider-xml.png)
...
![](/product/accounts/sso/saml2-provider-data.png)
...
![](/product/accounts/sso/saml2-map-attributes.png)
...
![](/product/accounts/sso/saml2-success.png)
