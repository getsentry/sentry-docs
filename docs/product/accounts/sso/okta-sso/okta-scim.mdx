...
- **Selection of Email for the Application username format** in the Sign On application tab in Okta.
  ![Okta username configuration](/product/accounts/sso/okta-sso/scim-username-config.png)

### Sentry Configuration

1. Sign in to [sentry.io](https://sentry.io). Select **Settings > Auth**
   ![Sentry Okta SCIM Auth Page](/product/accounts/sso/scim-settings-auth.png)
1. Under General Settings select "Enable SCIM", then "Save Settings"
   ![Sentry Enable SCIM Instruction](/product/accounts/sso/scim-enable-sentry.png)
   Sentry will display "SCIM Information" that contains your Auth Token and SCIM Base URL.
   ![SCIM Credentials Fields](/product/accounts/sso/scim-sentry-fields.png)
...
2. Select the "Provisioning" tab, then "Configure API integration".
   ![Okta configure SCIM API](/product/accounts/sso/okta-sso/scim-okta-configure.png)
...
7. On the Provisioning page, select "To App", then "edit":
   ![Okta Save SCIM Settings](/product/accounts/sso/okta-sso/scim-okta-edit.png)
...
![Okta Provisioned User Unable to Leave](/product/accounts/sso/okta-sso/okta-provisioned-unable-to-leave.png)
...
1.  Add a new custom attribute to your Okta application profile
    ...
    2. Under the "Provisioning" tab, select "Go to Profile Editor"
       ![Okta Provisioning Page](/product/accounts/sso/okta-sso/okta-go-to-profile.png)

    3. Select "+ Add Attribute"
       ![Okta Add Attribute](/product/accounts/sso/okta-sso/okta-add-attribute.png)
    ...
    4. Fill out the form with the following settings (You can set whatever value you want for any setting not listed below.):
       ...
       ![Okta Custom Attribute](/product/accounts/sso/okta-sso/okta-custom-attribute-values.png)

2.  Assign a group to your okta application
    ![Okta Assign Group](/product/accounts/sso/okta-sso/okta-assign-group.png)

3.  In the form, enter the string for the org-level role
    ![Okta Set Role](/product/accounts/sso/okta-sso/okta-set-group-attribute.png)
...
![Okta Role Restricted Role Select](/product/accounts/sso/okta-sso/okta-role-restricted-sentry-role-select.png)
...
![Okta Edit Attribute](/product/accounts/sso/okta-sso/okta-edit-sentryOrgRole-attribute.png)
