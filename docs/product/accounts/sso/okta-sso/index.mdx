...
1. Search for `Sentry`, then click "Add" to be brought to the setup wizard.
   ...
   ![Sentry in Okta Gallery of Integrations](/product/accounts/sso/okta-sso/okta-gallery.png)
...
1. Provide the settings. Note that for "1. General Settings", you will not need to provide any special settings. For "2. Sign On Options", provide the following:
   ...
   ![Configuring Sentry in Okta](/product/accounts/sso/okta-sso/okta-settings-for-sentry.png)
...
1. Copy the "Metadata URL" in the set up instructions.
   ...
   ![Okta metadata URL in setup instructions](/product/accounts/sso/okta-sso/okta-setup-instructions-page.png)

1. Sign in to Sentry. Select **Settings > Auth > Configure Okta**.

   ![Sentry single sign-on configuration page](/product/accounts/sso/okta-sso/okta-sentry-sso-settings-page.png)

1. Paste the Metadata URL from Step 8, then click "Continue".

   ![Sentry single sign-on configuration for Okta](/product/accounts/sso/okta-sso/okta-sentry-settings-metadata-url.png)
...
![Sentry single sign-on settings for Okta](/product/accounts/sso/okta-sso/okta-sentry-settings-for-okta.png)
