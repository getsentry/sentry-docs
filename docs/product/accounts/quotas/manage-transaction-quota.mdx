...
Unlike exceeding your error event quota for your first time exceeding quota while on a paid plan, you will not be entered into a one-time grace period the first time you deplete your transactions quota. Learn more about the grace period in this [Help article](https://sentry.zendesk.com/hc/en-us/articles/23983502355099-What-happens-when-I-run-out-of-event-capacity-and-a-grace-period-is-triggered).
