...
![Usage Stats page showing transactions](/product/accounts/quotas/usage-stats-transactions.png)
...
![Busiest Projects](/product/accounts/quotas/manage-trans-quota-01.png)

Once the changes are applied, sort the "Results" table by the "COUNT()" column to display your busiest transactions:

![Busiest Issues](/product/accounts/quotas/manage-trans-quota-02.png)
