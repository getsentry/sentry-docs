...
For each project, you'll need to specify how much of your allocation goes to errors, to performance units, and to attachments.
...
![Empty spend allocation page](/product/accounts/quotas/spend-allocation-empty.png)

2. Select the project, the event category (errors, performance units, or attachments), and the allocation amount you'd like to set aside for that project. You can choose your allocations by volume or spend. Repeat the process for each event type you'd like to allocate to.

![Create spend allocation modal](/product/accounts/quotas/spend-allocation-creation.png)
...
![Spend allocation page showing an existing allocation](/product/accounts/quotas/spend-allocation-populated.png)
