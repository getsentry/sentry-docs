...
If this is your first time exceeding errors quota and you're on a paid plan, however, you'll be entered into a one-time grace period. Learn more about the grace period in this [Help article](https://sentry.zendesk.com/hc/en-us/articles/23983502355099-What-happens-when-I-run-out-of-event-capacity-and-a-grace-period-is-triggered).
...
![Delete and Discard](./img/manage-event-stream-06-new.png)
...
![List of Discarded Issues](./img/manage-event-stream-07-new.png)
