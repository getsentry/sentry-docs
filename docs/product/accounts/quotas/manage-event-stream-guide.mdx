...
![Usage Stats page showing errors](/product/accounts/quotas/usage-stats-errors.png)
...
![Busiest Projects](/product/accounts/quotas/manage-event-stream-02.png)

Once the changes are applied, sort the "Results" table by the "COUNT()" column to display your busiest issues:

![Busiest Issues](/product/accounts/quotas/manage-event-stream-10.png)
...
![The Review & Confirm step of a subscription update.](/product/accounts/quotas/review-subscription.png)
...
![Per DSN Key rate limits](/product/accounts/quotas/manage-event-stream-11.png)
...
1. In the "KEY USAGE IN THE LAST 30 DAYS" graph, look for the highest point, or the maximum daily rate. In the example below, the maximum daily rate in the last month is less than 34K:
   ![Calculating rate limits](/product/accounts/quotas/manage-event-stream-14-new.png)
...
![Revisit rate limits](/product/accounts/quotas/manage-event-stream-15-new.png)
...
![Delete and Discard](/product/accounts/quotas/manage-event-stream-06-new.png)
...
![List of Discarded Issues](/product/accounts/quotas/manage-event-stream-07-new.png)
