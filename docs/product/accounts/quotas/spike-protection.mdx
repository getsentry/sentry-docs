...
![Spike limit threshold](/product/accounts/quotas/spike-limit-threshold.png)
...
![Spike zoomed out](/product/accounts/quotas/spike-protection-zoomed-out.png)
...
![Spike zoomed in plotted with spike limits](/product/accounts/quotas/spike-protection-zoomed-in.png)
...
![Spike limit projections with seasonality](/product/accounts/quotas/spike-protection-steady-state.png)
...
![A "bursty" project with intentional spikes.](/product/accounts/quotas/bursty_projects.png)
