...
![Create New Team](/product/accounts/getting-started/team-settings.png)
...
![Invite Members](/product/accounts/getting-started/invite-members.png)
...
1. Link a Sentry issue to a new or existing issue in your integrated [issue tracking](#33-issue-tracking) solution.
   ...
   ![Identify suspect commits and see suggested assignees for issues.](/product/accounts/getting-started/issue-integrations-01.png)

   ![Link a Sentry issue to a new or existing issue in your issue tracking solution.](/product/accounts/getting-started/issue-integrations-02.png)
...
![Issues page with Project dropdown open.](/product/accounts/getting-started/issues-project-dropdown.png)
...
![The Issues page with the Environment dropdown opened.](/product/accounts/getting-started/environment-dropdown.png)
