...
To set up Sentry's Application Metrics, use the links below for supported SDKs. After it's been set up, you'll be able to send counters, gauges, and distributions from your code and view them in Sentry with direct links to related traces. Once set up, see the [What to Track guide](/guides/metrics/) for practical patterns on choosing what to measure.
