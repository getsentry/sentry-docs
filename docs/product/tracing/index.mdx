...
title: Tracing
sidebar_order: 20
description: "Learn about tracing and distributed tracing and how it can be a powerful tool for not just observing, but also debugging application performance issues."
---
