...
title: Tracing
sidebar_order: 20
description: "Learn about using tracing and distributed tracing for observing and debugging application performance issues."
---
...
Distributed tracing enables you to trace and visualize interactions between multiple instrumented services, allowing you to identify performance bottlenecks that are affecting your application no matter where they're coming from. You can then use the Sentry Trace Explorer and Trace View to dig deeper to find the root cause. Distributed tracing is particularly helpful for identifying problems you can't just debug using console logs, such as race conditions, N+1, and caching issues.
