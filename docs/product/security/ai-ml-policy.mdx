...
All functionality leveraging RAG will require user opt-in. By opting in, you agree to send relevant stack trace and code from linked repositories to third-party AI subprocessors, as disclosed in our [subprocessor list](https://sentry.io/legal/subprocessors/).

We cannot guarantee that the use of generative AI will be BAA-compliant, however generative AI features in Sentry can be disabled for all users.
