...
You can update these settings within the new “Consent to Use Service Data” section of the **Legal & Compliance** page in [Sentry](https://sentry.io/settings/legal/), which is located within the “Usage & Billing” Settings.

## Use of Non-identify Data
