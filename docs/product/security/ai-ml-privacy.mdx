...
## Approach to AI/ML Privacy at Sentry

Throughout Sentry’s history, we’ve operated under [privacy by default](https://blog.sentry.io/terms-of-service-update/?). This applies to our work in the AI/ML space, where we also [want to be transparent](https://blog.sentry.io/terms-of-service-update/) about what data we’re using and why.

Sentry is at a juncture in our maturity where data and experience quality is much harder to maintain using traditional heuristics-based approaches. For example, fingerprinting error events as part of creating groups has gotten a lot more complicated with the rise of JavaScript, and use of extensions and third-party services. To train and validate models for grouping, notifications, and issue priority, Sentry will need access to additional service data to deliver a better user experience.
