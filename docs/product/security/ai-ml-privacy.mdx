...
<Note>
While our model inputs will use customer data, the outputs will **never** risk exposing customer information.
</Note>
...
We're confident that with these controls in place, we'll be able to use service and usage data to improve our products through AI while at the same time protecting that data.
