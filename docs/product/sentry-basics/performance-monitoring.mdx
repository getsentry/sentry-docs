...
- [**AI**](/product/ai-observability/) — LLM call latency, token usage, tool execution performance
...
- **[Agent Tracing](/product/ai-observability/)** — trace AI agent workflows, LLM calls, and tool executions alongside your application traces
