...
- **Set up [alerts](/product/alerts/)** to make sure you know when things you care about are going wrong. You can choose to be alerted via one of our chat integrations like [Slack](/integrations/notification-incidents/slack/) or [Discord](/integrations/notification-incidents/discord/). Check out our [alert best practices](/product/alerts/best-practices/) to learn how to only get relevant notifications.
