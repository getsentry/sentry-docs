...
sidebar_order: 30
description: "Follow this tutorial to set up Sentry for a sample React frontend application. By the end, you'll be able to monitor errrors and view readable stack traces and suspect commits to help you debug."
---
