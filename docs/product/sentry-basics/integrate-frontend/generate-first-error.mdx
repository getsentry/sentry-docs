...
1. Click the "Checkout" button on the right panel to generate an error.
   ...
   <div style={{"height":"0px","paddingBottom":"calc(36.37860082304527% + 41px)","position":"relative","width":"100%"}}>
     <iframe
   ...
   - The error appears in the browser console.
     ...
     ![Import and Configure SDK](/product/sentry-basics/integrate-frontend/generate-first-error-01.png)

   - An alert is sent to your email address configured on Sentry notifying you about an error that occurred in your app.

     ![Alert Email](/product/sentry-basics/integrate-frontend/new_issue_email.png)
