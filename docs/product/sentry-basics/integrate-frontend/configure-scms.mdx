...
sidebar_order: 5
description: "Learn how to integrate your source code with Sentry, so that Sentry can track commits and surface suspect commits and susgested assignees to help you resolve issues faster."
---
