...
<div style="position: relative; padding-bottom: calc(54.65935787000783% + 41px); height: 0; width: 100%;"><iframe src="https://demo.arcade.software/gfwrOiPMJ0lxasNIvJI3?embed" title="FE Tutorial -&gt; Add Stack Trace Linking" frameborder="0" loading="lazy" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="clipboard-write" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;color-scheme: light;"></iframe></div>
