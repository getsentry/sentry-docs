...
sidebar_order: 5
description: >-
  Learn how to integrate your source code with Sentry, so that Sentry can track
...
1. To integrate GitHub with your Sentry org, follow the [GitHub Integration Install instructions](/integrations/source-code-mgmt/github/#install). Be sure to give the integration access to the appropriate repository — in this case, the `frontend-tutorial` repo you forked.
...
- [Insights](/product/dashboards/sentry-dashboards/) to track application performance and errors across services.
