...
1. Fill out the information requested to add a code mapping between your Sentry project and the `frontend-tutorial` repository's `main` or `master` branch. Tell Sentry that your components live in the `src/` directory:
   ...
   ![Add code mapping](/product/sentry-basics/integrate-frontend/configure-scms-09.png)
...
1. Check your email for the alert about the new error. Notice that a new "Suspect Commits" section has been added to the email.
   ...
   ![Suspect Commits email](/product/sentry-basics/integrate-frontend/issue_email_suspect_commits.png)
...
1. In the right side panel, click under "Assigned To" to open the dropdown to see suggested assignees. You'll see that the author of the suspect commit is listed as a suggested assignee for this issue.
   ...
   ![Suggested Assignees](/product/sentry-basics/integrate-frontend/suggested_assignees.png)
...
<div style={{"height":"0px","paddingBottom":"calc(43.44919786096257% + 41px)","position":"relative","width":"100%"}}>
  <iframe
...
<div style={{"height":"0px","paddingBottom":"calc(51.714285714285715% + 41px)","position":"relative","width":"100%"}}>
  <iframe
    src="https://demo.arcade.software/gfwrOiPMJ0lxasNIvJI3?embed"
    frameborder="0"
    loading="lazy"
    webkitallowfullscreen
    mozallowfullscreen
