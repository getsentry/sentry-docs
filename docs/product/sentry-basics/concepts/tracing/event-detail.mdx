...
![Event detail showing critical event information, breakdowns, minimaps and waterfall view](/product/sentry-basics/concepts/tracing/transaction-detail.png)
...
![Trace navigator showing related events](/product/sentry-basics/concepts/tracing/trace-navigator.png)
...
![Span detail view shows the span id, trace id, parent span id, and other data such as tags.](/product/sentry-basics/concepts/tracing/span-detail.png)
...
![Operations breakdown in the event detail.](/product/sentry-basics/concepts/tracing/operations-breakdown.png)
...
![Operations calculation method.](/product/sentry-basics/concepts/tracing/operations-calc.png)
...
![Adding or removing child transactions.](/product/sentry-basics/concepts/tracing/addremove-transaction.png)
