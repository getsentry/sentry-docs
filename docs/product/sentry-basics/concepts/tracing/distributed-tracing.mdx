...
![Diagram illustrating the parent-child relationship between spans within a single transaction.](/product/sentry-basics/concepts/tracing/diagram-transaction-spans.png)
...
![Diagram illustrating the trace-transaction-span relationship illustrated above, now applied to the example.](/product/sentry-basics/concepts/tracing/diagram-transaction-example.png)
