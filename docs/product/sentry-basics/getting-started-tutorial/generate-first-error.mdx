...
From here, two optional steps make your setup even more powerful:
...
- [Configure Suspect Commits & Stack Trace Linking](/product/sentry-basics/getting-started-tutorial/configure-suspect-commits/) — connect GitHub so Sentry surfaces the commit that likely caused each error and links stack traces straight to your source.
