...
- See which commit likely introduced an error and who wrote it.

<Alert title="Time to complete">

This tutorial takes about **60 minutes**. Steps 1–4 set up distributed tracing across your stack (roughly 30 minutes). Steps 5 and 6 are optional and build on that foundation.
...
6. [Configure Suspect Commits & Stack Trace Linking](/product/sentry-basics/getting-started-tutorial/configure-suspect-commits/) _(optional)_
