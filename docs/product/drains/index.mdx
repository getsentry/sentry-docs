...
Drains support forwarding **logs** from all supported platforms. Some platforms also support forwarding **traces**:
...
- **OpenTelemetry Protocol (OTLP)**: The standard protocol for forwarding logs and traces
- **Platform-specific endpoints**: Custom endpoints provided by Sentry for specific platforms (like Vercel's custom drain endpoint)
