...
- Logs: Application logs collected via OTLP receivers or other input sources
- Traces: Distributed traces from OpenTelemetry-instrumented applications
...
exporters:
  otlphttp/project-a:
    logs_endpoint: https://o123456.ingest.us.sentry.io/api/1234567/integration/otlp/v1/logs
    headers:
      x-sentry-auth: "sentry sentry_key=your_project_a_key"
    compression: gzip
    encoding: proto

  otlphttp/project-b:
    logs_endpoint: https://o123456.ingest.us.sentry.io/api/7654321/integration/otlp/v1/logs
    headers:
      x-sentry-auth: "sentry sentry_key=your_project_b_key"
    compression: gzip
    encoding: proto
