...
- Logs: Application logs collected by Fluent Bit input plugins
- Traces: Distributed traces from your applications
...
Update your Fluent Bit configuration to use the OpenTelemetry output plugin. You can configure logs, traces, or both.
