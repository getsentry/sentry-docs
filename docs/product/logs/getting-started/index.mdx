...
To set up Sentry Logs, use the links below for supported SDKs. After it's been set up, you'll be able to view and query logs and parameters sent from your applications within Sentry. Once set up, see the [What to Log guide](/guides/logs/) for practical logging patterns.
