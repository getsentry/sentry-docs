...
For each project, you can configure how [Apdex](#apdex) and [User Misery](#user-misery) are calculated in your project's [Performance](https://sentry.io/settings/projects/:projectId/performance/) settings. You can override project-level settings at the transaction level in **Transaction Summary > Settings**.
