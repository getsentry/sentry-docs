...
sidebar_order: 50
description: >-
  With insights, you can track, analyze, and debug your application's
  performance. Sentry helps you identify performance opportunities and trace
  issues back to poorly performing code.
