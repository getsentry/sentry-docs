...
sidebar_order: 10
description: >-
  Learn more about Sentry's Insights widgets such as Most Slow Frames, Most
  Time-Consuming Queries, and Slow HTTP Ops, and how they can be used to surface
  performance insights in your applications.
