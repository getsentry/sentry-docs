...
As of Sentry Java SDK version 8.24.0, `contextTags` also applies to [structured logs](https://docs.sentry.io/product/logs/). MDC properties matching the configured `contextTags` will be attached to log entries as attributes, prefixed with "mdc.".
