...
To record the user's IP address and `Principal#name` as the username so you can then view in [trace details view](/concepts/key-terms/tracing/trace-details/):
