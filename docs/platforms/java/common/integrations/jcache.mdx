...
If you're using Spring Boot with `@Cacheable` / `@CachePut` / `@CacheEvict`, you don't need this integration — cache tracing is built into the Sentry Spring Boot starter. See the <PlatformLink to="/integrations/caffeine/">Caffeine</PlatformLink>, <PlatformLink to="/integrations/ehcache/">Ehcache</PlatformLink>, or <PlatformLink to="/integrations/redis/">Redis</PlatformLink> integration pages for Spring Boot setup.
