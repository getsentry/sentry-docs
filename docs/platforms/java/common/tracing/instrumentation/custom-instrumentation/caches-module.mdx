...
Make sure that there's a transaction running when you create the spans. If you're using a web framework those transactions will be created for you automatically. See <PlatformLink to="/product/dashboards/sentry-dashboards/">Performance Monitoring</PlatformLink> for more information.
...
For now you'll need to manually instrument the [Cache Module](https://sentry.io/orgredirect/organizations/:orgslug/dashboards/) by following the steps below.
