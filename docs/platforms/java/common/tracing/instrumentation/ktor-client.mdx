...
<Alert level="warning">
  ...
  integration](/platforms/java/tracing/instrumentation/okhttp/), you should
  ...
  integration](/platforms/java/tracing/instrumentation/okhttp/) instead, as it
  provides more detailed information about HTTP request.
</Alert>
