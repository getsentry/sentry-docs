...
![Attachments Access](/platforms/java/common/enriching-events/attachments/attachments-access.png)
...
![Attachments Access Denied](/platforms/java/common/enriching-events/attachments/attachments-access-denied.png)
...
![Attachments List Example](/platforms/java/common/enriching-events/attachments/attachments-list-example.png)
