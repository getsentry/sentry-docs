...
Passing an empty `DataCollection` or explicitly configuring any field enables Data Collection. All fields you don't configure use the defaults below, and `sendDefaultPii` no longer controls Data Collection categories.
