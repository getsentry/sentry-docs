...
description: "Learn more about how to configure the Sentry Java SDK. These options are set when the SDK is first initialized, passed to the init method as an object."
sidebar_order: 2
