...
```bash {tabTitle:Linux Package Manager}
...
See https://www.mediawiki.org/wiki/Excimer for additional distributions, or https://pecl.php.net/package/excimer for more information, respectively.
