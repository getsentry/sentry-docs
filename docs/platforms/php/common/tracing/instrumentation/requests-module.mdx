...
For detailed information about which data can be set, see the [Requests Module developer specifications](https://develop.sentry.dev/sdk/telemetry/transactions/#requests-module) and [HTTP Span Data Conventions](https://develop.sentry.dev/sdk/telemetry/transactions/#http).
