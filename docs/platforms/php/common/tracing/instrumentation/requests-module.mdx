...
---
Sentry offers a [requests monitoring dashboard](https://sentry.io/orgredirect/organizations/:orgslug/insights/http/) that can be auto-instrumented by our <PlatformLink to="/guides/laravel/">Laravel SDK</PlatformLink> and <PlatformLink to="/guides/symfony/">Symfony SDK</PlatformLink>.
