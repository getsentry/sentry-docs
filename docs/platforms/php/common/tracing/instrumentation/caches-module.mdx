...
---
Sentry offers a [cache-monitoring dashboard](https://sentry.io/orgredirect/organizations/:orgslug/insights/caches/) that can be auto-instrumented by our <PlatformLink to="/guides/laravel/">Laravel SDK</PlatformLink>.
