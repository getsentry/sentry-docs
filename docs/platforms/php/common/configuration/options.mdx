...
<SdkOption name="profiles_sample_rate" type="float" defaultValue="null">
  ...
  A number between `0` and `1`, controlling the percentage chance a given profile will be sent to Sentry. (`0` represents 0% while `1` represents 100%.) Applies equally to all profiles created in the app.
