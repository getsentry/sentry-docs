...
- [Laravel AI](https://laravel.com/docs/13.x/ai-sdk) agent invocations, LLM requests, tool executions, and embeddings (see <PlatformLink to="/ai-monitoring/">AI Agent Monitoring</PlatformLink>)
