...
The Laravel AI integration connects Sentry with the [Laravel AI](https://laravel.com/docs/13.x/ai-sdk) package. It powers <PlatformLink to="/ai-monitoring/">AI Agent Monitoring</PlatformLink> for Laravel applications.
...
For setup, provider support, privacy controls, and verification, see <PlatformLink to="/ai-monitoring/">Set Up AI Agent Monitoring</PlatformLink>.
