...
The `gen_ai` option is the master switch for <PlatformLink to="/ai-monitoring/">AI Agent Monitoring</PlatformLink>. The more specific `gen_ai_*` options let you disable individual AI span types while keeping the rest of AI monitoring enabled.
