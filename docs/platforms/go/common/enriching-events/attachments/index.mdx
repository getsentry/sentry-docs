...
![Attachments Access](/platforms/go/common/enriching-events/attachments/attachments-access.png)
...
![Attachments Access Denied](/platforms/go/common/enriching-events/attachments/attachments-access-denied.png)
...
![Attachments List Example](/platforms/go/common/enriching-events/attachments/attachments-list-example.png)
