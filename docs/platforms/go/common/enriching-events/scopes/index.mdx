...
description: "The Sentry Go SDK will in most cases automatically manage the scopes for you in the framework integrations. Learn what a scope is and how you can use it to your advantage."
---
...
<PlatformIdentifier name="push-scope" /> and <PlatformIdentifier name="configure-scope" /> both modify the active scope, but they differ in how long the changes persist:
