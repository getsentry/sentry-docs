...
For different databases, see the respective database driver documentation and just wrap the driver or connector with `sentrysql.NewDriver` or `sentrysql.NewConnector`.
