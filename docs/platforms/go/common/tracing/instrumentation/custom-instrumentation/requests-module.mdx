...
Sentry offers a [requests monitoring dashboard](https://sentry.io/orgredirect/organizations/:orgslug/dashboards/) that can be auto-instrumented by our Go SDK.
