...
description: "Learn how to capture performance data on any action in your app using the Sentry Go SDK."
sidebar_order: 20
---
...
func doWork(ctx context.Context) {
	// Set the OP based on values from https://develop.sentry.dev/sdk/telemetry/transactions/#span-operations
