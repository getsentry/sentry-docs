...
For a quick reference, there is a [complete example](https://github.com/getsentry/sentry-go/tree/master/_examples/martini) at the Go SDK source code repository.
