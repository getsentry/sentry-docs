...
<SdkOption name="diagnostic_level" type="enum" defaultValue="error">

Specifies the minimum level of messages to be printed if `debug` is turned on. Possible values are: `debug`, `info`, `warning`, `error`, and `fatal`.
...
<SdkOption name="attach_log" type="boolean" defaultValue="true">

If enabled, the SDK will attach the Godot log file to the event.

</SdkOption>

<SdkOption name="attach_screenshot" type="boolean" defaultValue="false">
...
<SdkOption name="screenshot_level" type="enum" defaultValue="fatal">

Specifies the minimum level of events for which screenshots will be captured. Possible values are: `debug`, `info`, `warning`, `error`, and `fatal`.
...
<SdkOption name="logger_event_mask" type="integer" defaultValue="5">

Specifies the types of errors captured as events. Accepts a single value or a bitwise combination of `GodotErrorMask` masks. The default value captures native errors and script errors (`MASK_ERROR | MASK_SCRIPT`).
...
<SdkOption name="logger_include_source" type="boolean" defaultValue="true">
...
<SdkOption name="logger_include_variables" type="boolean" defaultValue="true">
...
<SdkOption name="logger_messages_as_breadcrumbs" type="boolean" defaultValue="true">
