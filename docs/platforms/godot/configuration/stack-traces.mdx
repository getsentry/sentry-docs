...
To show inline source context in Sentry, `sentry-cli` can scan debug files for source references, resolves them locally, and creates a source bundle—an archive of all referenced source files. Run this command to create the bundle:
