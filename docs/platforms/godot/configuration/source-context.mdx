...
3. Turn on **Enable SCM Source Context** under your project's **Settings > [General Settings](https://sentry.io/orgredirect/organizations/:orgslug/settings/projects/:projectId/) > Client Security**.
...
- **Enable SCM Source Context** is turned on in your [project settings](https://sentry.io/orgredirect/organizations/:orgslug/settings/projects/:projectId/).
