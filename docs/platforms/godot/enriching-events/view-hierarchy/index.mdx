---
title: "Scene Tree"
description: "Learn more about capturing scene tree data during errors and crashes. Sentry provides a visual representation of your game's scene tree at the time of failure, giving you additional insights into issues."
---
...
Or, like so, if you're [configuring things programmatically](/platforms/godot/configuration/options/):
