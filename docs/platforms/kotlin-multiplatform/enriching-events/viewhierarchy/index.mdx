...
![Screenshots List Example](/platforms/kotlin-multiplatform/enriching-events/viewhierarchy/viewhierarchy-list-example.png)
...
![View Hierarchy Example](/platforms/kotlin-multiplatform/enriching-events/viewhierarchy/viewhierarchy-example.png)
