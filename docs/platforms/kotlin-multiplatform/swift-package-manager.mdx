...
Create a Frameworks directory in the directory where the `test.kexe` resides and insert the Sentry.framework directory (this can be found inside of `ios-arm64_x86_64-simulator`).
