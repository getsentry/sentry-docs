...
- If you are using an older version of the Sentry Cocoa SDK, you may need to update to version [8.25.0](https://github.com/getsentry/sentry-cocoa/releases/tag/8.25.0) or later to automatically include the privacy manifest for dynamically linked frameworks.
