---
title: Attributes
description: "Attributes automatically enrich your telemetry with typed key-value data. Use them to add business context that you can then filter and search in Sentry using the Dart SDK."
---
...
Pass attributes in the `attributes` parameter of any metric. Each metric has a 1 MiB size limit for attributes:
