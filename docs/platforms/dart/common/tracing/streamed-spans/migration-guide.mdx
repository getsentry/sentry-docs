...
Attribute values must be created with a typed `SentryAttribute` factory (`string`, `int`, `bool`, or `double`). See <PlatformLink to="/tracing/streamed-spans/#add-attributes">Add Attributes</PlatformLink> for the full list.
