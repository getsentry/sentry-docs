...
- <Link to="/product/insights/overview">Tracing</Link> creates transactions for:
  - <PlatformLink to="/integrations/http-integration/#performance-monitoring-for-http-requests">
    HTTP requests
  </PlatformLink>
  . - <PlatformLink to="/integrations/dio/#performance-monitoring-for-http-requests">
    Dio HTTP library
  </PlatformLink>
