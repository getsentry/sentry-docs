...
To set up replay, enable it by setting a non-zero sample rate ([SentryFlutterOptions](https://github.com/getsentry/sentry-dart/blob/main/packages/flutter/lib/src/sentry_flutter_options.dart)) and wrapping your root widget with `SentryWidget`:
