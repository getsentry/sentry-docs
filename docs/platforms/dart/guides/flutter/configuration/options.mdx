...
<SdkOption name="traceLifecycle" type="enum" defaultValue="static" availableSince="9.19.0">
...
<SdkOption name="beforeSendSpan" type="function" availableSince="9.19.0">
...
<SdkOption name="ignoreSpans" type="array" availableSince="9.19.0">
...
Set this boolean to `false` to disable auto [tracing](/product/dashboards/sentry-dashboards/) tracking.
