...
For more configuration details, see the <PlatformLink to="/platforms/android/configuration/app-not-respond/">Android ANR documentation</PlatformLink> and the <PlatformLink to="/platforms/apple/configuration/app-hangs/">Apple App Hangs documentation</PlatformLink>.
