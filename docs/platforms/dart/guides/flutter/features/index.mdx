...
- Native crash reports use Breakpad by default and are uploaded on the next application start. For coverage limitations and the Crashpad override, see <PlatformLink to="/troubleshooting/#issues-with-native-crashes-on-linux-andor-windows">Desktop Crash Reporting</PlatformLink>.
