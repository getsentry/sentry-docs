...
Sentry can send spans in one of two ways: the default transaction mode or stream mode, where spans are streamed to Sentry as they finish. See <PlatformLink to="/tracing/streamed-spans/">Stremead Spans</PlatformLink> to learn more.
