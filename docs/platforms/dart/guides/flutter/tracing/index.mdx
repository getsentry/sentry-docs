...
No extra enable flag is needed. For sampling examples and APIs to extend startup past the first frame, see <PlatformLink to="/integrations/app-start-instrumentation/">App Start Instrumentation</PlatformLink>.
