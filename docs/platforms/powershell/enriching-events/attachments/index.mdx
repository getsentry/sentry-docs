...
![Attachments Access](/platforms/dotnet/common/enriching-events/attachments/attachments-access.png)
...
![Attachments Access Denied](/platforms/dotnet/common/enriching-events/attachments/attachments-access-denied.png)
...
![Attachments List Example](/platforms/dotnet/common/enriching-events/attachments/attachments-list-example.png)
