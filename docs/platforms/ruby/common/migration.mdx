...
- **Tracing:** The Sentry Ruby SDK includes [tracing](/product/performance/), which you can enable if you haven't already as ([discussed here](/platforms/ruby/performance/)).
