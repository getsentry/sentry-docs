...
As a prerequisite to setting up Agent Tracing with Ruby, you'll need to first <PlatformLink to="/tracing/">set up tracing</PlatformLink>. Once this is done, you can use the custom instrumentation described below to capture AI agent spans.
