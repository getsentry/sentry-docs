...
Are you looking for our integration with the `tracing` crate? You can find it <PlatformLink to="/tracing/instrumentation/automatic-instrumentation/">here</PlatformLink>.
