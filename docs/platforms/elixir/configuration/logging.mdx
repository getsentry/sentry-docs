...
<Alert level="info" title="Looking for Structured Logs?">

This page covers **error and crash reporting** through Erlang's logger system. To send structured log events to Sentry's Logs product, see <PlatformLink to="/logs/">Set Up Logs</PlatformLink>.
