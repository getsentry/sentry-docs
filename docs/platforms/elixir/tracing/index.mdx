...
description: "Learn how to enable tracing in your app using the Sentry Elixir SDK and discover valuable performance insights of your application."
sidebar_order: 30
sidebar_section: features
---

With [tracing](/product/dashboards/sentry-dashboards/), Sentry tracks your software performance, measuring metrics like throughput and latency, and displaying the impact of errors across multiple systems.
...
Incoming requests answered with _404 Not Found_ aren't reported as transactions. To trace them, or to ignore other statuses, set <PlatformLink to="/configuration/options/#traces_ignore_http_status_codes">`traces_ignore_http_status_codes`</PlatformLink>.
...
When both tracing and <PlatformLink to="/logs/">structured logs</PlatformLink> are enabled, log events are automatically linked to the active trace. This lets you view logs alongside spans in the Sentry Trace Explorer.
...
```elixir {filename:lib/my_app/application.ex}
def start(_type, _args) do
