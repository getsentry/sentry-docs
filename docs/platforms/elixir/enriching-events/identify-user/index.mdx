---
title: Users
description: "Learn how to configure the Sentry Elixir SDK to capture the user and gain critical pieces of information that construct a unique identity in Sentry."
---
