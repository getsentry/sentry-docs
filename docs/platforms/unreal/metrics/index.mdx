...
The **Sample interval** setting controls how often game stats are collected. The default value of 60 seconds provides a good balance between visibility and overhead. Memory usage is read from `FPlatformMemory::GetStats()` and UObject count from the engine's global object array.
