...
<SdkOption name="AutomaticBreadcrumbs" type="bool" defaultValue="false">
...
<SdkOption name="AutomaticBreadcrumbsForLogs" type="bool" defaultNote="enabled for Fatal, Error, and Warning">
