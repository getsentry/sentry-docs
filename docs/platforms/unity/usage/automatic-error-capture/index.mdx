...
The Sentry SDKs already have the ability to connect events in a distributed system through the use of a trace. You can read more about how this works in the [Tracing documentation](/platforms/unity/usage/tracing/).
...
On the issues details page, you will see this as errors being connected within the Trace Preview. The example below shows a C# error being connected to an exception in Kotlin and a crash in C.
