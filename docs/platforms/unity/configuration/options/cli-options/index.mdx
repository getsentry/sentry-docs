...
Wether the SDK should automatically upload debug symbols to Sentry. This requires a valid auth token, organization and project.

</ConfigKey>

<ConfigKey name="upload-development-symbols" supported={["dotnet"]}>

Wether the SDK should automatically upload debug symbols to Sentry for development builds.

</ConfigKey>

<ConfigKey name="upload-sources" supported={["dotnet"]}>

Wether the SDK should automatically upload sources to Sentry. This enabled Sentry to provide source-context on events.
