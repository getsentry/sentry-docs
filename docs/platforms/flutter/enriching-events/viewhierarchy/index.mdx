...
![Screenshots List Example](/platforms/flutter/enriching-events/viewhierarchy/viewhierarchy-list-example.png)
...
![View Hierarchy Example](/platforms/flutter/enriching-events/viewhierarchy/viewhierarchy-example.png)
