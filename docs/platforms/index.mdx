...
We also <Link to="https://www.sentry.help/en/articles/23961784367387">discourage using Sentry alongside other APM tools</Link> because it can lead to a number of side-effects that negatively impact performance and stability of the application.
