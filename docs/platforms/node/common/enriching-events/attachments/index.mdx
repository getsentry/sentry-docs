...
![Attachments Access](/platforms/node/common/enriching-events/attachments/attachments-access.png)
...
![Attachments Access Denied](/platforms/node/common/enriching-events/attachments/attachments-access-denied.png)
...
![Attachments List Example](/platforms/node/common/enriching-events/attachments/attachments-list-example.png)
