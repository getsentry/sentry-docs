...
![An image showing the available customization options for the User Feedback Widget](/platforms/node/common/user-feedback/configuration/user-feedback-widget-customization.png)
