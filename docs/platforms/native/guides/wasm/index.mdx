...
No longer 'early' adoption, also issues should be raised on sentry-native or sentry-javascript GH instead.
...
<Alert>
We now provide `@sentry/wasm` as seen on our [JavaScript WASM docs](/platforms/javascript/guides/wasm/).
</Alert>
