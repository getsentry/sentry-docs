...
In order to use distributed tracing with the Native SDK, follow the <PlatformLink to="/usage/distributed-tracing/custom-instrumentation/">custom instrumentation</PlatformLink> steps.
