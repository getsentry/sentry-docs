...
![Attachments Example](/platforms/native/common/enriching-events/attachments/slide-bar-native-crashes.png)
...
![Attachments Access](/platforms/native/common/enriching-events/attachments/attachments-access.png)
...
![Attachments Access Denied](/platforms/native/common/enriching-events/attachments/attachments-access-denied.png)
...
![Attachments List Example](/platforms/native/common/enriching-events/attachments/attachments-list-example.png)
