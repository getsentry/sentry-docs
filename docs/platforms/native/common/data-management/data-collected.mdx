...
We recommend utilizing your own redactions in the `before_send` callback or similar hooks to scrub sensitive query string data before it is sent to Sentry.
