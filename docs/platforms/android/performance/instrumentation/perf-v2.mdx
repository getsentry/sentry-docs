...
Performance V2 is a set of features which enrich your existing instrumentation, giving you more insights into potential performance bottlenecks. These features tightly integrate with [sentry.io Mobile Vitals](/product/performance/mobile-vitals/).
