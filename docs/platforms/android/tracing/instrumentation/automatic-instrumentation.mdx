...
On Android 12 and later, the system splash screen does not receive separate Sentry instrumentation or change how TTID is calculated. TTID still finishes when the Activity draws its first frame.
