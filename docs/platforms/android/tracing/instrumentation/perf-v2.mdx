...
![Screenshot Performance V2 App Start](/platforms/android/tracing/instrumentation/perf-v2-app-start.png)
...
![Screenshot Performance V2 Frame Delay](/platforms/android/tracing/instrumentation/perf-v2-frame-delay.png)
