...
The current transaction name is used to group transactions in our [Insights](/product/dashboards/sentry-dashboards/) product, as well as annotate error events with their point of failure.
