...
description: "Migrate from an older version of our Sentry Android SDK."
---
...
<AnchorLinkGrid
  items={[
    {
      href: "#migrating-from-iosentrysentry-7x-to-iosentrysentry-800",
      title: "Migrate from sentry 7.x to 8.0.0",
      description:
        "Learn about migrating from Sentry Android SDK (io.sentry:sentry) 7.x to 8.0.0",
    },
    {
      href: "#migration-from-iosentrysentry-android-gradle-plugin3xx-to-iosentrysentry-android-gradle-plugin400",
      title: "Migrate Android Gradle plugin 3.x to 4.0.0",
      description:
        "Learn about migrating from the Sentry Android Gradle plugin 3.x to 4.0.0",
    },
    {
      href: "#migrating-from-iosentrysentry-android-6x-to-iosentrysentry-android-700",
      title: "Migrate sentry-android 6.x to 7.0.0",
      description: "Learn about migrating from Sentry Android SDK 6.x to 7.0.0",
    },
    {
      href: "#migrating-from-iosentrysentry-android-614x-to-iosentrysentry-android-6150",
      title: "Migrate sentry-android 6.14.x to 6.15.0",
      description:
        "Learn about migrating from Sentry Android SDK 6.14.x to 6.15.0",
    },
    {
      href: "#migrating-from-iosentrysentry-android-62x-to-iosentrysentry-android-630",
      title: "Migrate sentry-android 6.2.x to 6.3.0",
      description:
        "Learn about migrating from Sentry Android SDK 6.2.x to 6.3.0",
    },
    {
      href: "#migrating-from-iosentrysentry-android-6x-to-iosentrysentry-android-620",
      title: "Migrate sentry-android 6.x to 6.2.0",
      description: "Learn about migrating from Sentry Android SDK 6.x to 6.2.0",
    },
    {
      href: "#migrating-from-iosentrysentry-android-5x-to-iosentrysentry-android-600",
      title: "Migrate sentry-android 5.x to 6.0.0",
      description: "Learn about migrating from Sentry Android SDK 5.x to 6.0.0",
    },
    {
      href: "#migrating-to-iosentrysentry-android-timber-562",
      title: "Migrate to sentry-android-timber 5.6.2",
      description: "Learn about migrating to Sentry Android Timber 5.6.2",
    },
    {
      href: "#migrating-from-iosentrysentry-android-gradle-plugin-2x-to-iosentrysentry-android-gradle-plugin-300",
      title: "Migrate Android Gradle plugin 2.x to 3.0.0",
      description:
        "Learn about migrating from the Sentry Android Gradle plugin 2.x to 3.0.0",
    },
    {
      href: "#migrating-from-iosentrysentry-android-gradle-plugin-1x-to-iosentrysentry-android-gradle-plugin-200",
      title: "Migrate Android Gradle plugin 1.x to 2.0.0",
      description:
        "Learn about migrating from the Sentry Android Gradle plugin 1.x to 2.0.0",
    },
    {
      href: "#migrating-from-iosentrysentry-android-430-to-iosentrysentry-android-500",
      title: "Migrate sentry-android 4.3.0 to 5.0.0",
      description:
        "Learn about migrating from Sentry Android SDK 4.3.0 to 5.0.0",
    },
    {
      href: "#migrating-from-iosentrysentry-android-410-to-iosentrysentry-android-420",
      title: "Migrate sentry-android 4.1.0 to 4.2.0",
      description:
        "Learn about migrating from Sentry Android SDK 4.1.0 to 4.2.0",
    },
    {
      href: "#migrating-from-iosentrysentry-android-2x-to-iosentrysentry-android-3x",
      title: "Migrate sentry-android 2.x to 3.x",
      description: "Learn about migrating from Sentry Android SDK 2.x to 3.x",
    },
    {
      href: "#migrating-from-iosentrysentry-android-1x-to-iosentrysentry-android-2x",
      title: "Migrate sentry-android 1.x to 2.x",
