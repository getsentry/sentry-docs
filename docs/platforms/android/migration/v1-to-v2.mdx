...
If you are using the [GitHub](/integrations/source-code-mgmt/github/) or [GitLab](/integrations/source-code-mgmt/gitlab/) integrations, you need to do one of the following:
