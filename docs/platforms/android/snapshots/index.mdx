...
On Android you can either [generate images from compose previews (recommended)](/platforms/android/snapshots/#generate-snapshots-from-compose-previews-recommended) or [from an existing snapshot tool](/platforms/android/snapshots/#generate-snapshots-from-an-existing-snapshot-tool).
