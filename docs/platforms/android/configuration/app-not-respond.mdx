...
## ANR Fingerprinting (Experimental)

<Alert>

ANR Fingerprinting is available starting in SDK version `8.35.0`. This feature is experimental and may change in future versions.
...
ANR fingerprinting is enabled by default. To disable it:
