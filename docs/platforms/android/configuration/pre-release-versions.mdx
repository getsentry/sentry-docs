...
The [Sentry Kotlin Compiler Plugin](/platforms/android/enhance/kotlin-compiler-plugin/) snapshots are published from the same repository with the same version. If you're using it, update its version as well:
