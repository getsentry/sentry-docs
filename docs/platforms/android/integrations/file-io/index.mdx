...
To view the recorded transaction, go to your Sentry project's [Traces page](https://sentry.io/orgredirect/organizations/:orgslug/explore/traces/) and select it from the transaction list.
