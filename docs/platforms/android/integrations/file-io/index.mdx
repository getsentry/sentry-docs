...
To view the recorded transaction, log into [sentry.io](https://sentry.io) and open your project. Then go to the [Traces page](https://sentry.io/orgredirect/organizations/:orgslug/explore/traces/) and select the transaction named "Track Interaction" from the transaction list.
