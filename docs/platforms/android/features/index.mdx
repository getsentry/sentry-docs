...
- <Link to="/product/dashboards/sentry-dashboards/">Tracing</Link> that can track:
...
- <PlatformLink to="/configuration/memory-limiter">Memory Limiter</PlatformLink>, which reports process kills caused by Android's per-app memory limits on supported devices.
