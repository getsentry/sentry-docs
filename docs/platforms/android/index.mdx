...
<Alert level="info">
  ...
  to capture <Link to="https://perfetto.dev/">Perfetto</Link> traces and
  requires Android 15 (API level 35) or higher. To profile devices running older
  versions, see{" "}
  <PlatformLink to="/profiling/legacy">Legacy Profiling</PlatformLink>.
</Alert>
