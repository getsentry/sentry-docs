...
<Alert level="info">
  Profiling uses the Android <Link to="https://developer.android.com/reference/android/os/ProfilingManager">ProfilingManager</Link> to capture <Link to="https://perfetto.dev/">Perfetto</Link> traces and requires Android 15 (API level 35) or higher. To profile devices running older versions, see <PlatformLink to="/profiling/legacy">Legacy Profiling</PlatformLink>.
</Alert>
