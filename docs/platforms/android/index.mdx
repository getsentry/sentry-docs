...
- <PlatformLink to="/configuration/app-not-respond#anr-profiling-experimental">Capture stack profiles during ANR events</PlatformLink> for deeper diagnostics with flamegraphs
- <PlatformLink to="/configuration/app-not-respond#anr-fingerprinting-experimental">Reduce ANR noise</PlatformLink> by automatically grouping system-frame-only ANRs
