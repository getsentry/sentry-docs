...
Many of the categories listed here require you to enable the <PlatformLink to="/configuration/options/#send-default-pii">send-default-pii option</PlatformLink>.
