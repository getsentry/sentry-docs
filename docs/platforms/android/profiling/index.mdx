...
For Profiling to work, you have to first enable Sentry’s performance monitoring via `io.sentry.traces.sample-rate` (like in the example above). Read our <PlatformLink to="/performance/">performance setup documentation</PlatformLink> to learn how to configure sampling. If you set your sample rate to 1.0, all transactions will be captured.
