...
<application>
  ...
  See the Android Session Replay documentation for details: [Screenshot Strategy](https://docs.sentry.io/platforms/android/session-replay/#screenshot-strategy). -->
