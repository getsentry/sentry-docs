...
You can learn more about the various optimizations implemented in the Android Replay SDK in the [Replay Performance Overhead](/product/session-replay/mobile/performance-overhead/) docs.
