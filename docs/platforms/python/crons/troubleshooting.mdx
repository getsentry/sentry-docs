...
The SDK might be experiencing network issues. See <PlatformLink to="/troubleshooting/#network-issues">this section on troubleshooting connection problems</PlatformLink>.
