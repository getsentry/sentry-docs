...
<IntegrationGrid
  integrations={[
    ...
    {to: "/integrations/google-genai/", title: "Google Gen AI", icon: "google-genai"},
    {to: "/integrations/openai/", title: "OpenAI", icon: "openai"},
    {to: "/integrations/openai-agents/", title: "OpenAI Agents SDK", icon: "openai"},
    {to: "/integrations/langchain/", title: "LangChain", icon: "langchain"},
    {to: "/integrations/langgraph/", title: "LangGraph", icon: "langgraph"},
    {to: "/integrations/litellm/", title: "LiteLLM", icon: "litellm"},
    {to: "/integrations/pydantic-ai/", title: "Pydantic AI", icon: "pydantic-ai"},
    {to: "/integrations/huggingface_hub/", title: "Hugging Face Hub", icon: "huggingface_hub"},
  ]}
/>
