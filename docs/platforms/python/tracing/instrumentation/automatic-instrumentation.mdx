...
In stream mode, any span without a parent is a service span (equivalent to transactions). You can force any span to be a service by removing its parent. See <PlatformLink to="/tracing/instrumentation/custom-instrumentation/">Custom Instrumentation</PlatformLink> to learn more.
