...
You can add data attributes to your spans. This data is visible in the trace explorer in Sentry. Span attributes can be of type `string`, `number` or `boolean`, as well as (non-mixed) arrays of these types:
