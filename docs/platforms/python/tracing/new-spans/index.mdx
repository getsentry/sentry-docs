...
## Manual Instrumenation (Optional)
...
If you use a custom `traces_sampler`, the shape of the sampling context is different in stream mode. See the <PlatformLink to="/new-spans/migration-guide/">New Span API migration guide</PlatformLink> for details.
