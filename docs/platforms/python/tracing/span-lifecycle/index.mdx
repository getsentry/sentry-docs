...
Sentry maintains a [list of well-known span operations](https://develop.sentry.dev/sdk/telemetry/transactions/#list-of-operations) that you should use when applicable:
