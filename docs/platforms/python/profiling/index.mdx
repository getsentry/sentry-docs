...
If you had previously set `profiles_sample_rate` or `profilers_sampler` to use transaction-based profiling, then remove those lines of code from your configuration.
