...
![Attachments Access](/platforms/python/enriching-events/attachments/attachments-access.png)
...
![Attachments Access Denied](/platforms/python/enriching-events/attachments/attachments-access-denied.png)
...
![Attachments List Example](/platforms/python/enriching-events/attachments/attachments-list-example.png)
