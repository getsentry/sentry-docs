...
As you start using the SDK, the initial scopes are created for you automatically. You can call <PlatformIdentifier name="configure-scope" /> at any point in
...
determines the correct scope to use to perform that functionality. Internally the hub will
