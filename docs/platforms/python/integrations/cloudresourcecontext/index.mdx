...
The [developer documentation](https://develop.sentry.dev/sdk/foundations/data-model/events/contexts/#runtime-context) lists all the information that's being added.
