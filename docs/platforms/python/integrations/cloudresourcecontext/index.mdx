...
The [developer documentation](https://develop.sentry.dev/sdk/foundations/data-model/event-payloads/contexts/#runtime-context) lists all the information that's being added.
