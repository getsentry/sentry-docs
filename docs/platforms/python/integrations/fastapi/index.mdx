...
![Issues List](/platforms/python/integrations/fastapi/fastapi-issues-list.png)
...
![Performance details are shown as waterfall diagram](/platforms/python/integrations/fastapi/fastapi-performance-details.png)
