...
Once you've installed this integration, you can use the [AI Agents Dashboard](https://sentry.io/orgredirect/organizations/:orgslug/dashboards/?filter=onlyPrebuilt&query=agents&sort=mostPopular), a Sentry dashboard that helps you understand what's going on with your AI agents.
