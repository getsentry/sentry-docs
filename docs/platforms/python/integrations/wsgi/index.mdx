...
The version above applies for Sentry Python SDK version 2.0+ which drops support for some legacy Python and framework versions. If you're looking to use Sentry with older Python or framework versions, consider using an SDK version from the 1.x major line of releases.
