...
After running this script, a pipeline will be created in the [AI Monitoring](/product/ai-monitoring) section of the Sentry dashboard. The pipeline will have an associated OpenAI span for the `chat.completions.create` operation.
