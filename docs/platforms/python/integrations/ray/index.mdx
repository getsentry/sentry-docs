...
- **Note**: Capturing performance data from [Ray Actors](https://docs.ray.io/en/latest/ray-core/actors.html) is currently **not supported**. (As always, [PRs are welcomed](https://github.com/getsentry/sentry-python/blob/master/CONTRIBUTING.md))
