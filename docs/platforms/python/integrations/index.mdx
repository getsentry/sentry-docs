...
Non-auto-enabling integrations can be enabled using the `integrations` config option.
...
sentry_sdk.init(
    integrations=[
        ...
        # The asyncio integration is not enabled automatically and needs to be
        # manually.
        AsyncioIntegration(),
    ],
)
...
Any previously auto-enabled integrations that you want then have to be
...
added integrations, both default and auto enabling. Any integrations you want use
