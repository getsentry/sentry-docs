...
Sentry AI Agents tracing will automatically collect information about agents, tools, prompts, tokens, and models.
...
Verify that the integration works by running an AI agent. The resulting data should show up in your AI Agents dashboard.
