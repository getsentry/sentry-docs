...
```python {filename:mysettings.py} {"onboardingOptions": {"performance": "9-11", "profiling": "12-15"}}
# mysettings.py
import sentry_sdk
...
```python {filename:app.py} {"onboardingOptions": {"performance": "9-11", "profiling": "12-15"}}
# app.py
import sentry_sdk
...
```python {filename:mysettings.py} {"onboardingOptions": {"performance": "10-12", "profiling": "13-16"}}
# mysettings.py
import sentry_sdk
...
```python {filename:main.py} {"onboardingOptions": {"performance": "18-20", "profiling": "21-24"}}
# main.py
