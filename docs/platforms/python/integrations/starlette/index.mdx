---
title: Starlette
description: "Learn how to set up Sentry in you Starlette app, capture your first errors and traces, and view them in Sentry."
---
...
Create spans and track performance of all middleware layers in your project project. Set to `True` to enable.
