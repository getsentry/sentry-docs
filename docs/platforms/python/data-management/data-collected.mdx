...
Our AI integrations by default don't add data like LLM inputs and responses to spans. To start recording these, add `send_default_pii=True` in the `sentry_sdk.init()` call.
