...
The `sentry_sdk.start_span()` API has been replaced by
`sentry_sdk.tracing.start_span()`.

```python
  import sentry_sdk

- sentry_sdk.start_span(name="flow.checkout")
+ sentry_sdk.tracing.start_span(name="flow.checkout")
```
...
- sentry_sdk.start_transaction(name="flow.checkout")
+ sentry_sdk.tracing.start_span(name="flow.checkout")
```
