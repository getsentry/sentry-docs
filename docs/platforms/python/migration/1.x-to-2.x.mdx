...
There is no stable 2.0 release of the Sentry Python SDK yet. A release candidate (`2.0.0rc2`) is available for testing. If you decide to give it a try, please [let us know](https://github.com/getsentry/sentry-python/issues) if you run into any issues!
