...
We recommend that your release is prefixed with a project-specific package identifier (such as `"myapp@1.0.0"`).


The behavior of a few features depends on whether a project is using semantic or time-based versioning including the `"package@"` prefix:
