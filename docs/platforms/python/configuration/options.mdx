...
An optional list of socket options to use. If provided, these will override the default `urllib3` [socket options](https://urllib3.readthedocs.io/en/stable/reference/urllib3.connection.html#urllib3.connection.HTTPConnection). This is useful e.g. for enabling TCP keepalive in environments where you encounter frequent connection resets:
