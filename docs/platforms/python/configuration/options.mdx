...
Path to the client certificate to use. If set, supercedes the `CLIENT_CERT_FILE` environment variable.

</ConfigKey>

<ConfigKey name="key_file">

Path to the key file to use. If set, supercedes the `CLIENT_KEY_FILE` environment variable.
