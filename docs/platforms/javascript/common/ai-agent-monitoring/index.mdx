...
Any of `id`, `email`, or `username` is sufficient — Conversations displays whichever fields are present. See the [User Feedback](/platforms/javascript/user-feedback/#identifying-users) documentation for the full list of supported fields.
