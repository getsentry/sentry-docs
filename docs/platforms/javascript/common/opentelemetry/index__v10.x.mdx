...
- <PlatformLink to="/opentelemetry/custom-setup__v10.x/">Using Your Existing OpenTelemetry Setup</PlatformLink>
- <PlatformLink to="/opentelemetry/using-opentelemetry-apis__v10.x/">Using OpenTelemetry APIs</PlatformLink>
