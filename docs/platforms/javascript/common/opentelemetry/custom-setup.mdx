...
description: "For applications that manage their own OpenTelemetry provider, instrumentation, and exporters. Set enableOpenTelemetrySetup to false, leave Sentry tracing off, add openTelemetryIntegration for trace correlation, and use your exporter to send spans to Sentry over OTLP."
sidebar_order: 1
supported:
  - javascript.nextjs
  - javascript.node
