...
Initialize your OpenTelemetry provider before calling `Sentry.init()`. If your OpenTelemetry configuration is in a separate file, import it before initializing Sentry.
