...
This integration can be very helpful when wanting to reduce noise that is unrelated to your own application code.
...
The integration works by "marking" your JavaScript files with an "application key" during the build process.
