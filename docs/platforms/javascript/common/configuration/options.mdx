...
<PlatformSection notSupported={["javascript.bun", "javascript.cloudflare", "javascript.deno", "javascript.effect", "javascript.firebase", "javascript.nitro"]}>
...
<PlatformSection notSupported={["javascript.azure-functions", "javascript.cordova", "javascript.node"]} supported={["javascript", "javascript.firebase"]}>
