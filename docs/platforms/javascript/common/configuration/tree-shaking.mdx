...
<PlatformCategorySection supported={['browser']}>
<PlatformSection notSupported={["javascript.wasm", "javascript.cordova", "javascript.bun", "javascript.deno"]} supported={["javascript", "javascript.elysia"]}>
...
<PlatformSection supported={['javascript.node', 'javascript.azure-functions']} notSupported={['javascript.aws-lambda', 'javascript.firebase', 'javascript.gcp-functions']}>
