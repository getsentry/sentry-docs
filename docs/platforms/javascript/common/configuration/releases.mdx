...
See <PlatformLink to="/platforms/javascript/configuration/apis/#sessions">Session APIs</PlatformLink> for more information on how to manually capturing sessions.
