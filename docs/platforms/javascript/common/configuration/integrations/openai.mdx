---
title: OpenAI
description: "Adds instrumentation for OpenAI SDK."
supported:
  - javascript.node
...
This integration is **enabled by default for Node.js-based platforms** and automatically captures spans for OpenAI SDK calls. It requires SDK version `10.2.0` or higher.
