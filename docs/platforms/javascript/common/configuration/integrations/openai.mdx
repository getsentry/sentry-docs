...
For meta-framework applications using all runtimes, you need to manually wrap your OpenAI client instance with `instrumentOpenAiClient`. See instructions in the [Browser-Side Usage](#browser-side-usage) section.
