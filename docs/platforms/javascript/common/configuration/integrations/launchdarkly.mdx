...
Sentry can additionally track changes to feature flag definitions and report suspect feature flags. To enable the change tracking integration with your provider visit the [feature flag change tracking](/products/explore/feature-flags/#change-tracking) documentation page.
