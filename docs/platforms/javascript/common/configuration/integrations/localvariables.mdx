...
If you need to capture the full contents of a specific object, you can either destructure it into top-level variables or use [`Sentry.setExtra()`](/platforms/javascript/configuration/apis/#extra-context) to selectively attach the data you need.
