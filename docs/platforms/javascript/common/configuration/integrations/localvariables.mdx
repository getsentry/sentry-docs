...
Minified local variable names attached to exception frames cannot be unminified by Sentry at the current moment. There is an [active proposal](https://github.com/tc39/source-map/blob/main/proposals/scopes.md) for the sourcemaps spec that will add this capability.
