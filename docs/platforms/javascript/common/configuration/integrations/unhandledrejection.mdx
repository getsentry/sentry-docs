...
This option defines what to do after capturing an unhandled rejection.
It that mimicks behavior of [node's](https://nodejs.org/api/cli.html#--unhandled-rejectionsmode) `--unhandled-rejection` flag:
