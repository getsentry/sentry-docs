...
<PlatformContent includePath="feature-flags/integrations/js-featureflags/other-providers-alert" />
...
Sentry SDK **versions <PlatformContent includePath="feature-flags/integrations/js-featureflags/min-version" /> or higher.**
