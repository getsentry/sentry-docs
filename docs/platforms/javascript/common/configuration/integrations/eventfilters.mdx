...
_Import name: `Sentry.eventFiltersIntegration`_

<Alert>

In SDK versions before 11, this integration was called `InboundFilters` and exported as `inboundFiltersIntegration`.
