...
adds this integration automatically. In SDK version 11 and later, configure it through BrowserTracing's
`webVitals` option:
...
<SdkOption name="bfcacheNavigations" type="boolean" defaultValue="true">
