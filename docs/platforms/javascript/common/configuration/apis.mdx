...
<SdkApi
  name="setTag"
  signature="function setTag(key: string, value: Primitive): void"
  parameters={[]}
>
...
<SdkApi
  name="setTags"
  signature="function setTags(tags: Record<string, Primitive>): void"
  parameters={[]}
>
...
<SdkApi
  name="setContext"
  signature="function setContext(name: string, context: Record<string, unknown> | null): void"
  parameters={[]}
>
...
<SdkApi
  name="withActiveSpan"
  signature="function withActiveSpan<T>(span: Span | null, callback: (span: Span) => T): T"
>
