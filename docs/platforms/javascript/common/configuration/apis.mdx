...
<PlatformCategorySection supported={["server"]}>
  <Expandable title="Setting The User For the Current Request ">
    <PlatformSection notSupported={['javascript.bun', 'javascript.cloudflare', 'javascript.deno', 'javascript.effect', 'javascript.firebase', 'javascript.react-router', 'javascript.aws-lambda', 'javascript.azure-functions', 'javascript.gcp-functions']}>
