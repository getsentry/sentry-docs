...
<SdkApi
  ...
  signature="function setConversationId(conversationId: string): void"
>
...
The conversation ID is stored on the isolation scope and automatically added as the `gen_ai.conversation.id` attribute to all AI-related spans.
