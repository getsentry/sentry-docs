...
Make sure that there's an active span before you create your cache spans. If you're using a web framework like Express, such a span will be created for you automatically. See <PlatformLink to="/performance/">Performance Monitoring</PlatformLink> for more information.
...
### 1. Add Span When Putting Data Into the Cache
...
### 2.Add Span When Retrieving Data From the Cache
