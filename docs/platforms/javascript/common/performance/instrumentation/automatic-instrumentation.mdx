...
This option adds the ability to instrument routers for various frameworks to create transactions for route changes.

<PlatformContent includePath="performance/browser-routing-instrumentation" />
