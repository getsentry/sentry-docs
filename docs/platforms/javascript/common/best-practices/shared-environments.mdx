...
You can disable that by going to your **Project Settings > [Inbound Filters](https://sentry.io/orgredirect/organizations/:orgslug/settings/projects/:projectId/filters/data-filters/)** and disabling filtering out errors known to be caused by browser extensions.
