...
<Alert>
  **Replace `__MODULE_DSN__` with your actual Sentry project DSN.** You can find
  your DSN in your Sentry project settings under [Client Keys (DSN)](https://sentry.io/orgredirect/organizations/:orgslug/settings/projects/:projectId/keys/).
</Alert>
...
<Alert>
  **Replace `__DEFAULT_DSN__` with your actual Sentry project DSN.** This should
  ...
  your Sentry project settings under [Client Keys (DSN)](https://sentry.io/orgredirect/organizations/:orgslug/settings/projects/:projectId/keys/).
</Alert>
...
You can find your DSNs in each Sentry project's settings under [Client Keys (DSN)](https://sentry.io/orgredirect/organizations/:orgslug/settings/projects/:projectId/keys/).
