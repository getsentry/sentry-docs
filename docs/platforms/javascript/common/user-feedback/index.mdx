...
<PlatformSection notSupported={["javascript.node", "javascript.azure-functions", "javascript.deno", "javascript.cloudflare", "javascript.bun", "javascript.cordova", "javascript.wasm"]} supported={["javascript", "javascript.firebase"]}>
