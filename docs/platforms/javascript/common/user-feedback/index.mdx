...
![An example image of the User Feedback Widget on a demo site](/platforms/javascript/common/user-feedback/user-feedback-widget.png)
...
![An example of a Crash-Report modal with text boxes for user name, email, and additional details about the break.](/platforms/javascript/common/user-feedback/user_feedback_widget.png)
