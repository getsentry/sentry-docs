...
| `successForeground`       | `--success-foreground`         | `#268d75`                                 | `#2da98c`                                 | Color used for success-related components (such as text color when feedback is submitted successfully).   |
| `errorForeground`         | `--error-foreground`           | `#df3338`                                 | `#f55459`                                 | Color used for error related components (such as text color when there's an error submitting feedback). |
...
| `boxShadow`               | `--box-shadow`                 | `0px 4px 24px 0px rgba(43, 34, 51, 0.12)` | `0px 4px 24px 0px rgba(43, 34, 51, 0.12)` | Box shadow style used for the widget (injected button and form).                                   |
...
| `inputBorderRadius`       | `--input-border-radius`        | `6px`                                     | `6px`                                     | Border radius style for form content (such as inputs and buttons)                                   |
