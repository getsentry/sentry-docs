...
| `highlightToolText`           | `"Highlight"`                            | The label for the button that highlights portions of the screenshot.                                                    |
| `hideToolText`                | `"Hide"`                                 | The label for the button that hides portions of the screenshot.                                                        |
| `removeHighlightText`         | `"Remove"`                               | The label for the button that removes a highlighted/hidden section of the screenshot.                                    |
