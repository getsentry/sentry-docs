...
| `--button-outline-focus`       | `buttonOutlineFocus`      | `var(--input-outline-focus)`              | `var(--input-outline-focus)`              | Outline for buttons, in the focused state.                                                        |
...
| `--submit-outline-focus`       | `submitOutlineFocus`      | `1px auto #29232f`                        | `1px auto rgba(108, 95, 199, 1)`          | Outline for the submit button, in the focused state.                                              |
...
Alternatively, you can call `feedback.createWidget()` and have full control over when the form gets loaded, added to the dom, and finally shown to the user. Here is an example using JSX to define a button:
