...
The following config options apply to version 8.0.0 of the JavaScript SDK. If you are using any version 7 of the SDK refer to [configuration options](/platforms/javascript/user-feedback/configuration/v7/) for that version of the SDK.
