...
| `highlightToolText`           | `"Highlight"`                            | The label for the button that highlights portions ofthe screenshot.                                                    |
| `hideToolText`                | `"Hide"`                                 | The label for the button that hides portions of the screenshot.                                                        |
| `removeHighlightText`         | `"Remove"`                               | The label for the button that removed a highlight/hidden section of the screenshot.                                    |
