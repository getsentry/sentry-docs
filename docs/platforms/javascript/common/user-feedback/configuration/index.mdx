...
| `border`                  | `--border`                     | `1.5px solid rgba(41, 35, 47, 0.13)`      | `1.5px solid rgba(235, 230, 239, 0.5)`   | The border style used for the widget (injected button and form)                                       |
...
| `buttonBackground`        | `--button-background`          | `var(--background)`                       | `var(--background)`                       | Background color for buttons                                                                          |
| `buttonBackgroundHover`   | `--button-background-hover`    | `#f6f6f7`                                 | `#352f3b`                                 | Background color when hovering over buttons                                                           |
| `buttonBorder`            | `--button-border`              | `var(--border)`                           | `var(--border)`                           | Border style for buttons                                                                              |
...
| `buttonOutlineFocus`      | `--button-outline-focus`       | `var(--input-outline-focus)`              | `var(--input-outline-focus)`              | Outline color for buttons, in the focused state                                                       |
| `buttonForeground`        | `--button-foreground`          | `inherit`                                 | `inherit`                                 | Foreground color for buttons                                                                          |
| `buttonForegroundHover`   | `--button-foreground-hover`    | `inherit`                                 | `inherit`                                 | Foreground color for buttons when hovering                                                            |
...
| `triggerBorderRadius`     | `--trigger-border-radius`      | `1.7em/50%`                               | `1.7em/50%`                               | Border radius style used for the widget (injected button and success message)                         |
