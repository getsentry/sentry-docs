...
If you have set a user context by calling [`Sentry.setUser`](https://docs.sentry.io/platforms/javascript/enriching-events/identify-user/) then those values will be used as defaults for the `name` and `email` fields. If those fields are hidden from the user, then the default values will still be sent along with the feedback message.
...
| `confirmButtonLabel`          | `Confirm`                              | The label of the confirm button used in the feedback form.                     |
| `addScreenshotButtonLabel`    | `Add a screenshot`                     | The label of the button to add a screenshot to the form.                       |
| `removeScreenshotButtonLabel` | `Remove screenshot`                    | The label of the button which removes the screenshot from the form.            |
...
| `--success-foreground`         | `successForeground`       | `#268d75`                                 | `#2da98c`                                 | Color used for success-related components (such as text color when feedback is submitted successfully). |
| `--error-foreground`           | `errorForeground`         | `#df3338`                                 | `#f55459`                                 | Color used for error related components (such as text color when there's an error submitting feedback). |
...
| `--input-foreground`           | `inputForeground`         | `inherit`                                 | `inherit`                                 | Foreground color for form inputs.                                                                       |
| `--input-background`           | `inputBackground`         | `inherit`                                 | `inherit`                                 | Background color for form inputs.                                                                       |
...
| `--button-background`          | `buttonBackground`        | `var(--background)`                       | `var(--background)`                       | Background color for buttons.                                                                           |
| `--button-background-hover`    | `buttonBackgroundHover`   | `#f6f6f7`                                 | `#352f3b`                                 | Background color when hovering over buttons.                                                            |
| `--button-border`              | `buttonBorder`            | `var(--border)`                           | `var(--border)`                           | Border style for buttons.                                                                               |
| `--button-outline-focus`       | `buttonOutlineFocus`      | `var(--input-outline-focus)`              | `var(--input-outline-focus)`              | Outline color for buttons, in the focused state.                                                        |
| `--button-foreground`          | `buttonForeground`        | `inherit`                                 | `inherit`                                 | Foreground color for buttons.                                                                           |
| `--button-foreground-hover`    | `buttonForegroundHover`   | `inherit`                                 | `inherit`                                 | Foreground color for buttons when hovering.                                                             |
| `--submit-background`          | `submitBackground`        | `rgba(88, 74, 192, 1)`                    | `rgba(88, 74, 192, 1)`                    | Background color for the submit button.                                                                 |
| `--submit-background-hover`    | `submitBackgroundHover`   | `rgba(108, 95, 199, 1)`                   | `rgba(108, 95, 199, 1)`                   | Background color when hovering over the submit button.                                                  |
| `--submit-border`              | `submitBorder`            | `rgba(108, 95, 199, 1)`                   | `rgba(108, 95, 199, 1)`                   | Border style for the submit button.                                                                     |
| `--submit-outline-focus`       | `submitOutlineFocus`      | `1px auto #29232f`                        | `1px auto rgba(108, 95, 199, 1)`          | Outline color for the submit button, in the focused state.                                              |
| `--submit-foreground`          | `submitForeground`        | `#ffffff`                                 | `#ffffff`                                 | Foreground color for the submit button.                                                                 |
| `--submit-foreground-hover`    | `submitForegroundHover`   | `#ffffff`                                 | `#ffffff`                                 | Foreground color for the submit button when hovering.                                                   |
| `--trigger-background`         | `triggerBackground`       | `var(--button-background)`                | `var(--button-background)`                | Background color of the widget (injected button and form).                                              |
| `--trigger-background-hover`   | `triggerBackgroundHover`  | `var(--button-background-hover)`          | `var(--button-background-hover)`          | Background color of the injected button when in a hover state.                                          |
| `--trigger-border-radius`      | `triggerBorderRadius`     | `1.7em/50%`                               | `1.7em/50%`                               | Border radius style used for the widget (injected button and success message).                          |
| `--dialog-background`          | `dialogBackground`        | `var(--background)`                       | `var(--background)`                       | Background color of the widget (injected button and form).                                              |
| `--dialog-border-radius`       | `dialogBorderRadius`      | `20px`                                    | `20px`                                    | Border radius style for the form.                                                                       |
...
<style>
#sentry-feedback {
  --forground: 'red'; /* overrides both `white` and `black` colors */
}
</style>
```
...
Alternatively, you can call `feedback.createWidget()` and have full control over when the form gets loaded, added to the dom, and finally shown to the user. Here is an exampl using JSX to define a button:
