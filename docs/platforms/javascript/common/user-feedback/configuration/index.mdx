...
![An image showing the available customization options for the User Feedback Widget](/platforms/javascript/common/user-feedback/configuration/user-feedback-widget-customization.png)

### General

The following options can be configured as options for the integration in `feedbackIntegration({})`:
