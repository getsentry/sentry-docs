...
![An image showing the available customization options for the User Feedback Widget](/platforms/javascript/common/user-feedback/configration/user-feedback-widget-customization.png)
