...
| `showScreenshot`  | `boolean`                | `true`                                | Allows the user to send a screenshot attachment with their feedback. Requires SDK version 8.0.0 and above. For self-hosted, release 24.4.2 is also required. |
