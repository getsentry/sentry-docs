...
The following config options apply to version 8.0.0 of the JavaScript SDK. The Feedback Widget in version 7 of the SDK was a beta release and is now deprecated.
