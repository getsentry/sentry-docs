...
<PlatformSection notSupported={["javascript.node", "javascript.azure-functions"]} supported={["javascript", "javascript.firebase", "javascript.hapi", "javascript.hono", "javascript.nestjs", "javascript.nitro"]}>
