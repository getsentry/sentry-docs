...
sidebar_order: 6900
description: >-
  Learn about general User Feedback configuration fields for version 7 of the
  JavaScript SDK.
og_image: >-
...
<PlatformSection notSupported={["javascript.node", "javascript.eve", "javascript.flue", "javascript.mastra", "javascript.aws-lambda", "javascript.azure-functions", "javascript.connect", "javascript.express", "javascript.fastify", "javascript.gcp-functions", "javascript.koa"]}>
