...
![Attachments Example](/platforms/javascript/common/enriching-events/attachments/slide-bar-native-crashes.png)
...
![Attachments Access](/platforms/javascript/common/enriching-events/attachments/attachments-access.png)
...
![Attachments Access Denied](/platforms/javascript/common/enriching-events/attachments/attachments-access-denied.png)
...
![Attachments List Example](/platforms/javascript/common/enriching-events/attachments/attachments-list-example.png)
