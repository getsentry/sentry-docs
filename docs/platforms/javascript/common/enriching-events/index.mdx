...
<PlatformSection notSupported={["javascript.bun", "javascript.deno", "javascript.effect", "javascript.firebase", "javascript.aws-lambda", "javascript.azure-functions", "javascript.gcp-functions", "javascript.cloudflare"]}>
## Request Isolation
