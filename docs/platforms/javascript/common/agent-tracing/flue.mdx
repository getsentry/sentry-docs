...
Flushes ride the platform's event lifecycle and are best-effort. Traces and issues are sent during the run. Very recently buffered logs can be cut short when an isolate shuts down.
