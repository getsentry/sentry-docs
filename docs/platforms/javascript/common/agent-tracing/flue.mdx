...
- **Logs**: Every `log.info`, `log.warn`, and `log.error` call from your tools and hooks appears as <PlatformLink to="/logs/">Sentry Logs</PlatformLink>. When tracing is enabled, Sentry correlates these logs with the trace.
