...
<PlatformSection supported={["javascript.node", "javascript.azure-functions", "javascript.nextjs", "javascript.nuxt", "javascript.solidstart", "javascript.sveltekit", "javascript.react-router", "javascript.remix", "javascript.astro", "javascript.tanstackstart-react", "javascript.electron", "javascript.cordova", "javascript.capacitor", "javascript.deno", "javascript.wasm"]} notSupported={["javascript.firebase", "javascript.nitro"]}>

  ## Automatic Instrumentation

  _Import name: `Sentry.openAIIntegration`_

  <PlatformSection supported={["javascript.angular", "javascript.astro", "javascript.aws-lambda", "javascript.azure-functions", "javascript.bun", "javascript.capacitor", "javascript.cloudflare", "javascript.cordova", "javascript.deno", "javascript.effect", "javascript.electron", "javascript.elysia", "javascript.ember", "javascript.express", "javascript.fastify", "javascript.firebase", "javascript.gatsby", "javascript.gcp-functions", "javascript.hono", "javascript.mastra", "javascript.nestjs", "javascript.nextjs", "javascript.nitro", "javascript.nuxt", "javascript.react", "javascript.react-router", "javascript.remix", "javascript.solid", "javascript.solidstart", "javascript.svelte", "javascript.sveltekit", "javascript.tanstackstart-react", "javascript.vue", "javascript.wasm"]}>
    <Alert>
...
<PlatformSection supported={["javascript.node", "javascript.azure-functions", "javascript.bun", "javascript.nextjs", "javascript.nuxt", "javascript.astro", "javascript.solidstart", "javascript.sveltekit", "javascript.remix", "javascript.cloudflare", "javascript.tanstackstart-react"]} notSupported={["javascript.firebase", "javascript.nitro", "javascript.elysia"]}>
...
<PlatformSection supported={["javascript.angular", "javascript.ember", "javascript.gatsby", "javascript.react", "javascript.solid", "javascript.svelte", "javascript.vue"]}>

To get the full agent tree (`gen_ai.invoke_agent` → `gen_ai.chat` + `gen_ai.execute_tool`), wrap your tool loop with <PlatformLink to="/agent-tracing/">manual instrumentation</PlatformLink>.
