...
Eve reads the Sentry OTLP traces endpoint and your project's public key from environment variables. You can find both values in [Project settings > Client Keys (DSN)](https://sentry.io/orgredirect/organizations/:orgslug/settings/projects/:projectId/keys/). The public key is the value after `sentry_key=` in your DSN.
