...
- <PlatformLink to="/agent-tracing/flue/">Flue</PlatformLink> — run
  `flue add tooling sentry`. The blueprint wraps each agent Durable Object for
  you.
...
<IntegrationGrid
  integrations={[
    {to: "/agent-tracing/eve/", title: "Eve", icon: "vercel", description: "OTLP export, no Sentry SDK required"},
  ]}
/>

</PlatformSection>

<PlatformSection supported={["javascript.node", "javascript.cloudflare"]}>

<IntegrationGrid
  integrations={[
    {to: "/agent-tracing/flue/", title: "Flue", icon: "astro", description: "Sentry SDK and event bridge via flue add tooling sentry"},
  ]}
/>
