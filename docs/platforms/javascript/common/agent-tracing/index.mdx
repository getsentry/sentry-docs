...
- <PlatformLink to="/agent-tracing/google-genai/">
    Google Gen AI SDK
  </PlatformLink>
...
<PlatformSection supported={["javascript.node", "javascript.aws-lambda", "javascript.azure-functions", "javascript.connect", "javascript.express", "javascript.fastify", "javascript.gcp-functions", "javascript.hapi", "javascript.hono", "javascript.koa", "javascript.nestjs", "javascript.nextjs", "javascript.nuxt", "javascript.astro", "javascript.solidstart", "javascript.sveltekit", "javascript.remix", "javascript.tanstackstart-react"]}>

- [Mastra](/platforms/javascript/guides/mastra/) (exporter)
