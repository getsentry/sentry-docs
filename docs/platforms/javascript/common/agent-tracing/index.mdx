...
<IntegrationGrid
  integrations={[
    {to: "/configuration/integrations/vercelai/", title: "Vercel AI SDK", icon: "vercel"},
    {to: "/configuration/integrations/openai/", title: "OpenAI", icon: "openai"},
    {to: "/configuration/integrations/anthropic/", title: "Anthropic", icon: "anthropic"},
    {to: "/configuration/integrations/google-genai/", title: "Google Gen AI SDK", icon: "google-genai"},
    {to: "/configuration/integrations/langchain/", title: "LangChain", icon: "langchain"},
    {to: "/configuration/integrations/langgraph/", title: "LangGraph", icon: "langgraph"},
    {to: "/configuration/integrations/mastra/", title: "Mastra", icon: "mastra"},
  ]}
/>
