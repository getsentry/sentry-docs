...
- <PlatformLink to="/configuration/integrations/bfcache/">`bfcacheMetricsIntegration`</PlatformLink> — Track browser back/forward cache (bfcache) hit/miss rate and not-restored reasons as metrics.
