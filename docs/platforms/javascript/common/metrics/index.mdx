...
<PlatformSection notSupported={["javascript.node", "javascript.azure-functions", "javascript.deno", "javascript.cloudflare", "javascript.bun"]} supported={["javascript", "javascript.firebase", "javascript.elysia"]}>
