...
This is the <PlatformLink to="/install/esm-without-import">deferred entrypoint</PlatformLink> pattern, packaged for SEA. Keep your Sentry setup in `instrument.mjs`.
