...
Sometimes, you cannot directly pass the `--import` flag to the Node.js binary. In such cases, you can use the `NODE_OPTIONS` environment variable to pass it, like this:
