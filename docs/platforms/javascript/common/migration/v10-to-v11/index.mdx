...
While `autoInjectServerSentry` is set, the SDK uses that mode instead of the bundled initialization and prints a deprecation warning during the build. To learn more, see [Server-Side Initialization](/platforms/javascript/guides/nuxt/install/).
