...
<PlatformSection notSupported={["javascript.deno", "javascript.bun", "javascript.cloudflare", "javascript.wasm"]} supported={["javascript", "javascript.elysia"]}>
...
<PlatformSection notSupported={["javascript.bun", "javascript.capacitor", "javascript.cloudflare", "javascript.cordova", "javascript.deno"]} supported={["javascript", "javascript.elysia"]}>
