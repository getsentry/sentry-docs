...
TypeScript, linters, and tests do not catch all of these changes. Read through this guide before you upgrade, instead of upgrading and fixing what breaks.
...
The minimum supported Node.js version is **20.19.0**. Node.js 18 is no longer supported. Because of the module loader APIs the SDK relies on, the supported range has gaps:
