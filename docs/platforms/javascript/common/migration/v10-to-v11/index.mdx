...
Safari 14 is no longer supported. The minimum version is Safari 15. See <PlatformLink to="/troubleshooting/supported-browsers/">Supported Browsers</PlatformLink> for the full matrix.
