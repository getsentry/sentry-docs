...
To fix this, change the `tracePropagationTargets` option during SDK initialization. For more details, see [Automatic Instrumentation](/platforms/javascript/performance/instrumentation/automatic-instrumentation/#tracePropagationTargets) in our Tracing documentation.
</Expandable>
</PlatformCategorySection>
...
<Expandable title="Supporting older browsers">
