...
<PlatformSection notSupported={['javascript.aws-lambda', 'javascript.azure-functions', 'javascript.bun', 'javascript.cloudflare', 'javascript.deno', 'javascript.effect', 'javascript.electron', 'javascript.firebase', 'javascript.gcp-functions', 'javascript.nestjs', 'javascript.nitro', 'javascript.tanstackstart-react']}>
