...
If you're using stream mode, sampling works the same way as described in this guide but applies to service spans instead of transactions. See <PlatformLink to="/tracing/streamed-spans/">Streamed Spans</PlatformLink> for more information.
