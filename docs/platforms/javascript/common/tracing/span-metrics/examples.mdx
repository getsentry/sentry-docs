...
This example demonstrates proper queue instrumentation patterns. For more details on instrumenting queues, see the <PlatformLink to="/guides/node/tracing/instrumentation/queues-module/">Queues Module documentation</PlatformLink>.
