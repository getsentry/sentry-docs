...
<PlatformSection supported={["javascript.node", "javascript.azure-functions", "javascript.bun", "javascript.deno", "javascript.cloudflare", "javascript.tanstackstart-react"]}>
...
<PlatformSection notSupported={["javascript.node", "javascript.azure-functions", "javascript.bun", "javascript.deno", "javascript.cloudflare", "javascript.cordova", "javascript.wasm"]}>
...
- <PlatformSection notSupported={["javascript.node", "javascript.azure-functions", "javascript.bun", "javascript.deno", "javascript.cloudflare", "javascript.cordova", "javascript.wasm"]}><PlatformLink to="/session-replay/">Session Replay</PlatformLink> — Traces appear in the Replay timeline, showing performance data alongside the user's actions.</PlatformSection>
