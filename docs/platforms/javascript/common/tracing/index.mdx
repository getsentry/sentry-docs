...
<PlatformCategorySection supported={["server", "serverless"]}>
  ...
  <PlatformSection notSupported={["javascript.deno", "javascript.bun", "javascript.cloudflare", "javascript.effect", "javascript.firebase"]}>
    <Alert>
...
<PlatformSection supported={["javascript.node", "javascript.azure-functions", "javascript.bun", "javascript.deno", "javascript.cloudflare", "javascript.tanstackstart-react"]} notSupported={["javascript.firebase", "javascript.elysia"]}>

## Agent Tracing

If you're building with agents or LLMs, you can extend your tracing setup to capture agent workflows, model calls, tool executions, and token usage. With tracing already enabled, the SDK can automatically instrument supported AI libraries and connect agent activity to the rest of your application traces.
...
<PlatformSection notSupported={["javascript.node", "javascript.azure-functions", "javascript.bun", "javascript.deno", "javascript.cloudflare", "javascript.cordova", "javascript.wasm"]} supported={["javascript", "javascript.firebase"]}>
...
- <PlatformSection notSupported={["javascript.node", "javascript.azure-functions", "javascript.bun", "javascript.deno", "javascript.cloudflare", "javascript.cordova", "javascript.wasm"]} supported={["javascript", "javascript.firebase"]}><PlatformLink to="/session-replay/">Session Replay</PlatformLink> — Traces appear in the Replay timeline, showing performance data alongside the user's actions.</PlatformSection>
