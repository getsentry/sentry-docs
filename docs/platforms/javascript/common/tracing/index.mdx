...
<PlatformLink to="/agent-tracing/">Set up Agent Tracing</PlatformLink> to get
started.
...
>
  ...
  <PlatformLink to="/tracing/distributed-tracing/">
    trace propagation
  </PlatformLink>{" "}
...
- <PlatformSection
  ...
  >
    <PlatformLink to="/session-replay/">Session Replay</PlatformLink> — Traces
...
- <PlatformSection notSupported={["javascript.deno", "javascript.cordova"]}>
    <PlatformLink to="/logs/">Logs</PlatformLink> — Logs emitted during a trace
