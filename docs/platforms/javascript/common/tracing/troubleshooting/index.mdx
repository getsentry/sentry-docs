...
Event processors do not apply to streamed spans. In transaction mode, use `beforeSendTransaction` to change `event.transaction`. See <PlatformLink to="/enriching-events/transaction-name/">Transaction Name</PlatformLink> for other ways to set names.
