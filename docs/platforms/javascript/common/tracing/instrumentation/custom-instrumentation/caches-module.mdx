...
Make sure that there's an active span before you create your cache spans. If you're using a web framework like Express, a span will be created for you automatically. See <PlatformLink to="/performance/">Tracing</PlatformLink> for more information.
