...
<PlatformSection notSupported={["javascript.electron", "javascript.node", "javascript.aws-lambda", "javascript.azure-functions", "javascript.connect", "javascript.express", "javascript.gcp-functions", "javascript.koa"]}>
