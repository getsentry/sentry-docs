...
If you're using stream mode, automatic instrumentation works the same way as described in this guide but applies to service spans instead of transactions. See <PlatformLink to="/tracing/new-spans/">New Spans</PlatformLink> for more information.
