...
- <PlatformSection notSupported={["javascript.node", "javascript.azure-functions", "javascript.bun", "javascript.deno", "javascript.cloudflare", "javascript.wasm"]}><PlatformLink to="/session-replay/">Session Replay</PlatformLink> — Logs are automatically linked to replays, letting you jump from a log entry to see what the user was doing.</PlatformSection>
