...
Note that the privacy API prior to version 7.35.0 has been deprecated and replaced with the options above. Please see the [Replay migration guide](https://github.com/getsentry/sentry-javascript/blob/28db5111dbb9f9d653318a240f15b42c51239d00/packages/replay/MIGRATION.md#upgrading-replay-from-7340-to-7350---6645) for further information.
