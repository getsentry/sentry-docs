...
![Replay PII Scrubbing example](/platforms/javascript/common/session-replay/privacy/masking.png)
...
![Blocking example](/platforms/javascript/common/session-replay/privacy/blocking.png)
...
![Ignoring Example](/platforms/javascript/common/session-replay/privacy/ignoring.gif)
