...
```javascript {tabTitle: Svelte v5+} {filename: main.js} {"onboardingOptions": {"performance": "11, 14-23", "session-replay": "12, 24-30"}}
...
<OnboardingOption optionId="performance" hideForThisOption>
  Open the page in a browser (for most Svelte applications, this will be at
  localhost:5173) and click the button to trigger a frontend error.
</OnboardingOption>
