...
Thus, we recommend you follow the [`--import` flag setup instructions](#with---import-flag) if possible.
...
For this, create a `src/server.ts` file in your project and import `instrument.server.mjs`.
