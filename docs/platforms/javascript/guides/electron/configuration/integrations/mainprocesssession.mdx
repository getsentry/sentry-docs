...
If you'd prefer to capture sessions linked to the focus of `BrowserWindow`'s, use the <PlatformLink to="/configuration/integrations/browserwindowsession">BrowserWindowSession</PlatformLink> integration.
