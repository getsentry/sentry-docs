...
=======
## What You'll Learn
>>>>>>> 957204cafc6efd2b1fce8b43c3e4c58b1283f4aa
...
- Sent [Structured Logs](/platforms/javascript/guides/nextjs/logs/) to from your application to Sentry 
- Configure masking propers within [Replays](/product/explore/session-replay/web/getting-started/)
<<<<<<< HEAD
- Implement [tracing](/platforms/javascript/guides/nextjs/tracing/) and send [custom spans with attributes and metrics](/platforms/javascript/guides/nextjs/tracing/span-metrics)  */}
=======
- Implement [tracing](/platforms/javascript/guides/nextjs/tracing/) and send [custom spans with attributes and metrics](/platforms/javascript/guides/nextjs/tracing/span-metrics) 
>>>>>>> 957204cafc6efd2b1fce8b43c3e4c58b1283f4aa
