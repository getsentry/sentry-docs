...
Logs larger than the payload threshold are dropped. Check your [org stats](https://sentry.io/orgredirect/organizations/:orgslug/stats/?dataCategory=logBytes&statsPeriod=30d) to see if logs are being rate limited or dropped.
