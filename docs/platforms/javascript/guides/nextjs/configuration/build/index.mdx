...
A callback function that will be invoked when errors occur during the Sentry build process. This is particularly useful for preventing CI/CD pipeline failures when there are connectivity issues.

You can use this option to handle errors gracefully:
