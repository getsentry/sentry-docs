...
Because Oxygen is built on Cloudflare Workers, you need to wrap your request handler to capture errors on the edge.
...
+         // ___PRODUCT_OPTION_START___ performance
          ...
          enableLogs: true,
          // ___PRODUCT_OPTION_END___ logs
          // We include this here as well for the request context
          sendDefaultPii: true,
        },
...
Update your `entry.server.tsx` file to inject trace meta tags into the HTML:
