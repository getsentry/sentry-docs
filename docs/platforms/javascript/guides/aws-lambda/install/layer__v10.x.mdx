...
description: >-
  ...
  functions
sidebar_order: 1
og_image: /og-images/platforms-javascript-guides-aws-lambda-install-layer__v10.x.png
---
...
Choose the region and SDK version, then copy the provided ARN into the input.

<LambdaLayerDetail canonical="aws-layer:node:v10" />
...
<PlatformContent
  ...
  platform="javascript.aws-lambda__v10.x"
  noGuides
/>
