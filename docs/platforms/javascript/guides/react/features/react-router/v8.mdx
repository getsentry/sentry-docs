...
- Use `Sentry.wrapCreateBrowserRouter` for [`createBrowserRouter`](https://api.reactrouter.com/v8/functions/react-router.BrowserRouter.html) and [`createHashRouter`](https://api.reactrouter.com/v8/functions/react-router.HashRouter.html)
- Use `Sentry.wrapCreateMemoryRouter` for [`createMemoryRouter`](https://api.reactrouter.com/v8/functions/react-router.MemoryRouter.html)
