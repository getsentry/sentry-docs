...
- Use `Sentry.wrapCreateBrowserRouterV7` for [`createBrowserRouter`](https://reactrouter.com/v6/routers/create-browser-router) and [`createHashRouter`](https://reactrouter.com/v6/routers/create-hash-router)
- Use `Sentry.wrapCreateMemoryRouterV7` for [`createMemoryRouter`](https://reactrouter.com/v6/routers/create-memory-router) (introduced in SDK version `8.50.0`)
