...
The TanStack Router integration is designed to work with Sentry Tracing. Please see <PlatformLink to="/performance/#enable-tracing">Getting Started with React Performance</PlatformLink> for more details on how to set up and install the SDK.
