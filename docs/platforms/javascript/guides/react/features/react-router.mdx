...
The React Router integration is designed to work with Sentry Tracing. Please see [Getting Started with React Performance](/product/performance/getting-started/?platform=react) for more details on how to set up and install the SDK.
