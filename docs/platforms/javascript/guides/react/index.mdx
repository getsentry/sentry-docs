...
For readable stack traces in production, you can set up automatic source map uploads using the Sentry Vite plugin or Webpack plugin depending on your build setup.
...
Add your Sentry auth token to your environment:
...
You can get your auth token from [Sentry Settings > Auth Tokens](https://sentry.io/settings/auth-tokens/).

<Alert level="warning" title="Important">

Make sure to keep your auth token secret and add your `.env` file to `.gitignore` to avoid committing it to version control.
