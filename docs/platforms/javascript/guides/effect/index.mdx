...
<OnboardingOption optionId="performance">
  ...
  traced as Sentry spans with distributed tracing support
</OnboardingOption>
<OnboardingOption optionId="logs">
  - **Logging** via `Sentry.SentryEffectLogger`: Effect logs are forwarded to
  Sentry (requires `enableLogs: true`)
</OnboardingOption>
<OnboardingOption optionId="metrics">
  - **Metrics** via `Sentry.SentryEffectMetricsLayer`: Effect metrics (counters,
  gauges, histograms) are sent to Sentry
</OnboardingOption>
