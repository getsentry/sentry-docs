...
Therefore, we recommend to create a file named `instrument.js` that imports and initializes Sentry.
...
Adjust the Node.js call for your application to use the [--require](https://nodejs.org/api/cli.html#-r---require-module) parameter and point it at `instrument.js`

<PlatformContent includePath="getting-started-run" />

Alternatively, if you cannot use [--require](https://nodejs.org/api/cli.html#-r---require-module), import `instrument.js` at the top of your application.
