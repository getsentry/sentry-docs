...
Configuration should happen as early as possible in your application's lifecycle. Keep your generated `app/app.js` as it is, and add the import and the `Sentry.init()` call above the `App` class:
