...
Additionally, Sentry is investing heavily in [`@sentry/react-native`](/platforms/react-native/) and [`sentry-dart`](/platforms/dart/guides/flutter/) as primary cross-platform mobile SDKs. Both support the full Sentry feature set including Session Replay, Profiling, and Performance Monitoring.
