...
- Capacitor V2 requires Sentry JavaScript SDK on version 9.x. We recommend reading below [migration guide](#sibling-migration-guide) docs to find out how to address any breaking changes when upgrading to the sibling SDK.
