...
You can also use [Advanced Data Scrubbing](/concepts/data-management/scrubbing/advanced-datascrubbing/) to filter out sensitive data before it is stored on the server side:
