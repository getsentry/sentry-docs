...
Sentry React Native SDK provides error reporting and performanceEntry monitoring for React Native applications. The SDK automatically collect errors and crashes in your application and send them to Sentry. To do this, the SDK needs to access certain information about the device and the application. Some of the used APIs are considered sensitive by Apple and require the SDK to provide a privacy manifest. For more details read the [Data Privacy for Mobile](/product/security/mobile-privacy/).
