...
This integration relies on React Native's `Linking` module. Your app must have deep linking configured natively (URL schemes or universal links) for the integration to receive URLs.
