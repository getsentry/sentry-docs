...
If the web project is accessed remotely and not unique to the mobile application (for example the project also works as standalone web application), we recommend using separate Sentry projects for the mobile application and the web project.
