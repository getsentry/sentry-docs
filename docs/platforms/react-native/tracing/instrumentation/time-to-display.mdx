...
Recent versions of the React Native SDK have introduced fixes and fallbacks for some of these cases. However, Sentry’s mobile team has verified that **custom/manual instrumentation remains the most reliable solution** today, particularly for tabbed navigation scenarios.
