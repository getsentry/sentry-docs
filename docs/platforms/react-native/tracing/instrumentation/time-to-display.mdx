...
Sentry's React Native SDK package ships with a tracing feature that allows you to measure your application's [Time to Display](/product/performance/mobile-vitals/#time-to-initial-display-and-time-to-full-display). This guide will show you how to use Sentry's React Native SDK to measure Time to Display in your application.
