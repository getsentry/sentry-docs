...
Here are some of the features you can configure when installing Sentry:

- **Error Monitoring**: Automatically capture and report errors and exceptions as issues across your app, complete with stack traces and context.
