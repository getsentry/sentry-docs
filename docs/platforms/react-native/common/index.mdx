...
- **[Logs](/product/explore/logs/)**: Send, view, and query logs from your app alongside your errors to get richer context when debugging.
...
- **[Session Replay](/product/explore/session-replay/)**: Get reproductions of user sessions to improve your app experience.

- **[Profiling](/product/explore/profiling/)**: Collect and analyze function-level information about your code to fine-tune performance.
