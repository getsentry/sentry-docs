...
To attach a screenshot to the feedback form, you should implement the `onAddScreenshot` callback. The callback receives a filename and a `Uint8Array` of the image data.

An example of how to attach a screenshot using the [`react-native-image-picker`](https://www.npmjs.com/package/react-native-image-picker) and the [`react-native-quick-base64`](https://www.npmjs.com/package/react-native-quick-base64) libraries is the following:
