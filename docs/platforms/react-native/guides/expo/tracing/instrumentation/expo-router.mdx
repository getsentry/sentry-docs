...
This option will enable automatic measuring of the time to initial display for each route. To learn more see [Time to Initial Display](/platforms/react-native/guides/expo/tracing/instrumentation/time-to-display). The default value is `false`.
