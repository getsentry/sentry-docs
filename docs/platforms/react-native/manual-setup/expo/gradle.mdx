...
If you want to dynamically disable the automatic upload of source maps and debug symbols for your Expo project, you can set the `SENTRY_DISABLE_AUTO_UPLOAD` environment variable:

```bash
export SENTRY_DISABLE_AUTO_UPLOAD=true
```

Add use the `shouldSentryAutoUpload` function in your dynamic Expo configuration `app.config.js`:
