...
[Sentry Wizard](https://github.com/getsentry/sentry-wizard) will patch your project automatically, though you can follow the [Manual Install](./#manual-install) if you prefer. You only need to patch the project once. Then you can add the patched files to your version control system.
