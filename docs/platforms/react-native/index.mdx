...
<Alert level="info" title="Experimental Feature">

This AI integration prompt is experimental and designed for use with AI coding assistants. It provides a condensed setup guide that an AI agent can follow to integrate Sentry into your React Native app.

</Alert>

<Expandable title="View AI Integration Prompt">

<Include name="react-native-ai-integration-prompt.mdx" />
