...
In case you are using Xcode 14 or later, you might have to disable the "Enable User Script Sandbox" option in the target settings by setting it to `NO`. See [Troubleshooting](/platforms/apple/common/troubleshooting) for more information.
