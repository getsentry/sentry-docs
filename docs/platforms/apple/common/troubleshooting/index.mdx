...
Verify that the DSN you pass to `options.dsn` is a valid Sentry DSN URL starting with `https://`. If you're using environment-based DSN injection, ensure the value is available at runtime.
