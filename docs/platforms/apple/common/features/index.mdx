...
- Automatic <PlatformLink to="/tracing/instrumentation">Performance Tracking</PlatformLink> for:
  ...
  - Distributed tracing
  - <Link to="/product/dashboards/sentry-dashboards/mobile/mobile-vitals">Dashboards for Mobile Vitals</Link>
    - Cold and warm start
...
- <PlatformLink to="/product/profiling">Profiling</PlatformLink> (requires configuration, only available on iOS and macOS)
