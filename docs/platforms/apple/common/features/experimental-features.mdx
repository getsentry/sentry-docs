...
- Enable <PlatformLink to="/metrics/">Metrics</PlatformLink> to send counters, gauges, and distributions from your application to track application health and drill down into related traces, logs, and errors.
