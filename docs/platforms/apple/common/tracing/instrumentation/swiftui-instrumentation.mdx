...
SwiftUI view performance tracking is included in the main `Sentry` SDK. To start monitoring the performance of your views, wrap them with `SentryTracedView`:
...
For more information about TTID and TTFD metrics, see the [Mobile Vitals documentation](/product/dashboards/sentry-dashboards/mobile/mobile-vitals/#time-to-initial-display-and-time-to-full-display).
