...
For SwiftUI views, see the [SwiftUI Instrumentation documentation](/platforms/apple/common/tracing/instrumentation/swiftui-instrumentation) for TTID and TTFD tracking.
