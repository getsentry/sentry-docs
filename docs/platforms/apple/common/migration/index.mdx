...
description: "Migrate from an older version of our Sentry Apple SDK."
sidebar_order: 8000
...
Here's a list of guides on migrating to a newer version of the Sentry Apple SDK.

<AnchorLinkGrid
  items={[
    {
      href: "#migrating-from-8x-to-9x",
      title: "Migrate from 8.x to 9.x",
      description: "Learn about migrating from Sentry Apple SDK 8.x to 9.x",
    },
    {
      href: "#migrating-from-7x-to-8x",
      title: "Migrate from 7.x to 8.x",
      description: "Learn about migrating from Sentry Apple SDK 7.x to 8.x",
    },
    {
      href: "#migrating-from-6x-to-7x",
      title: "Migrate from 6.x to 7.x",
      description: "Learn about migrating from Sentry Apple SDK 6.x to 7.x",
    },
    {
      href: "#migrating-from-5x-to-6x",
      title: "Migrate from 5.x to 6.x",
      description: "Learn about migrating from Sentry Apple SDK 5.x to 6.x",
    },
    {
      href: "#upgrading-from-4x-to-5x",
      title: "Migrate from 4.x to 5.x",
      description: "Learn about upgrading from Sentry Apple SDK 4.x to 5.x",
    },
  ]}
/>
...
- <PlatformLink to="/configuration/app-hangs/#app-hangs-v2">
    App hang tracking V2
  </PlatformLink>
  : This is now the default only on **iOS and **tvOS** and we removed the option
  to enable/disable it. macOS still uses V1.
...
- <PlatformLink to="/tracing/instrumentation/automatic-instrumentation/#user-interaction-tracing">
    {" "}
    The user interaction tracing integration{" "}
  </PlatformLink>
- <PlatformLink to="/tracing/instrumentation/automatic-instrumentation/#file-io-tracking">
    {" "}
    The File I/O tracing integration{" "}
  </PlatformLink>
- <PlatformLink to="/tracing/instrumentation/automatic-instrumentation/#core-data-tracing">
    {" "}
...
- <PlatformLink to="/configuration/app-hangs/">App Hangs</PlatformLink> (not
