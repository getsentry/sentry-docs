...
The only supported profiling method is now <PlatformLink to="/product/profiling/#enable-ui-profiling">UI Profiling</PlatformLink> (also known as continuous V2 profiling), which was introduced in [version 8.49.0](https://github.com/getsentry/sentry-cocoa/releases/tag/8.49.0).
...
For more information, see the <PlatformLink to="/product/profiling/#enable-ui-profiling">UI Profiling documentation</PlatformLink>.
