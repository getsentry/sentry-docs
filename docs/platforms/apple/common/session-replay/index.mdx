...
Starting with [v9.27.0](https://github.com/getsentry/sentry-cocoa/release/9.27.0), you can use manual control when replay recording depends on user consent, authentication, or a specific workflow. To disable automatic recording, [set both replay sample rates to `0.0`](/platforms/apple/guides/ios/session-replay/configuration/#disable-automatic-replay-sampling).
