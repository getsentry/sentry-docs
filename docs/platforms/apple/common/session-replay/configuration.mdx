...
Starting with [v9.27.0](https://github.com/getsentry/sentry-cocoa/release/9.27.0), you can prevent Replay from starting automatically by setting both sample rates to `0.0` during initialization. You can then choose to start it after user consent, a feature flag, or a user action.
