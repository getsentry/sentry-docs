...
To prevent Replay from starting automatically, set both sample rates to 0.0 during initialization. You can then choose to start it after user consent, a feature flag, or a user action.
