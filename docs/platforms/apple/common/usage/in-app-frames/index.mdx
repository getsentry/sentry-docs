...
originates from your application or a private framework and marks all of them as `inApp`. You can improve your experience by telling Sentry which frames should be marked as `not inApp`, using [Stack Trace Rules](/product/data-management-settings/event-grouping/stack-trace-rules/#stack-trace-rules) on the server.
