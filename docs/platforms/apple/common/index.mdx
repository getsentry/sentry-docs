...
<PlatformSection supported={["apple.tvos", "apple.watchos", "apple.visionos"]}>
...
```swift {tabTitle:Swift} {"onboardingOptions": {"performance": "13-16", "profiling": "24-34", "session-replay": "17-22"}}
import Sentry
...
```objc {tabTitle:Objective-C} {"onboardingOptions": {"performance": "12-15", "profiling": "23-33", "session-replay": "16-21"}}
@import Sentry;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [SentrySDK startWithConfigureOptions:^(SentryOptions *options) {
        ...
        options.sessionReplay.sessionSampleRate = @0.1;
        // We recommend the ~5x more performant experimental view renderer
        options.sessionReplay.enableExperimentalViewRenderer = YES;
    }];
...
```swift {tabTitle:SwiftUI with App conformer} {"onboardingOptions": {"performance": "13-16", "profiling": "24-34", "session-replay": "17-22"}}
import Sentry
...
```swift {tabTitle:Swift} {"onboardingOptions": {"performance": "13-16", "profiling": "18-28", "session-replay": "17-22"}}
import Sentry
