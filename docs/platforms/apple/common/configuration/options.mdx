...
The default is `false`. This option is available as of SDK version 8.40.0. Learn more in the <PlatformLink to="/usage/#capturing-uncaught-exceptions">capturing uncaught exceptions</PlatformLink> documentation.
...
The default is `true`. This feature is not available in `DebugWithoutUIKit` and `ReleaseWithoutUIKit` configurations even when targeting iOS or tvOS platforms. Learn more in the <PlatformLink to="/tracing/instrumentation/automatic-instrumentation/#uiviewcontroller-tracing">UIViewController Tracing</PlatformLink> documentation.
...
This option defaults to `true`. Learn more in the <PlatformLink to="/configuration/app-hangs/">App Hangs</PlatformLink> documentation.
...
The default is `true` starting with SDK version 8.0.0. Learn more in the <PlatformLink to="/configuration/http-client-errors/">HTTP Client Errors</PlatformLink> documentation.
...
The default is `500-599`. Learn more in the <PlatformLink to="/configuration/http-client-errors/">HTTP Client Errors</PlatformLink> documentation.
...
This option defaults to `true`. Learn more in the <PlatformLink to="/configuration/watchdog-terminations/">Watchdog Terminations</PlatformLink> documentation.
...
The default is `true`. Learn more about screenshot options in the <PlatformLink to="/enriching-events/screenshots/">Screenshots documentation</PlatformLink>.
...
The default is `false`. Learn more about profiling in the <PlatformLink to="/profiling/">Profiling documentation</PlatformLink>.
...
The default is `true`. Performance Monitoring must be enabled for this flag to take effect. Learn more about <PlatformLink to="/tracing/">Performance Monitoring</PlatformLink>.
...
The default is `true`. This feature is unavailable for SwiftUI. Learn more in the <PlatformLink to="/tracing/instrumentation/automatic-instrumentation/#user-interaction-tracing">User Interaction Tracing</PlatformLink> documentation.
...
The default is `true` starting with SDK version 9.0.0. Learn more in the <PlatformLink to="/tracing/instrumentation/automatic-instrumentation/#prewarmed-app-start-tracing">Prewarmed App Start Tracing</PlatformLink> documentation.
...
The default is `true`. Learn more in the <PlatformLink to="/tracing/instrumentation/automatic-instrumentation/#network-tracking">Network Tracking</PlatformLink> documentation.
...
The default is `true`. Learn more in the <PlatformLink to="/tracing/instrumentation/automatic-instrumentation/#file-io-tracing">File I/O Tracing</PlatformLink> documentation.
...
The default is `true`. Learn more in the <PlatformLink to="/tracing/instrumentation/automatic-instrumentation/#core-data-tracing">Core Data Tracing</PlatformLink> documentation.
...
The default is `false`. Learn more in the <PlatformLink to="/tracing/instrumentation/automatic-instrumentation/#time-to-full-display">Time to Full Display</PlatformLink> documentation.
...
The default is `true`. Learn more in the <PlatformLink to="/configuration/swizzling/">Swizzling</PlatformLink> documentation.

</SdkOption>

<SdkOption name="swizzleClassNameExcludes" type="array">
...
The default is an empty set. This option is available with SDK version 8.23.0 and above. Learn more in the <PlatformLink to="/configuration/swizzling/">Swizzling</PlatformLink> documentation.
...
The default is `false`. This feature is currently experimental and disabled by default. Learn more in the <PlatformLink to="/tracing/instrumentation/automatic-instrumentation/#file-io-tracing">File I/O Tracing</PlatformLink> documentation.
...
The default is `true`. App Hang tracking is automatically disabled if a debugger is attached. Learn more in the <PlatformLink to="/configuration/app-hangs/">App Hangs</PlatformLink> documentation.
...
The default value is `2.0` seconds. Learn more in the <PlatformLink to="/configuration/app-hangs/">App Hangs</PlatformLink> documentation.
...
The default is `false`. Learn more in the <PlatformLink to="/configuration/metric-kit/">MetricKit</PlatformLink> documentation.
...
The default is `false`. Learn more in the <PlatformLink to="/features/experimental-features/">Experimental Features</PlatformLink> documentation.
