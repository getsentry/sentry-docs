...
We recommend disabling this feature for Widgets and Live Activities because it might detect false positives as Widgets and Live Activities use special mechanisms to update their UI.
