...
<Note>This feature is stable since version 8.17.0.</Note>
...
![Transaction with nested traced views](/platforms/apple/common/performance/instrumentation/swiftui-instrumentation/nested-view-transaction.png)
