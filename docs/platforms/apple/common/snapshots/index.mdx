...
sentry-cli snapshots upload --app-id com.example.your-app $TEST_RUNNER_SNAPSHOTS_EXPORT_DIR
```
...
Call `sentry-cli snapshots upload` directly from your workflow — the same command you ran in [Step 2](#step-2-test-locally). This is the simplest option if you aren't already using Fastlane.
