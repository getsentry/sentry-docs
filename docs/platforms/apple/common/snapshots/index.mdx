...
These methods are not mutually exclusive and you can use the SnapshotPreviews repo in addition to any existing snapshot tests you have.
### From Snapshot Previews (Recommended)

[SnapshotPreviews](https://github.com/EmergeTools/SnapshotPreviews) automatically turns every `#Preview` and `PreviewProvider` in your project into a snapshot so you don't have to maintain test code. 
