...
## Privacy within View Hierarchy Attachments

Sentry does not collect any user information with the view hierarchy, such as UILabel and UITextView text. The view hierarchy attachment only contains the view hierarchy structure and properties.

Some developers use the view's accessibilityIdentifier property with personal information. If you are using this property, make sure to disable accessibilityIdentifier reporting like this:
