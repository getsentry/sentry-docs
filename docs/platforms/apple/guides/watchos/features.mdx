...
Sentry's Apple SDK for watchOS enables basic reporting of errors and exceptions. The below, is a list of features that are available as part of this SDK.
