...
To see how elements are being masked, enable the masking preview from anywhere in your app. It will display a semi-transparent overlay on top of the masked elements.
