...
If you want to manually choose which part of your app's data to redact, you read our guide on [custom redaction](/platforms/apple/guides/ios/session-replay/customredact).
