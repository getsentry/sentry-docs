...
Q: Doesn't it work with SwiftUI?
A: Yes. Session Replay works with UIKit as well as SwiftUI.

Q: What's the lowest version of iOS supported?
A: Session Replay doesn't require a more modern iOS version to work. Recording happens even on the lowest version supported by the Sentry SDK. Today that's iOS 12.
