...
Capturing transactions requires that you first <PlatformLink to="/performance/">set up tracing</PlatformLink> if you haven't already. You'll also need to enable the <PlatformLink to="/">base Sentry integration</PlatformLink>.
