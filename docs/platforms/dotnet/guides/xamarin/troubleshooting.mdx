...
![System.Memory conflict](/platforms/dotnet/guides/xamarin/system-memory-conflict.png)
...
![ItemGroup with packagereference](/platforms/dotnet/guides/xamarin/finding-package-reference.png)
...
4. Make sure the `additional mtouch argument` is applied to all configurations and platforms.
   ![iOS project mtouch arguments](/platforms/dotnet/guides/xamarin/tvos-metadata.jpg)
