...
Additionally, when enabled, log messages are sent to Sentry as [Structured Logs](logs/). You can control which logs captured using the [Serilog MinimumLogLevel](https://github.com/serilog/serilog/wiki/Configuration-Basics#minimum-level).
