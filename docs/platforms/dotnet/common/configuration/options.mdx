---
title: Options
description: "Learn more about how the Sentry .NET SDK can be configured via options. These are being passed to the init function and therefore set when the SDK is first initialized."
sidebar_order: 1
---
