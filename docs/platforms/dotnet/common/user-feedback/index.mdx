...
![An example of a Crash-Report modal with text boxes for user name, email, and additional details about the break.](/platforms/dotnet/common/user-feedback/user_feedback_widget.png)
