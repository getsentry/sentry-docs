...
The KMP Replay configuration applies to **Android and iOS**. Android recording requires Android 8 (API level 26) or newer. On iOS, use a deployment target supported by your KMP SDK and its bundled Cocoa SDK. Other KMP targets do not use these Replay settings.
