...
## Replay and Pre-Release Checks

Use these guides to configure Replay or check your app before release:

- [Session Replay](/platforms/kotlin/guides/kotlin-multiplatform/session-replay/): Record user sessions on Android and iOS.
- [Size Analysis](/platforms/kotlin/guides/kotlin-multiplatform/size-analysis/): Analyze Android and iOS app builds for size regressions.
- [Snapshots](/platforms/kotlin/guides/kotlin-multiplatform/snapshots/): Compare UI images across changes.
