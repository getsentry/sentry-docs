...
The KMP guides cover [Session Replay](/platforms/kotlin/guides/kotlin-multiplatform/session-replay/), [Size Analysis](/platforms/kotlin/guides/kotlin-multiplatform/size-analysis/), and [Snapshots](/platforms/kotlin/guides/kotlin-multiplatform/snapshots/). Review the Replay rendering and masking caveats for Compose Multiplatform, and choose snapshot-generation tooling that supports your target UI.
