...
The KMP guides cover [Size Analysis](/platforms/kotlin/guides/kotlin-multiplatform/size-analysis/) and [Snapshots](/platforms/kotlin/guides/kotlin-multiplatform/snapshots/). Choose snapshot-generation tooling that supports your target UI.
