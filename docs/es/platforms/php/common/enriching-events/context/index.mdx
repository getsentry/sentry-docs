...
Si necesitas poder Buscar en datos personalizados, [usa etiquetas](../tags) en su lugar.
...
Sentry antes permitía añadir “datos adicionales” no estructurados mediante <PlatformIdentifier name="set-extra" />.