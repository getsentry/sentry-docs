...
Los contextos personalizados te permiten adjuntar datos arbitrarios a un evento. A menudo, este contexto se comparte entre cualquier incidencia capturada durante su ciclo de vida. No puedes buscarlos, pero son visibles en la página de la incidencia:
...
**La función Datos adicionales está obsoleta** en favor de los contextos estructurados.
