...
¿Todavía no tienes una cuenta y un proyecto de Sentry configurados? Ve a [sentry.io](https://sentry.io/signup/) y luego regresa a esta página.

<div id="install">
  ## Instalación
</div>

Sentry captura datos mediante un SDK en el entorno de ejecución de tu aplicación.
