...
Con Sentry Structured Logs, puedes enviar información de registros basada en texto desde tus aplicaciones a Sentry. Una vez en Sentry, estos registros pueden verse junto con errores relevantes, buscarse por cadenas de texto o consultarse mediante sus atributos individuales.
