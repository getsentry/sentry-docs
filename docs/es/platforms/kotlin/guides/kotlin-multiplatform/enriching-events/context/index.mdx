...
El SDK de Sentry hará todo lo posible por ajustar los datos que envíes y recortar payloads de contexto grandes. El SDK puede truncar partes del evento; para más detalles, consulta la [documentación para desarrolladores sobre el manejo de datos del SDK](https://develop.sentry.dev/sdk/expected-features/data-handling/).

<div id="additional-data">
  ## Datos adicionales
</div>

**“Datos adicionales” está en desuso** en favor de contextos estructurados.
