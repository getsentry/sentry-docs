...
* **Identificador de código**: El identificador único del ejecutable o la biblioteca
  dinámica, es decir, el archivo de código. El contenido de este identificador depende de la
...
* **Identificador de depuración**: El identificador único del archivo de depuración asociado. En
...
<Alert>
  La información de depuración no tiene que estar asociada a versiones. El identificador de
  depuración único garantiza que Sentry pueda elegir los archivos correctos para cada informe de
...
identificador de depuración. Consulta [*Comprobación de archivos de información de depuración*](/es/cli/dif/#checking-files) para más información.
...
*El identificador debe estar presente e idéntico tanto en el binario como en los archivos de información de depuración con símbolos eliminados.* Si el ID falta por alguna razón,
...
<div id="wasm-build-ids">
  ## ID de compilación de WASM
</div>

[WebAssembly admite ID de compilación](https://github.com/WebAssembly/tool-conventions/blob/main/BuildId.md) como una
...
también puede utilizarse para añadir un ID de compilación si tu cadena de herramientas aún no lo admite. También te permite
...
def obtener_uuid_proguard(nombre_archivo):
