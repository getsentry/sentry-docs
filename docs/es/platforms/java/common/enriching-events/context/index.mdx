...
Al enviar contexto, _ten en cuenta los límites de tamaño de la carga_. Sentry no recomienda enviar todo el estado de la aplicación ni grandes volúmenes de datos en los contextos. Si superas el tamaño máximo de la carga, Sentry responderá con el error HTTP `413 Payload Too Large` y rechazará el evento.

El SDK de Sentry intentará manejar lo mejor posible los datos que envíes y recortar cargas de contexto grandes. El SDK puede truncar partes del evento; para obtener más información, consulta la [documentación para desarrolladores sobre el manejo de datos del SDK](https://develop.sentry.dev/sdk/expected-features/data-handling/).

<div id="additional-data">
  ## Datos adicionales
</div>

**Los datos adicionales están obsoletos** en favor de los contextos estructurados.
