...
<Alert>
Check out this video on [**Migrating to Sentry SaaS**](<a href="https://sentry.io/resources/migrate-to-sentry-saas-workshop/" className="plausible-event-name=migrating+to+saas+video">Migrating to Sentry SaaS</a>) to learn about our relocation tooling.
</Alert>
