...
For multi-service architectures using the OpenTelemetry Collector, the [Sentry Exporter](/concepts/otlp/sentry-exporter/) provides automatic project routing without requiring a routing connector.
...
<Alert level="info">
  The [Sentry Exporter](/concepts/otlp/sentry-exporter/) handles project routing automatically, no routing connector required. It also supports automatic project creation.
</Alert>
