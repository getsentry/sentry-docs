...
If you need to process traces before sending them to Sentry (sampling, transforming, routing to multiple projects), see the [OpenTelemetry Collector](/concepts/otlp/forwarding/tools/collector/) guide.
