...
Refers to your code deployment naming convention. For example, `development`, `testing`, `staging` and so on. [Learn more](/concepts/key-terms/environments/). In some pages of [Sentry](https://sentry.io/), you filter on environment using a dropdown.
