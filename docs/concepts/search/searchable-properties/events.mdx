...
HTTP method of the [request](https://develop.sentry.dev/sdk/foundations/data-model/event-payloads/request/) that created the event.
...
Describes the status of the span/transaction. Check out our [Transaction Payloads documentation](https://develop.sentry.dev/sdk/foundations/data-model/event-payloads/transaction/) for all possible statuses.
