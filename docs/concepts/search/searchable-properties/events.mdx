...
HTTP method of the [request](https://develop.sentry.dev/sdk/foundations/data-model/events/request/) that created the event.
...
Describes the status of the span/transaction. Check out our [Transaction Payloads documentation](https://develop.sentry.dev/sdk/foundations/data-model/events/transaction/) for all possible statuses.
