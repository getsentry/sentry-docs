---
title: Agent Tracing - What It Is and How To Use It
...
With agent tracing, each model call span shows you an estimate of how much it costs and how many tokens it consumed. You'd be able to see that one step called an expensive model several times in a row instead of just once, or that a tool returned a block of text big enough that the agent was forced to reprocess it.

**Note:** Cost is an estimate to help guide your understanding of agent performance, not an exact representation. 
