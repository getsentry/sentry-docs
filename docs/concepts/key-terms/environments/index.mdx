...
sidebar_order: 20
description: >-
  Learn how environments can help you filter issues, releases, and user feedback
  in Sentry.
...
Since you can't delete environments, Sentry has an option to hide it from the UI. Hiding environments can be useful when you're no longer sending events from an environment, or you've accidentally created an environment you no longer want. You can hide environments from your environments dropdown by navigating to [**Project Settings > Environments**](https://sentry.io/orgredirect/organizations/:orgslug/settings/projects/:projectId/environments/), and selecting "Hide", but events sent to that environment **will still count against your quota**.
