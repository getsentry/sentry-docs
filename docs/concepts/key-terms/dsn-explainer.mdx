...
DSNs are safe to keep public because they only allow submission of new events and related event data.  A DSN may be used to fetch project config data such as: allowed_domains, pii_config, filter_settings, datascrubbing_settings, and quotas.  Many more fields may be returned see project-state for implementation details: https://github.com/getsentry/relay/blob/af431720462d1b3ac635f12817e4a51640e31a48/relay-server/src/services/project.rs#L71.
