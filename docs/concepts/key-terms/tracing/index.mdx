...
The [Trace Explorer](/product/explore/traces/) allows you to explore traces by querying [span attributes](/concepts/search/searchable-properties/spans/). This helps you find relevant distributed traces that will give you more information to debug and optimize your code.
