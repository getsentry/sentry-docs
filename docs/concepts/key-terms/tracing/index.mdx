...
The [Trace Details](/product/sentry-basics/tracing/trace-details/) allows you to drill down into the details of a single trace and traverse every transaction in that trace. This accelerates your ability to debug slow services, identify related errors, and root out other bottlenecks.
