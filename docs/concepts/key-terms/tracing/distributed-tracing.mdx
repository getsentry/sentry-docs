...
Through [Performance](/product/performance/) and [Discover](/product/discover-queries/), you can view trace data in the [trace view](/concepts/key-terms/tracing/trace-view/).
