...
- `**` to scrub [all default event PII fields](/concepts/data-management/scrubbing/server-side-scrubbing/event-pii-fields/) (other fields, like the span description, require specific selectors)
