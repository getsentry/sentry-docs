...
In addition, we provide an [_Advanced Data Scrubbing_](/concepts/data-management/scrubbing/advanced-datascrubbing/) feature that allows more control over how filters are applied.
...
[Advanced Datascrubbing Sources](/concepts/data-management/scrubbing/advanced-datascrubbing/#sources).
