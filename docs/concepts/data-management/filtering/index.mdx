...
Inbound data filters have partial support for [Application Metrics](/product/explore/metrics/). Only the **Releases** filter, which narrows Application Metrics to specific release versions, applies to Application Metrics.
