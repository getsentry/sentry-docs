...
<Alert>
  The Cloud transport requires your client to support **OAuth** and **Streamable HTTP**.
  All clients listed under [Client Instructions](#client-instructions) support this natively.
  If yours doesn't, use the [`mcp-remote`](https://www.npmjs.com/package/mcp-remote) bridge
  or the [Stdio Transport](#stdio-transport) instead.
</Alert>
