...
Some SDK integrations (such as OpenAI Agents SDK for Python and OpenAI SDK for Node) automatically infer the conversation ID. For all other integrations, you need to set it manually. See the [Agent Monitoring getting started guide](/ai/monitoring/agents/getting-started/) for setup instructions.
