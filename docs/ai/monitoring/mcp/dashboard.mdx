...
Once you've [configured the Sentry SDK](/ai/monitoring/mcp/getting-started/) for your MCP project, you'll start receiving data in the [MCP Dashboard](https://sentry.io/orgredirect/organizations/:orgslug/dashboards/?filter=onlyPrebuilt&query=mcp&sort=mostPopular).
