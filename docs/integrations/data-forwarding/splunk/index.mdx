...
Sentry supports Splunk as a first-party **Data Forwarder**, which currently only supports forwarding error events. For more details on Data Forwarding in general (including basic setup and overrides), check out the [Data Forwarding](/integrations/data-forwarding/) documentation.
...
Navigate to [**Settings » Data Forwarding**](https://sentry.io/orgredirect/organizations/:orgslug/settings/data-forwarding/) and add a new forwarder.
...
If you wish to modify your forwarder configuration per project, you can do so by following the [Project Overrides documentation](/integrations/data-forwarding/#project-overrides).
