...
sidebar_order: 1
description: >-
  Learn more about Sentry's Rookout integration and how it can help you debug an
  issue.
...
1. Navigate to [**Settings > Integrations**](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) > **Rookout**
