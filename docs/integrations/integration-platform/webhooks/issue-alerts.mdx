...
Sentry integrations which have been made available as [alert actions](/integrations/integration-platform/#alerts) can receive issue alert webhooks.
...
- type: object
- description: the event that triggered the alert
...
The following two fields are for [alert action UI components](/integrations/integration-platform/ui-components/alert-action) only.
