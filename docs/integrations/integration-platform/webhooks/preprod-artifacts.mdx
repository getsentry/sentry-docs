...
1. Navigate to [**Settings > Developer Settings > New Internal Integration**](https://sentry.io/orgredirect/organizations/:orgslug/settings/developer-settings/new-internal/)
