...
Sentry integrations which have been made available as [alert actions](/integrations/integration-platform/#alerts) can receive metric alert webhooks.
...
- type: object
- description: the incident that triggered the alert
...
The following field is for [alert action UI components](/integrations/integration-platform/ui-components/alert-action) only.
