...
Sentry integrations which have been made available as [alert rule actions](/integrations/integration-platform/#alerts) can receive metric alert webhooks.
...
The following field is for [alert rule action UI components](/integrations/integration-platform/ui-components/alert-rule-action) only.
