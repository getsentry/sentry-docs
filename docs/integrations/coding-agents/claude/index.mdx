...
Once installed, you can send any Seer root cause analysis to a Claude agent. Sending work to Claude Agent creates a managed agent in your Claude organization.
