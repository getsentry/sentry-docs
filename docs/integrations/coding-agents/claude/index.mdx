...
2. In Sentry, navigate to [**Settings > Integrations**](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) and search for **Claude Agent**.
...
Once installed, you can send any Seer root cause analysis to a Claude agent. Sending work to Claude Agent creates a managed agent in your Claude organization. Claude Agent automatically uses the first model available to your Anthropic API key, checking Claude Opus 5, Claude Opus 4.8, and Claude Sonnet 5 in that order.
