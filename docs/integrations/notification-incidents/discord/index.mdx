...
sidebar_order: 1
description: >-
  Learn more about Sentry's Discord integration, which allows you to manage
  Sentry issues in Discord.
...
1. Navigate to [**Settings > Integrations**](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) > **Discord** in Sentry.
...
4. Use the dropdown menu to select the Discord server you'd like to add Sentry to and click "Continue".
   ...
   <Alert>
     You'll need to have the "Manage Server" permission enabled for your Discord account in the
     server you're trying to add the bot to.
   </Alert>
...
Our Discord integration currently supports alerts. Support for personal notifications is planned for future updates.

### Setting Up Alerts

To create an alert that sends notifications to Discord, follow the steps below:

1. Go to the **Alerts** page in Sentry and click "Create Alert".

2. Select the alert type you'd like to create, then click "Set Conditions".

   ![Create alert](./img/discord-add-alert.png)

3. Configure your alert conditions.

4. Select "Send a Discord notification" from the actions dropdown.
...
![Discord Channel Link](./img/discord-copy-channel-link.png)
    ...
    For channel IDs, if the URL is `https://discord.com/channels/server-id/channel-id`, the ID is `channel-id`.
...
6. Test your configuration by clicking "Send Test Notification". If the bot has access to the given channel, you should see an example notification there.
   ...
   ![Discord alert](./img/discord-alert.png)

7. Name and save your alert.
