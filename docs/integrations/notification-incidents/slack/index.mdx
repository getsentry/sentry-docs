...
For [paid Slack Workspaces with access to AI assistant apps](https://slack.com/pricing), you can also open it as an Agent in Slack, using the dropdown in the top-right of your Slack window. This will open a new persistent panel in your Slack window for private conversations with Seer Agent. In these conversations, you don't have to mention it every time and new chats will open with a few example prompts to get you started.
