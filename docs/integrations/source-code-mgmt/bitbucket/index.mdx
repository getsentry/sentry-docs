...
sidebar_order: 1
description: >-
  Learn more about Sentry's Bitbucket integration and how it can track and
  resolve bugs faster by using data from your Bitbucket commits.
...
1. Navigate to [**Settings > Integrations**](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) > **Bitbucket**.
...
5. In Sentry, you’ll see a new Bitbucket Server instance appear on the [Integrations](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) page.
...
Once you’ve navigated to a specific issue, you’ll find the **External Links** section on the right hand panel. Here, you’ll be able to create or link Bitbucket issues.

![Link BitBucket issue to Sentry issue](./../img/global-link-issue.png)
...
1. Navigate to [**Settings > Integrations**](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) > **Bitbucket > Configurations**.
