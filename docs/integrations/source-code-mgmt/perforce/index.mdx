...
Sentry's Perforce integration connects your P4 Server to Sentry, enabling stack trace linking, commit tracking, and suspect commit detection for teams using [Perforce P4](https://www.perforce.com/products/helix-core) (formerly Helix Core) for version control.
...
1. In sentry.io, navigate to [**Settings > Integrations**](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) > **Perforce** and click "Add Installation".
...
1. Navigate to [**Settings > Integrations**](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) > **Perforce > Configurations**.
...
You can update your Perforce server credentials and settings at any time by navigating to [**Settings > Integrations**](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) > **Perforce > Configurations** and clicking the gear icon next to your instance. Changes take effect immediately.
