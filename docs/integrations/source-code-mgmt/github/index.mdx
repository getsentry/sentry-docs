...
<Alert level="warning">
**Deprecated:** This GitHub app is no longer supported and will be removed in the future. Migrate to the [Seer GitHub integration](/integrations/source-code-mgmt/github/#installing-github) instead._
</Alert>
