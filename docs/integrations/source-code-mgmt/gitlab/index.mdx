...
1. Navigate to External Links on the right panel of the issue's page and click "Link Issue".
   ...
   ![GitLab logo with Link GitLab Issue text =600x](./../img/global-link-issue.png)
...
1. To unlink an issue, click on the "X" next to its name under External Links.
   ...
   ![GitLab logo and project next to an X icon =600x](./img/unlink-issue2.png)
...
1. Navigate to [**Settings > Integrations**](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) > **GitLab > Configurations**.
