...
1. Navigate to [**Settings > Integrations**](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) > **LaunchDarkly**

2. Follow the full [LaunchDarkly installation instructions](https://launchdarkly.com/docs/integrations/sentry).
