...
- Sentry adds the following environment variables
  ...
  - `SENTRY_DSN`: This is set to the [DSN](/concepts/key-terms/dsn-explainer/) of your project
...
- Sentry adds the following environment variables
  ...
  - `SENTRY_DSN`: This is set to the [DSN](/concepts/key-terms/dsn-explainer/) of your project
  - `SENTRY_TRACES_SAMPLE_RATE`: This sets the [sampling rate](/platforms/python/sampling/#sampling-transaction-events) for transactions. You can manually edit your environment variables if you want a different sampling rate.
