...
This integration is maintained and supported by Factory. For more details, questions, or support feel free to reach out to support@factory.ai.
...
1. Navigate to [**Settings > Integrations**](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) > **Factory**
