...
To add the Height integration, navigate to [**Settings > Integrations**](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) > **Height** and click "Install".
...
![Height alert action settings](./img/height-alert.png)
