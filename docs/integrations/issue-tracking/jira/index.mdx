...
sidebar_order: 1
description: >-
  Learn more about Sentry's Jira integration and how it can help track and
  resolve bugs faster by connecting errors from Sentry with Jira issues.
...
1. Navigate to [**Settings > Integrations**](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) > **Jira**.
...
5. In Sentry, you’ll see a new Jira instance appear on the [Integrations](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) page.
...
1. Navigate to [**Organization Settings > Integrations**](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/).
...
5. In Sentry, you’ll see a new Jira Server instance appear on the [Integrations](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) page.
...
<Alert title="Note">
  ...
  <p>Automatic issue management is available to organizations on Business and Enterprise plans.</p>
</Alert>
...
To configure issue management automatically, create an [**Alert**](/product/monitors-and-alerts/alerts/). When selecting the **action**, choose **Create a new Jira issue**.

![Create Jira ticket alert action](./img/jira-ticket-alert.png)
...
To configure Issue sync, navigate to [**Organization Settings** > **Integrations**](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/), and click "Configure" next to your Jira Server instance. On the following page, you can configure how you want information to sync between Sentry and Jira.
...
Alert notifications in Sentry can be routed to many supported integrations, but by default are aimed at email. You will need to configure a project’s [**Alerts**](/product/monitors-and-alerts/alerts/) to properly route notifications to a specific integration.

### Ignored Fields

Ignored fields are Jira fields that are hidden in the issue creation form. To add ignored fields, navigate to [**Settings > Integrations**](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) and click "Configure" next to your Jira instance. Then scroll down to “Ignored Fields” and enter a comma separated list of the Jira field IDs.
...
### Alert not Creating Jira Issues
