...
Navigate to [**Settings > Integrations**](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) > **Linear (Sentry Agent)**, accept and install.
...
1. Navigate to [Settings > Integrations](https://sentry.io/orgredirect/organizations/:orgslug/settings/integrations/) > Linear (Sentry Agent)
