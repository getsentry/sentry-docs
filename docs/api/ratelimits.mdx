...
Polling the API for updates is likely to quickly trigger rate limiting. We recommend using our [webhooks](/integrations/integration-platform/webhooks/), if possible.
