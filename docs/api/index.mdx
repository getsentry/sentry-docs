...
Using your organization's region-specific domain will generally result in lower latency for most API calls. For example, if you are hosted in the US region, you would use `us.sentry.io`. You can check which region your organization is in by viewing your organization’s settings page.
