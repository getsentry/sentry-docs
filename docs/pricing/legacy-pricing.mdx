...
<Alert>
This information applies to organizations on plans that include transactions or performance units based billing. If you're on a paid or free plan that includes spans, please see the latest [pricing page](/pricing/).
</Alert>
...
Profile hours are determined by the length of the profile in milliseconds and is billed in hours. Partial hours are prorated and rounded down to the nearest cent. Profile Hours can't be purchased in advance and are only available through your Pay-as-you-go (PAYG) budget.
