...
Access Seer by turning it on in [Seer settings](https://sentry.io/orgredirect/organizations/:orgslug/settings/seer/) . Using Seer will add $40 per active contributor per month to your existing subscription, where an active contributor is defined as any user who makes 2 or more PRs to a [Seer-connected repository](/organization/integrations/source-code-mgmt/github/#seer). At the end of the month, contributor counts reset.
