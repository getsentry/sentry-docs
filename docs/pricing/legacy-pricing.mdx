...
All plans include 5GB of application metrics. Additional usage can only be purchased with your shared on-demand budget.
...
Organizations on all plans have the option to set a shared on-demand strategy. Organizations on plans with [Insights](/product/dashboards/sentry-dashboards/) features have the ability to choose between a shared or per-category on-demand strategy:
