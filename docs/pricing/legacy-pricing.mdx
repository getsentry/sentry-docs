...
Monitors for Uptime can't be purchased in advance. Uptime monitors are available to use and purchase through a predetermined on-demand budget that can be shared across all event types or defined per category.
