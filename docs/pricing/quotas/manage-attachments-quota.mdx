...
These tips will help you manage your attachment quota and are ordered from easiest (or least time-consuming0 to most challenging (or potentially time-consuming). The first three can be done in [sentry.io](https://sentry.io). The last one is something you'll do in your SDK.
