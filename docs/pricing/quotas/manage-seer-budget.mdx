...
<Alert>
[Seer](/product/ai-in-sentry/seer/) is only available when purchased additionally while on a team or business plan. Once Seer has been purchased, your subscription will have $25 worth of Seer budget to be used across scans and Issue Fixes.
</Alert>
...
You can look at your Seer usage in the ["Stats and Usage" page](/product/stats/#usage-stats) to understand the breakdown of your Issue Fixes and Issue Scans by time window and project. This may help you figure out where you need to further fine-tune your usage.
...
[Learn more about setting PAYG your budget](/pricing/#pricing-how-it-works).
