...
Automation will run based on available Seer or PAYG budget. Once both budgets have depleted, Seer will stop running issue scans and fixes unless additional budget is made available or the billy cycle resets.
...
1. **Seer Budget:**
   ...
   - You also have a shared $100 PAYG budget that covers all Sentry events, including any Seer usage that exceeds your monthly credit.
2. **Issue Scans:**
