...
To decrease your quota, go to **Settings > Subscription** and click "Manage plan". The cart will display the date that these changes will go into effect:

![The cart of a subscription update.](./img/cart.png)
