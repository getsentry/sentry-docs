...
If this is your first time exceeding your errors quota and you're on a paid plan, you'll be entered into a one-time grace period. Learn more by reading this [help article](https://www.sentry.help/en/articles/23983502355099-What-happens-when-I-run-out-of-event-capacity-and-a-grace-period-is-triggered).
...
If you have a rogue client, Sentry supports blocking an IP from sending data. Go to your project's [Inbound Filters](https://sentry.io/orgredirect/organizations/:orgslug/settings/projects/:projectId/filters/) settings to add the IP addresses (or subnets) in the "IP Addresses" field.

### Filter by Release

<Include name="feature-available-for-plan-business.mdx" />

If you discover a problematic release causing excessive noise, Sentry supports ignoring all events and attachments from that release. Go to your project's [Inbound Filters](https://sentry.io/orgredirect/organizations/:orgslug/settings/projects/:projectId/filters/) settings, then add the release to the "Releases" field.

### Filter by Error Message

<Include name="feature-available-for-plan-business.mdx" />

Sentry supports filtering out a specific or certain kind of error as well. Go to your project's [Inbound Filters](https://sentry.io/orgredirect/organizations/:orgslug/settings/projects/:projectId/filters/) settings, then add the error message to the "Error Message" field.
