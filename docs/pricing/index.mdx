...
<Alert>
This pricing page only applies to plans **started on June 5th, 2024 or later**. For information about older plans, go to your [**Settings**](https://sentry.io/orgredirect/organizations/:orgslug/settings/) page and click on "Subscription" (under the "Usage & Billing" heading).
</Alert>
...
| Span Unit Volume | Team Prepaid | Team PAYG* | Business Prepaid | Business PAYG* |
| ---------------- | ------------ | ---------- | ---------------- | -------------- |
...
_* PAYG stands for pay-as-you-go._
