...
Go to [**Organization Settings > Subscription**](https://sentry.io/orgredirect/organizations/:orgslug/settings/billing/overview/), then click "Start Trial" for Seer. Alternatively, you can find a similar flow on the **Issue** details page from the Seer panel or in the **Seer settings** page.
