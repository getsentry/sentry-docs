...
<Alert>
This pricing only applies to free plans or paid plans on the **latest** version of Sentry. For information about older plans, go to your [**Settings**](https://sentry.io/orgredirect/organizations/:orgslug/settings/) page and click on "Subscription" (under the "Usage & Billing" heading).
</Alert>
