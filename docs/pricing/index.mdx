...
| Errors Volume | Team Reserved | Team PAYG | Business Reserved | Business PAYG |
| ------------- | ------------ | ---------- | ---------------- | -------------- |
...
| Replays Volume | Team Reserved | Team PAYG | Business Reserved | Business PAYG |
| -------------- | ------------ | ---------- | -----------------| -------------- |
...
| Attachments Volume | Team Reserved | Team PAYG | Business Reserved | Business PAYG |
| ------------------ | ------------ | ---------- | ---------------- | -------------- |
