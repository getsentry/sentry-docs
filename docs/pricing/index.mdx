...
We bill based on the amount of data you want us to process. Our [Pricing plans](https://sentry.io/pricing/), each come with a pre-set event volume which is included in the price. For example, all paid plans come with a monthly set of:
- 50k errors
- 10M span units
- 50 replays
- 1 cron monitor
