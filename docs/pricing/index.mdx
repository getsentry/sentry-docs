...
For more information on how to manage your monthly spending, check out our [Quota Management documentation](/organization/quotas/).
...
When you buy reserved volume (or quota), you prepay for data at significant discounts. Your prepaid, reserved volume can be allocated on either a pooled basis between projects, or, if you have [Spend Allocation](/organization/quotas/spend-allocation/) enabled, it can be set on both a pooled and a per-project basis. Unused reserved volume expires at the end of each billing month.
...
If you've enabled [Spend Allocation](/organization/quotas/spend-allocation/), and your project has consumed both its dedicated event allocation and your organization's un-allocated pool, any excess event consumption will come from your on-demand budget **even if you have reserved volume still available**.
...
Users with the role of [Billing or Owner](/organization/membership/) can find all previous invoices by going to the "Receipts" tab in **Settings > Subscription**.
