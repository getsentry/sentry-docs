...
Sentry uses two billing cycles - one for paid plan subscriptions and reserved volume, and the other for pay-as-you-go usage. If you're on a paid plan, you can choose to be billed for it on either a monthly or an annual basis.
