...
sidebar_order: 30
description: "Add custom instrumentation to Sentry for visibility beyond auto-instrumentation and set up alerts."
---

You've got your Sentry SDK [auto-instrumentation](/product/trace-explorer/) running. Now what?
...
Already emitting OpenTelemetry? [Route those traces into Sentry](https://sentry.io/cookbook/route-opentelemetry-traces-to-sentry/) (~15 min recipe) instead of re-wrapping every operation.
...
For a full checkout walkthrough of custom spans, Trace Explorer, and creating an alert and dashboard see Sentry's [Track checkout performance recipe](https://sentry.io/cookbook/track-checkout-performance-react-native/) (~20 min recipe).
...
If you already have Vercel AI SDK telemetry, [send those OTel spans to Sentry](https://sentry.io/cookbook/vercel-ai-sdk-otel-sentry/) rather than adding `ai.inference` wrappers.
...
Explore the [Trace Explorer product walkthrough](/product/trace-explorer/) to learn more about the Sentry interface and discover additional tips.
