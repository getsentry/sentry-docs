...
- [Monitor AI agent costs (Next.js)](https://sentry.io/cookbook/monitor-ai-agent-costs-nextjs/) (~20 min) — custom spans around agent runs
- [Vercel AI SDK + OTel → Sentry](https://sentry.io/cookbook/vercel-ai-sdk-otel-sentry/) — instrument AI SDK calls
- [Monitor an MCP server](https://sentry.io/cookbook/monitor-mcp-server/) — trace tool calls end-to-end
