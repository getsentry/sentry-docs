...
- [Structure your logs](https://sentry.io/cookbook/structure-your-logs/) — patterns for searchable, useful log attributes
- [Setup Supabase log drain monitoring](https://sentry.io/cookbook/setup-supabase-log-drain-monitoring/) (~10 min) — forward platform logs into Sentry
- [Debug undefined props in React Native](https://sentry.io/cookbook/debug-undefined-react-native/) — pair logs with mobile debugging
