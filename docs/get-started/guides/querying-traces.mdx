...
You've enabled [Sentry Tracing](/product/trace-explorer/). Now what? 
...
Explore the [Trace Explorer product walkthrough guides](/product/trace-explorer/) to learn more about the Sentry interface and discover additional tips.

## Go one step further

Ready for a full workflow? Try a Cookbook recipe:

- [Monitor AI agent costs (Next.js)](https://sentry.io/cookbook/monitor-ai-agent-costs-nextjs/) (~20 min) — agent latency and cost in one place
- [Route OpenTelemetry traces to Sentry](https://sentry.io/cookbook/route-opentelemetry-traces-to-sentry/) — bring existing OTel pipelines in
- [Track checkout performance (React Native)](https://sentry.io/cookbook/track-checkout-performance-react-native/) — instrument a critical mobile flow
