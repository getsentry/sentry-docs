...
To see an example of querying traces, check out how to query your slowest endpoints on a schedule and open a fix PR, with [Automate weekly performance triage](https://sentry.io/cookbook/performance-bot-sentry-claude/) (~15 min recipe).
