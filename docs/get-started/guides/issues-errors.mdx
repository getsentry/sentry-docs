...
Ready for a full workflow? Try a Cookbook recipe:

- [Fix Sentry issues from Slack](https://sentry.io/cookbook/fix-sentry-issues-from-slack/) (~15 min) — triage and open fixes without leaving Slack
- [AI Code Review with Seer](https://sentry.io/cookbook/ai-code-review-seer/) (~15 min) — review PRs with production context
- [Debug with Sentry MCP + Claude Code](https://sentry.io/cookbook/debug-with-sentry-mcp-claude-code/) (~15 min) — pull issues into your coding agent

Browse more on the [Cookbook](/get-started/cookbook/) page or [sentry.io/cookbook](https://sentry.io/cookbook/).
