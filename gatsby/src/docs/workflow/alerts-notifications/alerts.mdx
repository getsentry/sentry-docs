...
- Send a notification to all [Per Project integrations](/workflow/integrations/)
...
- Send a notification to a global integration, which includes
    - [PagerDuty](/workflow/integrations/integrations/pagerduty/)
    - [Slack](/workflow/integrations/integrations/slack/)
...
For more details, see [Per-Project Integrations](/workflow/integrations/) (via “Service” as any individual integration) that can send Notifications.

By default, [issue owners](/workflow/issue-owners/) receive alert emails. If an issue owner is not configured or not found, the email will either not send or send to all project members as defined in **Project Settings > Issue Owners**.
