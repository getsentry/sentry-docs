...
<Alert>
Delete and discard and per-project rate limits are available only for Team and Business plans.
</Alert>
...
<Alert>
Per-key rate limiting is available only for Team and Business plans
</Alert>
...
<Alert level="info">
Filter by release is available only for Team and Business plans.
</Alert>
...
<Alert level="info">
Filter by error message is available only for Team and Business plans.
</Alert>
...
<Alert level="info">
Delete and Discard is available only for Team and Business plans.
</Alert>
