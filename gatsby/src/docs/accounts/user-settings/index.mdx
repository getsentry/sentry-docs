...
- Non-alert are are all other types of Sentry notifications such as workflow notifications, deploy notification, and quota & usage notifications. These are sent only email.
