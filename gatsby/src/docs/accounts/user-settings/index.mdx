...
## Account Details
Use account details to determine your preferred: 
...
You can also upload an Avatar to personalize your acount. Choose among displaying your initials, an image, or a Gravatar next to your name. 

## Security Settings

The Security Settings tab allows you to reset a password, sign out of all devices, and enable two-factor authenticaiont. 
...
**Note:** Changing your password invalidates all logged in sessions. 

Click the **Session History** tab to find a historical list of your sessions, including First Seen and Last Seen timestamps, under the Session History tab.
...
- Non-alert notifications are sent only email.

Define **Project Alerts** in **[Project] > Project Settings > Alerts**. For more details, see our [full documentation on Alerts & Notifications](/workflow/alerts-notifications/).

Define your preference for **Workflow Notifications**. Fine-tune your workflow notificastions per project using the dropdown selector.
...
Enable email notification for updates regarding your user account actions, such as claiming unassigned issues in the section devoted to **My Activity**.

**Note:** Find a shortcut to the Emails panel at the bottom of this section.

## Emails

The email address used to login to your Sentry account is by default your primary email address. Add an alternative email address in the **Add Secondary Emails** section.
