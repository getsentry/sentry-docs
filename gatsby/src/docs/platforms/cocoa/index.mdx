...
<PlatformContent includePath="init" />
...
<PlatformContent includePath="captureMessage" />
...
<PlatformContent includePath="crash" />
...
<PlatformContent includePath="enableAutoSessionTracking" />
...
<PlatformContent includePath="sessionTrackingIntervalMillis" />
