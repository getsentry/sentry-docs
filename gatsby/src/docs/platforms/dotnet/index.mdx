...
tags: []
---
<Alert level="" level="Learn about SDK usage"><markdown>

This page will provide you with details that are very specific to the platform. To learn how to use our unified
SDKs in general, please visit the [Error Reporting](/error-reporting/quickstart/?platform=csharp), [Enriching Error Data](/enriching-error-data/additional-data/?platform=csharp), [Releases](/workflow/releases/?platform=csharp),  and [Data Management](/data-management/event-grouping/?platform=csharp) sections.
...
<Alert level="info" level="Using an older version of .NET Framework or Mono?"><markdown>
...
Have a look at the [Changelog](https://github.com/getsentry/sentry-dotnet/releases).
