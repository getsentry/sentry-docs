...
Configure the bundler to output source maps. Here's an example of what this looks like for Webpack:
...
Debug IDs are used to match the stack frame of an event with its corresponding minified source and source map file. Visit [What are Artifact Bundles](/platforms/javascript/sourcemaps/artifact-bundles/) if you want to learn more about Artifact Bundles and Debug IDs.
