...
If you need, you can use both ways of setting up the SDK, but keep in mind that the inherited class will be the last method to be set, overriding the values from your `appsettings.json`.