...
You can configure the Sentry options inside of UserSentry callback and also using `appsettings.json`, the settings from `appsettings.json` will be applied before the callback options are executed.
</Alert>