...
Sentry uses the `androidx.lifecycle` libraries for detecting when the application is either in the background or in the foreground. This is necessary for having an accurate result across all the Android OS versions.
