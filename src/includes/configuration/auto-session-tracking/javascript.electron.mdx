Be default, the Electron SDK tracks sessions via the `MainProcessSession` integration. This captures sessions linked to the lifetime of the Electron main process.
