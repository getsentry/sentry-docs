...
For private frameworks, such as Sentry, dynamic and static frameworks differ. If you are not familiar with these terms, we recommend reading [Dynamic Library Programming Topics].
