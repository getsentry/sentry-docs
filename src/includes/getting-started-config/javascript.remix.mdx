...
Learn more about Sentry's Prisma integration <Link to="/platforms/node/performance/database/opt-in/#prisma-orm-integration">here</Link>.
...
You can refer to <a href="https://remix.run/docs/en/v1/guides/envvars#browser-environment-variables">Remix Docs</a> to learn how to use your Sentry DSN from environment variables.
