This snippet includes our [performance monitoring](/product/performance/) package, which registers and configures the Tracing integration, including custom Angular routing instrumentation:
