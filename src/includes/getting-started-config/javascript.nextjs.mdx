...
Once you're set up, the SDK will automatically capture unhandled errors and promise rejections in your frontend, and track frontend performance. You can also [manually capture errors](/platforms/javascript/guides/nextjs/usage).

To capture [Next.js API Route](https://nextjs.org/docs/api-routes/introduction) errors and monitor backend performance, you need to wrap your handlers with a Sentry function:
