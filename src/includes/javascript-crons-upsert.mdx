...
Using `Sentry.withMonitor()`, you can pass a third parameter with your monitor configuration:
...
Using `Sentry.captureCheckIn()`, you can pass a second parameter with your monitor configuration:
...
Available monitor config properties:
