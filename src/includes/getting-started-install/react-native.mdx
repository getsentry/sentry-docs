...
The _link_ step or the `sentry-wizard` call will patch your project accordingly, though you can [link manually](platforms/react-native/install/manual-setup/) if you prefer.
