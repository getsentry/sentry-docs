...
Link the SDK to your native projects to enable native crash reporting. If you're using `react-native` >=0.60:
...
The _link_ step or the `sentry-wizard` call will patch your project accordingly, though you can [link manually](/platforms/react-native/manual-setup/manual-setup/) if you prefer.
