To install the Sentry Capacitor SDK, use npm or yarn to install it alongside the corresponding Sentry SDK for the framework you're using such as Angular.
