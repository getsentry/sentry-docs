...
: The filename is required and will be displayed in Sentry.
...
It's possible to add, remove or modify attachments before an event is sent via
the [`beforeSend`](/platform-redirect/?next=/configuration/options/#before-send)
