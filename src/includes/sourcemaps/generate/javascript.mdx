...
If you are using webpack in your application, this is the recommended way to integrate your source maps with Sentry.
...
Rollup can be configured to generate source maps with the configuration below.
