...
Here is a simple project where your minified / transpiled files and their source maps reside in the same directory like below:
...
For this project, can use a simple Sentry configuration like:
