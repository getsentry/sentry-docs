...
You don't _have_ to upload the source files (referenced by source maps), but without them, the grouping algorithm will not be as strong, and sentry.io will not show any contextual source.
