...
For HTTP communications, Sentry's SDK provides `SentryHttpMessageHandler`, which can be used to [automatically attach trace headers to outgoing HTTP requests](/platforms/dotnet/performance/included-instrumentation/).
