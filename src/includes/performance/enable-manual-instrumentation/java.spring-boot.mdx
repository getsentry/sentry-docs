...
Methods executed outside of [Spring MVC request processing](/platforms/java/guides/spring-boot/automatic/#spring-mvc-integration) can be turned into transactions by annotating them with `@SentryTransaction` annotation:
