...
This code checks for the existence of a parent span and if we have one, we create a new span and set it as the current span. We then call the expensive operation. Finally, we finish the span and restore the current span to the parent span.
