...
- Automatic crash error tracking for [native iOS](/platforms/unity/configuration/ios-native/) using the [iOS SDK](/platforms/apple/guides/ios/), supporting ObjC, Swift and C
