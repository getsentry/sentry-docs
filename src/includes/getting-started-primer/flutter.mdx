...
- Breadcrumbs automatically captured:
    ...
    - by the [Dio Integration](/platforms/dart/configuration/integrations/dio-integration/)
...
- [Performance Monitoring](/product/performance/) creates transactions for:
    ...
    - [Dio Integration](/platforms/dart/configuration/integrations/dio-integration/#performance-monitoring-for-http-requests)
