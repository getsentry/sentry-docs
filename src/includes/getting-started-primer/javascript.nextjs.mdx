...
<Alert level="warning" title="Based on the Next.js plugin system">

The SDK relies on the experimental plugin system of Next.js.
Changes to the plugin system may prevent the SDK from working as expected.
