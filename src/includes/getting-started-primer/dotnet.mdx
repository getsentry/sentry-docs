...
- Multiple integrations with additional features such as <PlatformLink to="/performance/instrumentation/automatic-instrumentation/#entity-framework-core-integration">EFCore</PlatformLink>, <PlatformLink to="/performance/instrumentation/automatic-instrumentation/">SQLClient</PlatformLink>, Serilog, log4net, ASP.NET Core, EntityFramework, Xamarin
