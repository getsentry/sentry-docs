...
- Multiple integrations with additional features such as <PlatformLink to="/performance-monitoring/instrumentation/automatic-instrumentation/#Entity-Framework-Core-Integration">EFCore</PlatformLink>, <PlatformLink to="/performance-monitoring/automatic-instrumentation/#SQLClient-Integration">SQLClient</PlatformLink>, Serilog, log4net, ASP.NET Core, EntityFramework, Xamarin
