...
- Multiple integrations with additional features such as [EFCore](performance/instrumentation/automatic-instrumentation/#Entity-Framework-Core-Integration), [SQLClient](performance/instrumentation/automatic-instrumentation/#SQLClient-Integration), Serilog, log4net, ASP.NET Core, EntityFramework, Xamarin
