...
- Offline caching when a device is offline; we send a report once the App. is restarted
- [Breadcrumbs automatically](/platforms/android/enriching-events/breadcrumbs/#automatic-breadcrumbs) captured for:
    ...
    - Android fragment lifecycle events via [Fragment Integration](/platforms/android/configuration/integrations/fragment/)
    - OkHttp requests via [OkHttp Integration](/platforms/android/configuration/integrations/okhttp/)
    - Apollo requests via [Apollo Integration](/platforms/android/performance/instrumentation/apollo/)
    - Timber logs via [Timber Integration](/platforms/android/configuration/integrations/timber/)
...
- [Performance Monitoring](/product/performance/) creates transactions
    ...
    - Android fragment spans via [Fragment Integration](/platforms/android/configuration/integrations/fragment/)
    - Cold and Warm App. start spans and measurements via [Automatic Instrumentation](/platforms/android/performance/instrumentation/automatic-instrumentation/#app-start-instrumentation)
    - Slow and Frozen frames measurements via [Automatic Instrumentation](/platforms/android/performance/instrumentation/automatic-instrumentation/#slow-and-frozen-frames)
    - OkHttp request spans via [OkHttp Integration](/platforms/android/configuration/integrations/okhttp/)
    - SQLite and Room query spans via [Sentry Android Gradle Plugin](/platforms/android/performance/instrumentation/automatic-instrumentation/#sqlite-and-room-instrumentation)
    - Apollo request spans via [Apollo Integration](/platforms/android/performance/instrumentation/apollo/)
    - Distributed Tracing via [OkHttp](/platforms/android/configuration/integrations/okhttp/) and [Apollo](/platforms/android/performance/instrumentation/apollo/) integrations
