...
- [Performance Monitoring](/product/performance/) creates transactions for:
    ...
    - Distributed tracing through [OkHttp](/platforms/android/configuration/integrations/okhttp/) and [Apollo](/platforms/android/performance/instrumentation/apollo/) integrations
