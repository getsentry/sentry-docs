 ...
 *
 * **Note**: This plugin should be used after `rehype-prism-plus` as it relies on the `span.code-highlight`s generated by it.
 *
...
/**
 * Check if the node is a code block with the class `code-highlight`
 * @param {Element} node
 * @return {boolean}
 */
const onlyHighlitedCodeBlocks = node =>
  node.tagName === 'code' &&
  // className is an array of strings (made sure by rehype-prism-plus)
  node.properties.className.includes('code-highlight');
