...
To enable source context, you need to upload debug symbols to Sentry. You can do that by following the [Uploading Source Code Context for Flutter Android, iOS, and macOS](https://docs.sentry.io/platforms/flutter/upload-debug/#uploading-source-code-context-for-flutter-android-ios-and-macos) guide.
