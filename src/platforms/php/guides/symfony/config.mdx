...
In addition to the <Link to="/platforms/php/config/">configuration available in the PHP SDK</Link>, there are some Symfony-specific options.
...
you can read more about those in the <Link to="/error-reporting/configuration/">Unified API configuration docs</Link>,
