...
Performance monitoring integrations related to database, caching, and template rendering are disabled by default. To enable them, please see the [Integrations documentation](/platforms/php/guides/symfony/performance/pm-integrations/).
