...
As the HTTP client tracing is based on Symfony's [TraceableHttpClient](https://github.com/symfony/symfony/blob/558fec00b0fa92dc1499434355e5a35de162bbe7/src/Symfony/Component/HttpClient/TraceableHttpClient.php) there are a few things to consider:

- To get correct span timings, do not assign the response of the request to a variable if you do not intend to use it.
