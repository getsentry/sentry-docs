...
The Laravel SDK will create [breadcrumbs](../../usage/events/enriching-events/breadcrumbs/) for certain events occurring in the framework, the capture of this information can be configured using the following environment variables:
