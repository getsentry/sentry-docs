...
=======
Starting with Laravel 5.3 we can automatically add the authenticated user id to the scope if [`send_default_pii`](configuration/options/#send-default-pii) option is set to `true` in your `config/sentry.php`.
>>>>>>> e0b53c0fc99b7d636981c28bfe8fb7a0f8bd250f
