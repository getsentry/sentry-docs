...
If you'd like to use Sentry Perfomance Monitoring, you'll need to additionally register the TracingServiceProvider in `bootstrap/app.php`:

```php {filename:bootstrap/app.php}
$app->register('Sentry\Laravel\TracingServiceProvider');
```
