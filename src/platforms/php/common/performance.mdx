...
If you are using Performance Monitoring also for [JavaScript](/platforms/javascript/#monitor-performance) you can use a helper function to continue the trace started from your backend.
