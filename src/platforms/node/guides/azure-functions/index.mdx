...
Checkout Sentry's [Azure sample apps](https://github.com/getsentry/examples/tree/master/azure-functions/node) for detailed examples. Refer to the <Link to="/platforms/javascript/">JavaScript docs</Link> for more configuration options.
