...
- You should have experience with AWS console and a basic understanding of Lambda.
- You must have an AWS account to create an [IAM user](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_create.html).
