...
Please read the <Link to="/platforms/node/sourcemaps/">Source Maps docs</Link> first to learn how to configure Sentry SDK, upload artifacts to our servers, or use Webpack (if you’re willing to use _ts-loader_ for your TypeScript compilation).
