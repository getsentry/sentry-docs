...
If you're not doing this, e.g. you're using TypeScript and upload all your compiled files separately to the server, then this may take a little more effort. Please refer to <Link to="/platforms/node/typescript/">TypeScript usage docs</Link> to see a more complex and detailed example.
