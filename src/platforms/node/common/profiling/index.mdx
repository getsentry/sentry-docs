...
If you have any questions or feedback, please email us at [profiling@sentry.io](mailto:profiling@sentry.io). If you're adopting Profiling in a high-throughput environment, we recommend testing prior to deployment to ensure that your service's performance characteristics maintain expectations.
...
You must have the `@sentry/node` (minimum version `7.44.1`) package installed.
