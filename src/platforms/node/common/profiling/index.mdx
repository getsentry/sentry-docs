...
## Enabling Profiling
In order to enable profiling, import @sentry/profiling-node and add ProfilingIntegration to your integrations. it is important that @sentry/profiling-node is imported after @sentry/tracing.
