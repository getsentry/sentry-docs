...
: The fingerprint for grouping this event. Learn more how [Sentry groups errors](/product/data-management-settings/event-grouping/).
...
To learn more about what types of data can be collected via breadcrumbs, see the [breadcrumbs client API specification](/platforms/node/usage/events/enriching-events/breadcrumbs/).
...
For more on configuring breadcrumbs, see [_Configuration_](/platforms/node/legacy-sdk/config/).
...
We have provided some instructions to creating Source Maps over at [Source Maps](/platforms/node/legacy-sdk/sourcemaps/).
