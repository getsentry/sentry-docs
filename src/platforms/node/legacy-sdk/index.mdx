...
You can optionally pass an object of configuration options as the 2nd argument to _Raven.config_. For more information, see [_Configuration_](/platforms/node/legacy-sdk/config/).
...
For more information on reporting errors, see [_Usage_](/platforms/node/legacy-sdk/usage/).
...
See [context/wrap](/platforms/node/legacy-sdk/usage/#raven-node-additional-context) for more.
...
For more information, see [Recording Breadcrumbs](/platforms/node/legacy-sdk/usage/#raven-recording-breadcrumbs).

## Dealing with Minified Source Code

Raven and Sentry support [Source Maps](https://www.html5rocks.com/en/tutorials/developertools/sourcemaps/). If you provide source maps in addition to your minified files that data becomes available in Sentry. For more information see [Source Maps](/platforms/node/legacy-sdk/sourcemaps/).

## Middleware and Integrations

If you’re using Node.js with a web server framework/library like Connect, Express, or Koa, it is recommended to configure one of Raven’s server middleware integrations. See [_Integrations_](/platforms/node/legacy-sdk/integrations/).
...
- [Configuration](/platforms/node/legacy-sdk/config/)
- [Usage](/platforms/node/legacy-sdk/usage/)
- [Integrations](/platforms/node/legacy-sdk/integrations/)
  - [Connect](/platforms/node/legacy-sdk/integrations/#connect)
  - [Express](/platforms/node/legacy-sdk/integrations/#express)
  - [Koa](/platforms/node/legacy-sdk/integrations/#koa)
  - [Loopback](/platforms/node/legacy-sdk/integrations/#loopback)
  - [Sails](/platforms/node/legacy-sdk/integrations/#sails)
- [Source Maps](/platforms/node/legacy-sdk/sourcemaps/)
- [TypeScript](/platforms/node/legacy-sdk/typescript/)
- [CoffeeScript](/platforms/node/legacy-sdk/coffeescript/)
