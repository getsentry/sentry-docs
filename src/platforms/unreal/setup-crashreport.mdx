...
The files within the crash uploaded to Sentry can be persisted using _Event Attachments_. Learn more about these in [Attachments](/platforms/common/enriching-events/attachments/).
