...
Debug symbols uploading process respects only build configurations, target types and platform for which Sentry is enabled in `Misc` section of the plugin settings.
