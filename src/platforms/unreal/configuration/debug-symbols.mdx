...
The uploading process for debug symbols only respects build configurations, target types, and platforms for which Sentry is enabled in the "Misc" section of the plugin settings.
