...
redirect_from:
  ...
  - /clients/
  - /platforms/perl/
  - /platforms/node/guides/serverless-cloud/typescript/
  - /platf
  - /clients/perl/
  - /platforms/perl/enriching-error-data/scopes/
  - /platforms/node/guides/serverless-cloud/typescript/?promo_name=promo-panel&utm_source=bestasotools&utm_var=hp-take-over
