...
- <Link to="/platforms/flutter/">_Flutter_</Link>
...
Some platforms have been phased out or have been replaced with new SDKs. For those legacy integrations head over to the <Link to="/clients/">legacy clients</Link> page.
