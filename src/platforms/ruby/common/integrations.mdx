...
For common environments and frameworks like <Link to="/platforms/ruby/guides/rails/">Rails</Link>, <Link to="/platforms/ruby/guides/rack/">Rack</Link>, and others, we provide automatic integration for reporting. Most of the time you don’t need to change anything, although you can configure those features if you want.
