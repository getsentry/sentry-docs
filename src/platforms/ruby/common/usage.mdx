...
If you use Rails, Rake, Rack etc, you’re already done - no more configuration required! Check <Link to="../integrations/">_Integrations_</Link> for more details on other gems Sentry integrates with automatically.
