...
If you use Rails, Rake, Sidekiq, etc, you’re already done - no more configuration required! Check <Link to="/platforms/ruby/integrations/">_Integrations_</Link> for more details on other gems Sentry integrates with automatically.

Rack requires a little more setup: <Link to="/platforms/ruby/guides/rack/">_Rack (Sinatra etc.)_</Link>
...
For more information, see <Link to="/platforms/ruby/context/">_Context_</Link>.
