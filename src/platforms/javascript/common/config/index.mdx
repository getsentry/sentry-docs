...
- **[Basic Options](../platforms/common/configuration/basics/)**
...
- **[Filter Events Reported to Sentry](../platforms/common/configuration/filtering/)**
...
- **[Shutdown and Draining](../platforms/common/configuration/draining/)**
