...
For these reasons, it is best practice to upload source maps to Sentry beforehand. See our docs on <PlatformLink to="/sourcemaps/uploading/hosting-publicly/">uploading source maps</PlatformLink> to learn how.
