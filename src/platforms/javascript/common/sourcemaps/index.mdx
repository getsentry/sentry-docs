...
You may configure [sentry-cli](/cli/configuration/) through it's documented mechanisms, or instead simply bind required parameters when initializing the plugin:
