...
If you have **dynamic values in your path** (for example, `https://www.site.com/{some_value}/scripts/script.js`), you may want to use the [`rewriteFrames`](/platforms/javascript/integrations/plugin/#rewriteframes) integration to change your `abs_path` values.
