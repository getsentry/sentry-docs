...
To fix this, change the `tracingOrigins` option during SDK initialization. For more details, see [Included Instrumentation](/platforms/javascript/performance/included-instrumentation/#tracingorigins) in our Performance Monitoring documentation.
