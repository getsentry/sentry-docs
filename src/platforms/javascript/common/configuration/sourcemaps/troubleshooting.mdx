...
You can alternately <Link to="/api/releases/post-organization-release-files/">use our API</Link> to upload artifacts, following the same naming convention explained here.
