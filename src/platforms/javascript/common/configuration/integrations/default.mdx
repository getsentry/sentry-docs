...
```
document.querySelector('#teststuff').addEventListener('click', () => {
    e1 = new Error('fooooo');
    e2 = new Error('bar?');
    e2.cause = e1;
...
<img width="928" alt="Screen Shot 2021-04-21 at 11 34 50 PM" src="https://user-images.githubusercontent.com/65051899/115667031-2d45b980-a2fa-11eb-8689-b6d6011a67f6.png">
