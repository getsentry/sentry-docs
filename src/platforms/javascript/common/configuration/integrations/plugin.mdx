...
This integration intercepts Fetch API and XHR requests to get the response / request information, and captures events if there is a failed request according to the user's configuration.
