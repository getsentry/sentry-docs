...
<Alert title="Integration Usage In Next.js">

Next.js can operate within three runtimes: the Node.js runtime, the browser runtime, or the Edge runtime. However, it's important to note that not all integrations are compatible with all of these runtimes.
