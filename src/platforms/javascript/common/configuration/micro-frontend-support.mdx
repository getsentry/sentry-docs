...
those specific projects. This is especially useful for those who have set up [module federation](https://module-federation.github.io/) or similar frontend architectures. 
