...
categories:
  - browser
---
On this page, we provide instructions to install Sentry's JavaScript SDK using content delivery network (CDN), automatically reporting errors and exceptions in your application.
