...
## Custom scrubbing
As of SDK version 7.53.0, `beforeAddRecordingEvent` was added that allows you to scrub and/or filter out recording events before they leave the browser. These events include console logs and network request and response data.
...
Note that we have server-side scrubbing for this data that will certain patterns such as American social security numbers, credit cards, and private keys.
