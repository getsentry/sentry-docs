...
Session Replay uses a WebWorker to perform work off the main UI thread as to not degrade performance of your application. Ensure that workers can be loaded from our CDN by adding this entry:
