...
notSupported:
  - javascript.cordova
  - javascript.wasm
description: "Learn how to enable Session Replay in your app."
redirect_from:
...
<PlatformContent includePath="session-replay/getting-started/pre-requisites" />
...
<PlatformContent includePath="session-replay/getting-started/install" />
...
<PlatformContent includePath="session-replay/getting-started/configure" />
