...
<Alert level="warning" title="Warning">
Session Replay is generally available for all Browser SDKs. Capacitor support is still in Beta. Feel free to reach <a href="https://github.com/getsentry/sentry-capacitor/issues/319">out on GitHub</a> if you experience issues.
</Alert>
</PlatformSection>
