...
Content in bodies will be PII-sanitized server-side, based on object keys and values. Refer to our [Replay Privacy section](/session-replay/privacy/#network-request-and-response-bodies-and-headers) for more details.
