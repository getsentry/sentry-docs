...
We take privacy seriously. A series of privacy oriented settings exist, you can find it in a <PlatformLink to="/session-replay/privacy/#privacy-configuration">dedicated page about Session Replay privacy</PlatformLink>.
