...
<Note>
  ...
  Refer to our [Replay Privacy section](https://docs.sentry.io/platforms/javascript/session-replay/privacy/#network-request-and-response-bodies-and-headers) for more details.
</Note>
