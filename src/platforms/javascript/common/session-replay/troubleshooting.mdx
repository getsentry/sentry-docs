...
We've identified two major potential reasons for impacted performance and have added several performance degradation safeguards as a result, starting with version x.xx of the Sentry SDK. The two culprits are websites that have a large numbers of mutations (Read the entry above to learn more.) and large console messages. 
