...
where due to websites having extremely large number of mutations happening (see above _large number of mutations_), and very large console messages. We've added improvements for these
...
It's important to update the SDK to the latest version to benefit from these improvements. In the event you encounter performance problems with Session Replay on the latest version of the SDK,
