...
excerpt: ""
description: "Learn more about system integrations `InboundFilters`, `FunctionToString`, `Breadcrumbs`, `GlobalHandlers`, `LinkedErrors`, `UserAgent` that are enabled by default to integrate into the standard library or the interpreter itself."
---
