...
<Note>
 ...
 If you're using React, read our docs about how to set up your <a class href="/platforms/javascript/guides/react/configuration/integrations/react-router/">React Router
  integration</a>.
