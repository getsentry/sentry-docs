...
If you want to understand the inner workings of the loader itself, you can read documented source code in all its glory in our [sentry-javascript repository](https://github.com/getsentry/sentry-javascript/blob/master/packages/browser/src/loader.js).
