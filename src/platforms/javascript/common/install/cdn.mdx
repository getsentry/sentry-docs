...
This is an addition to the bundles mentioned above for errors and tracing. 

</Note>

Please refer to <PlatformLink to="/session-replay/">the Session Replay documentation</PlatformLink> for more information.
