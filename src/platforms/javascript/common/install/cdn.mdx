...
Use this bundle **in addition to** one of the bundles (for errors and tracing) above:

Please refer to our <PlatformLink to="/session-replay/">Session Replay documentation</PlatformLink> to learn more.
