...
If you use `defer`, we strongly recommend that you both place the script tag for the browser SDK first and also mark all of your other scripts with `defer` (but not `async`). This will guarantee that it’s executed before any of the others.
