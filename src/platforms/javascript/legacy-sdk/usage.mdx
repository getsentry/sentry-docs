...
: [Tags](/platforms/javascript/usage/events/enriching-events/tags/) to assign to the event.
...
To learn more about what types of data can be collected via breadcrumbs, see the [breadcrumbs client API specification](/platforms/javascript/usage/events/enriching-events/breadcrumbs/).
...
For more details on this feature, see the [_User Feedback guide_](/platforms/javascript/usage/events/enriching-events/user-feedback/).
