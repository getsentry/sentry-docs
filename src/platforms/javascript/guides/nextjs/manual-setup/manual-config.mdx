...
You can create a `sentry.properties` file in the base directory of your project, as in the [configuration step](/platforms/javascript/guides/nextjs/#configure):
