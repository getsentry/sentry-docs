...
If you have chosen to automatically configure the SDK (and not changed the default configuration), sourcemaps are already being captured in build time and sent to Sentry.

If this is not your case, or want to have a custom config, you can edit the [default config](/platforms/javascript/guides/nextjs/#manual-configuration) in the `next.config.js`.
