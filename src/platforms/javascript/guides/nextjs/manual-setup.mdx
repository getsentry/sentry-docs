...
_Requires `@sentry/nextjs` SDK on version `7.81.0` or newer._
...
You can optionally pass form data, headers to record them and configure the wrapper to record the Server Action responses:
