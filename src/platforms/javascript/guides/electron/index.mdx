...
If your app uses a custom Electron fork, contains modules with native extensions or spawns subprocesses, you have to upload those symbols manually using Sentry CLI. For more information, see <Link to="/platforms/electron/">_Native Usage_</Link>.
...
The Electron SDK supports [Source Maps](http://www.html5rocks.com/en/tutorials/developertools/sourcemaps/). If you upload source maps in addition to your minified files that data becomes available in Sentry. For more information see <Link to="/platforms/electron/">_Source Maps_</Link>.
...
during your build or release process. See <Link to="/workflow/debug-files/">_Debug Information Files_</Link> for a detailed description of how to
...
To find out why Sentry needs your source maps and how to provide them visit: <Link to="/platforms/javascript/sourcemaps/">Source Maps</Link>
