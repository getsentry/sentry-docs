...
redirect_from:
  ...
  - /platforms/javascript/guides/electron/lazy-load-sentry/
...
The SDK attempts to ensure JavaScript bundlers pick up the correct entry point
for the Electron process type, but this is not foolproof. If the incorrect entry
point is selected, your bundler may throw an error or an error will be thrown at
runtime. If this occurs there are process specific exports to ensure that the correct code
is bundled for the process.
