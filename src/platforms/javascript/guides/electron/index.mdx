...
If you change the `userData` directory used by your application, ensure this change is make before you configure the SDK as this path is used to cache scope and events between application restarts.
