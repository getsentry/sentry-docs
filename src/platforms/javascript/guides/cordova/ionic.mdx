...
It is highly recommended to use Ionic with Capacitor, [_click here_](../../capacitor/ionic/) to be redirected to the new documentation of Ionic with Sentry Capacitor.
</Alert>
