...
If you need help solving issues with your Sentry Cordova integration, you can read the edge cases documented here. If you need additional help, you can [ask on GitHub](https://github.com/getsentry/sentry-cordova), and customers on a paid plan may also contact support.
