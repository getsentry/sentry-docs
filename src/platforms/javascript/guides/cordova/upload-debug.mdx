...
We do not currently support automatic source map uploads or build scripts for Android. You must upload files manually [using our CLI](/product/cli/dif/#uploading-files)."
