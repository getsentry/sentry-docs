...
**Important:** If your application is built on Angular 8 or earlier then you need to use `@sentry/browser` (maybe in [proper version](https://www.npmjs.com/package/@sentry/browser) from times of your Angular version) because of [breaking change between TypeScript 3.7 and lower versions](https://github.com/microsoft/TypeScript/issues/33939).
