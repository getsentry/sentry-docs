...
Sentry uses mixins functionality to providing an access to a Vue component during its life cycle stages.
...
To set up the Vue Tracing Integration, you will first need to configure the BrowserTracing integration itself. For details on how to do this, see [Performance](/platforms/javascript/guides/vue/performance/).
