...
- **[Manage Configuration Options](/platforms/javascript/guides/react/configuration/)**
...
- **[Enrich Event Data](/platforms/javascript/guides/react/enriching-error-data/additional-data/)**
