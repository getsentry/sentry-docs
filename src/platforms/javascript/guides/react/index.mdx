...
Upload source maps using either our [Webpack plugin](/platforms/javascript/guides/react/sourcemaps/generating#webpack) or the [Sentry CLI](/product/cli/). Sourcemaps can be generated by [Uglify JS](/platforms/javascript/guides/react/sourcemaps/generating#uglifyjs), [System JS](/platforms/javascript/guides/react/sourcemaps/generating#systemjs), or [TypeScript](/platforms/javascript/guides/react/sourcemaps/generating#typescript).
