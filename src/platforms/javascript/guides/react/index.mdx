...
Upload source maps using either our [Webpack plugin](config/sourcemaps/#webpack) or the [Sentry CLI](/cli/). Sourcemaps can be generated by [Uglify JS](config/sourcemaps/#uglifyjs), [System JS](config/sourcemaps/#systemjs), or [TypeScript](config/sourcemaps/#typescript).
