...
: If a [Sentry User Feedback Widget](../../enriching-error-data/user-feedback/) should be rendered when the Error Boundary catches an error.

`dialogOptions` (Object)

: Options that are passed into the Sentry User Feedback Widget. See all possible customization options [here](../../enriching-error-data/user-feedback/#customizing-the-widget).
