...
![React Error Boundary stacktrace](errorboundary-error.png)
...
: If a [Sentry User Feedback Widget](../../usage/events/enriching-events/user-feedback/) should be rendered when the Error Boundary catches an error.

`dialogOptions` (Object)

: Options that are passed into the Sentry User Feedback Widget. See all possible customization options [here](../../usage/events/enriching-events/user-feedback/#customizing-the-widget).
