...
If prefer to use CDN to install our SDK, please see our documentation for <Link to="/platforms/javascript/configuration/install-cdn">installing with CDN</Link>.
...
Learn more about how to manually capture errors or enable message capture with Sentry's JavaScript SDK in <Link to="/platforms/javascript/enriching-error-data/capture">Capture Errors</Link>.
...
Learn more about the data sent to with events in <Link to="/platforms/javascript/enriching-error-data/additional-data/">Enrich Event Data</Link>.
...
Learn more about what releases can do in <Link to="/product/releases/">our documentation for releases</Link>.

### Upload Source Maps

We **highly recommend** you incorporate source maps to receive the full benefit of error tracking and monitoring. See our <Link to="/platforms/javascript/configuration/sourcemaps">source maps documentation</Link> to learn more.
...
If you are using our CDN, please see our documentation for <Link to="/platforms/javascript/configuration/install-cdn">installing with CDN</Link>.
