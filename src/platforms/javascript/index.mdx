...
Learn more about how to manually capture errors or enable message capture with Sentry's JavaScript SDK in [Capture Errors](./enriching-error-data/capture).
...
Learn more about sampling in [Filtering Events Reported to Sentry](./configuration/filter).
