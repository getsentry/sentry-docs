...
Using the new library has many advantages. One of which is the lack of an additional dependency (when targeting .NET Core 3, .NET 5 and later versions) and much faster performance.
