...
description: "Learn more about enabling logging to help troubleshoot."
sidebar_order: 20
---

Sentry has its own logger to report diagnostics that may be useful when troubleshooting. To enable logging, set the `Debug` option to `true`:
