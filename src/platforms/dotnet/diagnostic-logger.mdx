...
To override this behavior, you can provide your own implementation of `IDiagnosticLogger`. Here's an example implementation that naively appends diagnostic messages to a file:
