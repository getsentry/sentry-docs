...
These events are searchable. You can set alerts for them using properties like the `http.url` and `http.status_code`. Read our [Searchable Properties](/product/sentry-basics/search/searchable-properties/) docs to learn more.
