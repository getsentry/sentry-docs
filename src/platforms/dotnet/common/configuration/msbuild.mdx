...
<PropertyGroup>
  ...
  <!--
    ...
    Note: Symbols are sent by default in Release configuration.
          However, sending *sources* is always an opt-in feature.
  -->
  <SentryUploadSources Condition="'$(Configuration)' == 'Release'">true</SentryUploadSources>

  <!--
    If you *always* want to send symbols and sources to Sentry, you can
    uncoment the lines below instead. Be aware that this will slow down your
    local dev builds.
  -->
  <!--
