...
You can have the [Sentry .NET SDK write these envelopes to a path]([url](https://github.com/getsentry/sentry-dotnet/blob/e62013ca63436d2a786fb229570e96f42c7c4044/src/Sentry/Http/HttpTransportBase.cs#L341-L363)) in order to troubleshoot why they are too large.
