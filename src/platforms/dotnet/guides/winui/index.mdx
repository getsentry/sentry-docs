...
If you are using Just-In-Time (JIT) compilation, which will be the case for most users, all you need to do is [initialize the SDK with `SentrySdk.Init`](/platforms/dotnet/) in the constructor of your application class (usually `App.xaml.cs`).
...
sealed partial class App : Application
{
    public App()
    {
        ...
        SentrySdk.Init(o =>
        {
            ...
            // Disable Sentry's build in UnhandledException handler as this won't work with AOT compilation
