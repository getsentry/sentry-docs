...
If you need help solving issues with Sentry's Xamarin SDK, you can read the edge cases documented here. If you need additional help, you can [ask on GitHub](https://github.com/getsentry/sentry-xamarin/issues/new/choose), and customers on a paid plan may also contact support.
