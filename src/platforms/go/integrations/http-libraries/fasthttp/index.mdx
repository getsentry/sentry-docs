...
This page shows how to add Sentry instrumentation to programs using the FastHTTP package. For a quick reference, there is a [complete example](https://github.com/getsentry/sentry-go/tree/master/_examples/fasthttp) available directly in the Go SDK repository. [GoDoc-style API documentation](https://godoc.org/github.com/getsentry/sentry-go/fasthttp) is also available.
