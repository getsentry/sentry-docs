...
You can see [in the Serverless section](serverless/#source-context) how to bundle the source code with the binary, which applies to other forms of deployment as well.
