...
<Note>
 ...
 If you overwrite an automatically set tag, you must use [explicit tag syntax](https://docs.sentry.io/product/reference/search/#explicit-tag-syntax/) to search for it.
