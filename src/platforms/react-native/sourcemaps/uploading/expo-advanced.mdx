...
Sentry's React Native SDK package supports Expo applications. To see readable stack traces in the product correct source maps need to be uploaded to Sentry. This guide explains how to manually upload source maps for Expo applications releases.
...
To upload source map manually the Sentry Expo Plugin and Sentry Metro plugin need to be added to the application configuration.
...
- Bundle and Source Map name can change the generated Debug ID.
...
npx sentry-cli sourcemaps upload \
  ...
  index.android.bundle index.android.bundle.packager.map
```
