...
If the context - such as breadcrumbs, user, etc. - is missing on Android NDK events, you need to enable the [Scope Synchronization](/platforms/react-native/usage/events/enriching-events/scopes/#scope-synchronization) feature.
