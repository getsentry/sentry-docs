...
- Checking that you're not disabling the [`RewriteFrames`](/platforms/javascript/integrations/rewriteframes) default integration by overwriting it, filtering it out, or setting `defaultIntegrations: false`.
