...
By adding [Sentry Android Gradle Plugin (SAGP)](/platforms/android/gradle) to `android/app/build.gradle` you can enabled native symbols upload and other features.
