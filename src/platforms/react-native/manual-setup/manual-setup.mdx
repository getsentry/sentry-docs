...
You can enable native symbol upload and other features by adding [Sentry Android Gradle Plugin (SAGP)](/platforms/android/gradle) to `android/app/build.gradle`.
