...
<Note>
To capture UI transactions, you have to first set up <Link to="/platforms/react-native/performance/instrumentation/automatic-instrumentation/#enable-routing-instrumentation">routing instrumentation</Link>.
</Note>
