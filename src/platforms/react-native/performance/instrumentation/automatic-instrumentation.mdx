...
We export the React Profiler from our React Native SDK as well, you can read more at [React Component Tracking](/platforms/javascript/guides/react/components/componenttracking/).
