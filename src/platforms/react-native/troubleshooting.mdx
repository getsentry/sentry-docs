...
In case it is missing context on Android NDK events as breadcrumbs, user, etc..., You've to enable the [Scope Synchronization](/platforms/react-native/enriching-events/scopes/#scope-synchronization) feature.
