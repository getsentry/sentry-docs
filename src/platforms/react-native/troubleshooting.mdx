...
If you are using `React Navigation 5` and you've experienced not receiving transactions anymore, it might be because of this [Bug](https://github.com/react-navigation/react-navigation/issues/9213), upgrading to `React Navigation 6` should solve the issue, if not, file an issue in our [repo](https://github.com/getsentry/sentry-react-native).
