...
If you're using React Native v0.69 or higher, the autolink has changed and we're working on a fix, follow the [issue](https://github.com/getsentry/sentry-react-native/issues/2267).
