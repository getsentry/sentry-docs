...
This issue was fixed in version [4.1.1]([url](https://github.com/getsentry/sentry-react-native/releases/tag/4.1.1)) of the SDK. Please update to this version or a later one.

For more details, [see the troubleshooting page for the iOS SDK]([url](https://docs.sentry.io/platforms/apple/guides/ios/troubleshooting/)).
