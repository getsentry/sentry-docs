...
React Native 0.60.3 tooling was enexpectively moving the sourcemaps files which caused the Sentry gradle plugin to fail. This was fixed in 0.60.4. For more detailed information follow the [issue](https://github.com/getsentry/sentry-react-native/issues/2442).
