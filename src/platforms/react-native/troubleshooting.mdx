...
- Make sure that the name of the bundle in the stack trace exactly matches with the name on the sourcemaps; i.e. if your stack frames say `app:///index.bundle`, the artifacts must be named `index.bundle` and `index.bundle.map` respectively.
