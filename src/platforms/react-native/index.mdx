...
Under the hood the SDK relies on <Link to="/platforms/javascript/">our Browser JavaScript SDK</Link>. That means that all functions available for JavaScript are also available in this SDK.
