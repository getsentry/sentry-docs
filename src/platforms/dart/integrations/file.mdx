...
sidebar_order: 5
redirect_from:
  - /platforms/dart/configuration/integrations/file/
---
...
1. Sentry [Dart](/platforms/dart/#configure) SDK must be initialized.
2. Performance Monitoring must be set up. Learn more [here](/platforms/dart/performance/).
...
### 2. View the recorded transaction on Sentry
