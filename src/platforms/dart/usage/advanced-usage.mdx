...
If you want to track automatic [Breadcrumbs for HTTP requests](https://develop.sentry.dev/sdk/event-payloads/breadcrumbs/#breadcrumb-types), you can add a Sentry wrapper that does it automatically for you.
...
Or the `SentryHttpClient` can also be used as a wrapper for your own `HTTP Client`:
