...
Open the Sentry performance dashboard, find and select the transaction you executed.

### 3. View App Start Metrics:

Select the event within your transaction, Sentry displays the app start metrics on the right side of the screen.
