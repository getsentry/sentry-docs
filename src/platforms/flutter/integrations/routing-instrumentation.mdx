...
Before diving into the configuration, it's important to understand how the Routing Instrumentation behaves:
...
Check Sentry's performance page to see the transaction `MyWidget`.
