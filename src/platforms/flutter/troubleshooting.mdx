...
- Flutter on Windows, if you are using Flutter, version below `3.3.0`, you have to set the version and build number manually, see [this issue on GitHub](https://github.com/flutter/flutter/issues/73652). To do so:
