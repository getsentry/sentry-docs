...
- Use [inbound filters](https://docs.sentry.io/product/data-management-settings/filtering/) exclude unhandled errors that are caught outside of your application in release builds. The SDK cannot filter these directly due to obfuscated stack traces.
