...
Flutter `split-debug-info` and `obfuscate` flags are supported on iOS/macOS. They require compiling your app using Flutter `3.7.0` or higher and the Sentry Flutter SDK, version `6.10.0` and above.
