...
- On Windows, you have to set the version and build number manually, see [73652](https://github.com/flutter/flutter/issues/73652). This can be done like
    - Use Dart defines to build the app: `flutter build windows --dart-define=SENTRY_RELEASE=my_app@1.0.0+1`
    - Set the release on SentryOptions `options.release = 'my_app@1.0.0+1'` during SDK initialization.
