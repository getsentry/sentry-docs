...
Breadcrumbs don't contain the `Widget`'s labels, texts, etc due to PII concerns, but in case you want to capture them, you can enable it by setting the `sendDefaultPii` option to `true`.
