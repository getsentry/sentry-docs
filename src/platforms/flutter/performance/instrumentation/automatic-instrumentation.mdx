...
Sentry's Routing Instrumentation in Flutter automatically tracks and reports page navigation events in your app. Learn more in our [Routing Instrumentation](/platforms/flutter/integrations/routing-instrumentation/).
