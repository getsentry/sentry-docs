...
Further instructions can be found [here](/platforms/android/migration/).

User identification based on the [Android ID](https://developer.android.com/reference/android/provider/Settings.Secure#ANDROID_ID),
which was the default behavior of Sentry Android 4, is now deprecated.

You can restore this behavior by using the library [device_info_plus](https://pub.dev/packages/device_info_plus) and the following code snippet:
