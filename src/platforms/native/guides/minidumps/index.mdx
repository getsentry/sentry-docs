...
open-source libraries like <Link to="/platforms/native/breakpad/">_Breakpad_</Link> or <Link to="/platforms/native/crashpad/">_Crashpad_</Link>. You can either choose to
generate and upload minidumps yourself or use a higher-level SDK for platforms
with built-in support for native crashes:

- <Link to="/platforms/native/">_Native (C/C++)_</Link>
- <Link to="/clients/cocoa/">_Cocoa_</Link>
- <Link to="/platforms/electron/">_Electron_</Link>

In order to receive symbolicated stack traces, you have to upload debug
information to Sentry. For more information, see <Link to="/workflow/debug-files/">Debug Information Files</Link>.
...
- <Link to="/platforms/native/">Native SDK</Link>
- <Link to="/platforms/native/breakpad/">Google Breakpad</Link>
- <Link to="/platforms/native/crashpad/">Google Crashpad</Link>
...
in the same request, such as log files. Learn more about these in <Link to="enriching-error-data/attachments/">Attachments</Link>.
