...
!<Link to="ue4-crash-reporter.png">The UE4 Crash Reporter</Link>
...
!<Link to="ue4-include-crash-reporter.png">Include UE4 Crash Reporter</Link>
...
!<Link to="ue4-include-debug-files.png">Include Debug Files</Link>
...
see <Link to="/workflow/debug-files/">Debug Information Files</Link>.

## Event Attachments

The files within the crash uploaded to Sentry can be persisted using _Event Attachments_. Learn more about these in <Link to="enriching-error-data/attachments/">Attachments</Link>.
...
<Alert level="" title="Early Access"><markdown>
