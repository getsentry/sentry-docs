...
For more information, see the [Tagging Events section](../enriching-events/context/#tags) in Context.
...
For code samples, see [Grouping & Fingerprints](/product/data-management/event-grouping/#use-cases).
