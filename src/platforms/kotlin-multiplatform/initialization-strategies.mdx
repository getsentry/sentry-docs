...
sidebar_order: 0
description: "Different strategies how to initialize the Kotlin Multiplatform SDK."
---
...
Inside a Kotlin file in your commonMain e.g. `AppSetup.kt` or however you want to call it and create a function that will initialize the SDK.
Afterwards you can call it in an early lifecycle stage in your platforms.
...
It is also possible to mix the two initialization strategies by creating custom sourcesets that only target specific platforms. This allows you to use a shared initializer for some platforms while utilizing platform-specific initializers for others.
