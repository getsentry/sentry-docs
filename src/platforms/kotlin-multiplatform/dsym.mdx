...
For Apple applications please follow the [official documentation](/platforms/apple/guides/ios/dsym) on how to setup uploading debug symbols.
...
In order to upload ProGuard mapping files via Gradle you will need the [Sentry Android Gradle](/platforms/android/gradle) plugin installed:
...
Alternatively you can also use the sentry cli to upload ProGuard mapping files. You can find more information in the [full sentry-cli documentation](/product/cli/dif/#proguard-mapping-upload).
