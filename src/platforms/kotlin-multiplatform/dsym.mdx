...
For Apple applications please follow the [official documentation](https://docs.sentry.io/platforms/apple/guides/ios/dsym) on how to setup uploading debug symbols.

## Android

### ProGuard/R8 & DexGuard

In order to upload ProGuard mapping files you will need the [Sentry Android Gradle](https://docs.sentry.io/platforms/android/gradle) plugin installed:
