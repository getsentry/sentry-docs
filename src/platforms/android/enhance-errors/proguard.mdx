...
If [Source Context](/product/enhance-errors/source-context) is enable, Sentry can show snippets of code (_source context_) around the location of stack frames, which helps to quickly pinpoint problematic code.
