...
`SentryBaseEvent#getOriginThrowable` has been deprecated in favor of `SentryBaseEvent#getThrowable`, `SentryBaseEvent#getThrowable` now returns returns unwrapped throwable.
