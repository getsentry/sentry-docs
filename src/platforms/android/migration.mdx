...
If you always set a custom user using `Sentry.setUser(customUser)`, the behavior has changed. While you don't have to do make any update, if you want to maintain the old behavior, use the following code snippet:
