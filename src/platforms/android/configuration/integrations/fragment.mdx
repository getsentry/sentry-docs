...
To add the Fragment integration, [manually initialize](/platforms/android/configuration/manual-config/#initialize) the Android SDK, then add the `sentry-android-fragment` dependency. Using Gradle:
