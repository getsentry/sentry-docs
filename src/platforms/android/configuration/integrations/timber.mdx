...
To add the Timber integration, [manually initialize](/platforms/android/configuration/manual-config/#manual-initialization) the Android SDK, then add the `sentry-android-timber` dependency. Using Gradle:
