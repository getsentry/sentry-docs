...
To customize or drop the error event, you need to do a [manual initialization](/platforms/android/configuration/manual-config/#initialize) of the Sentry Android SDK.
