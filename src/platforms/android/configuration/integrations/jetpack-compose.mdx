...
If you initialize the SDK [manually as mentioned here](/platforms/android/configuration/manual-config/#initialize), you can enable user interactions like this:
