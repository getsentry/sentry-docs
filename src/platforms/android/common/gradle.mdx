...
redirect_from:
  - /platforms/android/proguard/#gradle-configuration
---

The [Sentry Android Gradle Plugin](https://github.com/getsentry/sentry-android-gradle-plugin) comes as an addition to the main Android and Hybrid SDKs and offers
seamless integration with the Gradle build system. It supports uploading ProGuard/R8 mappings, uploading Native debug symbols and sources as well as tracing
auto-instrumentation through bytecode manipulation.
...
sentry {
    ...
    tracingInstrumentation {
      ...
      // See [Tracing Auto-instrumentation section](/platforms/android/gradle/#tracing-auto-instrumentation)
...
The plugin utilizes [bytecode manipulation](https://www.infoq.com/articles/Living-Matrix-Bytecode-Manipulation/) framework to inject a code snippet 
...
This way you get potentially heavy operations automatically measured without the need to manually instrument those.

The plugin supports the following features for the auto-instrumentation:
