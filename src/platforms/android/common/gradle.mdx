...
The `io.sentry.android.gradle` >= `3.0.0` requires [Android Gradle Plugin >= 7.0.0](https://developer.android.com/studio/releases/gradle-plugin#7-0-0). For an older version of the Android Gradle Plugin, consider using `io.sentry.android.gradle:2.+`.
