...
To enable this feature enable `enableAutoActivityLifecycleTracing`. The SDK differentiates between a cold and a warm start, and doesn't track hot starts/resumes.
