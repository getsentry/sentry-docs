...
The App Start Instrumentation provides insight into how long your application takes to launch. It adds a span from the application launch to the first auto-generated UI transaction. Also, the SDK sets the Span operation to `app.start.cold` or `app.start.warm`.
