...
categories:
  - mobile
redirect_from:
  - /platforms/android/configuration/jetpack-compose/
  - /platforms/android/configuration/integrations/jetpack-compose/
---
...
- Support for <PlatformLink to="/usage/events/enriching-events/viewhierarchy/">View Hierarchies</PlatformLink>
