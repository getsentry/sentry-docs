...
class MyClass {
    ...
    fun main(args: Array<String>) {
        // NOTE: Replace the test DSN below with YOUR OWN DSN
        Sentry.init { options: SentryOptions -> options.dsn = "https://f7f320d5c3a54709be7b28e0f2ca7081@sentry.io/1808954" }
    ...
    fun logWithStaticAPI() {
        ...
        // Add extra data to future events in this scope.
        Sentry.configureScope { it.setExtra("extra", "thing") }

        // Add an additional tag to future events in this scope.
        Sentry.configureScope { it.setTag("tagName", "tagValue") }
...
class MyClass {
    ...
    fun main(args: Array<String>) {
        // NOTE: Replace the test DSN below with YOUR OWN DSN
        Sentry.init { it.dsn = "https://f7f320d5c3a54709be7b28e0f2ca7081@sentry.io/1808954" }
    }
    ...
    fun logSimpleMessage() {
        ...
        event.logger = MyClass::class.java.name
        Sentry.captureEvent(event)
    }
    ...
    fun logException() {
        try {
            ...
            val event = SentryEvent()
            val message = Message()
            message.message = "Exception caught"
            event.message = message
            event.level = SentryLevel.INFO
            event.logger = MyClass::class.java.name
            event.throwable = e
    ...
    fun myMethod() {
        ...
        Sentry.configureScope { scope: Scope ->
            scope.addEventProcessor { event, hint ->
                val message = Message()
                message.message = "Overwritten by myEventBuilderHelper!"
                event.message = message
