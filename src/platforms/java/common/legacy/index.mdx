...
This section covers legacy Sentry SDK for Java (1.7.x). Legacy SDK is not under active development anymore, and we **strongly encourage** updating to the most recent Sentry SDK.
