...
Sentry OpenFeign integration provides the `SentryFeignClient`, which creates a scope for each outgoing HTTP request executed with a [Feign](https://github.com/OpenFeign/feign)-based HTTP client.
