...
Although the plugin repository name contains `android`, it can be used for non-android projects. However, for non-android projects, the plugin only collects external dependencies and uploads <PlatformLink to="/source-context/">Source Context</PlatformLink>.
...
Check out our dedicated page for <PlatformLink to="/source-context/">Source Context</PlatformLink>
