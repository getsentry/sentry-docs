...
You can configure values such as `environment` and `release`. [See the configuration page](configuration/options/) for an in-depth explanation of each property.
