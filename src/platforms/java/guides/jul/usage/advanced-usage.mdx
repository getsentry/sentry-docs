...
When any SLF4J implementation supporting MDC is on the classpath (for example Logback, Log4j2, JUL), it’s possible to add extra data to events thanks to [the MDC system](https://www.slf4j.org/api/org/slf4j/helpers/BasicMDCAdapter.html).
