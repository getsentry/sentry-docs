...
Next, **you’ll need to configure your DSN** (client key) and optionally other values such as `environment` and `release`. <Link to="config/">See the configuration page</Link> for ways you can do this.
