...
implementation 'io.sentry:sentry-spring:{{ packages.version('sentry.java', '3.0.0') }}'
```

```scala {tabTitle: SBT}
libraryDependencies += "io.sentry" % "sentry-spring" % "{{ packages.version('sentry.java', '3.0.0') }}"
```
...
// project/dashboard
@EnableSentry(dsn = "https://f7f320d5c3a54709be7b28e0f2ca7081@sentry.io/1808954")
