...
To use Sentry's Log4j2 integration in Spring Boot application, you must include a dependency to the `sentry-log4j` module:

```xml {tabTitle:Maven}
<dependency>
    <groupId>io.sentry</groupId>
    <artifactId>sentry-log4j2</artifactId>
    <version>{{ packages.version('sentry.java.log4j2', '4.2.0') }}</version>
</dependency>
