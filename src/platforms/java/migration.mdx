...
* `SentryOptions#sendClientReports` is now enabled by default. To disable it, see [sendClientReports](/platforms/java/configuration/options/#send-client-reports).
