...
Sentry has multiple options for including contextual information. They are organized into "Tags", "User", and "Extra", and Sentry's documentation on them is [here](usage/events/enriching-events/context/). Breadcrumbs are a similar concept and Sentry's documentation covers them [here](usage/events/enriching-events/breadcrumbs/).
...
- [Usage](/platforms/elixir/usage/)
- [Configuration](/platforms/elixir/configuration/)
