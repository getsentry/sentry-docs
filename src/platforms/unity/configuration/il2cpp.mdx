...
You can opt out of this feature through the editor configuration window by selecting `Tools -> Sentry -> Advanced -> IL2CPP line numbers` or [programmatically](/platforms/unity/configuration/options/#programmatic-configuration).
