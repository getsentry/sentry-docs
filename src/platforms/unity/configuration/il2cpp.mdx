...
The support for line numbers in C# Exceptions with IL2CPP relies on the [debug symbol upload](/platforms/unity/configuration/il2cpp/). With the automated debug symbol upload enabled, the [Sentry SDK will upload the line mapping automatically](/platforms/unity/native-support/#debug-symbols).
