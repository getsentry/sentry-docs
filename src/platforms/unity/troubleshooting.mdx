...
By adding the snippet below to an `Editor` directory inside your Unity project you can set up automatically disabling the Sentry SDK for any targeted platform.
