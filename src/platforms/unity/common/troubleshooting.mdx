...
The Sentry UPM package include multiple DLLs within it. One or more of those DLLs might have been already been provided by other packages. [Unity's package manager does not resolve](https://forum.unity.com/threads/dll-conflicts-in-two-upm-package.1084307/#post-7038340) those dependency conflicts which means it has to be resolved manually:
