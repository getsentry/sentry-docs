...
5. Browse the documentation to learn more about the new capabilities of the SDK such as [enriching events](/platforms/unity/usage/events/enriching-events/), [performance monitoring](/platforms/unity/performance/) and [configuration](/platforms/unity/configuration/).
