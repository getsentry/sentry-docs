...
5. Browse the documentation to learn more about the new capabilities of the SDK such as [enriching events](enriching-events/), [performance monitoring](performance/) and [configuration](configuration/).
