...
<PlatformContent includePath="crons/getting-started/requirements" />

<PlatformContent includePath="crons/getting-started/setup" />
...
<PlatformContent includePath="crons/getting-started/connect-errors" />
