...
To link any exceptions captured during your job's lifecycle, use <PlatformLink to="/usage/events/enriching-events/context/">Sentry's context</PlatformLink> with your monitor slug.
