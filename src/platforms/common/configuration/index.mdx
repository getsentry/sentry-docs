...
<ConfigKey name="server-name" notSupported={["browser"]}><markdown>
...
<ConfigKey name="deny-urls" supported={["browser"]}><markdown>
...
<ConfigKey name="allow-urls" supported={["browser"]}><markdown>
...
<ConfigKey name="integrations" notSupported={["csharp", "aspnetcore"]}><markdown>
...
<ConfigKey name="default-integrations" notSupported={["csharp", "aspnetcore"]}><markdown>
...
<ConfigKey name="transport" notSupported={["php"]}><markdown>
...
<ConfigKey name="http-proxy" notSupported={["browser"]}><markdown>
...
<ConfigKey name="https-proxy" notSupported={["browser", "csharp", "aspnetcore", "php"]}><markdown>
...
<ConfigKey name="shutdown-timeout" notSupported={["browser", "php"]}><markdown>
