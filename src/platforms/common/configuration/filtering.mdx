...
<PlatformSection supported={["javascript", "node", "python"]} notSupported={["react-native", "javascript.nextjs"]}>
...
<PlatformSection supported={["javascript", "node", "python", "PHP"]} notSupported={["react-native", "javascript.nextjs"]}>
