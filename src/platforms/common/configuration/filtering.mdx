...
<PlatformSection supported={["javascript", "node", "python"]} notSupported={["capacitor", "react-native"]}>
...
<PlatformSection supported={["javascript", "node", "python", "PHP"]} notSupported={["capacitor", "react-native"]}>
