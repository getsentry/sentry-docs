...
The Sentry SDKs have several configuration options to help you both filter out events, as documented on this page, or <PlatformLink to="/configuration/sampling/">sample</PlatformLink> them.
...
<PlatformSection supported={["javascript", "node", "python", "go", "dotnet"]}>
