...
The Crash Free rate only indicates real crashes with [native support](platforms/unity/configuration/native-support/) enabled and is otherwise marked as Abnormal. This feature is currently limited to iOS.
