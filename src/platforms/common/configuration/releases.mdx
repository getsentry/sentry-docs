...
Release health support for .NET is currently limited to single-instance _Client_ applications only. This means it can be used with WPF, Xamarin, WinForms and similar app models.
