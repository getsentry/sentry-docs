...
Sometimes you want to know if an error was received from the production system or the staging server. This is what environments are for.

Sentry automatically creates environments when it receives an event with the `environment` tag set.
