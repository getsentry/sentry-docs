...
redirect_from:
  - /platforms/ruby/configuration/integration_options/
---
...
<PlatformContent includePath="common/configuration/options/logger/" />
<PlatformContent includePath="common/configuration/options/environment/" />
<PlatformContent includePath="common/configuration/options/enabled-environments/" />
...
<PlatformContent includePath="common/configuration/options/send-modules/" />
...
<PlatformContent includePath="common/configuration/options/breadcrumbs-logger/" />
...
<PlatformContent includePath="common/configuration/options/async/" />
<PlatformContent includePath="common/configuration/options/background-worker-threads/" />

<PlatformSection supported={["javascript", "python", "node", "dart", "java", "apple", "ruby"]}>
...
For our <PlatformLink to="/integrations/rails/">Rails integration</PlatformLink>, following options are provided:

<PlatformContent includePath="common/configuration/options/rails-report_rescued_exceptions/" />
<PlatformContent includePath="common/configuration/options/rails-skippable_job_adapters/" />
<PlatformContent includePath="common/configuration/options/rails-tracing_subscribers/" />

### DelayedJob

For our <PlatformLink to="/integrations/delayed_job/">DelayedJob integration</PlatformLink>, following options are provided:

<PlatformContent includePath="common/configuration/options/delayed_job.report_after_job_retries/" />

### Sidekiq

For our <PlatformLink to="/integrations/sidekiq/">Sidekiq integration</PlatformLink>, following options are provided:

<PlatformContent includePath="common/configuration/options/sidekiq.report_after_job_retries/" />

### Rake

<PlatformContent includePath="common/configuration/options/skip-rake-integration/" />
...
<PlatformSection supported={["javascript", "java", "python", "node", "php", "dotnet", "dart", "ruby"]}>
...
<PlatformContent includePath="common/configuration/options/transport-class/" />
...
<PlatformContent includePath="common/configuration/options/trusted-proxies/" />
