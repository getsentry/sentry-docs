...
Unity builds on top of the .NET framework but enables caching by default to be in line with other Mobile SDKs. Default set to `Application.persistentDataPath`, set to `null` to disable offline caching.
