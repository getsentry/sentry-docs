...
<ConfigKey name="enableAutoPerformanceTracking" supported={["flutter"]}>

Set this boolean to `false` to disable auto [performance monitoring](/product/performance/) tracking.

</ConfigKey>

<ConfigKey name="enableAutoPerformanceTracing" supported={["react-native"]}>

<Note>
Available since version 8.0.0 of Sentry Apple SDK and 5.0.0 of Sentry React Native SDK. It was named `enableAutoPerformanceTracking` before the mentioned releases.
</Note>
...
<ConfigKey name="enableOutOfMemoryTracking" supported={["javascript.capacitor", "flutter"]}>
...
<ConfigKey name="enableWatchdogTerminationTracking" supported={["apple", "react-native"]}>

<Note>
Available since version 8.0.0 of Sentry Apple SDK and 5.0.0 of Sentry React Native SDK. It was named `enableOutOfMemoryTracking` before the mentioned releases.
</Note>
