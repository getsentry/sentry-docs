...
Please, note when <PlatformIdentifier name="before-send" /> is being executed, all scope data has already been applied to the event. Further modification of the scope won't have any effect.
