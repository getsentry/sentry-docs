...
<ConfigKey name="diagnostic-level" supported={["dotnet"]}>

For app models that don't have a console to print to, such as WinForms and ASP.NET, you can <PlatformLink to="/configuration/diagnostic-logger/">customize the SDK diagnostic logger</PlatformLink> to write to a file or to Visual Studio's debug window.
