...
<ConfigKey name="logger" supported={["php"]} notSupported={["php.symfony"]}>

If enabled, the SDK prints out useful debugging information about if something went wrong while sending the event.
It isnot recommended to turn use this in production.

<Include name="platforms/configuration/options/logger.mdx" />
