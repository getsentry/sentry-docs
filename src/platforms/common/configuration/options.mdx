...
<ConfigKey name="attach-screenshot" supported={["android"]}>
...
<ConfigKey name="attach-screenshot" supported={["iOS"]}>

Takes a screenshot of the application when an error or exception is manually captured and includes it as an attachment.
