...
In addition to automatic performance metrics, the SDK supports setting [custom performance metrics](/product/sentry-basics/metrics/) on transactions. This allows you to define metrics that are important to your application and send them to Sentry.
