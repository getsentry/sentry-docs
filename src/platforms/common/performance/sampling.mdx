...
Setting a uniform sample rate is a good option if you want an even cross-section of transactions, no matter where in your app or under what circumstances they occur, and are happy with the default trace propagation and precedence behavior described below.
...
- want to modify the default precedence and propagation behavior described below
