...
description: "Learn how to set up performance monitoring for your application."
sidebar_order: 4000
supported:
  - javascript
  - javascript.vue
...
Test out performance monitoring by starting and finishing a transaction, which you _must_ do so transactions can be sent to Sentry. Learn how in our <PlatformLink to="/performance/instrumentation/custom-instrumentation/">Custom Instrumentation</PlatformLink> content.
