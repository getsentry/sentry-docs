...
<PlatformSection supported={["javascript.nextjs", "node", "python", "ruby", "java"]} notSupported={["javascript", "dart", "flutter", "react-native", "android", "apple", "dotnet", "javascript.cordova", "javascript.lectron", "go", "unity", "rust", "native", "php", "native.breakpad", "native.crashpad", "native.minidumps", "unreal", "native.wasm"]}>
