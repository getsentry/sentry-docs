...
<PlatformSection notSupported={["javascript", "javascript.cordova", "dotnet.xamarin", "dotnet.wpf", "dotnet.winforms", "android", "react-native", "apple", "flutter", "unity", "capacitor" ]}>
