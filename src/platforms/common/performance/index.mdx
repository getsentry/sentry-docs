...
<PlatformSection notSupported={["javascript", "javascript.cordova", "php.laravel", "dart", "flutter", "android", "apple", "react-native", "javascript.capacitor", "native", "unreal", "dotnet"] supported={["dotnet.aspnet","dotnet.aspnecoret"]}}>
