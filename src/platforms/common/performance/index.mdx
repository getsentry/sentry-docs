...
If you are also using Performance Monitoring for [JavaScript](/platforms/javascript/performance/), you can connect the frontend and the backend service by enabling [Distributed Tracing](/platforms/javascript/distributed-tracing/).
