...
The Getting Started page for our SDKs already include codes samples to both enable and configure Performance Monitoring. That means that you don’t need to set up anything. You can proceed straight to our content about instrumentation for this SDK.

If you installed the SDK a while back, you need to enable and configure tracing as documented here. If you’re on a legacy plan, you'll also need to add transaction events to your [subscription](https://sentry.io/pricing/).
...
<PlatformSection supported={["javascript", "java.spring-boot"]} notSupported={["javascript"]}>
...
You can now test out tracing by starting and finishing a transaction. You can learn how to do so with <PlatformLink to="/performance/manual/">Manual Instrumentation</PlatformLink>
