...
<PlatformSection supported={["dotnet", "go", "java", "javascript.nextjs", "node", "php", "python", "ruby", "dart"]}>
<Note>
...
<PlatformSection supported={["javascript", "javascript.vue", "java.spring", "react-native"]} notSupported={["java", "go", "android", "ruby", "python", "dotnet", "dart"]}>
...
<PlatformSection supported={["react-native", "java.spring", "java.spring-boot", "android", "javascript", "apple"]} >
...
<PlatformSection supported={["dotnet", "go", "java", "android", "ruby", "apple", "dart"]} notSupported={["javascript", "react-native", "java.spring", "java.spring-boot"]}>
