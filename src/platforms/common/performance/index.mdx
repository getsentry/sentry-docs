...
<PlatformSection supported={["dotnet", "go", "java", "javascript.nextjs", "node", "php", "python", "ruby", "dart", "flutter"]}>
<Note>
...
<PlatformSection supported={["javascript", "javascript.vue", "java.spring", "react-native"]} notSupported={["java", "go", "android", "ruby", "python", "dotnet", "dart", "flutter"]}>
...
<PlatformSection supported={["react-native", "java.spring", "java.spring-boot", "android", "javascript", "apple", "dart", "flutter"]} >
...
<PlatformSection supported={["dotnet", "go", "java", "android", "ruby", "apple", "dart", "flutter"]} notSupported={["javascript", "react-native", "java.spring", "java.spring-boot"]}>
