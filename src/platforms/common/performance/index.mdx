...
<PlatformSection supported={["javascript"]}><markdown>

Once tracing is enabled, certain types of operations are measured automatically in suported SDKs. To learn more, see <PlatformLink to="/performance/capturing/automatic/">Add Automatic Instrumentation</PlatformLink>.

<PlatformSection />

You can choose to manually measure any operation. To learn more, see <PlatformLink to="/performance/capturing/manual/">Add Manual Instrumentation</PlatformLink>.
