...
<PlatformSection supported={["dotnet", "go", "java", "javascript.nextjs", "node", "php", "python", "ruby", "dart", "flutter", "rust"]}>
<Note>
...
<PlatformSection supported={["dotnet", "go", "java", "android", "ruby", "apple", "dart", "flutter", "rust"]} notSupported={["javascript", "react-native", "java.spring", "java.spring-boot"]}>
