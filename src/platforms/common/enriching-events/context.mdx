...
notSupported:
  ...
  - native.ue4
redirect_from:
  - /platforms/<platform>/enriching-error-data/additional-data/manage-context/
---
...
If you come across any usages of "extra" (<PlatformIdentifier name="setExtra" /> in code) or "Additional Data" (in the UI), just mentally substitute it for context. Extra is deprecated in favor of context within most SDKs.
