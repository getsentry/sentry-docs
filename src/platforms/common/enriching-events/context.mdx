...
The best practice to attach custom data is via structured contexts. A context must always be a dictionary, object or map (depending on the programming language you're using), and its values can be arbitrary.
