...
notSupported:
  - native(question out)
  - native.breakpad(question out)
  - native.crashpad(question out)
  - native.minidumps(likely should disable...kind of ... weird)
  - native.wasm(question out)
  - native.ue4(question out)
  - dart (question out)
  - flutter(question out)
  - ruby(question out)
---
...
Our embeddable JavaScript widget is useful for browser-based SDKs when you may typically render a plain error page (the classic `500.html`).

To collect feedback our embeddable JavaScript widget requests and collects the user's name, email address, and a description of what occurred. When feedback is provided, Sentry pairs the feedback with the original event, giving you additional insights into issues.
...
<PlatformSection supported={["java", "dotnet", "apple", "android"]} >
...
Sentry pairs the feedback with the original event, giving you additional insight into issues.
...
<PlatformContent includePath="user-feedback/http-request" />
