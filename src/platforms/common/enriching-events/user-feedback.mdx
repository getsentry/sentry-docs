...
notSupported: ["dotnet", "android", "apple", "native"]
supported: ["dotnet.aspnet", "dotnet.aspnetcore"]
---
...
If you're using a framework, such as React or Angular, we recommend collecting user feedback in your error-handling component. Examples are provided in the [React](/platforms/javascript/react/components/errorboundary/) and [Angular](/platforms/javascript/angular/) documentation. If you're not using a framework, you can collect feedback just before an event is sent using `beforeSend`:
