...
Keep in mind that `with-scope` will not capture any exceptions inside its callback function,
and any error that happen there will be silently ignored and *not* reported.
