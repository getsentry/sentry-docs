...
Deobfuscated view hierarchies are currently only available for iOS and Android SDKs. Flutter and React Native are supported, but the view hierarchy is not yet deobfuscated.
