...
Deobfuscation for view hierarchies is available for iOS and Android SDKs, as well as React Native events coming from iOS platforms. Events from React Native on Android and Flutter will not be deobfuscated at this time.
