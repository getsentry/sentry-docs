...
When a user experiences an error, Sentry provides the ability to render an ASCII representation of your view hierarchy and include it as an <PlatformLink to="/enriching-events/attachments/">attachment</PlatformLink>.
