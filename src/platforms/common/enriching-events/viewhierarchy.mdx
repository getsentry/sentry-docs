...
When a user experiences an error, Sentry provides the ability to render a JSON represention of your view hierarchy and include it as an <PlatformLink to="/enriching-events/attachments/">attachment</PlatformLink>.
