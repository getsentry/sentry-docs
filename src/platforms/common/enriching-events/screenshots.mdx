...
<PlatformSection supported={["apple.io"]}>
In iOS is not possible to take a screenshot during hard crashes, only manually captured errors or exceptions will contain a screenshot.
</PlatformSection>
