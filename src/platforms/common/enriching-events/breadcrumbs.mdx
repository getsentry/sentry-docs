...
Developers who want to modify the breadcrumbs interface can learn more in our [developer documentation devoted to the Breadcrumbs Interface](https://develop.sentry.dev/sdk/event-payloads/breadcrumbs/).
