...
<PlatformContent includePath="enriching-events/breadcrumbs-example" />
...
<PlatformContent includePath="enriching-events/automatic-breadcrumbs" />
...
<PlatformContent includePath="enriching-events/before-breadcrumb" />
