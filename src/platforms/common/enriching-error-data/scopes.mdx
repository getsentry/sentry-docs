...
event. For instance <Link to="../additional-data/">contexts</Link> or
<Link to="../breadcrumbs/">breadcrumbs</Link> are stored on
...
used to <Link to="../additional-data/">modify the context</Link>.
...
<Link to="../additional-data/">the context documentation</Link>.
