...
- <Link to="/platforms/native/">Native C/C++</Link>
- <Link to="/platforms/javascript/guides/electron/">Electron</Link>
- <Link to="/platforms/native/minidump/">Minidump endpoint</Link>

To receive symbolicated stack traces, you have to upload debug information to Sentry. Unless the option to store crash reports is enabled, Sentry will use the crash reports only to create the event, then will drop the files. For more information, see <Link to="/workflow/debug-files/">Debug Information Files</Link>.
...
Learn more about how attachments impact your <Link to="/accounts/quotas/">quota</Link>.
...
!<Link to="slide-bar-native-crashes.png">Attachments Example</Link>
...
!<Link to="attachments-access.png">Attachments Access</Link>
...
!<Link to="attachments-access-denied.png">Attachments Access Denied</Link>
...
!<Link to="attachments-list-example.png">Attachments List Example</Link>
