...
This page provides an overview of manual breadcrumb recording and customization. Learn more about the information that displays on the **Issue Details** page and how you can filter breadcrumbs to quickly resolve issues in <Link to="/product/error-monitoring/breadcrumbs">Using Breadcrumbs</Link>.
...
- <Link to="../">Return to **Getting Started**</Link>
- <Link to="./">Return to the main enriching event data page</Link>
