...
Sentry makes it possible to render a JSON representation of the view hierarchy of an error and includes it as an <PlatformLink to="/usage/events/enriching-events/attachments/">attachment</PlatformLink>.
...
<PlatformContent includePath="usage/events/enriching-events/attach-viewhierarchy" />
...
<PlatformSection supported={["android"]}>
  <PlatformContent includePath="usage/events/enriching-events/attach-viewhierarchy-example" />
</PlatformSection>
