...
When a user experiences an error, an exception or a crash, Sentry provides the ability to take a screenshot and include it as an <PlatformLink to="/usage/events/enriching-events/attachments/">attachment</PlatformLink>.
...
<PlatformContent includePath="usage/events/enriching-events/attach-screenshots" />
...
![Screenshot Thumbnail](screenshot-thumbnail.png)
...
![Screenshots List Example](screenshot-list-example.png)
