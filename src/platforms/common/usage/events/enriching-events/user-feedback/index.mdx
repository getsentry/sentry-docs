...
While this feature isn't currently supported for Ruby or most of its frameworks, it is supported for [Rails](/platforms/ruby/guides/rails/usage/events/enriching-events/user-feedback/).
...
<PlatformContent includePath="usage/events/enriching-events/user-feedback/sdk-api-example" />
...
User Feedback for **[ASP.NET](/platforms/dotnet/guides/aspnet/usage/events/enriching-events/user-feedback/#integration)** or **[ASP.NET Core](/platforms/dotnet/guides/aspnetcore/usage/events/enriching-events/user-feedback/#integration)** supply integrations specific to supporting those SDKs.
...
<PlatformContent includePath="usage/events/enriching-events/user-feedback/example-widget" />
