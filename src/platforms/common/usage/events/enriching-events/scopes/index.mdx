...
<PlatformSection supported={["python", "dotnet"]}>
<Alert>
...
<PlatformContent includePath="usage/events/enriching-events/scopes/configure-scope" />

<PlatformContent includePath="usage/events/enriching-events/unset-user">
...
<PlatformContent includePath="usage/events/enriching-events/scopes/scope-synchronization" />
...
<PlatformContent includePath="usage/events/enriching-events/scopes/with-scope" />
...
<PlatformContent includePath="usage/events/enriching-events/scopes/scope-callback-param" />
