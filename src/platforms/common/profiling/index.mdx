...
PHP profiling beta is available starting in SDK version `3.15.0`.

Laravel is supported starting in SDK version `3.3.0`.

Symfony is supported starting in SDK version `4.7.0`.
