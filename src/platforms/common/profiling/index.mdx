...
React Native Profiling alpha is available since SDK version `5.7.0`.
...
Profile samples are collected periodically and sampling frequency is fixed make sure to check whether the overhead is within the acceptable range for your use case.
We are working on symbolication of the collected profiles. Out of the box, you will see function names.

As always, and especially with Profiling in React Native being an alpha feature, feedback is welcome on [Discord](https://discord.com/channels/621778831602221064/750735628932612096) or [GitHub](https://github.com/getsentry/sentry-react-native/issues/2668).
