...
In addition to using hooks in your SDK or our [regular server-side data scrubbing features](../#server-side-controls) to redact sensitive data, Advanced Data Scrubbing is an alternative way to redact sensitive information just before it is saved in Sentry. It allows you to:
