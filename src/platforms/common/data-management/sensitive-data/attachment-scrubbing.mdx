...
We do this by providing some built-in knowledge of some file formats and provide you with custom [source-selectors](#source-selectors) which help you write scrubbing rules without damage to the file if used carefully.
