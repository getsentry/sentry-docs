...
You can use the <PlatformIdentifier name="before-send-event" /> configuration parameter to simplify removing sensitive data from your event payload.

<PlatformContent includePath="configuration/before-send-event" />
...
<PlatformSection notSupported={["elixir"]}>
