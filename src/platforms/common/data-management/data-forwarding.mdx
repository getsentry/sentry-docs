...
The payload for Amazon is identical is our standard API event payload, and will evolve over time. For more details on the format of this data, see our <Link to="/api/events/get-project-event-details/">API documentation</Link>.
...
For details on the Splunk integration, visit the dedicated <Link to="/workflow/integrations/splunk/">_Splunk integration documentation_</Link>.
