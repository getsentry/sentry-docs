...
sidebar_order: 0
redirect_from:
  - ../../../enriching-error-data/additional-data/fingerprint-override/
---

In supported SDKs, you can override the Sentry default grouping passing the `fingerprint` attribute an array of strings. This works similar to the <Link to="../server-side-fingerprinting/">server side functionality</Link> which is always available and
