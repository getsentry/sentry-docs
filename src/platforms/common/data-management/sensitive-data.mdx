...
For more details, see <Link to="/error-reporting/configuration/filtering/">_Filtering Events_</Link>.
...
- Logging PII/SD (if using breadcrumbs, include console/log statements)
  ...
  // 3. Disable logging breadcrumb integration (e.g. <https://docs.sentry.io/platforms/javascript/#breadcrumbs-1>)
  ```
...
We are currently betatesting additional features around server-side data scrubbing. For more information see <Link to="/data-management/advanced-datascrubbing/">_Advanced Data Scrubbing_</Link>.
