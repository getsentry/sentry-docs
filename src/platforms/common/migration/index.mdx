...
Migrating to `Sentry` version 3.0.0
...
[Docs PR](https://github.com/getsentry/sentry-docs/pull/2945) Change: #759
...
You can add user feedback to events via a .NET API. Please refer to the [Attachments documentation](../enriching-events/user-feedback/).
