...
## I am still using the raven client, is there an easy way to upgrade to the new SDK?

We highly recommend upgrading to the newest SDK and its latest version. If you're still using the raven client, our <PlatformLink to="/migration/">migration guide</PlatformLink> might help you with that.
