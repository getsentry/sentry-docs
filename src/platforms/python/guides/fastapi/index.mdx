...
The FastAPI integration uses the [Starlette Integration](/platforms/python/guides/starlette/) and the [ASGI Integration](/platforms/python/configuration/integrations/asgi/) internally.
