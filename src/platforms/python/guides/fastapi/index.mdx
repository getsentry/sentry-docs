...
|                                                                       | **DEFAULT** </br> Send PII:<br/>Off<sup>1)</sup>  |                         Send PII:<br/>On<sup>2)</sup>                          |
| --------------------------------------------------------------------- | :-----------------------------------------------: | :----------------------------------------------------------------------------: |
|                                                                       |                                                   |                                                                                |
...
| HTTP headers                                                          | <span style="color: #69C289;">**Not Sent**</span> | <span style="color: #D79528;">Sent <br/> Denylist applied <sup>3)</sup></span> |
| Cookies                                                               | <span style="color: #69C289;">**Not Sent**</span> | <span style="color: #D79528;">Sent <br/> Denylist applied <sup>4)</sup></span> |
| Request body                                                          | <span style="color: #69C289;">**Not Sent**</span> |                   <span style="color: #C83852;">Sent</span>                    |
...
1\) `send_default_pii` is _**not**_ set or set to `False` in `sentry_sdk.init()` call

2\) `send_default_pii` is set to `True` in `sentry_sdk.init()` call

3\) Fields with a key appearing in the [Denylist](https://github.com/getsentry/sentry-python/blob/master/sentry_sdk/integrations/_wsgi_common.py#L19-L26) are replaced with `[Filtered]`

4\) Fields with a key appearing in the Denylist are replaced with `[Filtered]` (TODO: add link to deny list.)
...
### Data Collected Measuring Performance

|                                                                       |        Send PII:<br/>Off<sup>1)</sup>         |                         Send PII:<br/>On<sup>2)</sup>                          |
| --------------------------------------------------------------------- | :-------------------------------------------: | :----------------------------------------------------------------------------: |
|                                                                       |                                               |                                                                                |
| Data sent when an <br/> unhandled error occurs                        |   <span style="color: #C83852;">Yes</span>    |                    <span style="color: #C83852;">Yes</span>                    |
| Data sent on <br/> each request                                       |   <span style="color: #C83852;">Yes</span>    |                    <span style="color: #C83852;">Yes</span>                    |
| HTTP headers                                                          | <span style="color: #69C289;">Not Sent</span> | <span style="color: #D79528;">Sent <br/> Denylist applied <sup>3)</sup></span> |
| Cookies                                                               | <span style="color: #69C289;">Not Sent</span> | <span style="color: #D79528;">Sent <br/> Denylist applied <sup>)</sup></span>  |
| Request body                                                          | <span style="color: #69C289;">Not Sent</span> |                   <span style="color: #C83852;">Sent</span>                    |
| Information about logged-in user                                      | <span style="color: #69C289;">Not Sent</span> |                   <span style="color: #C83852;">Sent</span>                    |
| Users' IP address                                                     | <span style="color: #69C289;">Not Sent</span> |                   <span style="color: #C83852;">Sent</span>                    |
| event.logentry.params                                                 |                       -                       |                                       -                                        |
