...
|                                                                       | **Default** <br/> - No performance monitoring <sup>1)</sup> <br/> - Send PII = False <sup>2)</sup> | <br/>- Performance monitoring enabled <sup>3)</sup> <br/>- Send PII = False <sup>2)</sup> | <br/>- No performance monitoring <sup>1)</sup> <br/>- Send PII = True <sup>4)</sup> | <br/>- Performance monitoring enabled <sup>3)</sup> <br/> - Send PII = True <sup>4)</sup> |
| --------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------: |
| Data sent when an <br/> unhandled error occurs                        |                                                Yes                                                 |                                            Yes                                            |                                         Yes                                         |                                            Yes                                            |
| Data sent for <br/> each request                                      |                                                 No                                                 |                                            Yes                                            |                                         No                                          |                                            Yes                                            |
| HTTP Headers                                                          |                                              Not Sent                                              |                                         Not Sent                                          |                                        Sent                                         |                                           Sent                                            |
| Cookies                                                               |                                              Not Sent                                              |                                         Not Sent                                          |                                        Sent                                         |                                           Sent                                            |
| Request Body                                                          |                                              Not Sent                                              |                                         Not Sent                                          |                                        Sent                                         |                                           Sent                                            |
| event.logentry.params                                                 |                                                 -                                                  |                                             -                                             |                                          -                                          |                                             -                                             |
| Data of logged in User                                                |                                              Not Sent                                              |                                         Not Sent                                          |                                      Not Sent                                       |                                         Not Sent                                          |
| event.breadcrumbs.values <br/> -> value.data                          |                                              Not Sent                                              |                                         Not Sent                                          |                                      Not Sent                                       |                                         Not Sent                                          |
| event.exception.values <br/> -> value.stacktrace.frames -> frame.vars |                                                 -                                                  |                                             -                                             |                                          -                                          |                                             -                                             |
| event.spans -> span.data                                              |                                              Not sent                                              |                                           Sent                                            |                                      Not sent                                       |                                           Sent                                            |
