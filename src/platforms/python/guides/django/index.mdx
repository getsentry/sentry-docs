...
If you experience memory leaks in your channels consumers while using the SDK, you need to wrap your entire application in Sentry's <Link to="/platforms/python/guides/asgi/">ASGI middleware</Link>.
...
- Logging with any logger will create breadcrumbs when the <Link to="/platforms/python/guides/logging/">Logging</Link>
...
You can use the user feedback feature with this integration. For more information see <Link to="enriching-error-data/user-feedback/">User Feedback</Link>.
