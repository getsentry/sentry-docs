...
The Django integration uses the [WSGI Integration](/platforms/python/configuration/integrations/wsgi/) and for projects with Django Channels additionally the [ASGI Integration](/platforms/python/configuration/integrations/asgi/) internally.
