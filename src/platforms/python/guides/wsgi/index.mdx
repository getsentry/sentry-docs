...
It is recommended to use an [integration for your particular WSGI framework if available](/platforms/python/), as those are easier to use and capture more useful information.
