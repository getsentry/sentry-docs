...
This integration can be set up to be used with [Google Cloud Dataproc](https://cloud.google.com/dataproc/). It is recommended that Cloud Dataproc image version 1.4 or 2.0 be used as they come with Spark 2.4 and 3.1, respectively (required by the worker integration).
