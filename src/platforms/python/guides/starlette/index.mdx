...
If you have the `starlette` package in your dependencies, the Starlette integration will be enabled automatically. There is nothing to do for you except initializing the Sentry SDK.
