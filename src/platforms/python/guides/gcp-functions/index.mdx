...
Timeout warning reports an issue when function execution time is about to expire. Update the sentry initialization to set `timeout_warning` to `true`:
...
- Issues reports automatically include:
  ...
  - You can add more context as described <Link to="context/">here</Link>
