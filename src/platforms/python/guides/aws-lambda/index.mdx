...
- Automatically report all events from your Lambda Functions. You can [modify the transaction sample rate] <PlatformLink to="/configuration/filtering/">Distributed Tracing</PlatformLink> using `traces_sample_rate`.
