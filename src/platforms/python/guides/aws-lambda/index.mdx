...
- You can control transactions sample rate using `traces_sample_rate`. You can learn more about transactions in <PlatformLink to="/configuration/filtering/">Distributed Tracing</PlatformLink>
