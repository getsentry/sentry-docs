...
If you use an ASGI framework please use our specific integrations for <a href="/platforms/python/guides/fastapi/">FastAPI</a>, <a href="/platforms/python/guides/starlette/">Starlette</a>, <a href="/platforms/python/guides/sanic/">Sanic</a>, <a href="/platforms/python/guides/quart/">Quart</a>, or <a href="/platforms/python/guides/falcon/">Falcon</a> instead of this ASGI middleware.
