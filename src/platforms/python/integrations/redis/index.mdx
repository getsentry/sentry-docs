...
The [Redis](https://redis.io/) integration hooks into the [Redis client for Python](https://pypi.org/project/redis/) and logs all Redis commands as <PlatformLink to="/usage/events/enriching-events/breadcrumbs/">breadcrumbs</PlatformLink>.
