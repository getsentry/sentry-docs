...
The [gRPC](https://grpc.io/) integration instruments incoming grpc requests and outgoing unary-unary, unary-stream grpc
...
In older versions of this integration you had to add the interceptors by hand. Since Python SDK version X.X.X you do not need to add any interceptors by hand but only add the GRPCIntegration as described above.
</Note>
...
If you use a framework (like Django, Flask, FastAPI, ...) the transaction will be created for you automatically.
