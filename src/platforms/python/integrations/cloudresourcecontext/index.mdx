...
![AWS EC2 Cloud Resource Context in Sentry event](cloudresourcecontext-aws-ec2.png)

In Google Cloud Platform GCE the context looks like this:

![Google GCE Cloud Resource Context in Sentry event](cloudresourcecontext-gcp-gce.png)
