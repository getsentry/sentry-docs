...
- [installing Sentry in Lambda Layer](/platforms/python/integrations/aws-lambda/manual-layer/),
- and [installing Sentry as a Container Image](/platforms/python/integrations/aws-lambda/container-image/).
...
Install our Python SDK using `pip` into your package directory:
...
You can set options for `AwsLambdaIntegration` to change its behavior:
