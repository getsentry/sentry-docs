...
- <Link to="/platforms/python/integrations/gcp-functions">
    Google Cloud Functions
  </Link>
- <Link to="/platforms/python/integrations/aws-lambda">
...
- You can add more context as described <PlatformLink to="/usage/events/enriching-events/context/">here</PlatformLink>.
