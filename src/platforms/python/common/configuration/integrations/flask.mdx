...
The Flask integration adds support for the [Flask framework](https://flask.palletsprojects.com/en/1.1.x/). For more information, see our [Flask integration guide](/platforms/python/guides/flask/).
