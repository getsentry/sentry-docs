...
Trigger an error in the code running in your cloud and see the error and performance data show up in Sentry.io. It takes a couple moments until the performance data shows up in Sentry.io.
