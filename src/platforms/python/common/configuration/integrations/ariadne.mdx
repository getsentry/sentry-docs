...
Enter `{ hello }` into the query field nand press the Execute query button. Your
web app will be queried and it will encounter the `ZeroDivisionError` error we've
...
It takes a couple of moments for the data to appear in [Sentry](https://sentry.io).
