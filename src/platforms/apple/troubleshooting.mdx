...
## My app is not symbolicated

If your stacktrace is is not symbolicated and you are using App Store Connect as a repository for your symbols, try manually uploading the symbols by following the [documentation](/platforms/apple/dsym/).

We are currently investigating why Apple does not provide debug symbols for some apps.
