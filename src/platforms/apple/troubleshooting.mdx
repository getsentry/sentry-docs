...
If you opt-in for screenshots for crash, we recommend to update to at least [7.25.0](https://github.com/getsentry/sentry-cocoa/releases/tag/7.5.3). Since the introduction of screenshots for crash in the version 7.20.0, projects that enabled 'enableCaptureScreenshot' had their crash reports duplicated.