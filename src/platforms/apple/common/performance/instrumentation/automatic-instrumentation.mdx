...
User interaction tracing, once enabled, captures transactions for clicks (this do not work with SwiftUI). Since 8.0.0, this feature has been enabled by default. To disable it:
