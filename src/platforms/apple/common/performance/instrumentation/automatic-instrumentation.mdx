...
The Sentry SDK adds spans for file I/O operations to ongoing transactions bound to the Scope. Currently, the SDK supports operations with [NSData][NSData], but many other APIs like [NSFileManager][NSFileManager] use [NSData][NSData].
