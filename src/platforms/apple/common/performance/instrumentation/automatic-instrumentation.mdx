...
We recommend updating to at least [7.18.1](https://github.com/getsentry/sentry-cocoa/releases/tag/7.11.0), because the SDK might report a too high percentage of slow frames.
