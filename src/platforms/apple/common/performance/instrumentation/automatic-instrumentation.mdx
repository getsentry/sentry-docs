...
We recommend updating to at least [7.18.1](https://github.com/getsentry/sentry-cocoa/releases/tag/7.11.0), or else the SDK might report too high a percentage of slow frames.
