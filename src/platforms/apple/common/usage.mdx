...
- We strongly recommend you to not use versions 6.0.2 to 6.0.8. With [#786](https://github.com/getsentry/sentry-cocoa/pull/786) released in 6.0.2, we introduced a severe bug,
that could lead to wrong stacktraces and error messages. We fixed this in 6.0.9.
