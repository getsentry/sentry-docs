...
This is helpful in cases where you completely want to control what should be attached to the event.
...
- If you're currently using a version between 6.0.2 and 6.0.8 we strongly recommend you to upgrade it to the latest. In those versions the [SDK had a regression](https://github.com/getsentry/sentry-cocoa/pull/786) that affected the quality of the stacktraces and error messages. We fixed this in 6.0.9.
