...
The SDK checks the following statements when the user launches the app and reports an OOM if all of them are true:
...
* There was no debugger attached to the process of the app. Our logic would falsely report OOMs whenever you restart the app in development.
* The OS did not update your app.
* The user didn't update the OS of his device.
