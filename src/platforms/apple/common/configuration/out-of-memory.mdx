...
<Note>
This integration is only available before 8.0.0. We renamed it to <PlatformLink to="/configuration/watchdog-terminations/">watchdog terminations</PlatformLink> in the 8.0.0 release.
</Note>
