...
<Note>
  This integration is available since version 8.0.0 of Sentry Apple SDK. It was named{' '}
  <PlatformLink to="/configuration/out-of-memory/">Out of Memory</PlatformLink> before the
  8.0.0 release.
</Note>
