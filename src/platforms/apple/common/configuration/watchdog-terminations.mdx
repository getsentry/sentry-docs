...
- There was no debugger attached to the process of the app. If there was, our logic would otherwise falsely report watchdog terminations whenever you restarted the app in development.
