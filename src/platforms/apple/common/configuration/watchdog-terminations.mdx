...
- The user launched the app at least once. When your app watch killed by the watchdog during the first launch, the SDK can't detect it.
...
[SentrySDK startWithConfigureOptions:^(SentryOptions *options) {
    options.dsn = @"___PUBLIC_DSN___";
    options.enableWatchdogTerminationsTracking = NO;
}];
```
