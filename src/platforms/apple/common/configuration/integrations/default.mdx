...
description: "Learn more about SentryCrashIntegration, SentryAutoBreadcrumbTrackingIntegration, and SentryOutOfMemoryTrackingIntegration that are enabled by default."
---
...
This integration tracks out-of-memory crashes based on heuristics. This feature is available for iOS, tvOS, and Mac Catalyst and works only if the application was in the foreground. Checkout the <PlatformLink to="/configuration/out-of-memory/">configuration</PlatformLink> for more details.
