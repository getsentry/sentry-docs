...
description: "Learn more about the SentryCrashIntegration, SentryAutoBreadcrumbTrackingIntegration, and SentryOutOfMemoryTrackingIntegration, which are enabled by default."
---
