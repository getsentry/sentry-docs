...
Our Carthage setup generates 3 different frameworks: - Sentry - SentryPrivate - SentrySwiftUI

You only need to add _SentryPrivate_ to your project if you changed carthage build process to generate static frameworks. Otherwise, you can ignore it.
You add _SentrySwiftUI_ to your project if you want to measure performance of your SwiftUI views.
