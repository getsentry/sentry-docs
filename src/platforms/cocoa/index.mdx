...
Our SDK hooks into all signal and exception handlers, except for MacOS. If you are using MacOS, please see the additional step provided in <Link to="/platforms/cocoa/usage/">Advanced Usage</Link>
...
Monitor the <Link to="/workflow/releases/health/">health of releases</Link> by observing user adoption, usage of the application, percentage of [crashes](/workflow/releases/health/#crash), and [session data](/workflow/releases/health/#session). Release health will provide insight into the impact of crashes and bugs as it relates to user experience, and reveal trends with each new issue through the release details, graphs, and filters.
...
For more details, see the <Link to="/workflow/releases/health/">full documentation on Release Health</Link>.

## Deep Dive

- <Link to="/platforms/cocoa/dsym/">Uploading Debug Symbols</Link>
  - [With Bitcode](/platforms/cocoa/dsym/#with-bitcode)
  - [Without Bitcode](/platforms/cocoa/dsym/#without-bitcode)
- <Link to="/platforms/cocoa/usage/">Advanced Usage</Link>
