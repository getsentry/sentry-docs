...
See the <PlatformLink to="/performance/instrumentation/custom-instrumentation/">Performance Monitoring Documentation</PlatformLink> to learn what you can do with transactions.
