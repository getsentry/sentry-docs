...
If you're using none of the above, you can generate this tracing information with the Sentry SDK's `getTraceparent()` and `getTaggage()` functions. Here's an example:
