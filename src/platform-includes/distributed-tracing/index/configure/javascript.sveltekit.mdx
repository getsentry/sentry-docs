...
If you're using version `7.57.x` or below, you'll need to have our <PlatformLink to="/performance/">performance monitoring</PlatformLink> feature enabled for distributed tracing to work.
