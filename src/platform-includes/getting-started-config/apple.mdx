...
## Have your Swift concurrency stack traces stitched together

> This feature is experimental and may have bugs.

If you are using Swift concurrency, you can have your stack traces stitched together. This means that you can see the full stack trace of your async code.
For this to happen you need to enable the `swiftAsyncStacktraces` option.
You can also enable this in your objc project, however, only async code written in Swift will be stitched together.
