...
To find more information about the _legacy_ method of uploading source maps, please see the <PlatformLink to="/sourcemaps/troubleshooting_js/uploading-without-debug-ids">guide to upload source maps without debug IDs</PlatformLink>.

If you are newly setting up source maps, please continue below.
