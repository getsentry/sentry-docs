...
If you previously set up source maps, we recommend upgrading your tooling (SDK, bundler plugins, Sentry CLI).

The process of how uploading source maps to Sentry has changed a lot and upgrading to the newest versions and using the current process is usually easier than to troubleshoot the legacy method.
