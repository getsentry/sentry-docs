...
With Artifact bundles being recently released, visit <PlatformLink to="/sourcemaps/artifact-and-release-bundles">this page</PlatformLink> to understand the difference between **Artifact** and **Release bundles**, and the implications of using them.
