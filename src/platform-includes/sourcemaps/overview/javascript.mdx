...
- <PlatformLink to="/sourcemaps/uploading/typescript/">
  ...
  <Note>If you're using one of Webpack, Vite, Rollup or Esbuild, use the corresponding Sentry plugin instead (see section "Sentry Plugin Support").</Note>
