...
If you used Create React App to set up your React application see our [Create React App](/platforms/javascript/guides/react/sourcemaps/uploading) guide to upload source maps.
...
- <PlatformLink to="/sourcemaps/uploading/create-react-app/">
    Create React App
  </PlatformLink>
