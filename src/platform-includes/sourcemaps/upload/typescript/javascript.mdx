In this guide, you'll learn how to successfully upload source maps using our `sentry-cli` tool. This guide is only applicable if you're using `tsc` to compile your project. If you use another tool (such as Webpack) in combination with TypeScript, you'll most likely want to follow [this](/platforms/javascript/uploading/webpack/) guide instead.
