...
If you're using TypeScript (that is, `tsc`) to compile your project, you should configure typescript to generate source maps and use Sentry CLI to create the release and upload source maps.
