Sentry uses [releases](/product/releases/) to match the correct source maps to your events. You can use the Sentry Rollup plugin to automatically create releases and upload source maps to Sentry when bundling your app.
