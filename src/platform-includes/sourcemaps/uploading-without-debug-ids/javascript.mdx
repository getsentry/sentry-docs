...
You can still upload source maps regardless of what version of our SDK or bundler plugin (or sentry-cli) your application depends on. Visit the regular <PlatformLink to="/sourcemaps/troubleshooting_js">Source Maps</PlatformLink> guide if you experience any problems following this guide.
