...
- Bundler Plugins
	...
	- rollup: `>=` `0.7.2`
	- vite: `>=` `0.7.2`
	- webpack: **Currently doesn't support Debug IDs**
    sentry-cli: `>=` `2.17.0`
...
Visit [Artifact vs. Release Bundles](/platforms/javascript/sourcemaps/artifact-and-release-bundles/) for more information on Artifact Bundles and Debug IDs.
