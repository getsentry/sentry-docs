...
| Pros                                                                                    | Cons                                                                                                                                                           |
| :-------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| With Debug IDs, configuring your build pipeline to upload artifacts is straightforward. | **Requires a version update to Javascript SDKs, bundler plugin ( or `sentry-cli`).**                                                                           |
