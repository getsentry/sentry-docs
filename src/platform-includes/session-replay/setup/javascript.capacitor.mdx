Several options are supported and passable using the integration constructor. See the [configuration documentation](/javascript/guides/capacitor/session-replay/configuration/) for more details. To set up the integration, add the following to your Sentry initialization:
