...
If you want to uninstall the SDK, you can run the following commands:
...
After that, you can remove the `ios/sentry.properties` and `android/sentry.properties` files. At last, you need to remove all the code using `@sentry/react-native` from your project.
