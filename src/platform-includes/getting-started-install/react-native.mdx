...
If you wish to install Sentry's React Native SDK v4, read the steps [here](/platforms/react-native/troubleshooting#set-up-skd-v4-with-react-native-069-or-higher).
