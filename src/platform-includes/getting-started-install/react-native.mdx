...
For React Native 0.68 and older, you'll have to `confirm` to use wizard on unsupported React Native version and manually patch the Xcode project later. Read more on the [Manual Configuration](/platforms/react-native/manual-setup/manual-setup/) page.
