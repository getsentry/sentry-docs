...
To track automatic Breadcrumbs for `HTTP` requests, check out the [SentryHttpClient](/platforms/dart/usage/events/enriching-events/breadcrumbs/#automatic-breadcrumbs) Wrapper for the [http](https://pub.dev/packages/http) library.
