There are different ways to <PlatformLink to="/install/">install Sentry's JavaScript SDK</PlatformLink>, but the following is our recommended way of doing it. Add the following code to the top of your application, before all other scripts:
