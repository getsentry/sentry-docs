...
Instead of [creating and configuring](https://sentry.io/crons/create/) your Monitor upfront,
you can programmatically create and update your Monitors directly in code.
...
Supported units are `MonitorScheduleUnit::minute()`, `MonitorScheduleUnit::hour()`, `MonitorScheduleUnit::day()`,
`MonitorScheduleUnit::week()`, `MonitorScheduleUnit::month()` and `MonitorScheduleUnit::year()`.
