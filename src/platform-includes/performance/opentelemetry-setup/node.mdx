...
<Note>
  If you are using the <a href="https://www.npmjs.com/package/@sentry/opentelemetry-node" target="_blank" rel="noopener">@sentry/opentelemetry-node</a> package, you can continue to do so and find usage instructions in the package's README. This package has a slightly easier setup process, but provides a more limited connection between Sentry and OpenTelemetry than the instructions outlined above.
</Note>