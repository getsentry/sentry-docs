...
Sentry's Android SDK, version x.x and above, reports [ANR rate](platforms/android/configuration/app-not-respond/) errors if the main UI thread of your application is blocked for more than five seconds. 
