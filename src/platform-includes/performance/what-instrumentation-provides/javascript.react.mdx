...
If you are using `react-router` in your application, you need to use our [`react-router` instrumentation](/platforms/javascript/guides/react/integrations/react-router/) to be able to trace `navigation` events.
