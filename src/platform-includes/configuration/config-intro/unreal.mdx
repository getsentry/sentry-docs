...
Not all options can be used on all platforms. Such options have corresponding notices displayed in the UE editor explicitly specifying platforms on which they can take effect.
