...
- Events [enriched](/platforms/javascript/usage/events/enriching-events/context/) with device data
- [Breadcrumbs](/platforms/javascript/usage/events/enriching-events/breadcrumbs/) created for outgoing HTTP request with XHR and Fetch, and console logs
