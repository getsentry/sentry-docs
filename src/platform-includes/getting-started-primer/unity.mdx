...
- Supports C# errors on multiple platforoms, including: Android, iOS, macOS, Linux, Windows, and WebGL
...
- [Performance Monitoring](/product/performance/) creates transactions and spans for:
