...
- [Screenshot attachments](/platforms/unity/usage/events/enriching-events/screenshots/) for errors
...
- [Breadcrumbs automatically](/platforms/unity/usage/events/enriching-events/breadcrumbs/#automatic-breadcrumbs) captured for
