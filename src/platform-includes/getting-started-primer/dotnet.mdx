...
- <PlatformLink to="/usage/events/enriching-events/breadcrumbs/#automatic-breadcrumbs">
...
- <PlatformLink to="/usage/events/enriching-events/attachments/">
    Attachments
  </PlatformLink> enrich your event by storing additional files, such as config or
  log files
- <PlatformLink to="/usage/events/enriching-events/user-feedback/">
    User Feedback
...
- Events <PlatformLink to="/usage/events/enriching-events/context/">enriched</PlatformLink> with device data
