...
We just released a new <PlatformLink to="/integrations/logcat">Logcat integration</PlatformLink>, which automatically creates breadcrumbs for your `android.util.Log.*` calls.

Using Jetpack Compose? Measure composition and rendering time of your `@Composable` functions using our <PlatformLink to="/integrations/jetpack-compose#performance-metrics">performance metrics for Jetpack Compose</PlatformLink>.
