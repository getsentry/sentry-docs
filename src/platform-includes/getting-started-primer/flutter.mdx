...
- Breadcrumbs automatically captured:
  ...
  - via the Native SDKs [Automatic Breadcrumbs for Android](/platforms/android/usage/events/enriching-events/breadcrumbs/#automatic-breadcrumbs) and [Automatic Breadcrumbs for iOS](/platforms/apple/integrations/default/#sentryautobreadcrumbtrackingintegration)
...
- [Performance Monitoring](/product/performance/) creates transactions for:
  ...
  - [sqflite Database Instrumentation](/platforms/flutter/integrations/sqflite-instrumentation/)
