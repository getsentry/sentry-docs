...
- Events [enriched](/platforms/flutter/usage/events/enriching-events/context/) with device data
...
- Breadcrumbs automatically captured:
  - by the [Dart SDK](/platforms/dart/usage/events/enriching-events/breadcrumbs/#automatic-breadcrumbs)
  - by the [Flutter SDK](/platforms/flutter/usage/events/enriching-events/breadcrumbs/#automatic-breadcrumbs)
  - via the Native SDKs [Automatic Breadcrumbs for Android](/platforms/android/usage/events/enriching-events/breadcrumbs/#automatic-breadcrumbs) and [Automatic Breadcrumbs for iOS](/platforms/apple/configuration/integrations/default/#sentryautobreadcrumbtrackingintegration)
...
- [Attachments](/platforms/flutter/usage/events/enriching-events/attachments/) enrich your event by storing additional files, such as config or log files.
- [User Feedback](/platforms/flutter/usage/events/enriching-events/user-feedback/) provides the ability to collect user information when an event occurs.
...
- [Screenshot attachments for errors](/platforms/flutter/usage/events/enriching-events/screenshots/)
- [View Hierarchy attachments for errors](/platforms/flutter/usage/events/enriching-events/viewhierarchy/)
