...
- [Breadcrumbs automatically](/platforms/apple/usage/events/enriching-events/breadcrumbs/#automatic-breadcrumbs) captured for
  ...
  <!-- When adding an auto breadcrumb item here please also update /platform-includes/usage/events/enriching-events/breadcrumbs/automatic-breadcrumbs/apple.mdx -->
