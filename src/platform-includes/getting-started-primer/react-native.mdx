...
- [Performance Monitoring](/product/performance/) creates transactions automatically for:
  - [Routing Instrumentation](/platforms/react-native/performance/instrumentation/automatic-instrumentation/#enable-routing-instrumentation) (React Navigation v4 and above and React Navigation)
