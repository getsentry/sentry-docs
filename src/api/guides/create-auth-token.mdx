...
![Sentry.io UX walkthrough of creating an internal integration.](create-internal-integration.gif)
...
![Sentry.io UX walkthrough of creating a token and setting it's permissions.](set-token-permissions.gif)
