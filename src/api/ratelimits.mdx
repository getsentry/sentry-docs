...
Polling the API for updates is a quick way to get rate limited, instead leverage our [webhooks](/product/integrations/integration-platform/webhooks/) if possible.
