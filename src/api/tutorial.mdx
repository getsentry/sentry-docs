...
This guide walks you through the basics of authenticating with Sentry's API and using the API with cURL to list the teams in an organization and create a new team.
...
1. Paste the following cURL command into your terminal:
    ...
    ```bash
    curl https://sentry.io/api/0/organizations/$SENTRY_ORG_ID/teams/ \
        -H 'Authorization: Bearer '$SENTRY_AUTH_TOKEN
    ```

1. Here's an example of what the output of the command should be, for an organization called "test" with one project named "test-project":
    ...
    This output gives you information about both the organization and the projects in that organization.
