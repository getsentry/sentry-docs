...
If you don't have an authentication token, follow the [Create a Sentry Authentication Token](/api/tutorials/create-auth-token) tutorial to create an organization auth token with the following permissions, or higher:
