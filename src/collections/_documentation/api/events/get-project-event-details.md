...
GET /api/0/projects/_{organization_slug}_/_{project_slug}_/events/_{event_id}_/

: Return details on an individual event.

  <table class="table"><tbody valign="top"><tr><th>Path Parameters:</th><td><ul><li><strong>organization_slug</strong> (<em>string</em>) – the slug of the organization the event belongs to.</li><li><strong>project_slug</strong> (<em>string</em>) – the slug of the project the event belongs to.</li><li><strong>event_id</strong> (<em>string</em>) – the hexadecimal ID of the event to retrieve (as reported by the raven client).</li></ul></td></tr><tr><th>Authentication:</th><td>required</td></tr><tr><th>Method:</th><td>GET</td></tr><tr><th>Path:</th><td>/api/0/projects/<em>{organization_slug}</em>/<em>{project_slug}</em>/events/<em>{event_id}</em>/</td></tr></tbody></table>
