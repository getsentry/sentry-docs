...
GET /api/0/issues/_{issue_id}_/events/latest/

: Retrieves the details of the latest event for an issue.

  <table class="table"><tbody valign="top"><tr><th>Path Parameters:</th><td><strong>group_id</strong> (<em>string</em>) – the ID of the issue</td></tr><tr><th>Method:</th><td>GET</td></tr><tr><th>Path:</th><td>/api/0/issues/<em>{issue_id}</em>/events/latest/</td></tr></tbody></table>
