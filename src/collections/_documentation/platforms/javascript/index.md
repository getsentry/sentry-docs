...
Keep in mind, that browsers are taking some security measures when serving script files from different origins. In order for errors to always make their way to Sentry, make sure that you configure CORS headers and add appropriate script attribute. For more information, refer to our [What the heck is "Script error"?](https://blog.sentry.io/2016/05/17/what-is-script-error#the-fix-cors-attributes-and-headers) blog post.
