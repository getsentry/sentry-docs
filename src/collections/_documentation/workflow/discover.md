...
This version of Discover will deprecate at the end of February 2020. For our new query builder, see the [full Discover v2 documentation]({%- link _documentation/performance/discover2/index.md -%}).
{%- endcapture -%}
