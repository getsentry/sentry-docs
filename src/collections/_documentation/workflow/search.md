...
[{% asset search-pinning-step-two.png %}]({% asset search-pinning-step-two.png @path %})
...
[{% asset search-pinning-step-three.png %}]({% asset search-pinning-step-three.png @path %})
...
[{% asset search-add-org-filter-step-one.png %}]({% asset search-add-org-filter-step-one.png @path %})

2: Name the search in the resulting modal and click 'Save.'

[{% asset search-add-org-filter-step-two.png %}]({% asset search-add-org-filter-step-two.png @path %})
...
[{% asset search-delete-org-wide-filter.png %}]({% asset search-delete-org-wide-filter.png @path %})
