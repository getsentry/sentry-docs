...
[{% asset user-settings/us-pass.png alt="Password field in Security under User Settings" width="450" %}]({% asset user-settings/us-pass.png @path %})
...
[{% asset user-settings/us-2fact.png alt="Two-Factor Authentication selection in Securty under User Settings" width="745" %}]({% asset user-settings/us-2fact.png @path %})
...
[{% asset user-settings/us-alert.png alt="Alerts field in Notifications under User Settings" width="450" %}]({% asset user-settings/us-alert.png @path %})
...
[{% asset user-settings/us-eroute.png alt="Email Routing field in Notifications under User Settings" width="450" %}]({% asset user-settings/us-eroute.png @path %})

## Weekly Reports

Reports are generated per project and sent once a week.  

[{% asset user-settings/us-wrfield.png alt="Weekly Reports field in Notifications under User Settings" width="450" %}]({% asset user-settings/us-wrfield.png @path %})
...
[{% asset user-settings/us-ereport.png alt="Weekly Report email sample" width="745" %}]({% asset user-settings/us-ereport.png @path %})
...
[{% asset user-settings/us-deploy.png alt="Deploy Notifications selection in Notifications under User Settings" width="673" %}]({% asset user-settings/us-deploy.png @path %})
