...
[{% asset user-settings/us-close.png alt="Close Account button in Close Account section under User Settings" width="709" %}]({% asset user-settings/us-close.png @path %})
...
[{% asset user-settings/us-apps.png alt="Create New Application button in the Applications section under User Settings" width="378" %}]({% asset user-settings/us-apps.png @path %})
