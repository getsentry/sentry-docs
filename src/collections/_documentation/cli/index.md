...
-   [Release Management]({%- link _documentation/cli/releases/index.md -%})
    -   [Creating Releases]({%- link _documentation/cli/releases/index.md -%}#creating-releases)
    -   [Finalizing Releases]({%- link _documentation/cli/releases/index.md -%}#finalizing-releases)
    -   [Commit Integration]({%- link _documentation/cli/releases/index.md -%}#commit-integration)
    -   [Managing Release Artifacts]({%- link _documentation/cli/releases/index.md -%}#managing-release-artifacts)
    -   [Creating Deploys]({%- link _documentation/cli/releases/index.md -%}#creating-deploys)
