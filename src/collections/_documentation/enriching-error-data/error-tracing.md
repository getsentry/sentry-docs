...
If you also need several example cases to supplement a unique request ID, you can use Sentry's [Discover]({%- link _documentation/performance/discover2/index.md -%}) functionality to search for all request ids you've seen on a specific URL.
