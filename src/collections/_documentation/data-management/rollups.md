...
If everything else fails, grouping falls back to messages. With this, the grouping only uses the message without the parameters. But if that is not available, it uses the message attribute.
