...
Now that you've specified the release in your SDK config, head on over to [our main source maps docs]({%- link _documentation/platforms/javascript/sourcemaps.md -%}#sourcemaps) to learn how to [create your source maps]({%- link _documentation/platforms/javascript/sourcemaps.md -%}#sourcemaps) and [make them available to Sentry]({%- link _documentation/platforms/javascript/sourcemaps.md -%}#sourcemaps). There you'll also find a [troubleshooting guide]({%- link _documentation/platforms/javascript/sourcemaps.md -%}#sourcemaps).
