      ...
      <div className="max-w-3xl mx-auto px-4 pb-4 sm:px-6 lg:px-8">
        ...
        {displayPosts.map(frontMatter => {
          ...
          return (
            <article
              key={slug}
              className="bg-white rounded-lg shadow-lg mb-8 fancy-border"
            >
              {image && (
                <div className="relative w-full h-64">
                  <Image
                    className="object-fill rounded-lg rounded-b-none"
                    src={image}
                    fill={true}
              ...
              <div className="p-6">
                ...
                <div>
                  ...
                  <div className="prose max-w-none text-gray-700 py-2">{summary}</div>
                  <dl>
