          ...
          <div className="absolute right-0 mt-1 w-72 bg-black rounded-md shadow-lg z-10 border border-gray-700">
                ...
                >
                  <div>
                    ...
                    <div className="text-sm text-gray-400">Copy the raw Markdown content to clipboard</div>
                  </div>
                </button>
                ...
                >
                  <div>
                    ...
                    <div className="text-sm text-gray-400">Open the Markdown file in a new tab</div>
                  </div>
                </button>
