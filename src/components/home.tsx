    ...
    <div className="tw-app">
        ...
        <div className="flex flex-col md:flex-row gap-4 mx-auto pt-20">
          <div className="flex flex-col justify-center mx-auto text-center">
            ...
            <p className="max-w-[55ch] text-[18px] mx-auto">
              Sentry enables developers to monitor errors, collect traces and spans, and view replays across your entire application platform so you can fix issues faster, and get back to building.
            </p>
            <div className="w-full md:max-w-[calc(100%-2rem)] lg:max-w-[900px] mx-auto my-4">
      ...
      <footer className="mt-12 pb-10 w-full z-50 max-w-7xl mx-auto md:px-6 space-y-4 px-6 lg:px-8">
        ...
        <p className="px-3 text-sm">
          &copy; {new Date().getFullYear()} • Sentry is a registered trademark of Functional
          Software, Inc.
        </p>
