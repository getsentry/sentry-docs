          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-[var(--gray-11)] dark:text-white leading-relaxed">
                ...
                Use{' '}
                <a href="/product/ai-in-sentry/seer/ai-code-review/" className="text-[#8b5cf6] underline">code review</a>
                {' '}to review PRs and prevent errors, and{' '}
                <a href="/product/ai-in-sentry/seer/root-cause-analysis/" className="text-[#8b5cf6] underline">Issue Autofix</a> 
                {' '}to run automated root cause analysis and fix issues.
              </p>
            </div>
          </div>
