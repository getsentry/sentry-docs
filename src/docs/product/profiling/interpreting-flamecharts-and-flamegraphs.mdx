...
![Flamechart example](flamechart.png)
...
![Flamechart weights](flamechart-weights.png)
...
<img src="flamechart-chronological.png" width="45%"/>
<img src="flamechart-merged.png" width="45%"/>
...
![Flamegraph example](flamegraph.png)
...
![Profiling issue](profiling-issue.png)
...
![JSON decoding problem](json-decoding.png)
...
![JSON decoding profile](json-decoding-profile.png)
...
<video width="100%" height="auto" controls={true} autoplay muted>
  <source src="missing-instrumentation.mp4" type="video/mp4"/>
</video>
...
<video width="100%" height="auto" controls={true} autoplay muted>
  <source src="missing-preview.mp4" type="video/mp4"/>
</video>
...
![Hair chart](flamechart-hair.png)
![Hair chart](flamechart-hair-merged.png)
...
![Span waterfall view](spans-waterfall.png)
![Span condensed view](spans-condensed.png)
...
<video width="100%" height="auto" controls={true} autoplay muted>
  <source src="tree-drawer.mp4" type="video/mp4"/>
</video>
