...
![profiling-information-span](profiling-information-span.png)

From this view, you can click “View Profile” to zoom in on the flame chart.

![profiling-summary-view](profiling-summary-view.png)
...
![profiling-page-view](profiling-page-view.png)


To zoom in further, select from the list of “Slowest App Functions” and see the associated flame chart for the profile.

Selecting one of the transactions will take you to the “Transaction Profile” summary page below.  On this page, you can examine the consolidated flame graph that presents aggregated sample data for the selected transaction.

![transaction-profile-view](transaction-profile-view.png)
