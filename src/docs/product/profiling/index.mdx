...
- [Android (Java and Kotlin only)](https://docs.sentry.io/platforms/android/profiling/)
- [iOS (Swift and Objective-C only)](https://docs.sentry.io/platforms/apple/profiling/)
- [Node.js](https://docs.sentry.io/platforms/node/profiling/)
- [Python](https://docs.sentry.io/platforms/python/profiling/)
- [PHP (including Laravel and Symfony)](https://docs.sentry.io/platforms/php/profiling/)
- [Go [experimental]](https://docs.sentry.io/platforms/go/profiling/)
- [Ruby [experimental]](https://docs.sentry.io/platforms/ruby/profiling/)
- [Rust [experimental]](https://docs.sentry.io/platforms/rust/profiling/)
