...
The **Profiling** page allows you to interact and examine detailed profiling data.
...
Below that, there are three widgets to choose from. The "Suspect Functions" widget shows you a list of the functions that took the most time in your application. It lists out the transactions where the function was called from and clicking on the transaction will take you to an example profile. The "Most Regressed Functions" and "Most Improved Functions" widgets shows you a list of the functions that have gotten slower/faster over time. Clicking on on the timings will take you to an example from either before/after the detected regression/improvement.
