...
- **Only a subset of user flows are being tested.** Performance tests are typically set up for the most common user flows, but it's impractical to build and maintain tests for every possible way in which someone may be using your app.
