...
- Build Number
- [Semantic Version](/platform-redirect/?next=/configuration/releases/#bind-the-version)

## Filtering Releases

Search on the **Releases** page supports both raw text and query syntax. If you are using our [semantic versioning](/platform-redirect/?next=/configuration/releases/#bind-the-version) format, the following query tokens are known to Sentry:
