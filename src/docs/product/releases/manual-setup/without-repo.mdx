---
title: Set Up Releases Without a Repository Integration
sidebar_order: 4
description: "Learn how to provide release information to Sentry if you don’t want Sentry to connect to your repository."
---

If you don’t want Sentry to connect to your repository, or you’re using an unsupported repository provider or VCS (for example, Perforce), you can tell Sentry about your raw commit metadata via the CLI or the API.
