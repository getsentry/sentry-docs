...
If you're using one of our [release automation](/product/releases/setup/release-automation/) options, suspect commits should already be enabled and this step should be done automatically.
