...
See the release adoption percentage over time. This graph compares sessions on this release with sessions on all releases. You can change the main date range to see adoption in a different time frame.
