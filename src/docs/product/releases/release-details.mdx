...
See the list of people that authored commits in this release together with the absolute and relative counts of commits per person. [Learn how to add commits to a release](/product/releases/adding-commits/).
