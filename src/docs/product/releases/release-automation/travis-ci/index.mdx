...
<Link to="travis-env-vars.png">View of Travis CI environment variables.</Link>
...
For more details about the release management concepts in the snippet above, see the full documentation on <Link to="/cli/releases/">release management</Link>.
