...
For more details about scopes and API endpoints, see the full documentation on <Link to="/api/permissions/">API Permissions</Link>.

!<Link to="internal-integration-permissions.png">View of internal integration permissions.</Link>
...
!<Link to="jenkins-add-credential.png">View of Jenkins add credentials.</Link>
...
For more details about the release management concepts below, see the full documentation on <Link to="/cli/releases/">release management</Link>.
...
1. Make sure you add a binding to map the environment variable `SENTRY_AUTH_TOKEN` to the internal integration token credential you added in the previous step.
   ...
   !<Link to="jenkins-freestyle-bindings.png">View of environment variable bindings.</Link>

2. Add the following build step after your deployment step:

   !<Link to="jenkins-freestyle-shell.png">View of jenkins freestyle shell.</Link>
