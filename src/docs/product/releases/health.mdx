...
Sentry's [iOS](/platforms/apple/guides/ios/), [Android](/platforms/android/), [React Native](/platforms/react-native/), C and C++ SDKs are automatically configured to track release health. We have limited support for release health in [Electron](/platforms/javascript/guides/electron/). [Rust](/platforms/rust/) needs to be manually configured to track release health.
...
We are working to add Release health support for Flutter
