...
Sentry provides [inbound data filters](/product/error-monitoring/filtering/) to filter data into your project. Data filters are only partially supported for session events.

## What Release Health Monitors

Once you configure your SDK, Sentry connects the metrics to the specific release of your application and the associated code.
...
Percentage of users who did not experience a crash during the specified time period.
