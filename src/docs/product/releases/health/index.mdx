...
To sort releases by active sessions, select Display: Sessions and to sort by active users select Display: Users.

![Sort By: Active Sessions / Users dropdown](release_active.png)
...
To sort releases by crash free sessions, select Display: Sessions and to sort by crash free users select Display: Users.

![Sort By: Crash Free Sessions / Users dropdown](release_crash_free.png)
