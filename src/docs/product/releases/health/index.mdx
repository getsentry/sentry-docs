...
- "Replaced" -  the release was previously tagged as "High Adoption", but no longer meets the minimum threshold
  
<Note>

"Replaced" releases that reach the threshold will once again be marked as "High Adoption".
