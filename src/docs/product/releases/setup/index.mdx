...
If you decide not to use a repository integration, you can use [our API to send your commit metadata](/product/releases/suspect-commits/#using-the-api) to Sentry.
