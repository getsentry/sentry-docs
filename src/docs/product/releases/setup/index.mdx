...
[Suspect Commits](/product/releases/suspect-commits/) allow you to more easily pinpoint what changes may be responsible for a given issue. To set them up:
...
2. Configure your release management script to [associate commits with each release](/product/releases/suspect-commits#enable-suspect-commits). If you're using one of our [release automation](/product/releases/setup/release-automation/) options, this will be done for you.
