...
With an additional repository integration enabled or manual commits, you can also track suspect commits.

If you're using one of our [release automation](/product/releases/setup/release-automation/) options, step 2 below will be automated.

1. [Install a repository integration](/product/integrations/source-code-mgmt/) (this step is optional, but highly recommended)
...
Typically, a release = a deployment, but if you have several environments you want to which you want to deploy a release, this step also allows you to create those deployments individually.
