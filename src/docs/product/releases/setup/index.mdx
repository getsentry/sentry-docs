...
If you're using one of our [release automation](/product/releases/setup/release-automation/) options, it will automate steps 3.2 and 4 of this process. You just need to ensure that the SDK is configured and that you've uploaded source maps. If you're managing your releases manually, then you should follow all of the steps below.
