...
[Adding commits](/product/releases/adding-commits/) to a release allows you to more easily pinpoint which changes may be responsible for a given issue. To set them up:
...
Learn more about the benefits of tracking commits in [Adding Commits](/product/releases/adding-commits/).
