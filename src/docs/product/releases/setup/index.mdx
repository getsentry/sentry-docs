...
[Adding commits](/product/releases/adding-commits/) to a release allows you to more easily pinpoint what changes may be responsible for a given issue. To set them up:
