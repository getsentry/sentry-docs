...
- If you can’t install a repository integration, send commit metadata via the [create release endpoint](/product/releases/manual-setup/without-repo/) or omit the `set-commits` line (`set-commits` is required for suspect commits).
