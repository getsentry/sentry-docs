...
Before starting, confirm that your Sentry project is properly set up to track commit metadata by [installing a repository integration](/product/releases/#install-a-repository-integration). Once that's installed, and you've added your repository, come back to this guide. If you've already installed a repository integration, you're ready to go.
...
- [Pipeline (Jenkinsfile)](/product/releases/release-automation/jenkins/#pipeline)
- [Freestyle project](/product/releases/release-automation/jenkins/#freestyle-project)
...
- If you can’t install a repository integration, send commit metadata via the [create release endpoint](/product/releases/manual-setup/without-repo/) or omit the `set-commits` line.
