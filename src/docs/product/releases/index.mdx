...
In your release process, add a step to create a release in Sentry and associate it with commits from your linked repository. We recommend using Sentry’s [Command Line Interface](/product/cli/releases/) or [our API](/product/releases/manual-setup/use-the-api/) to add this step in your release process, especially if you're using [Release Automation](/product/releases/release-automation/).
