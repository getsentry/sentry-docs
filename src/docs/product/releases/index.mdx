...
Additionally, releases are used for applying <Link to="/platforms/javascript/sourcemaps/">source maps</Link> to minified JavaScript to view original, untransformed source code.
...
You need to be an Owner or Manager of your Sentry organization to set up or configure an integration. Read more about <Link to="/accounts/membership/">roles in Sentry</Link>.
...
For more information, see the <Link to="/cli/releases/">CLI docs</Link>.
...
For more information, see the <Link to="/api/releases/post-organization-releases/">API reference</Link>.
...
To tell Sentry about your commit metadata via the API use the <Link to="/api/releases/post-organization-releases/">create release endpoint</Link>.
...
You can also use our <Link to="/api/releases/post-release-deploys/">API</Link> to create a deploy.
...
To learn more, please check out our <Link to="/platforms/javascript/sourcemaps/">Source Maps</Link> docs.
