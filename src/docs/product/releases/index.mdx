...
If you don't wish to see a release anymore you can archive it either using CLI:
...
![archive release ui](archive-release-ui.png)

Archived releases won't show up in Releases view unless you filter for them:

![archived releases ui](archived-releases-ui.png)

You can always restore archived release either in the UI or using CLI:
