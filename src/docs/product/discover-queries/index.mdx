...
<SandboxLink scenario="discover" projectSlug="react">
  Discover
</SandboxLink> provides visibility into your data across environments by building upon and
enriching your error data. You can <SandboxLink
  scenario="oneDiscoverQuery"
  projectSlug="react"
>
  query
</SandboxLink> and unlock insights into the health of your entire system and get answers to
critical business questions — all in one place. Use <b>Discover</b> to view comprehensive information
sent to Sentry.
