...
The <SandboxLink scenario="discover" projectSlug="react">Discover</SandboxLink> homepage will open the query builder where you can immediately begin building a new query. By default, this will show the pre-built "All Events" query. Columns in the homepage can be [edited and saved, or saved from other queries](#set-as-default). To navigate back to the [query management page](#saved-queries), where pre-built and saved queries can be found, click the "Saved Queries" button.
