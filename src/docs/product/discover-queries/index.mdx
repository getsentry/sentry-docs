...
The <SandboxLink scenario="discover" projectSlug="react">Discover</SandboxLink> homepage will open the query builder where you can immediately begin building a new query. By default, this will show the pre-built "All Events" query. Columns in the homepage can be [saved from other queries](#set-as-default). To navigate back to the query management page, where pre-built and saved queries can be found, click the "Discover" breadcrumb.
...
The **Discover** default homepage is available only if you're in the Early Adopter program. Features available to Early Adopters are still in-progress and may have bugs. We recognize the irony. If you’re interested in being an Early Adopter, you can turn your organization’s Early Adopter status on/off in General Settings. This will affect all users in your organization and can be turned back off just as easily.

</Note>

Queries can be used as your **Discover** homepage. You can find the "Set As Default" button by opening the context menu in the **Discover** page or within the [query results](#query-results). You can customize your homepage by configuring how your columns and charts appear, and then clicking "Set As Default". Navigating to **Discover** through the left sidebar will now open a new query builder with this configuration pre-loaded.

If you do not wish to use this configuration as your default homepage anymore, click "Remove Default" on the homepage and the homepage will revert to the All Events query.
