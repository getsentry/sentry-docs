...
If you don't want to use this configuration as your default homepage anymore, click "Remove Default" on the homepage and the homepage will revert to the "All Events" query.
