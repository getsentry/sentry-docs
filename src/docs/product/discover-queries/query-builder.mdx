...
You can also add an equation to your query using the query's table columns as equation variables. The result of the equation is displayed in the results table. Learn more in [Adding Query Equations](query-equations/).
