...
When the "Display" selection is either "Total Period", "Previous Period", "Total Daily" or "Bar Chart", up to three Y-Axis can be set by selecting multiple checkboxes in the Y-Axis dropdown.
