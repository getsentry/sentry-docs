...
User feedback is only applicable for [error issues](/product/issues/#error-issues). Other categories of issues (such as, [performance issues](/product/issues/#performance-issues)) do not support this feature.
