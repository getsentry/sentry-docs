...
Feedback from the Crash-report Modal can also be found on the User Feedback tab of the associated Issue Details page.
...
If you don't have Sentry's default issue alert turned on, follow these steps to set up alerts for every new User Feedback issue:
