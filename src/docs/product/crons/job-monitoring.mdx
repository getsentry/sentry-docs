...
Sentry's Cron job monitor service is able to notify you and store a timeline of the following check-ins events:
...
On your Cron monitor details page, you will find a daily historical bar chart of the past 30 days for successful, failed, and missed check-ins with a line chart of the runtime average for the job execution.

Below, in the "Issues" section, any issues created from this Crons will be listed here. Issues are created when a cron monitor job execution is missed or failed. If you have configured the Sentry SDK for your job, any errors thrown during the job runtime will be shown here as well.
