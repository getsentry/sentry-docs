...
Starting from v2.16.1, the Sentry CLI enables monitor check-in authorization using your project's DSN. **The ability to monitor check-in authorization through an auth token is deprecated.** See instructions below to update your CLI and use your project's DSN.
