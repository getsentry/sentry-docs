...
Starting from v2.16.1 of the Sentry CLI, the ability to monitor check-in authorization through an auth token has been deprecated. Read on to learn how to update your CLI and use your project's DSN instead.
