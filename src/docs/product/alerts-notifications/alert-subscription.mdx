---
title: Alert Rules & Subscription
sidebar_order: 3
---

Configure alerts to your team's needs with alert rules and subscription. Create new alerts, audit active alerts, and designate the recipient(s) of each alert.
