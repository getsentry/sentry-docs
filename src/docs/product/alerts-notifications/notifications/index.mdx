...
Resolving an issue will send a notification email as long as you have workflow notifications enabled for that project. For more details about submitting a fix, see documentation on [resolving issues](/product/releases/suspect-commits/).
...
Deploy emails are sent to users who have committed to the release that was deployed. For more details, see [deploy documentation](/product/releases/setup/#notify-sentry).
