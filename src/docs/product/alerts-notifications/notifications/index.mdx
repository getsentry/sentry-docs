...
Resolving an issue will send a notification email as long as you have workflow notifications enabled for that project. For more details about submitting a fix, see documentation on [resolving issues](/product/releases/#associate-commits-with-a-release).
...
Deploy emails are sent to users who have committed to the release that was deployed. For more details, see [deploy documentation](/product/releases/#tell-sentry-when-you-deploy-a-release).
...
- 80% of the organization's error volume has been depleted
- Errors or transactions have exceeded the organization's quota, which includes on-demand capacity

For more details, see our [full documentation on Quotas](/product/accounts/quotas/).
...
![Radio buttons with options for always, only on issues I subscribe to, and never.](workflow_notifications_subscription.png)
...
Configure your deploy notifications broadly for all notifications and/or according to organization by navigating to **Settings > Account > Notifications**.
