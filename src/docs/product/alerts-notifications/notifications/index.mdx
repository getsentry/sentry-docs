...
2. Resolved
   ...
   - Auto-resolve is located in **Project Settings > General Settings**. For more details about submitting a fix, see documentation on [resolving issues](/product/releases/#after-associating-commits).
     ...
     !<Link to="auto-resolve.png">A slider to indicate whether the auto resolve is disabled or not</Link>
...
!<Link to="deploy-emails.png">An example of an email describing deployed features</Link>
...
!<Link to="workflow_notifications_subscription.png">Radio buttons with options for always, ony on issues I subscribe to, and never.</Link>
...
!<Link to="fine_tune_workflow.png">A dropdown with the options to choose default, always, only on issues I subscribe to, and never.</Link>

**Unsubscribe**

To opt-out of workflow notifications for a specific issue, click "Unsubscribe" at the bottom right of the issue’s page.

!<Link to="unsubscribe.png">An unsubscribe button to stop notifications.</Link>

### Deploy Notifications

Deploy notification settings are located in **Setting > Account > Notifications**.

!<Link to="deploy_notifications.png">An unsubscribe button to stop notifications.</Link>
