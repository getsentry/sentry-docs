...
**Resolved**: Resolve an issue to indicate that no more events are expected. If another event is seen in the issue, the issue will revert to unresolved, which often identifies a regression.
