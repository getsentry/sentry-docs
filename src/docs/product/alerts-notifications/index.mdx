...
Notifications are emails triggered by changes in issue state, releases, and quota usage. To change the frequency of your email notifications, configure your [Notification Subscription](/product/alerts-notifications/notifications/#notification-subscription).
