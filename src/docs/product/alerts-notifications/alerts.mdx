...
Sentry automatically groups individual error events into Issues based on stack trace and other factors. For more details about grouping, see the <Link to="/data-management/event-grouping/">full documentation on Grouping & Fingerprints</Link>.

Sentry has two types of alerts you can use for errors:

[Issue Alerts](#issue-alerts)

: Notifies you when individual Sentry <Link to="/data-management/event-grouping/">Issues</Link> match your alerting criteria, such as an Issue happening more frequently than usual.
...
!<Link to="notifications/alert-stream2.png">Alert stream illustrates alert duration, trends, severity, time duration and percentage of users affected.</Link>
...
!<Link to="notifications/alert_details.png">Alert details illustrates a graph showing errors.</Link>
...
!<Link to="notifications/alert-conditions2.png">The alert condition in this example shows the conditions are conflicting with each other.</Link>
...
- Send an email
  - Send email to either <Link to="/product/sentry-basics/issue-owners">Issue Owners</Link>, Team, or [Member](/accounts/membership/#member)
- Send a notification to all <Link to="/product/integrations/">Per Project integrations</Link>
- Send a notification via an integration
  - This includes:
    - Legacy integrations
    - Integrations built using the <Link to="/product/integrations/integration-platform/">Integration platform</Link> (includes published integrations, internal integrations, unpublished integrations)
...
- Send a notification to a global integration, which includes
  - <Link to="/product/integrations/integrations/pagerduty/">PagerDuty</Link>
  - <Link to="/product/integrations/integrations/slack/">Slack</Link>

!<Link to="notifications/alert-actions2.png">The alert condition in this example shows the conditions are conflicting with each other.</Link>

For more details, see <Link to="/product/integrations/">Per-Project Integrations</Link> (via “Service” as any individual integration) that can send Notifications.

By default, <Link to="/product/sentry-basics/issue-owners/">issue owners</Link> receive alert emails. If an issue owner is not configured or not found, the email will either not send or send to all project members as defined in **Project Settings > Issue Owners**.

!<Link to="notifications/issue_owners.png">Issue owners can be toggled on or off.</Link>
...
!<Link to="notifications/alert_frequency.png">A dropdown that adjusts the frequency of an alert.</Link>
...
!<Link to="notifications/alert_environment.png">A dropdown allowing you to choose an environment to attach to an alert.</Link>
...
!<Link to="notifications/alert_digest.png">A sliding adjustment scale for the frequency of alert emails.</Link>

## Alert Listing

This is a listing of all your project's alerts.

!<Link to="notifications/alert-listing.png">Alert rules are divided by projects, their conditions/triggers, and actions(s).</Link>
...
!<Link to="notifications/issue_owners2.png">A toggle indicating if all users are issue owners or not.</Link>
...
!<Link to="notifications/default_project_alerts.png">A toggle for turning on or off all project alerts.</Link>
...
!<Link to="notifications/specific_project_alert.png">Dropdown indicating a choice between default, on, or off.</Link>
