...
- Send a notification via an integration
    - This includes:
        - Legacy integrations
        - Integrations built using the [Integration platform](/product/integrations/integration-platform/index) (includes published integrations, internal integrations, unpublished integrations)
