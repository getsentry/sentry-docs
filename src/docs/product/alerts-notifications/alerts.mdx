...
Sentry users with admin permissions or higher can create alerts. To confirm or set admin permissions, in [sentry.io](sentry.io), navigate to **Project Settings > Alerts > New Alert**.
