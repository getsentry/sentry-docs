...
Typical uses of metric alerts include detecting a spike in the overall number of errors in a project, or a triggered performance metric like [latency](/product/performance/metrics/#latency), [Apdex]((/product/performance/metrics/#apdex)), [failure rate](/product/performance/metrics/#failure-rate), and [throughput](/product/performance/metrics/#throughput-total-tpm-tps).
