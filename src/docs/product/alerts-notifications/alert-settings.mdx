...
The “Alert Rules” tab displays your alert rules, along with their type, current status, and the project they’re associated with. If you have Performance configured for your organization, the Alerts page also displays a “History” tab where you can find a list of your alerts along with visual graphs, associated projects, and the last time the alert was triggered. In the “History” tab, the default view shows unresolved alerts.
