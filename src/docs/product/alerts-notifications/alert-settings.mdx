...
The “Alert Rules” tab displays your alert rules, along with their type, current status, and the project they’re associated with. If you have [Performance Monitoring](/product/performance/) configured for your organization, the **Alerts** page also displays a “History” tab where you can find a list of triggered alerts, along with visual graphs, associated projects, and the last time the alert was triggered. In the “History” tab, the default view displays unresolved alerts.
...
With alert settings, you can configure alert email templates and set minimum/maximum delivery intervals for alerts. Access alert settings by navigating to **Settings > [Organization] > [Project] > Alerts**.
