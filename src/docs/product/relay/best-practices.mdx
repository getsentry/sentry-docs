...
- To monitor your Relay setup, configure [Logging](/product/relay/logging/#logging), [Metrics](/product/relay/metrics/), and [Health Checks](/product/relay/logging/#health-checks).
