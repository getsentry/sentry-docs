...
description: "Learn about our guildelines for operation when self-hosting external Relays."
sidebar_order: 5
redirect_from:
  - /meta/relay/best-practices/
---

This page reviews our guildelines for operation when self-hosting external Relays, that is, Relays that run on your hardware and forward events to `sentry.io`.
