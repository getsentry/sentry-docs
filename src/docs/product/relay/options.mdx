...
| key                        | type    | default value                              | possible values                 | optional | description                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|----------------------------|---------|--------------------------------------------|---------------------------------|----------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| relay.mode                 | String  | managed                                    | managed, static, proxy, capture | false    | Controls how Relay obtains the project configuration for events. For detailed explanation of these modes, see [Relay Modes](/product/relay/modes/).                                                                                                                                                                                                                                                                                              |
| relay.upstream             | String  | `https://sentry.io`                        |                                 | false    | Fully qualified URL of the upstream Relay or Sentry instance.    <Alert level="warning" title="Important">  Relay does not check for cycles. Do not set this option to an endpoint that will cause events to be cycled back here.    </Alert>                                                                                                                                                                                                    |
| relay.host                 | String  | `0.0.0.0` in Docker, otherwise `127.0.0.1` |                                 | false    | The host to which Relay should bind (network interface). Example: `0.0.0.0`                                                                                                                                                                                                                                                                                                                                                                      |
| relay.port                 | Integer | 3000                                       |                                 | false    | The port to bind for the unencrypted Relay HTTP server. Example: `3000`                                                                                                                                                                                                                                                                                                                                                                          |
| relay.override_project_ids | Boolean |                                            |                                 | true     | Overrides project identifiers stated in client DSNs with the identifier used at the Sentry upstream. By default, Relay rejects data on project ID mismatch.  Set this setting to `true` when Relay redirects traffic to a migrated Sentry instance, such as when moving from self-hosted to Sentry SaaS. Validation of project identifiers can be safely omitted in these cases, and you can continue to use the previous DSNs in your services. |
