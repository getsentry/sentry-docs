...
| key                             | type    | value            | description                                                                                                                                                                                                             |
| ------------------------------- | ------- | ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| spool.envelopes.path            | String  | default: `null`  | The path to the spool file used to save envelopes to disk. If provided, Relay will create the directory structure and enable on-disk spooling. Note that `~` is interpreted as a literal and not as the home directory. |
