...
You have a working Relay instance. Make sure to check [Operating Guidelines](/product/relay/best-practices/) to learn how to monitor and scale your Relay setup.
