...
You have a working Relay instance. Make sure to check [Operating Guidelines](/product/relay/operating-guidelines/) to learn how to monitor and scale your Relay setup.
