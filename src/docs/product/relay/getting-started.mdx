...
This example displays the default logging level, which you can modify so it displays either more or less information. For details about configuring logging please see [Logging](../options/#logging) on the options page.
