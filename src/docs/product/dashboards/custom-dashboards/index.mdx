...
"Create Dashboard" will immediately take you to a new dashboard edit mode. When you edit an existing dashboard, you can tell that you’re in edit mode because the widgets are lightly grayed out. From here, you can:
