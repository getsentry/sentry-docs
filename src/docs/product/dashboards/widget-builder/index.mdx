...
For performance widgets (based on transactions), [metrics-based](/product/sentry-basics/search/searchable-properties/#metrics-properties) data is the default. If you make a selection in configuring your widget that's not metrics-compatible, then your widget will use event-based data and a message saying this will be displayed.
