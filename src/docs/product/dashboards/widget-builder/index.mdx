...
The selections you make here may affect whether Sentry uses [_metrics-based or events-based_](/product/sentry-basics/events-metrics/) data. If the data type isn't applicable for the type of widget you've set up, you'll receive a warning.
