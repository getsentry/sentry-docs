...
- **Issues For Review**: A table of unresolved issues for you or your team's review ordered by the most recently seen issues
...
You can track the impact of your issues by counting the error events associated with each unique issue. Modify the "Issues For Review" widget by selecting the "All Events" data set. Update the search condition to filter for error events:
...
Monitoring the number of unique issues alongside the total number of errors in your projects can give you a sense of the impact of issues in your project. For example, a low number of unique issues and a high number of total errors indicates you have a few high impact issues. Modify the "Issues For Review" widget by selecting the "All Events" data set. Update the search condition to filter to error events:
