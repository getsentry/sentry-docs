...
The widget library contains a collection of prebuilt widgets you can add to your [custom dashboards](/product/dashboards/customize-dashboards/). To access it, click on the plus icon in the empty widget box and switch to the "Widget Library" tab in the modal that appears.
