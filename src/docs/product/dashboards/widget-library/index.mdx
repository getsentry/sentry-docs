...
The widget library contains a collection of prebuilt widgets you can add to your [custom dashboards](/product/dashboards/customize-dashboards/). You can access the widget library in the sidebar that is on the right of the [widget builder](/product/dashboards/widget-builder/).
