...
1. Clicking the "Edit Dashboard" button at the top right hand corner.
2. Clicking the pencil icon to edit a widget
3. Clicking the widget panel with the plus icon
