...
When you visit Dashboards for the first time, you'll find a dashboard with a set of pre-built widgets. You can build a new dashboard or edit an existing dashboard by clicking on either the "Create Dashboard" or the "Edit Dashboard" buttons on the top right-hand corner.

Next, you can build or edit widgets by:

- Clicking on the pencil icon to edit an existing widget.
- Clicking on the widget panel with the plus icon to create a new widget.
