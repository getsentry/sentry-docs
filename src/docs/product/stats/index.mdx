...
title: Stats
sidebar_order: 20
description: "Learn about projects and teamsa across your organization."
---

The Stats page is split up into two sections: [Usage Stats](#usage-stats) and [Team Stats](#team-stats).

Usage Stats shows your organization’s event usage while also providing a high-level overview of how different projects are using Sentry. Team Stats on the other hand gives you insights into how your team is using Sentry—for example it shows you how many issues your team has reviewed and the number of releases they’ve shipped—as well as giving you an overview of the health of your projects.
...
On the Team Stats tab you can see information about the overall health of your projects and see how your team is using Sentry. At the top of this page you can select a team which will filter the metrics below and the default time range is set to the last 8 weeks which allows you to compare changes week by week.

![Overview of Usage Stats page](team-stats.png)

### Project Health

This is an overview of your application and shows you a summary of your projects’ Crash-Free Rate, as well the User Misery of your team’s key transactions. This gives you a quick idea as to which projects and key transactions might need attention from your team. In this section you can also view how many alerts have been triggered from the metric alerts your team owns.

### Team Activity

The Team Activity section shows how many issues have been reviewed and reveals a breakdown per project, as well as the mean time it took to resolve issues and the number of releases that have been created in the projects that your team owns.
