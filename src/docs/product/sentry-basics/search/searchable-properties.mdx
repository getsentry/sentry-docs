...
| release.package<br /> release.version<br /> release.build | Restrict results to events tagged with the matching semantic version. Supports ranges and wildcards. For more information, see [Sorting and Filtering Releases](/product/releases/usage/sorting-filtering/). |
