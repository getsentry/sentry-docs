...
[Session Replay](/product/session-replay/) objects are not represented within the existing event data tables inside Sentry. As such, they share some common field names, but also have unique fields as well.
