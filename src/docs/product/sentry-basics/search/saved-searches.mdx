...
You can create your own saved searches, which you can make visible to just you, or to your entire organization (if you are an organization owner or manager). These saved searches are not associated with a specific project, but with all projects across the organization.
