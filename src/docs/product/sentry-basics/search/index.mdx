...
Search terms should auto-complete, and when they don't, that means you have an invalid data set. If you complete the term and tap the Return/Enter key, an error message is displayed.
