...
Search terms should auto-complete, and when they don't that means you have an invalid data set. If you complete the term and hit enter, an error message is displayed.
...
Typically, when you're searching using numbers or durations, you should use comparison operators rather than exact matches. Comparison operators are:
