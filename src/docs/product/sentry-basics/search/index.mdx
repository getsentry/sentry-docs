...
These filters are normally only persistent within the current page, but you can choose to "lock" the current filter selection such that any changes made to the "locked" filter will be persisted throughout the application.
