...
- **processed events** - A processed event is one instance of you sending data to Sentry. The number of events you send is based on the sample rate that you set in the SDK. For transaction events that are processed but not sampled, Sentry doesn't store the full transaction data, only aggregate data. Learn more in [Metrics](/product/sentry-basics/events-metrics/).

- **sampled events** - The events that you decide to keep from your processed events that Sentry stores for you. Currently, this only applies to transaction events. For these events, we store the complete transaction data rather than just aggregate data. Learn more in [Metrics](/product/sentry-basics/events-metrics/).

- **metrics** - Metrics are generated from all of your processed events, or all the events that you send to Sentry. Learn more in [Metrics](/product/sentry-basics/events-metrics/).
