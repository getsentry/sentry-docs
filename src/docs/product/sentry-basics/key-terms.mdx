...
**Sentry SDK** - Sentry's software development kit. SDKs are programming language/framework-specific. When you instrument your application with one of our SDKs, _event_ data from your application is captured, or sent to Sentry, so we can provide you with error and transaction information about your software.

**sentry.io** - Sentry's user interface, where event data captured by our SDK is visualized.
