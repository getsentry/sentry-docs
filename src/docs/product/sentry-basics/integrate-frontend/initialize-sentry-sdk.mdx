...
If you're using your own source code, you can skip this section and either:

- Follow the instructions on [Getting Started](/platforms/) for your platform. You can select the desired platform.
- Go directly to the [next step](/guides/integrate-frontend/generate-first-error/).
