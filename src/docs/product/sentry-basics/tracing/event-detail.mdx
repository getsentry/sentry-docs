...
In some cases, a span may be the parent of one or more transactions. You can identify which span has children with the expand callout. Clicking this icon will embed the first child transaction. When a transaction is embedded, the collapse callout will appear for you to hide it again.
