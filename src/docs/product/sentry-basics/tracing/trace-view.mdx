...
- SDK sampling. Setting a sample rate that's too low may prevent the SDK from sending a transaction. [We recommend sending us all of your transaction data](/product/data-management-settings/dynamic-sampling/#server-side-controls--sdk-sampling).
