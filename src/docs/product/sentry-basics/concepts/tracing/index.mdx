...
sidebar_order: 70
description: "Learn more about the distributed tracing features Sentry offers to help you track your software performance across multiple systems."
redirect_from:
  - /product/sentry-basics/tracing/
---

[Distributed tracing](/product/sentry-basics/tracing/distributed-tracing/) provides a connected view of related errors and transactions by capturing interactions among your software systems. With distributed tracing, Sentry tracks your software performance and displays the impact of errors across multiple systems, tracing issues back through services and connecting your front-end to your back-end.
