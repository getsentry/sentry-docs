...
redirect_from:
  ...
  - /learn/environments/
  - /product/sentry-basics/environments/
...
![All Envs dropdown](sentry-env.png)
...
<div style="position: relative; padding-bottom: calc(66.54028436018957% + 41px); height: 0; width: 100%">
  <iframe
