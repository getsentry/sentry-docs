...
You could also do this based on the file path of the erroring function, or on the function name itself. See [Server-Side Fingerprinting](/product/data-management-settings/server-side-scrubbing/)
