...
More on **SDK Side Fingerprinting** [here](/product/data-management/event-grouping/sdk-fingerprinting/).
...
You could also do this based on the file path of the erroring funciton, or on the function name itself. See [Additional Examples](/product/data-management/event-grouping/server-side-fingerprinting/#examples)
