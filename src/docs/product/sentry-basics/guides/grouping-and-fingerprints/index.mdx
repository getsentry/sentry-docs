...
If you'd like to unmerge issues, you can go to the Issue Details page and click “Merged Issues”. You will see the fingerprints that have been merged into that issue. Select the checkbox(es) and click “Unmerge”.
