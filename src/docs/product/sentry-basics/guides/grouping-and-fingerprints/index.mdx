...
Let's first understand what makes events group into an issue. `testTypeIssue15` is an issue that had four events. These events grouped into the issue because they shared the same *fingerprint*
