...
!<Link to="issues-dashboard.png">Issues Dashboard</Link>
...
!<Link to="issue-stacktraces-comparison.png">Issues Dashboard</Link>
...
More on **SDK Side Fingerprinting** <Link to="/data-management/event-grouping/sdk-fingerprinting/">here</Link>.
...
!<Link to="connection-timeouts-2.png">ConnectionTimeouts</Link>

You can do it based on the **type** as in:

!<Link to="connection-timeout-type.png">ConnectionTimeoutType</Link>

Or you can do it based on the **message** as in any value after the word host:

!<Link to="connection-timeout-message.png">ConnectionTimeoutMessage</Link>

### 2. Implement

Here's how to set the match based on the error **type**

!<Link to="connection-timeout-type-example.png">ConnectionTimeoutTypeExample</Link>
...
!<Link to="connection-timeout-message-example.png">ConnectionTimeoutMessageExample</Link>
