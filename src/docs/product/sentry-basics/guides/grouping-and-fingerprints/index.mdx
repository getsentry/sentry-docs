...
You could also do this based on the file path of the erroring funciton, or on the function name itself. See [Additional Examples](/platform-redirect/?next=/data-management/event-grouping/server-side-fingerprinting/#examples)
