...
You could also do this based on the file path of the erroring function, or on the function name itself. See [Fingerprint Rules](product/data-management-setttings/fingerprint-rules/)
