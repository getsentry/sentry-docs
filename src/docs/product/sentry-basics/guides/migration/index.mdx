...
Once you complete the onboarding steps, get your **org slug** from the browser URL or under **Settings > General Settings**. We'll need this information to know where to migrate your data.
