...
Create and manage Metric Alerts by navigating to Alerts and clicking the "Alert Rules" tab where you'll see a list of all active rules and can add new rules or modify existing ones. Then, select your project and choose Metric Alert. Sentry users with admin permissions or higher can create alerts.
...
Actions define how you and your team will be alerted. Possible actions are:
