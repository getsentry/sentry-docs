...
Add filters to narrow down what you'll be alerted about, such as transactions by URL, tags, or other event properties. Depending on the type of alert you chose, you might also be able to set which tyes of events you want to be alerted about.
