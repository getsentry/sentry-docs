...
Choose the time period that you want to have your metric aggregated over. Your choices range between one minute and one day.

<Note>

We evaluate this time window every minute. As an example, with an hour time window, we'd evaluate time periods:
