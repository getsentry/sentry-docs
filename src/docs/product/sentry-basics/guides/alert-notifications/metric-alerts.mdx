...
Each environment necessitates different levels of urgency and workflow. The urgency and workflows you apply to Production alerts might differ from those you apply to alerts originating from your QA environment.
...
Actions define how you'll be alerted. Possible actions are:
...
## Step 7: Give the Alert Rule a Name & Save
...
MIMI NOTE: Ask Adi for a use case
...
MIMI NOTE: Ask Adi if there are best practices for Alert Builder and Alert Details.
