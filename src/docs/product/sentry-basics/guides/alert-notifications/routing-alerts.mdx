...
A Sentry Org owner or manager can install and configure the Slack integration in their Sentry account. For more information see [Slack Configuration](/workflow/integrations/integrations/slack/).
...
- [PagerDuty + Sentry Integration](/integrations/pagerduty/)
...
For more information take a look at our documentation for [Integration Platform](/workflow/integrations/integration-platform)
