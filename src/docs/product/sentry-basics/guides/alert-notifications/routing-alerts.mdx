...
!<Link to="alerts_notifications_14.png">Alert Rule Actions</Link>

### **Slack Alerts**

A Sentry Org owner or manager can install and configure the Slack integration in their Sentry account. For more information see <Link to="/workflow/integrations/integrations/slack/">Slack Configuration</Link>.
...
!<Link to="alerts_notifications_16.png">Slack action in alert rule</Link>
...
!<Link to="alerts_notifications_15.png">Slack notification</Link>
...
!<Link to="alerts_notifications_18.png">Legacy Integrations</Link>
...
!<Link to="alerts_notifications_17.png">Plugin Configuration</Link>
...
!<Link to="alerts_notifications_19.png">Service in Alert Rule Action</Link>

For more details about specific integrations:

- <Link to="/integrations/pagerduty/">PagerDuty + Sentry Integration</Link>
...
!<Link to="alerts_notifications_24.png">Web Hook Service Integration</Link>
...
!<Link to="alerts_notifications_25.png">Web Hook Service Action</Link>

For more information take a look at our documentation for <Link to="/workflow/integrations/integration-platform">Integration Platform</Link>
...
!<Link to="alerts_notifications_23.png">Issue Owner Settings</Link>

For more information go to <Link to="/workflow/issue-owners/">Issue Owners</Link>
...
!<Link to="alerts_notifications_20.png">User Setting Notifications</Link>
