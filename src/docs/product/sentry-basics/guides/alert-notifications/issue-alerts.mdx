...
Manage issue alerts by navigating to **Alerts** and clicking the "Alert Rules" tab, where you can both view a list of all active rules and add new rules or modify existing ones.
...
To create an alert, click "Create New Alert", choose your project, and then select "Issues". Click "Set Conditions" to start adding the details of the alert.
