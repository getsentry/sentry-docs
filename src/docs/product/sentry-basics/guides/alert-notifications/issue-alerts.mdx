...
You can choose a team to associate with the alert. When you do so, members of the selected team can edit this alert. Only teams that you're a member of are available for you to choose.
