...
Create and manage Issue Alerts by navigating to Alerts and clicking the "Alert Rules" tab where you'll see a list of all active rules and can add new rules or modify existing ones. Sentry users with admin permissions or higher can create alerts.
