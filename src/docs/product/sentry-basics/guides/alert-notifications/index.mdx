...
1. Identify the critical errors and route them appropriately (for example, to [PagerDuty](/product/integrations/pagerduty/)) to be resolved by the appropriate people as soon as possible.
...
2. Maintain visibility into workflows, deploys, and quota usage by fine tuning notifications according to Sentry project or organization.

## Next

[Creating Metric Alerts](/product/sentry-basics/guides/alert-notifications/metric-alerts/)
