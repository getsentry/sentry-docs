...
Instead, we recommend you create your own alerts to provide you with the information that your team needs at a useful frequency. To create your own alert, navigate to **Alerts** and click "Create New Alert". Select your project, and then select from the alerting options under "Errors" or "Performance".
