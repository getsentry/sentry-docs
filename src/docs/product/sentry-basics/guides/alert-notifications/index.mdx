...
For tighter control over the alerts you're receiving, create [custom alert rules](/product/sentry-basics/guides/alert-notifications/creating-custom-rules/) for either a Metric Alert or an Issue Alert.
