...
- [Routing Alerts to 3rd Party Integrations](/product/sentry-basics/guides/alert-notifications/routing-alerts/#routing-alerts-to-third-party-integrations)
...
[releases documentation](/product/releases/manual-setup/without-repo/)
