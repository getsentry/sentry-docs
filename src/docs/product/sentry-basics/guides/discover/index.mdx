...
8. Per line item/issue you can click on the issue name to open the issue details page and triage it. You can also click on _Open Group_ to continue querying through the events stack in the context of a specific issue.
