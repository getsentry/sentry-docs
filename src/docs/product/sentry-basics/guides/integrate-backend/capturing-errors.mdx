...
If you're using your own source code, follow the instrutions in [Capturing your first event](/platforms/python/guides/django/) to introduce an error into your app.
