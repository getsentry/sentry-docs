...
- Follow the instructions in the [Django Getting Started](/platforms/python/guides/django/) docs. You can select your platform from the dropdown at the top of the page.
- Continue with [the next step](/guides/integrate-backend/configuration-options/).
...
5. Setup and activate a Python 3 virtual environment in the project root.
   ...
   > You can name the virtual environment whatever you want. In our case, we named it "sentry-demo-django".
...
8. Follow the `deploy` target execution flow.
   ...
   Commands mentioned within the `Makefile` will be explained in detail in the next part of the tutorial, [Configuration Options](/product/sentry-basics/guides/integrate-backend/configuration-options/).
