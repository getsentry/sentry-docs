This step-by-step tutorial walks you through the flow of setting up and configuring your Sentry account to monitor errors in your `Python` backend application. As part of this guide you will:
