...
1. To integrate GitHub with your Sentry org, follow the instructions in the [Global Integrations documentation](/product/integrations/source-code-mgmt/github/)
