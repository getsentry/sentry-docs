...
If you're not using the provided React demo code, follow <Link to="/error-reporting/quickstart/">Capturing your first event</Link> to introduce an error to your source code and continue with [Step 2](#step-2-handle-the-error)
...
2. Open the browser's **Console** to verify that an error has occurred
   ...
   !<Link to="generate-first-error-02.png">Import and Configure SDK</Link>
...
4. Click on the **Checkout** button on the left panel to generate an error
   ...
   !<Link to="generate-first-error-01.png">Import and Configure SDK</Link>
...
<Link to="/guides/integrate-frontend/upload-source-maps/">Enable Readable Stack Traces in your Errors</Link>
