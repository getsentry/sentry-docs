...
If you're not using the provided React demo code, follow [Capturing your first event](/platforms/javascript/) to introduce an error to your source code and continue with [Step 2](#step-2-handle-the-error)
