...
Once captured, the SDK enriches the error data with contextual information that it gets from the application's runtime and sends all this data as an *event* to your Sentry account.
