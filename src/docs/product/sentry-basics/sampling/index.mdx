...
Our dynamic sampling works best when you send us as much data as you can and we recommend that you send us 100% of your data (or set your SDK sample rate to 1.0). You may want to lower your SDK sample rate based on budgetary concerns. However, as you purchase more transaction volume, your per-transaction pricing goes down accordingly.
