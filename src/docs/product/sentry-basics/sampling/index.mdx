...
You can use your SDK sample rate to control how much and what type of data you send to Sentry. However, it can often be difficult to decide what an appropriate sample rate would be, and this can change over time. We recommend you send us all of your data and let us manage the sampling. Here’s why.
