...
Starting December 1st, 2020, Sentry's organization subdomains (`o<YOUR_ORG_ID>.ingest.sentry.io`) will migrate from the prior IP address to the following single address:
