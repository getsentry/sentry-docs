...
sidebar_order: 1
description: "Learn about Sentry's Terms of Service, Privacy Policy, Data Processing Addendum, California Consumer Privacy Act Addendum, and Business Associate Amendment. Sentry also provides a way to self-serve most legal and compliance documentation for your organization."
---
...
- [Data Processing Addendum (DPA)](https://sentry.io/legal/dpa/3.0.0/)
- [California Consumer Privacy Act Addendum (CCPA)](https://sentry.io/legal/ccpa/1.0.0/)
- [Business Associate Amendment (BAA)](https://sentry.io/legal/baa/) - Available only on a Business plan or higher
