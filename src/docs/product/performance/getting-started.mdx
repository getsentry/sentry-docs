...
- <PlatformLinkWithLogo platform="javascript" label="JavaScript" url="/platforms/javascript/performance"/>
...
- <PlatformLinkWithLogo platform="android" url="/platforms/android/performance"/>

- <PlatformLinkWithLogo platform="react-native" url="/platforms/react-native/performance"/>

- <PlatformLinkWithLogo platform="apple" label="iOS" url="/platforms/apple/guides/ios/performance/"/>

- <PlatformLinkWithLogo platform="flutter" url="/platforms/flutter/performance"/>
