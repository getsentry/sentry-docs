...
<!-- need some use cases/examples here -->
...
Custom metrics data is displayed in [sentry.io](https://sentry.io) in:

- The sidebar of a transaction event detail under the "Custom Performance Metrics" heading

  <!-- image here -->

- When you query and add columns for them in **Discover**

  <!-- image here -->

- When you create visualizations based on them in **Dashboards**
  <!-- image here -->
