...
description: "Learn more about Sentry's Performance Metrics and how they provide insight about how users are experiencing your application. Guage application performance with Apdex, failure rate, throughput, and latency."
---
