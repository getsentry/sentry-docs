...
The in-browser Sentry SDKs collects web vitals information (where supported) and adds that information to frontend [transactions](product/performance/transaction-summary/). These web vitals are then summarized in several graphs for a quick overview of how each frontend transaction is performing for your users.

![Visualization of Web Vitals](./diagram-transaction-vitals.png)

## Core Web Vitals

Core Web Vitals are called this because they're considered to be the most important by Google and directly measure the user experience. According to a May, 2021 [Google blog post](https://developers.google.com/search/blog/2020/11/timing-for-page-experience), these metrics also impact your search ranking.
