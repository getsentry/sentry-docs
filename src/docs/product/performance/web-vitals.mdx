...
You can visit the [web-vitals]Web Vitals page to get an overview of how page loads on your application are performing.
...
The **Web Vitals** page gives you an overview of your page load performance for the selected project(s). You can use this page as a starting point to investigate poor Web Vitals affecting your website and drill down to better understand which pages affect your website performance most.

Open the **Web Vitals** page by clicking "Web Vitals" in the sidebar, under "Performance".

At the top of the left of page, the [Performance Score](#performance-score) ring shows the overall performance rating of your application. The Performance Score ring is broken down by the individual component Web Vital scores, so that you can see which of your Web Vitals impact your score most. To the right, the trend your application's Performance Score is shown over time in an area chart. You can find out more about how Performance Score is calculated [here](#performance-score).

At the center of the page, Web Vital meters show you the raw vital values for your application and the individual score for each Web Vital. These meters can be useful for prioritizing which Web Vitals need attention most. Click a meter to open a summary of the Web Vital and see which of your pages have the most [Opportunity](#opportunity) for improvement.

At the bottom of the Web Vitals page, a sortable table shows a lists your application's pages, along with their associated P75 values for each Web Vital. Each page also possess its own individual Performance Score. The [Opportunity](#opportunity) column displays a page score's potential impact to your application's overall Performance Score if maximized to 100. The search bar above this table allows users to narrow down to specific pages by name.
...
The **Page Overview** page gives you an overview of a single page of your application. In the **Page Overview**, you can further drill down to a specific page load sample [Event](/product/sentry-basics/concepts/tracing/event-detail/), [Replay](/product/session-replay/), or [Profile](/product/profiling/). You can navigate to the **Page Overview** of any of your application's pages through the main table in the [Web Vitals](#web-vitals-page) page, or through the slideout panel when clicking on a Web Vital meter in the [Web Vitals](#web-vitals-page) page.
...
**Opportunity** scores are number values you can find associated to each of your website application's pages. The **Opportunity** score is the maximum possible increase to your application's overall [Performance Score](#performance-score), if you were to raise a page's individual score to 100. If a page in your application already has a score of 100, the **Opportunity** score would be 0, since there is no further potential to increase your applications overall [Performance Score](#performance-score) by improving this page. You can use **Opportunity** scores to get a sense of which pages are most valuable to improve.
