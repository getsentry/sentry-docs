...
**Performance Scores** are a number rating from 0 to 100 that summarizes the percieved performance of your web application. Each page load on your web application that gets sent to Sentry is scored based on it's **Web Vitals**. These scores are aggregated to provide a score for each of your pages, and an overall score for your application.
