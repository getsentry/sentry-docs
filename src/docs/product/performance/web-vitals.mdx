...
Vitals measure render time, response time, and the sum of shifting rendering processes. Each data point provides insights about the overall performance of your application.
