...
| --------------------------------------------------------------- | ----------------------------- | ----------------- |
| [Largest Contentful Paint](#largest-contentful-paint-lcp) (LCP) | Chromium                      | 4 seconds         |
| [First Input Delay](#first-input-delay-fid) (FID)               | Chromium, Firefox, and Safari | 300 milliseconds  |
| [Cumulative Layout Shift](#cumulative-layout-shift-cls) (CLS)   | Chromium                      | 0.25              |
| [First Paint](#first-paint-fp) (FP)                             | Chromium                      | 3 seconds         |
| [First Contentful Paint](#first-contentful-paint-fcp) (FCP)     | Chromium                      | 3 seconds         |
| [Time To First Byte](#time-to-first-byte) (TTFB)                | Chromium, Firefox, and Safari | 0.25              |
...
Google's "Bad", "Needs improvement", and "Good" levels are used to classify data points into red, yellow, and green for the corresponding Web Vitals.
