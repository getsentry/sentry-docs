...
**Opportunity** scores are number values associated with each page and are meant to give you a sense of which pages are most valuable to improve. The **Opportunity** score is the maximum possible increase to your application's overall [Performance Score](#performance-score), if you were to raise a page's individual score to 100. If a page in your application already has a score of 100, the **Opportunity** score would be 0, since there is no further potential to increase your applications overall [Performance Score](#performance-score) by improving this page.
