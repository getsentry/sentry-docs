...
While we do our best to provide you with the most useful transaction data, our **Performance at Scale** feature allows you to turn the priorities that we apply to your data retention on or off:
...
Our Performance at Scale feature works best when you send us as much data as you can (ideally 100%). As you purchase more transaction volume, however, your per-transaction pricing goes down accordingly. Update your transaction sample rate in the SDK by setting the [tracesSampleRate](/platform-redirect/?next=/performance/).
