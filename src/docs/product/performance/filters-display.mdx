...
[Web Vitals](/product/performance/web-vitals/) includes frontend pageload transactions. The transactions are automatically filtered to only include `transaction.op:pageload`. This generally corresponds to all browser page transitions that are the first load of a page, and include performance information from the beginning of the load itself as well as performance of the SPA frameworks being loaded, such as React or Vue, if available.

![Performance Web Vitals tab](performance-landing-widgets.png)
...
In the second row, there are actionable widgets that can show you areas of concern in your application, such as Most Regressed Transactions or Most Recurring Issues. Below these widgets, there are links to other parts of the application, which you can follow to see additional context. Transactions shown in these lists can be temporarily removed from the view by clicking the 'X' beside the transaction name.
...
- [Most Improved](/product/performance/widgets/#most-improved)
- [Most Regressed](/product/performance/widgets/#most-regressed)
- [Most Related Issues](/product/performance/widgets/#most-related-issues)
- [Most Slow Frames](/product/performance/widgets/#most-slow-frames)
- [Most Frozen Frames](/product/performance/widgets/#most-frozen-frames)
- [Worst LCP Vitals](/product/performance/widgets/#worst-lcp-vitals)
- [Worst FCP Vitals](/product/performance/widgets/#worst-fcp-vitals)
- [Worst FID Vitals](/product/performance/widgets/#worst-fid-vitals)
- [Slow HTTP Ops](/product/performance/widgets/#slow-http-ops)
- [Slow DB Ops](/product/performance/widgets/#slow-db-ops)
- [Slow Browser Ops](/product/performance/widgets/#slow-browser-ops)
- [Slow Resource Ops](/product/performance/widgets/#slow-resource-ops)
