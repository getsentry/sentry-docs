...
Each tab in **Performance** displays an automatically selected set of [metrics](/product/performance/metrics/) and table columns based on the platform of your project. For example, a JavaScript project defaults to a Frontend (Pageload) display.
