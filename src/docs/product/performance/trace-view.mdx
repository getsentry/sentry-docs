...
- Exceeding the span limit, transactions are associated via the child spans of the parent transaction, but if there are more spans than the limit the association cannot be made
