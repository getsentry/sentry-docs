...
<Alert>
  Note this view will only show up to 100 transactions from the trace. The full list of transactions will be available through a linked Discover query.
</Alert>
