...
This confidence score is unbounded, and by default sentry shows trends with a high confidence score. Though if you want to see trends regardless of the score add `confidence():>0` to the search bar.
