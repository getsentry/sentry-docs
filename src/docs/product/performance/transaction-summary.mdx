...
The "Spans" tab displays a list of suspect spans that correspond to where most of the time in a transaction is being spent and can help you find spans where performance problems lie.
