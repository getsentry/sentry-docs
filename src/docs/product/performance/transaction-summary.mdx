...
In the example below, the exclusive time of each span is highlighted by the darker areas. For example, the `http.server` has an exclusive time of 10 ms + 15 ms = 25 ms.
