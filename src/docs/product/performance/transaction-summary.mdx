...
This graph shows the P75 of [First Paint](/product/performance/web-vitals/#first-paint-fp), [First Contentul Paint](/product/performance/web-vitals/#first-contentful-paint-fcp), [Largest Contentful Paint](/product/performance/web-vitals/#largest-contentful-paint-lcp), and [First Input Delay](/product/performance/web-vitals/#first-input-delay-fid) over time. This view can help you understand the web vitals associated with the transaction is doing over time.
