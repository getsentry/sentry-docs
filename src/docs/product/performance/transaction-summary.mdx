...
Frontend transaction will have a "Web Vitals" tab. Clicking on the tab will take you to the [Web Vitals page](/product/performance/web-vitals) where you can see a detailed view of the web vitals associated with this transaction.
