...
Some transactions will additionally contain web vital information. With this view, you'll be able to examine a summary of these vitals.

By default, outliers will be excluded from the view to provide a more informative view of these vitals. Outliers are determined by computing the upper bound using the [upper outer fence](/), and any data points above the upper bound is then deemed to be an outlier. If you wish to see all of the data available, including the outliers, you can still do so.

You can see a histogram for each of the following web vitals on this view.

- [First Paint (FP)](/product/performance/metrics/#first-paint-fp)
- [First Contentful Paint (FCP)](/product/performance/metrics/#first-contentful-paint-fcp)
- [Largest Contentful Paint (LCP)](/product/performance/metrics/#largest-contentful-paint-lcp)
- [First Input Delay (FID)](/product/performance/metrics/#first-input-delay-fid)
- [Cumulative Layout Shift (CLS)](/product/performance/metrics/#cumulative-layout-shift-cls)

If you see an region of interest on any one of the histograms, click and drag over the area to zoom in for a more detailed view. You may also want to see more information related to the transactions in the histograms. Click "Open in Discover" beneath the web vital of choice to build a custom query to investigate further. For more details, see the full documentation for the Discover [Query Builder](/product/discover-queries/query-builder/).
