...
This graph shows the unsmoothed data of the Display data, along with a smoothed version of that data using a modified version of [ASAP](https://arxiv.org/pdf/1703.00983.pdf) smoothing.
