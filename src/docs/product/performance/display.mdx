...
From the Performance homepage, you can view trends by toggling from By Transaction to By Trend at the top of the page. This page surfaces transactions that have had significant changes in their performance over time. You can find the Trends View by toggling the tab in the Performance homepage's upper right corner.
