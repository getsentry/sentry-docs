...
To support [metrics](https://docs.sentry.io/product/sentry-basics/metrics/), the search bar is used to filter by transaction name only, rather than to search for transactions matching the query.
