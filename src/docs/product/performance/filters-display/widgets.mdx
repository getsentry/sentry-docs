...
Shows database queries that take the most time in your application. These queries are usually either slow, very frequent, or both. Click on a query to open its [**Query Summary** page](/product/performance/database#query-summary-page) or click "View All" to open the [**Queries** page](/product/performance/database#queries-page).
