...
Shows database queries that take the most time in your application. These queries are usually either slow, very frequent, or both. See [Database](/project/performance/database) for more information.
