...
Shows resources that take the most time in your application. These resources are usually either slow, very frequent, or both. Click on a query to open its [**Resource Summary** page](/product/performance/resources#resource-summary-page) or click "View All" to open the [**Resources** page](/product/performance/resources#resources-page).
