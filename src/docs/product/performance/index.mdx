...
All transactions mode shows [Apdex](../metrics/#apdex) and [TPM](../metrics/#throughput-total-tpm-tps). You can configure the Apdex threshold in **Settings > Performance**.
