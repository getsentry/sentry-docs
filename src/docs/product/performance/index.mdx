...
The **Performance** page provides you with several filter and display options so that you can focus on the performance data that's most important to you. You can search to find the specific transactions you want to investigate and use [widgets,](/product/performance/filters-display/#widgets) to customize the information being displayed, including which transactions appear first in the [transactions table](/product/performance/filters-display/#transaction-table).
