...
redirect_from:
  ...
  - /product/performance/performance-homepage/
...
With performance monitoring, Sentry tracks application performance, measures metrics like throughput and latency, and displays the impact of errors across multiple services. Sentry captures [distributed traces](/product/performance/distributed-tracing/) consisting of [transactions and spans](/product/performance/distributed-tracing/#traces-transactions-and-spans) to measure individual services and individual operations within those services.
...
The [trends view](/product/performance/trends/) surfaces transactions that have had significant changes in their performance over time. This view is ideal for providing you with insights when you have transactions with large counts.

## Track Performance Across Multiple Services

[Distributed tracing](/product/performance/distributed-tracing/) provides a connected view of related errors and transactions by capturing interactions among your software systems. With tracing, Sentry tracks your software performance and displays the impact of errors across multiple systems. Tracing issues back through services connects your front-end to your back-end.

The [Trace View](/product/performance/trace-view/) allows you to drill down into the details of a single trace and traverse every transaction in that trace. This accelerates your ability to debug slow services, identify related errors, and root out other bottlenecks. You can also drill all the way down into a span for a single transaction and information about it on the [Event Detail](/product/performance/event-detail/) page.
