...
Spans on the **Screen Details** page are tagged if they end before TTID or TTFD, as it could mean they are affecting the respective metrics. Just because a span has been identified as TTID ir TTFD affecting it doesn't necessariliy mean it's the culprit. This is an approximation and a tool for you to identify on an aggregate level if a span may be affecting TTID or TTFD and narrow down the scope of spans to investigate.

![TTID and TTFD Affecting Spans](./ttid-ttfd-affecting-spans.png)
