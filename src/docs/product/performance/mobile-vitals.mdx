...
Mobile Vitals are a set of metrics to measure how fast your app starts and the number of slow and frozen frames your app users experience. Each metric provides insights into the overall performance of your mobile application. These metrics give you the details you need to not only prioritize critical performance issues, but to trace issues down to the root cause to solve them faster.
