...
<div style="position: relative; padding-bottom: calc(62.74089935760171% + 41px); height: 0; width: 100%"><iframe src="https://demo.arcade.software/bEv0SO2UEmqbVJVok99o?embed" frameborder="0" loading="lazy" webkitallowfullscreen mozallowfullscreen allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;color-scheme: light;" title="General Settings — totes-ma-gotes — Sentry"></iframe></div>
