...
Shows transactions with the highest count of poor FCP (First Contentful Paint) and visualizes the split in vital performance to illustrate the proportions of user experience. Learn more in [Web Vitals](/product/performance/web-vitals).
