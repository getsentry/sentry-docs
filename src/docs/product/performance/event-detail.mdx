...
The quick trace (top right of the span view) shows an abbreviated view of the related [trace](/product/performance/distributed-tracing) for the current transaction.
...
Clicking [Trace ID] will bring you to the [Trace View](/product/performance/trace-view)
