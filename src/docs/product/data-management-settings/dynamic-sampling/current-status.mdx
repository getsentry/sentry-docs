...
You can still use Dynamic Sampling rules for any project and SDKs for both error and transaction rules. To sample distributed traces, you need to use one of the supported SDKs listed above.
