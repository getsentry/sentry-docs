...
At the moment the Python and Javascript SDKs have full support for dynamic sampling.

For Python you SDK version: (to be released) or higher.

For Javascript you SDK version: (to be released) or higher

**Note** that you can still use Dynamic Sampling rules for any project and SDKs for both Error and
Transaction rules. To use transaction traces though you would need to use one of the supported SDKs
listed above.

## Current limitations

The following section describes the known limitations and functionality particularities that might trip you when
writing dynamic sampling rules.
