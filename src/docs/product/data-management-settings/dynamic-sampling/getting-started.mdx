...
**Note:** You need to have organization owner or manager role in order to edit project settings.
...
**Note** that the rules are evaluated from top to bottom, it is important that the rule for the specific Release 1.2.1 is before the rule for all releases. If you created them the other way around you can reorder by draging and dropping the rules in the table.
