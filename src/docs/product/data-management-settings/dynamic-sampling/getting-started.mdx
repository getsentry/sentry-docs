...
Rules evaluate top to bottom, with the first matching rule determining the sample rate. It is important that the rule for the specific release comes before the rule for all transactions. If created the other way around, you can reorder by draging the rules in the list.
