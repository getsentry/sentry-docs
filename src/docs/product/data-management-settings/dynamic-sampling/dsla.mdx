...
- [Getting Started](/product/data-management-settings/dynamic-sampling/getting-started/dsla/)

  : Learn about how you can control with transactions Sentry retains using dynamic sampling.

- [Dynamic Sampling Configurations](/product/data-management-settings/dynamic-sampling/sampling-configurations-dsla/)

  : Learn about effective dynamic sampling configurations.

- [Current Limitations](/product/data-management-settings/dynamic-sampling/current-limitations/dsla/)
