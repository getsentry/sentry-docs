...
For most projects there are only a handful of transactions that you really care about. We prioritize key, or starred, transactions over others, so you can have more visibility into your important data, rather than sample all transactions in equivalent manner.
