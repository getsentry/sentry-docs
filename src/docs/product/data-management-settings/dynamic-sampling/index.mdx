...
Please note that Dynamic Sampling is only available on the latest version of our plans and starting from 5M reserved transactions. Your plan can be updated by any Organization Owner or Billing Member by going to Settings > Subscription > Manage Subscription
