...
We prioritize key, or favorite, transactions up to five times over other transactions, so you can have
more visibility of important transactions, rather than sample all transactions in equivalent manner.
