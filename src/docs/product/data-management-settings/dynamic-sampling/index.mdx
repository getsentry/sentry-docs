...
When we talk about SDK sample rates in this section, we're only referring to your transaction sample rate (or tracesSampleRate); not your error sample rate.
