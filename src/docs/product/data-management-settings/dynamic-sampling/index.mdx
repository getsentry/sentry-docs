...
Typically, for most projects there are only a few transactions that you really care about. We prioritize key, or starred, transactions over others, so you can have more visibility into your important data.
