...
circumstances the error occur. If we sample by trace information, and we have see an error event we know that all the
transactions from the trace containing the error will also be present.
