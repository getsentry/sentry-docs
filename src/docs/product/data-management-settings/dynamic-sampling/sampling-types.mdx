...
1. Client-side, in your SDK, by [configuring the transaction sample rate](/platform-redirect/?next=/configuration/sampling/#configuring-the-transaction-sample-rate) during SDK initialization.
