...
Now that you know how Sentry is sampling at a high-level, you can set server-side sampling rules in **[Project] > Settings > Dynamic Sampling**.
...
The **Dynamic Sampling** page in [sentry.io](https://sentry.io) allows you to change the order of your rules to make them more effective.
