...
![The Dynamic Sampling page with a list of rules](server-side-sampling.png)
...
Dynamic sampling also makes your SDK and your server-side sampling configuration largely independent of each other. This helps if you're building native applications with many active releases at a given time.
