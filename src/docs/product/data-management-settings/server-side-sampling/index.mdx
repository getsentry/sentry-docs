...
> [A trace](/product/sentry-basics/tracing/) A trace represents the record of the entire operation you want to measure or track, like page load, an instance of a user completing some action in your application, or a cron job in your backend. A trace consists of one or more transactions and it can be distributed across multiple services or projects.
