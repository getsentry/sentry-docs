...
For more detailed information about each of these, check out our [full Current Limitations documentation]().
...
![Setting a uniform sampling rate for your project](set-uniform-sample-rate.png)
