...
With that done, set your global sample rate:

![Setting a global sample rate for your project](set-global-sample-rate.png)
...
If the chart displayed on screen doesn’t provide enough information for you to determine a global sampling rate for this project, we recommend checking your **Stats** page. The **Stats** page provides a complete overview of how many transactions each project accepts, filters, and drops rather than for just one project.
