...
**Dynamic Sampling** is currently only available for the following SDK's:
...
We're actively working on adding more conditions that you can sample by (for example, transaction name). However, feel free to provide suggestions by joining the channel [#dynamic-sampling](https://discord.com/channels/621778831602221064/1004667579035570176) on our Discord Server.
