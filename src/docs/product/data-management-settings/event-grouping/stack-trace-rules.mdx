...
Frame categorization is heavily used by our newest grouping algorithm, so [if you have it enabled](/product/data-management-settings/event-grouping/grouping-breakdown#enabling-the-grouping-breakdown-beta), you can match on a variety of categories, including:
...
If you have the [Grouping Breakdown feature enabled](/product/data-management-settings/event-grouping/grouping-breakdown#enabling-the-grouping-breakdown-beta) (currently available only to Early Adopters), Sentry groups events by identifying the most interesting group of frames it can find in a stack trace.
