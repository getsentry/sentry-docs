...
If you have the [Grouping Breakdown feature enabled](/product/data-management-settings/event-grouping/grouping-breakdown#enable-the-grouping-breakdown-beta) (currently available only to Early Adopters), Sentry groups events by identifying the most interesting group of frames it can find in a stack trace.
