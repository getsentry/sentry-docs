...
There are four different ways in in [sentry.io](https://sentry.io) to update how events group into issues:
...
- [Merging Issues](/product/data-management-settings/event-grouping/merging-issues/): Merges together similar issues that have already been created. No settings or configuration changes are required for this.
