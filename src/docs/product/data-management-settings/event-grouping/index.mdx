...
There are four different approaches for updating how events group into issues.

- [Fingerprint Rules](/product/data-management-settings/event-grouping/fingerprint-rules/): Set new grouping rules in [sentry.io] for incoming issues. This doesn't affect already existing issues.
- [Stack Trace Rules](/product/data-management-settings/event-grouping/stack-trace-rules/): <!-- TO DO need a succinct description here for how this is different from fingerprint rules -->
...
- [Grouping Breakdown](/product/data-management-settings/event-grouping/grouping-breakdown/): <!-- TO DO need a succinct description here for how this is different from merging -->
