...
redirect_from:
  ...
  - /platforms/rust/usage/sdk-fingerprinting/
  - /platforms/java/data-management/event-grouping/sdk-fingerprinting/
  - /platforms/dotnet/guides/winforms/data-management/event-grouping/fingerprint-rules/
  - /platforms/javascript/guides/wasm/data-management/event-grouping/fingerprint-rules/
