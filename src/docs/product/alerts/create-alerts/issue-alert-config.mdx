...
There are several configuration options available when you create an issue alert, and they're described below.
...
"When" conditions, or triggers, specify what type of activity you'd like monitored. The following alert triggers are available:
...
Learn more about and <PlatformLink to="/enriching-events/tags/">tags</PlatformLink> and [event attributes](/product/sentry-basics/search/searchable-properties/#event-properties) in the full documentation.

## “Then” Conditions: Actions

"Then conditions", or actions, specify what should happen when trigger and filter conditions are met. The following actions are available:
