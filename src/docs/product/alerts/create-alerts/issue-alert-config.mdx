...
Learn more about and <PlatformLink to="/usage/events/enriching-events/tags/">tags</PlatformLink> and [event attributes](/product/sentry-basics/search/searchable-properties/#event-properties).
