...
The preview displays a list of issues that would have triggered the alert you've configured and when they would have last triggered it. Previews can't be generated for certain alert rules and previews containing issue frequency conditions are approximated.
