...
Displays what issues would have triggered a rule with your current conditions and when they would have last triggered it. Previews cannot be generated for certain rule sets and previews containing issue frequency conditions will be approximated.
