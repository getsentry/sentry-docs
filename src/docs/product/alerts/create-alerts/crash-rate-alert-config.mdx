...
## Crash Rate Alerts (Function + Time Interval)
...
Both types of crash rate alerts basically use the percentage function, that calculates the crash free percentage on either the user or the sessions.
