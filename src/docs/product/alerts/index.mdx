...
This feature is only available if you're in the [Early Adopter](https://docs.sentry.io/product/accounts/early-adopter/) program. Features available to Early Adopters are still in-progress and may have bugs. We recognize the irony.
