...
## Crash-Rate Alerts for Release Health

[Crash-rate alerts](/product/alerts/alert-types/#crash-rate-alerts) trigger when the crash free percentage for either [sessions or users](/product/releases/health/#active-sessionsusers) falls below a certain threshold. Use crash rate alerts to monitor the health of your sessions and users over your project, or in a specific release.

You can find a list of available crash rate alerts in [Crash-Rate Alerts](/product/alerts/alert-types/#crash-rate-alerts)
