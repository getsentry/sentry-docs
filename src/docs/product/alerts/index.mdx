...
[Crash-rate alerts](/product/alerts/alert-types/#crash-rate-alerts) trigger when the crash free percentage for either [sessions or users](/product/releases/health/#active-sessionsusers) falls below a certain threshold. Use crash rate alerts to monitor the health of your application per project, or in a specific release.
