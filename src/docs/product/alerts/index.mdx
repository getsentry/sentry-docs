...
By default all users can mute alerts for everyone. Sentry users with manager or owner permissions can change the minimum role requirement in **Organization Settings > General Settings > Let Members Create and Edit Alerts**.
