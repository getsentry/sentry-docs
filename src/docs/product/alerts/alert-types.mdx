...
The **Alert Details** page for a crash-rate alert shows you the history of the users or sessions crash-free percentage in the last 14 days by default, though you can also choose a time period of the last 30 days using the "Display" dropdown. These options are available for all time intervals greater than 30 minutes. For time intervals of 30 minutes, you can only see the users or sessions crash free percentage for the last six hours.
