...
The **Alert Details** page for a crash-rate alert shows you the history of the user or session crash-free percentage. By default, the page shows history for the last 24 hours, but you can change this view to show the last 6 hours, 3 days or 7 days, using the "Display" dropdown.
