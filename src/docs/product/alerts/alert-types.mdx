...
Alerts when transaction durations meet certain conditions. The conditions can be customized with flexible aggregates like percentiles, averages, and min/max.
