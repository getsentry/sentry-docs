...
- **Users Experiencing Errors:** {#users-experiencing-errors}
...
- **Crash Free Session Rate:** {#crash-free-session-rate}
...
- **Crash Free User Rate:** {#crash-free-user-rate}
...
- **Largest Contentful Display:** {#largest-contentful-display}
...
- **First Input Delay:** {#first-contentful-display}
