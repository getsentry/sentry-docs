...
- **Dead Clicks**: User clicks on `a` and `button` tags that do not result in any page activity after 7 seconds (meaning, no HTML was added, removed, or updated; no visual changes were observed in the page).
