...
Replays are retained for 90 days in [sentry.io](https://sentry.io) (the same retention period as other event types, such as Errors and Transactions). The retention period is not configurable.
