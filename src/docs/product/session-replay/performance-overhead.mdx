...
- At the time of publishing this document, the Session Replay plugin is an additional ~36KB gzipped.
  - In our own research, this is among the smallest file size Session Replay SDKs available.
