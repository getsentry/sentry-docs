...
When defining your policy it is important to ensure that [sentry.io](https://sentry.io) or your self-hosted Sentry domain is in your `default-src` or `connect-src` policy, or browsers will block requests that submit policy violations.
