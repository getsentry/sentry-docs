...
!<Link to="crumb-section.png">Breadcrumbs section</Link>
...
!<Link to="toggle-time-btn.png">Switch time format button</Link>
...
!<Link to="filter-by.png">Filter By Types/Levels</Link>
