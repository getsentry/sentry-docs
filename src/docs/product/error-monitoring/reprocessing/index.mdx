...
title: Reprocessing
sidebar_order: 10
description: Learn about reprocessing errors with new debug files and sourcemaps.
---

After you have uploaded new [debug information
files](/platforms/native/data-management/debug-files/) or
[sourcemaps](/platforms/javascript/sourcemaps/), Sentry only uses them for new
events going forward. _Reprocessing_ allows you to apply them to older events as
well.
