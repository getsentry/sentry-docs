...
title: Reprocessing
sidebar_order: 10
description: Sentry can reprocess issues that were missing required debug information files. Learn which platforms support reprocessing and how to set it up for your projects.
---
