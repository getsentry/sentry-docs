...
- **Org Members** can view most data in the organization and act on issues. They can join and leave teams, and access projects their teams own. For Business and Enterprise plans, members can also create personal projects (if allowed by organization settings).
...
\*For Business and Enterprise plans, depending on organization settings, Org Members who are not a Team Admin for any team can create a new personal project. When creating this project, the member can add a new personal team that they will become a Team Admin for. [Team Admin permissions](#permissions-1) will then apply for this team.
...
Org Members can join teams as a Team Contributor and be assigned Team Admin for specific teams. Depending on organization settings, Org Members who are not a Team Admin for any team can create a new personal project and personal team once, and become Team Admin for that team.
