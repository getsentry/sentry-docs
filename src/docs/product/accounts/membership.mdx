...
The role of Admin has been deprecated and replaced with new Team-level roles, available for Business plan users. Existing Admin-level users will continue holding the role.
...
| Can see and edit legal and compliance details                    |        |        |    X     |
...
| Can change Project settings                                  |     X   (*Only for projects they have access to*)  |        |
| Can add and remove Projects                                      |  X  (*Only for teams they’re an existing Admin for*)       |  |
| Can edit Global Integrations                                 |         |        |
| Can add, remove, and change members                                |         |        |
| Can add and remove teams                                         |         |        |
| Can add and remove repositories                                  |   X (*Only for teams they’re an existing Admin for*)     |       |
| Can change organization settings                             |         |        |
| Can remove an organization                                   |       |        |
| Can assign Team Admin Role                                   |    X (*Only for teams they’re an existing Admin for*)        |        |
