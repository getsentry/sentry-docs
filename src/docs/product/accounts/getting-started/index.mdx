...
1. Identify **suspect commits** that likely introduced an error ((GitHub and GitLab only)[/product/integrations/]).
...
If you're using a different SCM provider or don't want Sentry to connect to your repository, check out our [Releases documentation](/product/releases/adding-commits/) to learn how you can still add commits to your release.
