...
While **your current subscription volume won't change,** your current transactions quota will be converted to Performance Units at a 1:1 ratio. Depending on the Performance event types sent to Sentry, the rate at which you consume your total quota will change.

_For example, if you send 1M Transactions and 1M Transactions with Profiling, you will be consuming 2.3M units of your total quota [(1M _ 1 unit) + (1M _ 1.3 units)]._
