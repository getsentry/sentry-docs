...
All customers have the option to set a shared on-demand strategy. Customers on plans with [performance monitoring](/product/performance/) features have the ability to choose between a shared or per-category on-demand strategy:
