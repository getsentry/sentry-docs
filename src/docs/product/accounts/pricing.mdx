...
This document clarifies concepts around pricing and billing. For the breakdown of plans and prices, go to our [pricing page](https://sentry.io/pricing/).

## Volume {#capacity}

Volume is the total number of events and attachments/data units sent by and billed to your organization.

> An [event](/product/sentry-basics/key-terms/) is an error or transaction sent to Sentry’s server for processing. Errors can also have associated attachments. Additional metadata around the event (breadcrumbs, user context, environment, traces) do not count separately. Events and attachments are also called data.
...
Reserved volume (or quota) allows you to prepay for data at significant discounts. Your prepaid, reserved volume is always applied before on-demand volume. Unused reserved volume expires at the end of each billing month.
...
If you lower your on-demand budget mid-month below the month’s existing bill, we guarantee your new, lowered on-demand budget will be applied within 24 hours. In the meantime, the old on-demand budget will remain in effect. However, in most cases, the new budget will be applied within minutes.
...
- We bill you for [prepaid volume](#prepaid-reserved-capacity) every month
- You can also set up an [on-demand budget](#on-demand-capacity), for possible overages, which is priced differently.

You're only billed for on-demand volume if you use it. If you run out of prepaid data and on-demand budget, then we drop events and attachments and you're not billed for that data.
...
You must have either `Billing` or `Owner` permissions to access or make changes to information on this page. If you don't have those permissions, or you are not a member of the organization in Sentry, please reach out to a Billing member or an Owner to obtain invoices.
...
Plan upgrades take effect immediately. Plan downgrades and cancellations are processed as the end of the current contract cycle and cannot be refunded. If you no longer want to be on a paid plan, you'll revert to the base Developer plan at the end of your current billing cycle.

If you're currently on a paid plan, you can sign up for a 30-day trial; if you're on a free plan, you can run a trial for 14 days. Before the trial ends, Sentry will provide you options to upgrade and continue to use our latest features like Performance Monitoring. If you choose to opt in to a new plan at the end of your trial, the new plan takes effect immediately. If you don't sign up for plan or upgrade by the end of a trial, you will be downgraded to the same plan you were on prior to starting the trial.
