...
By setting an on-demand budget, you can control the maximum amount you'll pay for on-demand each month. Once your usage has consumed the maximum budget volume, you'll still be able to access prior event data. However, any additional data you send will be rejected.

If you raise your on-demand budget mid-month, your organization will start accepting additional data as soon as your new budget is applied. We guarantee new budgets will be applied and effective within 24 hours. However, in most cases your organization will start accepting data within minutes.
...
After the new budget is in effect, all additional data will be rejected and no additional on-demand volume will be added. At end of billing month, you will be charged for any on-demand volume consumed.
