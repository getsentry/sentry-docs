...
Please note that all per-category pricing listed below have been rounded to the nearest millionth.
...
Monitors for Crons cannot be pre-purchased. Crons are available to use and purchase through a pre-determined on-demand budget that can be shared across all event types or defined per category.
