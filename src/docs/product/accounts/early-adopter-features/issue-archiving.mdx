...
If you archive an issue with the "Forever" option, events for that issue will still be recorded, but the issue will never escalate even if it meets escalating conditions. You can still unarchive any archived issue, including those that have been archived "Forever". All unarchived issues will show up in the "Unresolved" tab. 
