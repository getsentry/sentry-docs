...
You can set up a new alert rule via the Opsgenie integration configuration page by going to **Alerts** and clicking "Create Alert", or by going to the **Alerts** page in Sentry.
