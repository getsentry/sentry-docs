...
Sentry supports data storage in both the US and the EU. Our primary hosting site will be in Germany and Sentry EU data at rest will remain in the EU.

You can choose where to store your data when you're setting up your Sentry account by selecting from the dropdown menu under "Data Storage" in the "Create a New Organization" section. Please note that once selected, your data storage location can't be changed. The only way to switch regions is by creating a new account.

## What Type of Data Is Stored Where

Here's a list of the types of data that will be stored in the local region (EU or US) versus the data stored in the US.

### Data Stored in local data center (EU or US)
