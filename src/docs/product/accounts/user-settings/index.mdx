...
Account preferences provide customization of your Sentry experience like notifications, primary email, and the ordering of frames in a stack trace. Manage your account by selecting "User settings" from the dropdown under your organization’s name.
...
<Note><markdown>
Changing your password invalidates all logged in sessions.
</Note></markdown>
...
- Alerts notify you about problems in your application and can be sent to many supported [integrations](/product/integrations/#webhook-alerts). You can set alerts on both errors and performance data.
...
For more details, see our [full documentation on Alerts & Notifications](/product/alerts-notifications/).
