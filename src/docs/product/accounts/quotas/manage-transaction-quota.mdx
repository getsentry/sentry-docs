...
This page is accessible to all members of your organization, so a Billing or Owner member can share this page with the developers directly responsible for a given project. Also, you can come back to this page to assess if the changes you've are having the desired effect.
...
## 2. Inbound Filters {#inbound-data-filters}
...
This page in [sentry.io](https://sentry.io) only refers to errors, but it is applicable for transactions as well.
