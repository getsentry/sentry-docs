...
<!-- does this make sense for transactions? -->

You can set up a query in **Discover** to see which transactions consume you're receiving the most and if you want to adjust that. When you're building the query, search for `event.type:transaction` and then set the columns to `transaction`, `title`, `project`, and `count`, as shown below:
