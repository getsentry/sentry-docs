...
You can set up a query in **Discover** to see which transactions consume you're receiving the most and if you want to adjust that. When you're building the query, set the columns as shown below:

![Busiest Projects](manage-event-stream-02.png)
<!-- update screenshot -->

Once the changes are applied, the "Results" table displays your busiest transactions:
