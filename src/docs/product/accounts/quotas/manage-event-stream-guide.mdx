...
Check out additional configuration options with the [tryCatch](/platforms/javascript/configuration/trycatch/) and [ReportingObserver](/platforms/javascript/integrations/reportingobserver/) integrations.
