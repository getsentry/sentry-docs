...
Note that only spikes that are over an hour long at minimum will be viewable from the stats page. A spike threshold in the form of a dotted line will be viewable for spikes that last more than 6hrs and less than 30 days.
