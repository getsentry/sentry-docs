...
<Note>
Notifications for Spike Protection are turned off by default to avoid excessive noise for users. Read the <a class href="/product/accounts/quotas/spike-protection/#notifications">notification</a> section below to learn how to turn them on for key projects.
</Note>
