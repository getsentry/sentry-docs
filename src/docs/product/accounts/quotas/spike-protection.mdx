...
To turn off notifications for yourself, go to **User Settings > Notifications > Spike Protection**. You can choose to turn off notifications for all projects, or customize notifications on a per-project basis.
