...
To ensure accuracy, only spikes that are over an hour long and fall into a time range that's between 6 hours and 30 days will be viewable from the **Stats** page. You'll be able to gage any spikes against a spike threshold in the form of a dotted line as long as the time range is between 6 hours and 30 days.
