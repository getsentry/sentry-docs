...
<Note>
Notifications for Spike Protection are turned off by default to avoid excessive noise for users. Read the [notification](#notifications) section below to learn how to turn them on for key projects.
</Note>
...
![spike-protection-notification-action](https://user-images.githubusercontent.com/26800704/233509692-b8a42c50-ad36-4aff-a9a7-65fb9810c745.png)
...
When a spike is detected, team members with Billing, Manager, or Owner-level permissions in Sentry will be notified via email, Pagerduty or Slack if they've enabled notifications for that project.
