...
For each project, you'll need to specify how much of your allocation goes to errors, to transactions, and to attachments. If your projects consume more than the limit you've set, overage volume will first come from your unallocated event pool, then from your on-demand budget if you've set one.

If your projects consume more than the limit you've set, overage volume will first come from your unallocated event pool, then from your on-demand budget if you've set one.

<Note>
With spend allocation, excess event consumption may come from your [on-demand budget](/product/accounts/pricing/#on-demand-capacity/) **even if you still have reserved volume available**.
</Note>
