...
For each project, you'll need to specify how much of your allocation goes to errors, to performance units, to replays, and to attachments.
...
2. Select the project, the event category (errors, performance units, replays or attachments), and the allocation amount you'd like to set aside for that project. You can choose your allocations by volume or spend. Repeat the process for each event type you'd like to allocate to.
