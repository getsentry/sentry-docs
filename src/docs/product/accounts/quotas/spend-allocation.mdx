...
If your projects consume more than the limit you've set, overage volume will first come from your unallocated event pool, then from your on-demand budget if you've set one. Once all your monthly volume has been consumed, any additional events will be dropped.
