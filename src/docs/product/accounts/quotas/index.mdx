...
Data and quotas are interconnected in Sentry. At the most basic level, when you [subscribe to Sentry](https://sentry.io/pricing/), you pay for the amount of data &#151 events (errors, replays, and transactions) and attachments &#151 to be tracked. Each of these data categories has a quota. When Sentry accepts an event or attachment, it counts toward your quota for that type of data.
...
| 7. [Apply SDK filtering](#7-sdk-filtering-beforesend) | &check; | &check; |  |
