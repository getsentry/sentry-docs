...
## Quota Managing by Data category

<!-- prettier-ignore-start -->

| something here     | Errors | Transactions | Attachments |
| ------------------ | ------ | ------------ | ----------- |
| [SDK filtering](#1-sdk-filtering-beforesend)      | Y      | N            | N           |
| [SDK configuration](#2-sdk-configuration)   | Y      | Y            | N           |
| [SDK sample rate](#3-sdk-sample-rate)    | Y      | Y            | N           |
| [Event grouping](#4-event-grouping)     | Y      | N            | N           |
| [Quota availability](#5-quota-availability)    | Y      | Y            | Y           |
| [Spike protection](#6-spike-protection)   | Y      | N            | N           |
| [Delete & Discard](#delete--discard)   | Y      | N            | N           |
| [Resolved](#resolve)            | Y      | N            | N           |
| [Ignore](#event-repetition)             | Y      | N            | N           |
| [Rate limiting](#8-rate-limits)        | Y      | N            | Y           |
| [Inbound filters](#9-inbound-filters)     | Y      | Y            | Y           |
