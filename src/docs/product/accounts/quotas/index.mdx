...
Because Sentry bills on monthly event volume, spikes can consume your Sentry capacity for the rest of the month. If it really is a spike, spike protection drops events during the spike to try and conserve your capacity. We also send an email [notification](/product/alerts-notifications/notifications/#quota) to the Owner when spike protection is activated.
