...
If you're on this page, it's probably because you've had some unanticipated quota usage. Or you're looking to control it for the future because you're a smarty pants who already knew this might be an issue.
...
This list of things to do to manage your quota is arranged from the fastest and least involved thing you can do to the most. Each of these items is linked to a longer explanation if you need it and the table indicates whether the action will affect, errors, transactions, or attachments or a combination of those.

<!-- prettier-ignore-start -->

| Action | Errors | Transactions | Attachments |
| ------ | ------ | ------------ | ----------- |
1. [Check your spike protection is enabled](#1-spike-protection) | Y | N | N |
1. [Review your event usage to see which projects are using up your quota](#common-workflows-for-managing-your-event-stream) | Y | Y | Y |
1. [Adjust your quota](#3-quota-availbility) | Y | Y | Y |
1. [Limit your events](#4-rate-limits) | Y | N | Y |
1. [Delete and discard issues](#5-delete--discard-issues) | Y | N | N* |
1. [Filter your events](#6-inbound-filters) | Y | Y | Y |
1. [Check your issue grouping (some of this is in the SDK)](#7-event-grouping) | Y | N | N|
1. [Update your SDK sample rate](#8-sdk-sample-rate) | Y | Y | N |
1. [SDK filtering](#9-sdk-filtering-beforesend) | Y | N | N |
1. [SDK configuration](#10-sdk-configuration) | Y | Y | Y |

<!-- prettier-ignore-end -->

### Size Limits

In addition to all the things you can actively do to manage your quota, Sentry imposes limits on various fields within an event, as well as the size of full events and the requests they are sent in:
...
## What Counts Towards my Quota (Quick Guide)

<!-- prettier-ignore-start -->

| Strategy (think about this name)                                    | Yes, this event counts                  | No, this event does not count |
| ------------------------------------------------------------------- | --------------------------------------- | ----------------------------- |
