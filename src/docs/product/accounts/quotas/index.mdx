...
| ------------------ | ------ | ------------ | ----------- |
| SDK filtering      | Y      | N            | N           |
| SDK configuration  | Y      | Y            | N           |
| SDK sample rate    | Y      | Y            | N           |
| Event grouping     | Y      | N            | N           |
| Quota availability | Y      | Y            | Y           |
| Spike protection   | Y      | N            | N           |
| Delete & Discard   | Y      | N            | N           |
| Resolved           | Y      | N            | N           |
| Ignore             | Y      | N            | N           |
| Rate limiting      | Y      | N            | Y           |
| Inbound filters    | Y      | Y            | Y           |
| Event usage stats  | Y      | Y            | Y           |
| Size limits        | Y      | Y            | Y           |
