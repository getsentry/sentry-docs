...
### 2. Increasing Quota {#increasing-quotas}
...
All Sentry SDKs support the `beforeSend` callback method, which you can use to modify the event's data or drop it completely. Learn More in the SDK Filtering section of [Manage Your Error Quota](/product/accounts/quotas/manage-event-stream-guide/#9-sdk-filtering-beforesend).
