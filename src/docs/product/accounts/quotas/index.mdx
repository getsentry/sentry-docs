...
- [Manage Your Performance Units Quota](/product/accounts/quotas/manage-performance-units-quota/)
...
- **Performance Unit** - A performance unit represents the total number of units that can be used across different Performance event types - (Transactions or a Transactions with Profiling). A Transaction consumes 1 Performance Unit and a Transaction with Profiling consumes 1.3 Performance Units.
