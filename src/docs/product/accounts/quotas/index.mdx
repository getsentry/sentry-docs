...
## Quota Management by Data category

<!-- prettier-ignore-start -->

| something here     | Errors | Transactions | Attachments |
| ------------------ | ------ | ------------ | ----------- |
| [Spike protection](#1-spike-protection)   | Y      | N            | N           |
| [Event usage stats](#common-workflows-for-managing-your-event-stream)     | Y      | Y            | Y           |
| [Quota availability](#3-quota-availability)    | Y      | Y            | Y           |
| [Rate limiting](#4-rate-limits)        | Y      | N            | Y           |
| [Delete & Discard](#5-delete--discard)   | Y      | N            | N           |
| [Resolved](#event-repetition)            | Y      | N            | N           |
| [Ignore](#event-repetition)             | Y      | N            | N           |
| [Inbound filters](#6-inbound-filters)     | Y      | Y            | Y           |
| [Event grouping](#7-event-grouping)     | Y      | N            | N           |
| [SDK sample rate](#8-sdk-sample-rate)    | Y      | Y            | N           |
| [SDK filtering](#9-sdk-filtering-beforesend)      | Y      | N            | N           |
| [SDK configuration](#10-sdk-configuration)   | Y      | Y            | N           |
| [Size limits](#size-limits)        | Y      | Y            | Y           |
