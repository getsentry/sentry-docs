...
If you rename your organization's slug, you will need to replace the previous organization slug with the new slug name in places where you enter the configuration values when setting up SSO/SAML.
...
If you rename your organization's slug, you will need to replace the previous organization slug with the new slug name in places where you enter the configuration values when setting up SCIM.
