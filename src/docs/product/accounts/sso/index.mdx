...
You may refer to [our documentation](/product/accounts/azure-sso/) for more detailed setup instructions.
...
You may refer to [our documentation](/product/accounts/okta-sso/) for more detailed setup instructions.
