...
Sessions last for [Django's default session length](https://docs.djangoproject.com/en/1.11/topics/http/sessions/#using-cookie-based-sessions), which is 2 weeks, and for individual organizations with Single Sign On, we expire organization access after one day (20 hours).
