...
If you use Okta to assign organization membership, you’ll be unable to make membership changes through Sentry and will need to continue using Okta.
...
If you use Okta to assign organization-level roles, you’ll be unable to make membership changes through Sentry and will need to continue using Okta.
