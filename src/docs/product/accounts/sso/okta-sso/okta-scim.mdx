...
- A list of valid roles can be found in the organization member's settings page.
- For security, roles with the `org:admin` permission scope cannot be provisioned through SCIM.
