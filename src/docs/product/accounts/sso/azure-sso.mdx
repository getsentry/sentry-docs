...
If you rename your organization's slug, you will need to replace the previous organization slug with the new slug name in the relevant steps where you enter the SAML configuration values.
...
If you rename your organization's slug, you will need to replace the previous organization slug with the new slug name in the relevant steps where you enter the SCIM configuration values.
