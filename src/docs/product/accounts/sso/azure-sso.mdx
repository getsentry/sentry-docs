...
1. Take the values from your Sentry SCIM configuration and enter your SCIM URL in the "Tenant URL" field and your SCIM Auth token in the "Secret Token" field.
...
1. It's recommended that you select the "Send an email notification when a failure occurs" option.
