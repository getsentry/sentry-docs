...
Azure SCIM integration is not currently available to all Sentry users. If you are interested in participating in SCIM's beta, please reach out to [support@sentry.io](mailto:support@sentry.io).

Also, this feature is only available if your organization is on a Business or Enterprise plan; it is not available on Trial plans.
