...
Go to **Project Settings** to perform tasks such as deleting tags, editing ownership rules, and managing data forwarding. You can also access proccessing settings (including detector threshold settings for performance issues) and SDK setup configurations.
