...
redirect_from:
  - /product/sentry-basics/search/saved-searches/
---
...
![UI walkthrough of the Saved Searches feature.](saved-searches.gif)
...
![UI walkthrough of the Custom Saved Searches feature.](custom-saved-searches.gif)
