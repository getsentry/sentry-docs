...
Sentry metrics help you measure the data points you care about over time, in order to pinpoint and solve issues impacting user experience and app performance. Track everything from processing time and event size to user signups and conversion rates, and correlate them with powerful tracing data in order to get deeper insights and solve issues faster.
