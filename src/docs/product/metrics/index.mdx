...
Sentry adds certain common tags by default such as, `project`, `environment`, and `release`, but you can also create your own custom tags to track attributes that help organize your data for your specific use case. Some common examples of useful tags are browser name, region, language, or customer.

## Limits and Restrictions

### Cardinality

When dealing with metrics, it's important to be wary of cardinality explosion. Here's an example to help you understand what this means.
