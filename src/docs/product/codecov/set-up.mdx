...
- The [Github Integration](/integrations/source-code-mgmt/github/) installed in Sentry with [Code Mappings](/integrations/source-code-mgmt/github/#stack-trace-linking) enabled.
<Note>
    If you have the Github integration set up correctly, your stack traces will show an “Open this line in Github” message.
</Note>

- A [Codecov](https://about.codecov.io/) account with [Source Code Coevreage](https://about.codecov.io/product/feature/source-code-coverage/) enabled.
