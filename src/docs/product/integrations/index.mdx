...
Set these integrations up once per organization, then they're available for _all_ projects. Organization level integrations fall into two categories: integrations created by Sentry and integrations created by partners. Content for the Integration Platform is maintained by Sentry partners but linked here for your convenience.
