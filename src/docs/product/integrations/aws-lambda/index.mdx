...
1. Click on the link that says **Go to AWS**.
...
1. Wait a minute or two for the stack to be created. When you see the status change to **Create Complete**, copy the stack ID back into the installation modal, insert it into the input field that says **ARN**, and finally press **Next**.
