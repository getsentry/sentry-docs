---
title: AWS Lambda (Node/Python)
sidebar_order: 1
description: "Learn more about Sentry's AWS Lambda integration and how you can automatically instrument your Node/Python Lambda functions with Sentry without changing your code."
---
...
Looking for instructions to set up the Python serverless SDK manually? [Check out these docs instead](/platforms/python/guides/aws-lambda/).
