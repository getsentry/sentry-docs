...
The channel field must be filled in with a Discord channel ID, _not_ a channel name (this is because multiple Discord channels can share a name). To get this channel ID, you must enable Discord's Developer Mode (Settings -> Advanced -> Developer Mode).
