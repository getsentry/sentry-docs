...
Metric alert Slack notifications include a chart of the metric's status status and a link to investigate the alert further.

   ![](slack-metric-alert-message.png)
