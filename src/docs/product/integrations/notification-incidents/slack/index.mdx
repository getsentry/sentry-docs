...
1.  In Sentry, navigate to **Settings > Integrations > Slack**.
...
4.  Your integration details page will refresh and show the Slack workspace you just added.
...
Navigate to **Alerts > Create Alert**. From here, you can configure when notifications are sent to your Slack workspace(s).

You can select Slack as either an [issue alert](/product/alerts/alert-types/#issue-alerts) action:

![](slack_issue_alert.png)

or a [metric alert](/product/alerts/alert-types/#metric-alerts) action.
