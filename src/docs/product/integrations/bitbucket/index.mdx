...
Use data from Bitbucket commits to track and resolve bugs.
...
- [Configure](#configure)
    ...
    - [Suspect Commits](#suspect-commits-and-suggested-assignees)
    - [Issue Management](#issue-management)
    - [Resolving in Commit](#resolving-in-commit)
