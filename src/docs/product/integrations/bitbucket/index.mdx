...
redirect_from:
  ...
  - /workflow/legacy-integrations/bitbucket/
  - /workflow/global-integrations/integrations/bitbucket/
---
...
<Alert title="Note" level="info">
  Sentry owner or manager permissions, and Bitbucket admin permissions are
  required to install this integration.
</Alert>
...
Note: Confirm <Link to="/meta/ip-ranges/">Sentry's IP ranges</Link> are allowed.
