...
Sentry’s Integration Platform provides a way for external services to interact with Sentry using the REST API and webhooks. Integrations using this platform are first-class actors within Sentry.
