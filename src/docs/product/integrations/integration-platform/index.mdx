...
[Public integrations](/product/integrations/integration-platform/public-internal-integrations/public-integration) require a logo image to be uploaded. The requirements for those are:
...
If you're looking for any of the new features below, we recommend you switch to using Sentry integrations and build an [internal integration](/product/integrations/integration-platform/public-internal-integrations/internal-integration).
