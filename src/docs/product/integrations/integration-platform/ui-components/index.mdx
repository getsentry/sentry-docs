...
![Sentry modal that creates a Shortcut Story that's linked to a Sentry issue.](../../project-mgmt/shortcut/shortcut_create_story_with_issue.png)
...
![Sentry's sidebar button illustrating that an issue is linked.](../../project-mgmt/shortcut/shortcut_story_in_linked_issues_82.png)
