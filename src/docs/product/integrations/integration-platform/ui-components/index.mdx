...
!<Link to="../../clubhouse/clubhouse_create_story_with_issue.png">Sentry modal that creates a Clubhouse Story that's linked to a Sentry issue.</Link>
...
!<Link to="stack-trace-example.png">Example of a stack trace using Rookout.</Link>
...
!<Link to="../../clubhouse/clubhouse_story_in_linked_issues_82.png">Sentry's sidebar button illustrating that an issue is linked.</Link>
