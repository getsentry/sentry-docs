...
The `uri` keys in your schema elements describe the URI path that will receive a request from that UI Component. Sentry will append the path in the `uri` field onto the host of your integration's **Webhook URL**.
