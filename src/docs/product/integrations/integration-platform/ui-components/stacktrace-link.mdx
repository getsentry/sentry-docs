...
This feature allows the developer to insert a link within a stack trace frame. The link contains details about the project, file name and line number. This can be used to view the file on your service or continue the debugging with a helpful reference.
