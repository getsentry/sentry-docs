...
- `uri` - (Required) The link destination. Sentry will automatically add the following query params to the link. See [URI Guidelines](/product/integrations/integration-platform/ui-components/#uri-guidelines) for formatting help.
