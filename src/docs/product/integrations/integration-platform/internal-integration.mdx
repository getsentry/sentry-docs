...
Internal integrations automatically generate an [Authentication Token](/product/integrations/integration-platform/#using-auth-tokens) when configured. Should you need multiple tokens, or need to get a new one, you can go to **Settings > Developer Settings > [Your Internal Integration]** and do so.
