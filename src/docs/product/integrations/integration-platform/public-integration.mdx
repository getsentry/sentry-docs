...
Public integrations generate [Authentication Tokens](/product/integrations/integration-platform/#using-auth-tokens) after a successful [OAuth Installation](#oauth-process).
