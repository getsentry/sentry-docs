...
1. Click the "Configure" button next to your Bitbucket Instance.
...
After you've set up code mapping for your project, you should see a direct link to the problem line of code in your stack trace, as shown below:

![](bitbucket-stacktrace-link.png)
