...
These features will be automatically enabled for you once your GitHub integration has been set up. To disable it, go to **Settings > Integrations > GitHub** and toggle it off.
...
Sentry will comment up to five issues per file that were first seen within the past 90 days and were last seen within the past 14 days.
