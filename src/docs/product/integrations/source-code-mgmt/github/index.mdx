...
Sentry will automatically try to set up code mappings on Python and JavaScript projects for organizations with the GitHub integration installed. However, you can still manually add code mappings yourself. Support for other languages and other source code integrations are planned.
