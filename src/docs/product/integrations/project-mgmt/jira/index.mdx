...
Sentry owner, manager, or admin permissions, and Jira admin permissions are required to install this integration. This includes permissions: `read`, `write`, `act_as_user`, `access_email_addresses`.
