...
If you're having trouble configuring Stack Trace Linking, verify the following:

1. Check that the **stack trace** does not have relative paths. And if it does, create a **Code Mapping** for that **stack trace root**.
