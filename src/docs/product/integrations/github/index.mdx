...
1. Confirm <Link to="/meta/ip-ranges/">Sentry's IP ranges</Link> are allowed for your GitHub Enterprise instance.
...
For more details, see the full documentation for <Link to="/accounts/sso/">Single Sign-on</Link>.
