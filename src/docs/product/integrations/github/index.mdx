...
Use data from GitHub commits to track and resolve bugs.
...
- [Configure](#configure)
    ...
    - [Resolving in Commit or Pull Request](#resolving-in-commit-or-pull-request)
...
### Resolving in Commit or Pull Request
