...
redirect_from:
  ...
  - /workflow/legacy-integrations/pagerduty/
  - /workflow/global-integrations/integrations/pagerduty/
---
...
On this page:
- [Install](#install)
- [Deleting the legacy PagerDuty integration](#deleting-the-legacy-pagerduty-integration)
