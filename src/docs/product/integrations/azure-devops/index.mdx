...
To configure issue management automatically, create an [**Issue Alert**](/product/alerts-notifications/issue-alerts/). When selecting the [**action**](alerts-notifications/issue-alerts/#actions), choose **Create a new Azure DevOps work item**.
