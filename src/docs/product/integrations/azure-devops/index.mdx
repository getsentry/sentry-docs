...
<Alert title="Note" level="info">
  Sentry owner or manager permissions, and Azure project admin permissions are
...
2. If you have the legacy VSTS integration installed, you’ll see a button next to Azure DevOps that says **Upgrade**. If you do not have the legacy VSTS integration installed, you’ll see a button that says **Install**.
   ...
   ![](azure-global-install.png)

3. In the resulting modal, click **Add Installation**.

   ![](azure-global-add-installation.png)
...
- For Single Sign-On, see <Link to="/accounts/sso/azure-sso/">Azure Active Directory SSO</Link>.
