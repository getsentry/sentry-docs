...
- If you have multiple accounts in Azure DevOps, open https://aex.dev.azure.com in another tab, select the correct account and redo the installation. If that works, please upvote https://github.com/getsentry/sentry/issues/14357, which is where we're tracking this improvement.
