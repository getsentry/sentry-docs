...
Linear needs to set up only once per organization, then it is available for _all_ projects. It is maintained and supported by the company that created it. For more details, see <Link to="/product/integrations/integration-platform/">Integration Platform</Link>.
