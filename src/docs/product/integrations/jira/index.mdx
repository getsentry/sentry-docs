...
### Trouble with on premise installation
...
### "Something went wrong" message when installing JIRA on SaaS sentry.io

![](jira-something-went-wrong.png)

This usually happens if you have an ad blocker that is blocking the conversation between JIRA and Sentry during setup. To remediate this, disable your ad blocker and go through the installation flow again.
