...
This issue typically occurs if you have an ad blocker blocking the conversation between JIRA and Sentry during setup. To remediate this, disable your ad blocker and go through the installation flow again.
