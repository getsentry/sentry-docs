...
Linear needs to be set up only once per organization, and then it is available for _all_ projects. It's maintained and supported by the company that created it. For more details, see [Integration Platform](/product/integrations/integration-platform/).
