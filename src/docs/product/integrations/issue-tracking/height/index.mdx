...
Issue tracking allows you to create Height tasks from within Sentry, and link Sentry issues to existing Height tasks. Issue management can be configured in two ways — automatically or manually.
