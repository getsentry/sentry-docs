...
![Installed Height integration](height-install.png)
...
![Height metric alert rule action settings](height-rule.png)
...
![Link Height issue in Sentry](height-link-issue.png)

Here, you’ll be able to create or link Height tasks:

![Create Height issue form](height-create-issue.png)
