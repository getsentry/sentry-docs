...
Ignored fields are Jira fields that are hidden in the issue creation form. To add ignored fields, navigate to **Organization Settings > Integrations** and click "Configure" next to your Jira instance. Then scroll down to “Ignored Fields”.

Type the id or name of the Jira field, not the label, into the text input box. The following section will state how to find the field id or name.

#### Find the id of the Field

1. In Jira, access a ticket that has the field that you want the id or name of
2. Right click the screen and select “Inspect” or click F12
3. Click the “Elements” tab of the Inspect module
4. Click the “Select an element” button on the top left of the Inspect module
   ![Select an element button](select-element.png)
5. Click the field that you want the id or name of
6. View the name or id of the field
   a. The name or id of the field is the last part of the ‘data-testid’ field
      ![Jira field id or name](jira-field-id-name.png)
