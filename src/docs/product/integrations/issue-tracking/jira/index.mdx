...
Enter a comma separated list of the Jira field IDs, which is different from the label on the form. If you need help finding the field's ID, see the Atlassian docs [here](https://confluence.atlassian.com/jirakb/how-to-find-id-for-custom-field-s-744522503.html).
