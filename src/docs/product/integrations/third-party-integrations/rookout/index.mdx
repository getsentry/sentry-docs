...
title: Rookout
sidebar_order: 1
description: "Rookout is an organization level integration for adding a layer of depth to Sentry Issues by allowing you to jump right from an Issue to a non-breaking breakpoint on the line that caused the error."
redirect_from:
