...
title: Jira
sidebar_order: 1
description: "Jira is an organization level integration for connecting errors from Sentry with Jira issues."
redirect_from:
...
- The IP addresses Sentry uses to make outbound requests are [allowed](/meta/ip-ranges/).
