...
title: Vercel
sidebar_order: 1
description: "Vercel is an organization level integration for connecting your Sentry and Vercel projects to automatically upload source maps and notify Sentry of release deployment."
redirect_from:
