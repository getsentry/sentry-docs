...
sidebar_order: 1
description: "Microsoft Teams is an organization level integration for receiving alerts that let you assign, ignore, and resolve issues right in your Teams channels "
---
