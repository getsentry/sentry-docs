...
title: Linear
sidebar_order: 1
description: "Linear is an organization level integration for creating new Linear issues from Sentry and linking Sentry issues to existing Linear issues."
---
