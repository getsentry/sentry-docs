...
title: Split
sidebar_order: 1
description: "Split is an organization level integration for processing and displaying Sentry exception data in the Split platform as events for analysis."
redirect_from:
  - /workflow/integrations/split/
  - /workflow/integrations/global-integrations/split/
---

The Split integration quickly processes and displays Sentry exception data in the Split platform as events for analysis. You can control what environments and traffic types you're capturing exceptions for in the Split dashboard without having to touch any code.
