...
title: GitHub
sidebar_order: 1
description: "GitHub is an organization level integration for tracking and resolving bugs faster by using data from your GitHub commits, and streamlining your triaging process by creating a GitHub issue directly from Sentry."
redirect_from:
