...
title: GitLab
sidebar_order: 1
description: "GitLab is an organization level integration for tracking and resolving bugs faster by using data from your GitLab commits. Additionally, you can streamline your triaging process by creating a GitLab issue directly from Sentry."
redirect_from:
...
1. Within Integrations, find the GitLab icon and click **Install**.
   ...
   ![GitLab icon and install button](integration-pg.png)
