...
2. Click the "Add to Team" button and pick the Team you want for the integration
...
3. To navigate to Alert Rule settings, click "Add Alert Rule" for this project.
   ...
   You can also access **Alerts** from your **Project Settings**. From Project Settings, you can configure when notifications are sent to your Microsoft Team(s).
