...
1. You can uninstall the integration from Vercel or Sentry. To do so in Sentry, navigate to **Organization Settings** > **Integrations** > **Vercel** > **Configurations**, click "Uninstall" and confirm.
