...
![](vercel_failed_to_fetch.png)

This usually happens if you have an ad blocker that is blocking the conversation between Vercel and Sentry during setup. To remediate this, disable your ad blocker and go through the installation flow again.
