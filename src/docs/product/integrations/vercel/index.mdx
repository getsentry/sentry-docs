...
redirect_from:
  ...
  - /workflow/global-integrations/integrations/vercel/
---
...
2. Select your account and click "Add".
   ...
   !<Link to="vercel_install.png">Sentry modal showing Vercel installation</Link>
   ...
   !<Link to="vercel_internal_integration.png">Sentry modal showing Vercel internal integration</Link>
...
1. Select a Sentry project and a Vercel project to link together.
   ...
   !<Link to="vercel_link_project.png">Sentry modal showing linking Sentry project to Vercel project</Link>
   ...
   !<Link to="vercel_env_vars.png">Sentry modal showing linking Sentry project to Vercel project</Link>
...
- If you have not already done so, <Link to="/error-reporting/quickstart/">instrument your code with Sentry</Link>.
...
1. The integration must be uninstalled from Vercel. Visit the Vercel integration configuration page (**Organization Settings** > **Integrations** > **Vercel** > **Configurations**) and click "Uninstall" then "Visit Vercel" in the modal that pops up.
   ...
   !<Link to="vercel_uninstall.png">Sentry modal showing uninstalling Vercel integration</Link>
...
3. Delete the internal integration that was created by navigating to **Organization Settings** > **Developer Settings** and clicking the trash can icon next to **Vercel Internal Integration**. You will be prompted to confirm the deletion by entering a string provided in the modal. Enter the string and click "Confirm" to finalize the deletion.
   ...
   !<Link to="vercel_delete_internal_integration.png">Sentry modal showing uninstalling Vercel integration</Link>
