...
For error issues, the stack trace of the latest event is shown by the issue title. You can also hover over the coloured square to the left of the issue information to see the error level (error, info, fatal, warning, debug, or sample) of the latest event:
