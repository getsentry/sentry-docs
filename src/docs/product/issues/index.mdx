...
In addition to collecting application errors, Sentry can also collect performance problems. If your application is configured for [Performance Monitoring](/product/performance), Sentry will detect common performance problems, and group them into issues just like it does with errors.

Learn more in [Performance Issues](/product/issues/performance-issues/).
