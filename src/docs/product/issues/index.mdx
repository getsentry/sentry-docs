...
Sentry can also saved your issue queries on this page, which can be accessed by clicking the "Saved Searches" button in the header. Learn more in [Saved Searches](/product/sentry-basics/search/saved-searches/)
