...
- Ignored: The issue is ignored permanently or until a condition is met to move it to the Unresolved state. [Issue alerts](/product/alerts-notifications/issue-alerts/) are suppressed for ignored issues.
