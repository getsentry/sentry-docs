...
Paying attention to to the status tags attached to Issues on the [**Issues** page](https://sentry.sentry.io/issues/) in Sentry, can help you triage and prioritize problems with your application that are important to you. Keep in mind that an Issue can only have **one status at a time.**
