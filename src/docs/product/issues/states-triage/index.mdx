...
You can sort and prioritize Issues on the Issues page in Sentry.io by paying attention to the status tags attached to every Issue. It's important to note that an Issue can only have one status at a time.
...
One way to sort the Issues that you see is by selecting a tab at the top of the page. On the “Unresolved tab” you'll find: New, Ongoing, Escalating, and Regressed issues, but you can also narrow down what you see by choosing the “For Review”, “New”, “Escalating”, “Ongoing”, or “Archived” tabs.
...
You can remove an Issue from the Issue list by deleting it, but it will reappear as a new Issue if it reoccurs.
