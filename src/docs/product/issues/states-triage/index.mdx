...
Triaging is the act of deciding what action you want to take on an issue. The image below shows how issues move through different states, with the applicable labels.
