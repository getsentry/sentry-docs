...
We support CODEOWNERS files with a maximum size of 3MB. If your file exceeds this size, we suggest using wildcard rules to consolidate multiple entries into a single one.
