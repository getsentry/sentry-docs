...
Head to your organization’s **Settings > Integrations** page, and click on the integration you’d like to use. You’ll need to configure the integration first, if you haven’t already and add the repository you'd like to use.
