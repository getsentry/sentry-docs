...
It's the most important piece of information that the Sentry grouping algorithm uses to group events into one issue. You can also customize how events are grouped. Learn more about customized grouping in [Grouping Issues](/product/data-management-settings/grouping-issues/).
