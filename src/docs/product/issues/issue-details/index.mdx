...
The quick trace (which displays below the date) is an abbreviated view of the related [trace](/product/performance/distributed-tracing) for the current transaction.
...
Click "View Full Trace" to display the [Trace View](/product/performance/trace-view).
