...
- Warning - yellow
- Fatal - red
  <!-- - Debug - this one doesn't show up in search options - is that because there are no issues that meet the criteria?) -->
  <!-- - Sample - this one doesn't show up in search options - is that because there are no issues that meet the criteria?) -->
