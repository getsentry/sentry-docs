...
The performance could be improved by moving the JSON decoding to a background queue:
...
The performance could be improved by moving the JSON decoding to a coroutine:
