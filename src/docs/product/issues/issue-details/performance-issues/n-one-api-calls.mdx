...
If the list has 100 books in it, the page will make 100 network calls simultaneously. The number 100 is the "N" in "N+1 API Calls". This effect is visible in the span waterfall, which shows all the simultaneous network requests:
