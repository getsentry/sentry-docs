...
View it by going to the **Issues** page in Sentry, selecting your Android project, clicking on the Consecutive DB Queries error you want to examine, then scrolling down to the "Span Evidence" section in the "Details" tab.
## Example
