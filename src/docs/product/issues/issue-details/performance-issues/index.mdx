...
<table>
   <tr>
       ...
       <td>
          <ul>
            <li><a href="./large-render-blocking-asset/">Large Render Blocking Asset</a></li>
            <li><a href="./n-one-api-calls/">N+1 API Calls</a></li>
            <li><a href="./uncompressed-asset">Uncompressed Asset</a></li>
          </ul>
        </td>
    </tr>
   <tr>
       ...
       <td>
          <ul>
            <li><a href="./consecutive-db-queries/">Consecutive DB Queries</a></li>
            <li><a href="./n-one-queries/">N+1 Queries</a></li>
            <li><a href="./slow-db-queries/">Slow DB Queries</a></li>
          </ul>
        </td>
    </tr>
   <tr>
    <th>Mobile</th>
       <td>
          <ul>
            <li><a href="./file-main-thread-io/">File I/O on Main Thread</a></li>
            <li><a href="./db-main-thread-io/">Database on Main Thread</a></li>
            <li><a href="./json-decoding-main-thread/">JSON Decoding on Main Thread</a></li>
            <li><a href="./image-decoding-main-thread/">Image Decoding on Main Thread</a></li>
            <li><a href="./n-one-api-calls/">N+1 API Calls</a></li>
          </ul>
        </td>
    </tr>
