...
If no ownership rules match the event, the alert will notify members based on the [fallback setting selected](/product/alerts/create-alerts/issue-alert-config/#issue-owners).
