...
Learn more about how to manually capture errors or enable message capture with Sentry's JavaScript SDK in [Capture Errors](/sdks/javascript/errors/capture).
...
Learn more about the data sent to with events in [Enrich Event Data](/sdks/javascript/errors/).
...
When you’re using the Sentry JavaScript SDK, the SDK automatically fetches the source code and source maps by scraping the URLs within the stack trace. If you need to disable the JavaScript source fetching, log in to Sentry and toggle off `Allow JavaScript source fetching` in your organization's settings for Security & Privacy. See our [source maps documentation](/sdks/javascript/config/sourcemaps) to learn more.

Upload source maps using either our [Webpack plugin](/sdks/javascript/config/sourcemaps/#webpack) or the [Sentry CLI](/cli/). Sourcemaps can be generated by [Uglify JS](/sdks/javascript/config/sourcemaps/#uglifyjs), [System JS](/sdks/javascript/config/sourcemaps/#systemjs), or [TypeScript](/sdks/javascript/config/sourcemaps/#typescript).
...
- **[Manage Configuration Options](/sdks/javascript/config/)**
...
- **[Enrich Event Data](/sdks/javascript/errors/)**
...
- **[Review and Manage Integrations](/sdks/javascript/integrations/)**
...
- **[Troubleshooting](/sdks/javascript/troubleshooting/)**
