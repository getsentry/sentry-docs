...
Learn more about how to manually capture errors or enable message capture with Sentry's JavaScript SDK in [Capture Errors](/sdks/react/errors/capture).
...
Learn more about the data sent to with events in [Enrich Event Data](/sdks/react/errors//).
...
- **[Manage Configuration Options](/sdks/react/config/)**
...
- **[Enrich Event Data](/sdks/react/errors/)**
...
- **[Review and Manage Integrations](/sdks/react/integrations/)**
...
- **[Troubleshooting](/sdks/react/troubleshooting/)**
