...
- **[Shutdown and Draining](./shutdown-drain/)**
  ...
  Learn more about the default behavior of our React SDK if the application shuts down unexpectedly.

- **[Source Maps](./sourcemaps/)**

  Learn more about the Sentry React SDK's automatic fetching of source code and source maps by scraping the URLs within the stack trace.
