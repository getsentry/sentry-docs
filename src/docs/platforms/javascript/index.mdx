...
<Alert level="warning" title="Use of defer"><markdown>
...
<Alert level="warning" title="Dealing with Ad-Blockers"><markdown>
...
<Alert level="warning" title="Support for <= IE 11"><markdown>
...
[![Modal popup asking user for more context on what occurred before the break.](js-index/sentry-dialog.png)](js-index/sentry-dialog.png)
