...
[![Error in Unresolved Issues with title This is my fake error message](error-message.png)](error-message.png)
...
[![Stack trace of a captured error](automatically-capture-errors.png)](automatically-capture-errors.png)
...
[![Modal popup asking user for more context on what occurred before the break.](sentry-dialog.png)](sentry-dialog.png)
