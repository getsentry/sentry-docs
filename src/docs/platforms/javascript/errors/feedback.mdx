...
If you're using a framework, such as React or Angular, we recommend collecting user feedback in your error-handling component. Examples are provided in the [React](/platforms/react/components/errorboundary/) and [Angular](/platforms/angular/) documentation.
