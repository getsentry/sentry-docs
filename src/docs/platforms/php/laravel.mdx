...
The Laravel integration will create [breadcrumbs](/platforms/php/#breadcrumbs) for certain events occurring in the framework, the capture of this information can be configured using the following options:
...
If you want errors to be sent to Sentry when you are developing set the DSN value to `null`.
