...
title: Support
sidebar_order: 8
description: "As a paying customer of Sentry, you have access to various forms of support; and if you are using the self-hosted version, you can get in contact with the Sentry community for questions. All Sentry repositories can be found on GitHub."
---

The primary source of truth for Sentry bugs and feature requests is [GitHub](https://github.com/getsentry/sentry/issues). If you run into something please open an issue there. If you are a paying customer you can contact our Customer Support team in the app. If you need help configuring Sentry you can ask on our Discord or Discussions, but we don't make any promises.
