...
The `index.md` is exposed as the root platform instructions, and `{guide}.md` is exposed as a child integration of the platform. This functions similarly to the [platform pages](../pages/platforms).
