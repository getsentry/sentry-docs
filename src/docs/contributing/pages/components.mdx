...
Enforces the correct casing or case_style setting of terms for each platform in the main body text (not in code samples):
...
This component only works in platform pages.
