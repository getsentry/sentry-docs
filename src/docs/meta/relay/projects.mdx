...
The public key (`<DSN_KEY>`) is the key of the project's DSN and is unrelated toh the Relay public key used for Relay registration.
...
[getting started]: /product/relay/getting-started/
