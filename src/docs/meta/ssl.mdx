...
<Alert title="Note" level="warning">
  The contents of this page only apply to Sentry's SaaS product. It **does not**
  apply to Self-hosted or Single Tenant.
</Alert>

Sentry's API, Dashboard, and Event Submission require a minimum TLS version of 1.0 to communicate securely.
