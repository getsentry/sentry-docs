...
Checkout additional configuration options with the [TryCatch](/platforms/javascript/#trycatch) and [ReportingObserver](/platforms/javascript/#reportingobserver) integrations.
