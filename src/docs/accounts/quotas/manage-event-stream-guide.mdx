...
- [Integrating the SDK: Decluttering Sentry](/platforms/javascript/#decluttering-sentry)
- [Filtering Events](/error-reporting/configuration/filtering)
- [Enriching Error Data](/enriching-error-data/additional-data/?platform=browser)
...
Check out additional configuration options with the [TryCatch](/platforms/javascript/#trycatch) and [ReportingObserver](/platforms/javascript/#reportingobserver) integrations.
...
For more information on the Fingerprint algorithm and customizing event grouping see [Grouping & Fingerprints](/data-management/event-grouping/).
