...
For more details, see our <Link to="/workflow/alerts-notifications/">full documentation on Alerts & Notifications</Link>.
...
!<Link to="us-ereport.png">Weekly Report email sample</Link>
