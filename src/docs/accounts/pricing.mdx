...
If your projects have a high volume of events, you can control how many errors Sentry receives by reviewing Sentry's guide to <Link to="/accounts/quotas/manage-event-stream-guide/">Manage Your Event Stream</Link>.
...
Users with the role of <Link to="/accounts/membership/">Billing or Owner</Link> can find all previous invoices by going to **Organization > Usage & Billing > Usage & Payments > Receipts**.
