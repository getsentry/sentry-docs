...
For other SAML2 SSO providers not listed above, Sentry provides generic connectors for <Link to="/accounts/sso/saml2/">SAML2 based authentication</Link>, which may be configured manually.
