...
The `raven-go` SDK is no longer maintained and was superseded by the `sentry-go` SDK. Learn more about the project on [GitHub](https://github.com/getsentry/sentry-go) and check out the <Link to="/platforms/go/migration/">migration guide</Link>.
...
More on this in <Link to="/clients/go/config/">Configuration</Link> section.
...
- <Link to="/clients/go/config/">Configuration</Link>
- <Link to="/clients/go/usage/">Usage</Link>
- <Link to="/clients/go/context/">Context</Link>
- <Link to="/clients/go/integrations/">Integrations</Link>
  - <Link to="/clients/go/integrations/">net/http</Link>
