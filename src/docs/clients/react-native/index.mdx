...
This SDK has been superseded by the new React Native SDK. Sentry preserves this documentation for customers using the old client. We recommend using the <Link to="/platforms/react-native/">updated React Native SDK</Link> for new projects.
...
The _link_ step will pull in the native dependency and patch your project accordingly. If you are using expo you don’t have to (or can’t) run that link step. For more information about that see <Link to="/clients/react-native/expo/">_Using Sentry with Expo_</Link>.
...
To see what is happening during linking you can refer to <Link to="/clients/react-native/manual-setup/">_Manual Setup_</Link> which will give you all the details.
...
Currently we only support mixed stack traces on iOS. By default this feature is disabled. We recommend testing your app thoroughly when activating this, to turn it on `deactivateStacktraceMerging: false` see: <Link to="/clients/react-native/config/">_Additional Configuration_</Link>.

## Deep Dive

- <Link to="/clients/react-native/config/">Additional Configuration</Link>
- <Link to="/clients/react-native/expo/">Using Sentry with Expo</Link>
- <Link to="/clients/react-native/codepush/">Using Sentry with CodePush</Link>
- <Link to="/clients/react-native/sourcemaps/">Source maps for Other Platforms</Link>
- <Link to="/clients/react-native/cocoapods/">Setup With CocoaPods</Link>
- <Link to="/clients/react-native/ram-bundles/">Using RAM Bundles</Link>
- <Link to="/clients/react-native/manual-setup/">Manual Setup</Link>
