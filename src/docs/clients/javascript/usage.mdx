...
To learn more about what types of data can be collected via breadcrumbs, see the [breadcrumbs client API specification](/platforms/javascript/enriching-error-data/breadcrumbs/).
...
For more details on this feature, see the [_User Feedback guide_](/platforms/javascript/enriching-error-data/user-feedback/).
