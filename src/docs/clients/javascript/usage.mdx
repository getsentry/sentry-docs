...
: [Tags](/platforms/javascript/enriching-error-data/additional-data/#tags) to assign to the event.
...
To learn more about what types of data can be collected via breadcrumbs, see the <Link to="/platforms/javascript/enriching-error-data/breadcrumbs/">breadcrumbs client API specification</Link>.
...
For more on configuring breadcrumbs, see <Link to="/clients/javascript/config/">_Configuration_</Link>.
...
For more details on this feature, see the <Link to="/platforms/javascript/enriching-error-data/user-feedback/">_User Feedback guide_</Link>.
...
For more information, see <Link to="/data-management/event-grouping/">Customize Grouping with Fingerprints</Link>.
