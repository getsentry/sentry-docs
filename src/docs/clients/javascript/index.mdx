...
A new JavaScript SDK has superseded this deprecated version. Sentry preserves this documentation for customers using the old client. We recommend using the <Link to="/platforms/javascript">updated JavaScript SDK</Link> for new projects.
...
If you’re using Node.js on the server, you’ll need <Link to="/clients/node/">raven-node</Link>.
...
For installation using npm or other package managers, see <Link to="/clients/javascript/install/">_Installation_</Link>.
...
Once you have Raven up and running, we highly recommended you check out <Link to="/clients/javascript/config/">_Configuration_</Link> and <Link to="/clients/javascript/usage/">_Usage_</Link>.
...
- <Link to="/clients/javascript/install/">Installation</Link>
- <Link to="/clients/javascript/config/">Configuration</Link>
- <Link to="/clients/javascript/usage/">Usage</Link>
- <Link to="/clients/javascript/integrations/">Integrations</Link>
...
- <Link to="/clients/javascript/sourcemaps/">Source Maps</Link>
- <Link to="/clients/javascript/tips/">Tips and Tricks</Link>
