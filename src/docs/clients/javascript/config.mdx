...
Can also be defined with `Raven.setRelease('721e41770371db95eee98ca2707686226b993eda')`. To learn more about configuring releases and deploys, click <Link to="/workflow/releases/">here</Link>.
...
: Additional <Link to="/platforms/javascript/enriching-error-data/additional-data/">tags</Link> to assign to each event.
