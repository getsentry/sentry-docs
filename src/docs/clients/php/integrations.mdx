...
This documentation refers to the v2.x of the bundle. This version does not support the newest <Link to="/platforms/php/">Unified API client</Link>.

You can upgrade to <Link to="/platforms/php/symfony/">the newer version</Link> if you're on PHP 7.1+ and Symfony 3.4+.
