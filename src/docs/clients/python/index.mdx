...
A new Python SDK has superseded this deprecated version. Sentry preserves this documentation for customers using the old client. We recommend using the <Link to="/platforms/python/">updated Python SDK</Link> for new projects.
...
- <Link to="/clients/python/usage/">Basic Usage</Link>
- <Link to="/clients/python/advanced/">Advanced Usage</Link>
- <Link to="/clients/python/breadcrumbs/">Logging Breadcrumbs</Link>
- <Link to="/clients/python/integrations/">Integrations</Link>
...
- <Link to="/clients/python/transports/">Transports</Link>
- <Link to="/clients/python/platform-support/">Supported Platforms</Link>
- <Link to="/clients/python/api/">API Reference</Link>

Resources:

- <Link to="/clients/python/">Documentation</Link>
