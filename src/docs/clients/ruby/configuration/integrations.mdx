...
sidebar_order: 900
redirect_from:
  - /clients/ruby/integrations/
  - /platforms/ruby/integrations/
description: "Learn about the automatic integrations Sentry provides and how to configure them."
---

For common environments and frameworks like [Rails](/platforms/ruby/guides/rails/), [Rack](/platforms/ruby/guides/rack/), and others, we provide automatic integration for reporting. Most of the time you don’t need to change anything, although you can configure those features if you want.
