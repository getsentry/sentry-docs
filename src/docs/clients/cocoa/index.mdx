...
A new Cocoa SDK has superseded this deprecated version. Sentry preserves this documentation for customers using the old client. We recommend using the <Link to="/platforms/cocoa/">updated Cocoa SDK</Link> for new projects.
