...
A new Node SDK has superseded this deprecated version. Sentry preserves this documentation for customers using the old client. We recommend using the <Link to="/platforms/node">updated Node SDK</Link> for new projects.
...
You can optionally pass an object of configuration options as the 2nd argument to _Raven.config_. For more information, see <Link to="/clients/node/config/">_Configuration_</Link>.
...
For more information on reporting errors, see <Link to="/clients/node/usage/">_Usage_</Link>.
...
If you’re using Node.js with a web server framework/library like Connect, Express, or Koa, it is recommended to configure one of Raven’s server middleware integrations. See <Link to="/clients/node/integrations/">_Integrations_</Link>.
...
- <Link to="/clients/node/config/">Configuration</Link>
- <Link to="/clients/node/usage/">Usage</Link>
- <Link to="/clients/node/integrations/">Integrations</Link>
...
- <Link to="/clients/node/sourcemaps/">Source Maps</Link>
- <Link to="/clients/node/typescript/">Source Maps</Link>
- <Link to="/clients/node/coffeescript/">CoffeeScript</Link>
