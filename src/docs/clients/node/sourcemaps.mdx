...
Additional information can be found in the <Link to="/api/releases/">Releases API documentation</Link>.
...
If you are not doing this, eg. you are using TypeScript and upload all your compiled files separately to the server, then we need to be a little smarter about this. Please refer to <Link to="/clients/node/typescript/">TypeScript usage docs</Link> to see a more complex and detailed example.
