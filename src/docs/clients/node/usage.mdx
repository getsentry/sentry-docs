...
To learn more about what types of data can be collected via breadcrumbs, see the [breadcrumbs client API specification](/platforms/node/enriching-error-data/breadcrumbs/).
