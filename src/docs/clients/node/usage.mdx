...
: The fingerprint for grouping this event. Learn more how <Link to="/data-management/event-grouping/">Sentry groups errors</Link>.
...
To learn more about what types of data can be collected via breadcrumbs, see the <Link to="/platforms/node/enriching-error-data/breadcrumbs/">breadcrumbs client API specification</Link>.
...
For more on configuring breadcrumbs, see <Link to="/clients/node/config/">_Configuration_</Link>.
