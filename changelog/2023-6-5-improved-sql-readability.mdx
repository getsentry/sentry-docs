...
![](https://storage.googleapis.com/sentry-docs-changelog/improved-sql-readability-1.jpg)

*After:*

![](https://storage.googleapis.com/sentry-docs-changelog/improved-sql-readability-2.jpg)
